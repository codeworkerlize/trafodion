...
--set param ?filter 'SE_OFFENDER=30' ; -- 30 seconds
select current_timestamp "CURRENT_TIMESTAMP"             -- (1) Now
       ,cast(tokenstr('blockedFor:', variable_info)      -- (2) SumIOTime 
             as NUMERIC(18)) TOTAL_IO_TIME_IN_SECS
       ,cast(text as varchar(10)) PROCESS_ID             -- (3) process id 

...
public class SingleModeTest1 extends BaseTest {
    ...
    private void testTableLockSingleMode(int lockMode) {
        ...
        assertTrue(lockManager.validateAllLocks("test table lock single lock mode with lockReleaseAll " + getLockModeName(lockMode)));
    }

...
/**
 * 测试释放锁接口lockReleaseAll
 */
@FixMethodOrder(MethodSorters.JVM)
public class TestLockConflict1 extends BaseTest {
    ...
    private void testTableLockConflict(int lockMode, int lockMode1) {
        ...
        assertTrue(lockManager.validateAllLocks("test table lock conflict with lockReleaseAll " + getLockModeName(lockMode) + " " + getLockModeName(lockMode1)));
    }
    ...
    private void testRowLockConflict(int lockMode, int lockMode1) {
        ...
        releaseAll(lockManager, lockObject1);
        assertTrue(checkLockApply(0));
        assertTrue(lockManager.validateAllLocks("test row lock with lockReleaseAll " + getLockModeName(lockMode) + " " + getLockModeName(lockMode1)));
    }
}

...
public class TrxTableClient4 {
  ...
  static Table t = null;
  static long id = 1L;
  static long startIdVal = -1;
  static long commitIdVal = -1;
 ...
 // Initialize and set up tables 
    public static void initialize() throws Exception {
     ...
     System.out.println("TrxTableClient4 start ");
  ...
  static public void testGet() throws IOException {
    ...
    Batch.Call<TrxRegionService, GetTransactionalResponse> callable = 
      ...
      public GetTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        //Get get = new Get(ROW1).addColumn(FAMILY, VALUE1);
  ...
  static public void main(String[] args) {
    ...
    try {
      ...
      testGet();
      testCommitRequest();
      // Read-only transaction, so no commit

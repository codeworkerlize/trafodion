...
public class TrxTableClient {
 ...
 // Initialize and set up tables 
  ...
  static public void testBeginTransaction() throws IOException {
    ...
    Batch.Call<TrxRegionService, BeginTransactionResponse> callable = 
      ...
      try {
        ...
        System.out.println("BeginTransactionResponse exception " + e );
        e.printStackTrace();
      }
      for (BeginTransactionResponse bresponse : result.values())
      {
        boolean hasException = bresponse.getHasException();
        String exception = bresponse.getException();
        if (hasException)
        {
          System.out.println("BeginTransactionResponse exception " + exception );
          throw new IOException(exception);
        }
      }
  ...
  static public void testCheckAndPut() throws IOException {
    ...
    Batch.Call<TrxRegionService, CheckAndPutResponse> callable = 
      ...
      public CheckAndPutResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW1, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
  ...
  static public void testCheckAndPut2() throws IOException {
    ...
    Batch.Call<TrxRegionService, CheckAndPutResponse> callable = 
      ...
      public CheckAndPutResponse call(TrxRegionService instance) throws IOException {        
        ...
        builder.setQualifier(HBaseZeroCopyByteString.wrap(QUAL_A));
        builder.setValue(HBaseZeroCopyByteString.wrap(VALUE1));
        Put p = new Put(ROW1, startIdVal).addColumn(FAMILY, QUAL_B, Bytes.toBytes(2));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
      ...
      try {
        ...
        System.out.println("  testCheckAndPut2Response exception " + e );
        e.printStackTrace();
      }
      for (CheckAndPutResponse cresponse : result.values())
      {
  ...
  static public void testCheckAndPut3() throws IOException {
    ...
    Batch.Call<TrxRegionService, CheckAndPutResponse> callable = 
      ...
      public CheckAndPutResponse call(TrxRegionService instance) throws IOException {        
        ...
        builder.setQualifier(HBaseZeroCopyByteString.wrap(QUAL_A));
        builder.setValue(HBaseZeroCopyByteString.wrap(VALUE1));
        Put p = new Put(ROW2, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testCheckAndPut4() throws IOException {
    ...
    Batch.Call<TrxRegionService, CheckAndPutResponse> callable = 
      ...
      public CheckAndPutResponse call(TrxRegionService instance) throws IOException {        
        ...
        builder.setQualifier(HBaseZeroCopyByteString.wrap(QUAL_A));
        builder.setValue(HBaseZeroCopyByteString.wrap(VALUE2));
        Put p = new Put(ROW2, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(2));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
    ...
    Batch.Call<TrxRegionService, CommitResponse> callable = 
      ...
      try {
        result = t.coprocessorService(TrxRegionService.class, HConstants.EMPTY_START_ROW, HConstants.EMPTY_END_ROW, callable);
         ...
         t.printStackTrace();
         System.out.println("  testCommit exception " + t );
      }
  ...
  static public void testGet() throws IOException {
    ...
    System.out.println("Finished testGet " + result);
    return;
  } 
  ...
  static public void testPut3() throws IOException {
    ...
    Batch.Call<TrxRegionService, PutTransactionalResponse> callable = 
      ...
      public PutTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW3, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testPut4() throws IOException {
    ...
    Batch.Call<TrxRegionService, PutTransactionalResponse> callable = 
      ...
      public PutTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW4, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testPut5() throws IOException {
    ...
    Batch.Call<TrxRegionService, PutTransactionalResponse> callable = 
      ...
      public PutTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW5, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testPut6() throws IOException {
    ...
    Batch.Call<TrxRegionService, PutTransactionalResponse> callable = 
      ...
      public PutTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW6, startIdVal).addColumn(FAMILY, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testPutException() throws IOException {
    ...
    Batch.Call<TrxRegionService, PutTransactionalResponse> callable = 
      ...
      public PutTransactionalResponse call(TrxRegionService instance) throws IOException {        
        ...
        Put p = new Put(ROW1, startIdVal).addColumn(FAMILYBAD, QUAL_A, Bytes.toBytes(1));
        MutationProto m1 = ProtobufUtil.toMutation(MutationType.PUT, p);
        builder.setPut(m1);
  ...
  static public void testPerformScan(final int nextCallSeq) throws IOException {
    ...
    try {
      presult = t.coprocessorService(TrxRegionService.class, HConstants.EMPTY_START_ROW, HConstants.EMPTY_END_ROW, callable);
      System.out.println("testPerformScan step 1 ");
    } catch (Throwable e) {
      System.out.println("testPerformScan step 1 exception " + e);
    }
  ...
  static public void testOpenScanner() throws IOException {
    ...
    try {
      ...
      System.out.println("  testOpenScanner exception " + e );
      e.printStackTrace();
    }
  ...
  static public void testRecoveryRequest() throws IOException {
    ...
    Batch.Call<TrxRegionService, RecoveryRequestResponse> callable = 
      ...
      try {
        rresult = t.coprocessorService(TrxRegionService.class,
                  HConstants.EMPTY_START_ROW, HConstants.EMPTY_END_ROW, callable);
      } catch (Throwable e) {
        System.out.println("  testRecoveryRequest exception " + e );
        e.printStackTrace();
      }
  ...
  static public void main(String[] args) {
    ...
    try {
      ...
      id++; //Should be 10 // should be COMMIT_SUCCESSFUL
      testBeginTransaction();
      testPut();
      testCommitRequest();
      testCommit();

      id++; //Should be 11 // should have one from the Get
      testBeginTransaction();
      testGet();
      testCommitIfPossible();
      ...
      id++; //Should be 13  // Should have no rows
      testBeginTransaction();
      testGet();
      testCommitIfPossible();
      ...
      id++; //Should be 21  // should be COMMIT_SUCCESSFUL with six rows
      testBeginTransaction();
      testPut1();
      testPut2();
      testPut3();
      ...
      testPerformScan(1);  // Get the second three
      testCloseScanner();
      testCommitIfPossible();

      id++; //Should be 22  Should show ROW1
      testBeginTransaction();
      testGet();
      testCommitIfPossible();
      ...
      id++; //Should be 24  Should show zero rows
      testBeginTransaction();
      testGet();
      testCommitIfPossible();
...
/*
      testBeginTransaction();
      testPutException();
      int ret = testCommitRequest();
      if (ret < 3){
         try {
            testCommit();
         } catch (IOException e) {
            System.out.println("TestPutException threw IOException " + e);
         } catch (Throwable t) {
            System.out.println("TrxPutException threw throwable exception " + t);
         }
      }
      else {
         testAbortTransaction();
...
*/
      ...
      System.out.println("TrxTableClient threw IOException " + e);
    } catch (Throwable t) {
      System.out.println("TrxTableClient threw throwable exception " + t);
    }

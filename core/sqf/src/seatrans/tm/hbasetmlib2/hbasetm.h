...
private:
   ...
   static JavaMethodInitTM * JavaMethods_;
...
private:
   ...
   JavaMethodInitTM JavaMethods_[JM_TMLAST];
   static jclass       javaClass_;
...
public:
   ...
   short prepareCommit(int64 pv_transid, char *querycontext, int querycontext_len, char *errstr, int &errstrlen);
   ...
   int regTruncateOnAbort(int64 pv_transid,
                           ...
                           char *errstr,
                           int &errstrlen);
   int pushOnlineEpoch(int64 pv_transid,
   ...
   short commitSavepoint(int64 pv_transid, int64 pv_svpt_id, int64 pv_psvpt_id = 0);
   short abortSavepoint(int64 pv_transid, int64 pv_svpt_id, int64 pv_psvpt_id = 0);

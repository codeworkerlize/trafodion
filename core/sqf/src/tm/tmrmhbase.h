...
class RM_Info_HBASE :public virtual RM_Info
{
    public:
      ...
      virtual int32 hb_epoch_operation(CTmTxBase *pp_txn, CTmTxMessage * pp_msg);
      virtual int32 hb_ddl_operation(CTmTxBase *pp_txn, int64 pv_flags, CTmTxMessage * pp_msg);

      virtual int32 commit_savepoint(CTmTxBase *pp_txn, CTmTxMessage * pp_msg);
      virtual int32 rollback_savepoint(CTmTxBase *pp_txn, CTmTxMessage * pp_msg);
};

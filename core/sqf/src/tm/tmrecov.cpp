...
{
   CTmTxKey lv_txKey(pp_transid->iv_instance_cluster_id, pp_transid->iv_node, pp_transid->iv_seq_num);
...
CTmRmTxRecoveryState *TM_Recov::get_txState(TM_Txid_Internal *pp_transid)
{
   ...
   CTmTxKey lv_key(pp_transid->iv_instance_cluster_id, pp_transid->iv_node, pp_transid->iv_seq_num);
...
void TM_Recov::add_txinfo(TM_TX_Info *pp_txinfo)
{
   ...
   CTmTxKey lv_txKey(pp_txinfo->transid()->iv_instance_cluster_id, pp_txinfo->transid()->iv_node, pp_txinfo->seqnum());
...
TM_TX_Info * TM_Recov::get_txinfo(TM_Txid_Internal *pp_transid)
{
   ...
   CTmTxKey k(pp_transid->iv_instance_cluster_id, pp_transid->iv_node, pp_transid->iv_seq_num);

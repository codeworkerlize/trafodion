...
// Interval for tm to refresh in seconds
#define TM_REFRESH_MON_DEFAULT 5
...
typedef enum {
    ...
    TM_MSG_TYPE_COMMIT_SAVEPOINT         = 223,
    TM_MSG_TYPE_COMMIT_SAVEPOINT_REPLY   = 224,
    TM_MSG_TYPE_ROLLBACK_SAVEPOINT       = 225,
    TM_MSG_TYPE_ROLLBACK_SAVEPOINT_REPLY = 226,
    ...
    TM_MSG_TYPE_SDNTRAN                  = 347,
    TM_MSG_TYPE_SDNTRAN_REPLY            = 348,

    TM_MSG_TYPE_PUSHEPOCHREQUEST         = 349,
    TM_MSG_TYPE_PUSHEPOCHREQUEST_REPLY   = 350,
    ...
    TM_MSG_TXINTERNAL_REFRESH_MON        = 1029
} TM_MSG_TYPE;
...
typedef struct epochmessage_req {
    TM_Transid_Type     iv_transid;
    char                epochreq[TM_MAX_TABLE_STRING];
    int                 epochreq_len;
    char                key_eyecatch[10];
} Epoch_Message_Req_Type;
...
typedef struct _tmlibmsg_h_as_3 {
    ...
    int              iv_pid;
    int              iv_nid;
    int              iv_querycontext_len;
    char             ia_querycontext[TM_MAX_QUERYCONTEXT_STRING];
...
typedef struct _tmlibmsg_h_as_24 {
    TM_Transid_Type  iv_transid;
    int              iv_tag;
    int              iv_pid;
    int              iv_nid;
    int64            iv_svpt_id;  //savepoint id
    int64            iv_psvpt_id; //parent savepoint id
} Commit_Svpt_Req_Type;

typedef struct _tmlibmsg_h_as_25 {
    TM_Transid_Type     iv_transid;
    int                 iv_tag;
    int                 iv_pid;
    int                 iv_nid;
...
typedef struct _tmlibmsg_h_as_23 {
    ...
    union {
        ...
        Epoch_Message_Req_Type  iv_push_epoch;
        ...
        // Savepoint requests
        Commit_Svpt_Req_Type iv_commit_svpt;
        Abort_Svpt_Req_Type  iv_abort_svpt;
    } u;
} Tm_Req_Msg_Type;
...
typedef struct epochrequest_rsp {
    char	iv_err_str[TM_MAX_ERROR_STRING];
    int     iv_err_str_len;
} Epoch_Request_Rsp_Type;
...
typedef struct _tmlibmsg_h_as_45 {
  char      iv_err_str[TM_MAX_ERROR_STRING];
  int       iv_err_str_len;
} Commit_Svpt_Rsp_Type;

typedef struct _tmlibmsg_h_as_46 {
} Abort_Svpt_Rsp_Type;
...
typedef struct _tmlibmsg_h_as_44 {
    ...
    union {
        ...
        Epoch_Request_Rsp_Type  iv_push_epoch_response;
        ...
        // savepoint responses
        Commit_Svpt_Rsp_Type iv_commit_svpt;
        Abort_Svpt_Rsp_Type  iv_abort_svpt;
    } u;
} Tm_Rsp_Msg_Type;

...
//------------------------------------------------------------------------
// TM_DEQUE::push_nolock
// Purpose : pushes data to the front of the queue without lock the queue.
// This is used to push data in FIFO order to the queue.
//------------------------------------------------------------------------
void TM_DEQUE::push_nolock(void *pp_data)
{
    iv_deque.push_front(pp_data);
}
...
//------------------------------------------------------------------------
// TM_DEQUE::remove_all_nolock
// Purpose : Delete all the entries specified in pp_data without lock.
//------------------------------------------------------------------------
void TM_DEQUE::remove_all_nolock(void *pp_data)
{
  if (pp_data == NULL)
    return;

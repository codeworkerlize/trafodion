...
public:
    ...
    CTmTxKey(int16 pv_instance_cluster_id, int32 pv_node, int32 pv_seqnum) {set(pv_instance_cluster_id, (int16) pv_node, pv_seqnum);}
    ...
    void set(int16 pv_instance_cluster_id, int16 pv_node, int32 pv_seqnum)
    {
        iv_key.s.iv_instance_cluster_id = pv_instance_cluster_id;
        iv_key.s.iv_node       = pv_node;
        iv_key.s.iv_seqnum     = pv_seqnum;
    }
    int32 node() {

...
class TMLIB : public JavaObjectInterfaceTM
{
   private:
        ...
        static const char *mrminterface_classname;

        static jclass hbasetxclient_class;
        static jclass RMInterface_class;
        static jclass MRMInterface_class;

        static JavaMethodInitTM *TMLibJavaMethods_;
 
        static bool javaMethodsInitialized_; 
        static bool enableCleanupRMInterface_;
        static bool enableCleanupMRMInterface_;
    ...
    public:
        ...
        short add_or_update(TM_Transid pv_transid, TM_Transseq_Type pv_startid,
                            SB_Int64_Type pv_svpt_id = -1, SB_Int64_Type pv_psvpt_id = -1,
        ...
        bool enableCleanupMRMInterface() {return enableCleanupMRMInterface_;}
        void enableCleanupMRMInterface(bool pv_bool) {enableCleanupMRMInterface_=pv_bool;}

...
TM_Transid::operator= (const TM_Txid_Internal &rhs)
{
    ...
    iv_tx.txid.iv_instance_cluster_id = rhs.iv_instance_cluster_id;
...
bool TM_Transid::operator== (TM_Transid &rhs)
{
    if (iv_tx.txid.iv_seq_num == rhs.get_seq_num() &&
        ...
        iv_tx.txid.iv_instance_cluster_id == rhs.get_instance_clusterid() &&
...
int16 TM_Transid::get_instance_clusterid()
{
    int16 *instance_cluster_id = (int16 *)&iv_tx.txid.iv_instance_cluster_id;
    return *instance_cluster_id;
}

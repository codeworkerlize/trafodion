...
my $en = $ENV{'SB_TEST_IDTM_ENABLED'};
if ($en == '1') {
    sqconfigdb::addDbPersistData( "PERSIST_PROCESS_KEYS", "DTM,PSD,WDG,GSID"  );
    sqconfigdb::addDbPersistData( "GSID_PROCESS_NAME", "\$GSID0"  );
    sqconfigdb::addDbPersistData( "GSID_PROCESS_TYPE", "TMID"  );
    sqconfigdb::addDbPersistData( "GSID_PROGRAM_NAME", "idtmsrv"  );
    sqconfigdb::addDbPersistData( "GSID_PROGRAM_ARGS", "-v -norefresh"  );
    sqconfigdb::addDbPersistData( "GSID_REQUIRES_DTM", "N"  );
    sqconfigdb::addDbPersistData( "GSID_STDOUT", "stdout_GSID0"  );
    sqconfigdb::addDbPersistData( "GSID_PERSIST_RETRIES", "2,30"  );
    sqconfigdb::addDbPersistData( "GSID_PERSIST_ZONES", "%zid+"  );
}
else {

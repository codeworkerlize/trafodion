...
namespace SB_Trans {
    ...
    public:
        ...
        virtual int                wait_req_done(MS_Md_Type *pp_md, int timeout) = 0;
        //                         reply-done
    ...
    public:
        ...
        virtual int               wait_req_done(MS_Md_Type *pp_md, int timeout);
        //                        request-done
        static  int               wait_req_done_static(MS_Md_Type *pp_md);
        static  int               wait_req_done_static(MS_Md_Type *pp_md, int timeout);
        //                        reply-done
        virtual void              wait_rep_done(MS_Md_Type *pp_md);

        void                      is_stopped_inc();
        int                       is_stopped_get();
        void                      is_stopped_set(int pv_val);

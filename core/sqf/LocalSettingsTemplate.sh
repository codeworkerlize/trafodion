...
if [ "x${ARCH}" = "xx86_64" ]; then
    ...
    LLVM="${TOOLSDIR}/dest-llvm-3.8.1"
    THRIFT_LIB_DIR="$TOOLSDIR/thrift-0.10.0/lib"
    THRIFT_INC_DIR="$TOOLSDIR/thrift-0.10.0/include"
fi
...
LOG4CPLUS_LIB_DIR="$TOOLSDIR/log4cplus-1.2.1-c++0x/lib"
LOG4CPLUS_INC_DIR="$TOOLSDIR/log4cplus-1.2.1-c++0x/include"

...
public:
    ...
    inline void refreshIdtm(unsigned long counter)
       { ((SharedMemHdr *) ip_cshm)->lastIdtmRefresh = counter; }

    inline void refreshDTM(unsigned long ts)
       { ((SharedMemHdr *) ip_cshm)->lastDTMRefresh = ts; }

...
public:
  ...
  inline unsigned long getLastIdtmRefresh()
     {  return ((SharedMemHdr *) clientBuffers)->lastIdtmRefresh; }

  inline unsigned long getLastDTMRefresh()
     {  return ((SharedMemHdr *) clientBuffers)->lastDTMRefresh; }

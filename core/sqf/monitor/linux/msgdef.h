...
typedef enum {
    ...
    MsgType_Feature,                        // enable/disable feature
...
{     
    char  license[LICENSE_NUM_BYTES_MAX];        // valid if success == true
...
struct Startup_reply_def
{
    ...
    int   startup_size;                     // size of this struct
    int return_code;                        // error returned to sender
    short features;                         // enabled features

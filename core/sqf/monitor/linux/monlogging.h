...
extern bool terminateMonitor;

extern void mon_failure_exit();
...
{
public:
    CMonLog( const char *log4cplusConfig
...
private:
    ...
    // log4cplus configuration file name
    string log4cplusConfig_;

    // log4cplus component
    string log4cplusComponent_;

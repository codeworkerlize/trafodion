...
function usage {
   ...
   print_usage_line "-prodver" "Specifies product version(open,EsgynDB) in the version string."
...
/*prodver*/
#define VERS_PRODVER $(echo $prodver | sed -e "s: :_:g")
...
Implementation-Version-5: branch $(echo $funbranch | sed -e "s:_dh_:-:g")
...
[ -z "$major" ]  && major="$TRAFODION_VER_MAJOR"
[ -z "$minor" ]  && minor="$TRAFODION_VER_MINOR"
[ -z "$update" ] && update="$TRAFODION_VER_UPDATE"
[ -z "$prodver" ] && prodver="$TRAFODION_VER_PROD"
[ -z "$copyright" ] && copyright=" Copyright (c) $PRODUCT_COPYRIGHT_HEADER"

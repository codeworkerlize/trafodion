...
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,2,2,&(systemDefaults_[0]),(long)0,
&(defName[0]),(long)0)) != 0);}
...
27};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,2,2,&(defaultValue[0]),(long)0,
&(textSize),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,2,2,&(catsysName_[0]),(long)0,&(catUID)
,(long)0)) != 0);}
...
24};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,1,2,&(catName),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,2,2,&(catsysName_[0]),(long)0,
&(catName[0]),(long)0)) != 0);}
...
23};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,1,2,&(catUID),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,2,2,&(schemataName_[0]),(long)0,
&(catUID),(long)0)) != 0);}
...
32};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,1,2,&(ver),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,1,2,&(catsysName_[0]),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,3,2,&(objectsTable[0]),(long)0,
...
18};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,4,2,&(hostVarP->objectUID_),(long)0,
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,2,2,&(txtTbl[0]),(long)0,&(objUID),
(long)0)) != 0);}
...
29};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,2,2,&(mvDescText),(long)0,
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Exec(&__SQL_id0,&__SQL_id1,1,2,&(rewriteTable[0]),(long)0)) != 0);}
...
27};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,10,2,&(hostVarP->operationTimestamp_),
...
20};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_Fetch(&__SQL_id0,&__SQL_id1,2,2,&(objName[0]),(long)0,
&(schName[0]),(long)0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_SetDescPointers(&__SQL_id1,1,1,2,&(cqdText[0]),(long)0)) != 0 ||(
...
7};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_ExecFetch(&__SQL_id0,(long)0,0,0)) != 0);}
...
33};
if ((SQLCODE = SQL_EXEC_ClearDiagnostics(&__SQL_id0))  != 0 ||(SQLCODE = 
SQL_EXEC_SetDescPointers(&__SQL_id1,1,1,2,&(catRequestText[0]),(long)0))

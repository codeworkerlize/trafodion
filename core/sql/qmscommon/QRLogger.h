...
public:
   ...
   * Must be called before initlog4cplus().
   * Used for the default initialization in case the log4cplus configuration
   * file is not found.

...
class REFRESH_LIB_CLASS CRUDeltaDefList : public CDSPtrList<CRUDeltaDef> {
 ...
 public:
  CRUDeltaDefList(EOwnership ownership = eItemsAreOwned) : inherited(ownership) {}
  ~CRUDeltaDefList() {}
...
class REFRESH_LIB_CLASS CRUDeltaStatisticsMap : public CDSLongMap<CRUDeltaStatistics> {
 public:
...
class REFRESH_LIB_CLASS CRUUpdateBitmap {
 ...
 public:
  //-- Pack/unpack for IPC
  static CRUUpdateBitmap *CreateInstance(CUOFsIpcMessageTranslator &translator);

...
class REFRESH_LIB_CLASS CRUSimpleRefreshTaskExecutor : public CRURefreshTaskExecutor {
  //----------------------------------//
  //	Public Members
  //----------------------------------//
 private:
 ...
 public:
  BOOL IsSingleDeltaRefresh() const { return isSingleDeltaRefresh_; }
 ...
 protected:
  ...
  void IncrementNumOfPhases() { numOfPhases_++; }
 ...
 private:
  ...
  CRUSimpleRefreshTaskExecutor &operator=(const CRUSimpleRefreshTaskExecutor &other);
 ...
 private:
  ...
  enum { MORE_PHASE_CODE = 12304, MIN_MAX_RECOMPUTATION_NEEDED = -12308, MULTIDELTA_RECOMPUTATION_NEEDED = -12319 };
  ...
  enum { CHECK_RMS_EACH_N_STMT = 10, PERCENT_OF_RMS_SMEM_USED = 90 };
#endif

...
void CRUDupElimGlobals::Init(BOOL isRangeResolv, BOOL isSingleRowResolv, Lng32 updateBmpSize, Lng32 nCtrlColumns,
                             Lng32 nCKColumns, TInt32 lastDEEpoch, TInt32 beginEpoch, TInt32 endEpoch,
                             Lng32 rangeLogType, BOOL wasPrevDEInvocationCompleted, BOOL isSkipCrossTypeResoultion) {

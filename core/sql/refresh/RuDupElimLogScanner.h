...
class REFRESH_LIB_CLASS CRUDupElimLogScanner : public CRUDupElimTaskExUnit {
 ...
 public:
  CRUDupElimLogScanner(const CRUDupElimGlobals &globals, CRUSQLDynamicStatementContainer &ctrlStmtContainer);
  ...
  //-----------------------------------------//
 public:
  CRUIUDLogRecord *GetCurrentRecord() const { return pCurrentRec_; }

  CRUIUDLogRecord *GetPrevRecord() const { return pPrevRec_; }

 public:
  BOOL IsEntireDeltaScanned() const { return isEntireDeltaScanned_; }

  const CRUEmpCheckVector &GetEmpCheckVector() const { return empCheckVector_; }

  const CRUDeltaStatisticsMap &GetStatisticsMap() const { return statMap_; }
 ...
 public:
  ...
  void SetEmpCheckVector(const CRUEmpCheckVector &ecVec) { empCheckVector_ = ecVec; }
 ...
 public:
  ...
  virtual void LoadReply(CUOFsIpcMessageTranslator &translator) { statMap_.LoadData(translator); }
  ...
  virtual void StoreReply(CUOFsIpcMessageTranslator &translator) { statMap_.StoreData(translator); }

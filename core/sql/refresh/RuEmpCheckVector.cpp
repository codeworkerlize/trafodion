...
CRUEmpCheckVector::CRUEmpCheckVector() : pVec_(NULL), size_(0), isFinal_(FALSE) {}

CRUEmpCheckVector::CRUEmpCheckVector(const CRUEmpCheckVector &other) : size_(other.size_), isFinal_(other.isFinal_) {
  if (0 == size_) {
    return;
  }
...
CRUEmpCheckVector::~CRUEmpCheckVector() { delete[] pVec_; }
...
CRUEmpCheckVector &CRUEmpCheckVector::operator=(const CRUEmpCheckVector &other) {
  if (this == &other) {
    return *this;
  }

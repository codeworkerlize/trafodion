...
class REFRESH_LIB_CLASS CRURefreshTask : public CRUTask {
 ...
 public:
  ...
  CRUMV &GetRootMV() const { return rootMV_; }
  ...
  CRUDeltaDefList &GetDeltaDefList() const { return GetRootMV().GetDeltaDefList(); }

  BOOL IsSingleDeltaRefresh() const { return GetRootMV().IsSingleDeltaRefresh(); }

 public:
  //-- Implementation of pure virtual functions
  virtual CRUTask::Type GetType() const { return CRUTask::REFRESH; }
 ...
 public:
  ...
  BOOL IsRecompute() const { return GetRootMV().WillBeRecomputed(); }
 ...
 protected:
  ...
  virtual BOOL IsImmediate() const { return (FALSE == NeedToExecuteInternalRefresh()); }

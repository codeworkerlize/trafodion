...
class REFRESH_LIB_CLASS CRUTask {
 ...
 public:
  ...
  TInt32 GetGain() const { return gain_; }
 ...
 public:
  ...
  CRUTaskList &GetTasksThatIDependOn() const { return *pPredList_; }

  // What are the tasks that depend on me?
  CRUTaskList &GetTasksThatDependOnMe() const { return *pSuccList_; }
 ...
 public:
  ...
  //-----------------------------------//
 public:
  void SetRunning(BOOL val) { isRunning_ = val; }

  void SetExecuted(BOOL val) { wasExecuted_ = val; }
 ...
 private:
  ...
  TInt32 GetCost() const { return cost_; }
...
class REFRESH_LIB_CLASS CRUTaskList : public CDSPtrList<CRUTask> {
 ...
 public:
  CRUTaskList(EOwnership ownership = eItemsAreOwned) : inherited(ownership) {}
  ~CRUTaskList() {}
...
inline BOOL CRUTask::IsReady() const { return (0 == GetTasksThatIDependOn().GetCount()); }

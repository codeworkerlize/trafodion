...
CRUSQLDynamicStatementContainer::CRUSQLDynamicStatementContainer(short nStmts)
    : CRUSQLStatementContainer(nStmts), pDynamicStmtVec_(new CRUSQLDynamicStatementContainer::DynamicStmt[nStmts]) {}

CRUSQLDynamicStatementContainer::~CRUSQLDynamicStatementContainer() { delete[] pDynamicStmtVec_; }

CRUSQLDynamicStatementContainer::DynamicStmt::DynamicStmt()
    : sql_(NULL), prepared_(FALSE), paramNum_(0), paramSumStringSize_(0){};

CRUSQLDynamicStatementContainer::DynamicStmt::~DynamicStmt() {
  if (sql_ != NULL) delete sql_;
}
...
char const *CRUSQLDynamicStatementContainer::DynamicStmt::GetLastSQL() {
...
void CRUSQLDynamicStatementContainer::DynamicStmt::SetStatementText(const CDSString &sql) {
...
CDMPreparedStatement *CRUSQLDynamicStatementContainer::DynamicStmt::GetPreparedStatement(BOOL DeleteUsedStmt) {
  if (FALSE == prepared_) {
...
void CRUSQLDynamicStatementContainer::DynamicStmt::SetCompiledTimeParam(short paramIndex, const CDSString &value) {
  ...
  // statement
  paramSumStringSize_ += value.GetLength() - params_[paramIndex].GetLength();

  RUASSERT(strlen(sql_) + paramSumStringSize_ < CUOFsIpcMessageTranslator::MaxMsgSize);
...
void CRUSQLDynamicStatementContainer::DynamicStmt::PrepareSqlText(char *buffer) {
  buffer[0] = '\0';
  ...
  CRUGlobals::GetInstance()->LogDebugMessage(CRUGlobals::DUMP_COMPILED_DYNAMIC_SQL, "", msg);
#endif
}
...
void CRUSQLDynamicStatementContainer::DynamicStmt::StoreData(CUOFsIpcMessageTranslator &translator) {
...
void CRUSQLDynamicStatementContainer::DynamicStmt::LoadData(CUOFsIpcMessageTranslator &translator) {

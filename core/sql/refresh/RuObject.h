...
class REFRESH_LIB_CLASS CRUObject {
 ...
 public:
  BOOL IsDDLLockPending() const { return isDDLLockPending_; }
  ...
  BOOL CanReleaseDDLLock() const { return canReleaseDDLLock_; }
 ...
 public:
  ...
  //--------------------------------//
 public:
  void SetInvolved() { isInvolved_ = TRUE; }
 ...
 public:
  ...
  void SetReleaseDDLLock(BOOL flag) { canReleaseDDLLock_ = flag; }

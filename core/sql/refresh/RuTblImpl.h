...
class REFRESH_LIB_CLASS CRURegularTbl : public CRUTbl {
 ...
 public:
  ...
  //--------------------------------//
 public:
  virtual const CDSString &GetFullName() { return pddTable_->GetFullName(); }
  virtual const CDSString &GetCatName() { return pddTable_->GetCatName(); }
  virtual const CDSString &GetSchName() { return pddTable_->GetSchName(); }
  virtual const CDSString &GetName() { return pddTable_->GetName(); }
  virtual BOOL IsAudited() { return pddTable_->GetIsAudited(); }
  virtual BOOL IsRegularTable() const { return TRUE; }
  virtual BOOL IsFullySynchronized() { return TRUE; }
 ...
 protected:
  ...
  virtual CDDKeyColumnList *GetDDKeyColumnList() { return pddTable_->GetKeyColumnList(); }

  // Get the list of detailed info about all the columns
  virtual CDDColumnList *GetDDColumnList() { return pddTable_->GetColumnList(); }

  virtual CUOFsFileList *GetPartitionFileList() { return pddTable_->GetPartitionFileList(); }
 ...
 protected:
  ...
  virtual void DropDDLLock(const CDSString &name) { pddTable_->DropDDLLock(name); }
...
class REFRESH_LIB_CLASS CRUMVTbl : public CRUTbl {
 ...
 public:
  ...
  virtual BOOL IsRegularTable() const { return FALSE; }
  virtual BOOL IsFullySynchronized() { return (CDDObject::eON_STATEMENT == pddMV_->GetRefreshType()); }
  virtual BOOL IsAudited() { return (CDDObject::eAUDIT == pddMV_->GetAuditType()); }

  virtual BOOL IsInitialized() { return (CDDObject::eINITIALIZED == pddMV_->GetMVStatus()); }
 ...
 protected:
  // Get the store by key column list
  virtual CDDKeyColumnList *GetDDKeyColumnList() { return pddMV_->GetKeyColumnList(); }

  // Get the list of detailed info about all the columns
  virtual CDDColumnList *GetDDColumnList() { return pddMV_->GetColumnList(); }

  // Get the list of all partitions
  virtual CUOFsFileList *GetPartitionFileList() { return pddMV_->GetPartitionFileList(); }

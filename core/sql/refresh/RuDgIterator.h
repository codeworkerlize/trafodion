...
class REFRESH_LIB_CLASS CRUDependenceGraphIterator {
 public:
  ...
  //----------------------------------------------//
 public:
  CRUTask *GetCurrentTask() { return pCurrentTask_; }
 ...
 protected:
  CRUTaskList &GetAllTasksList() const { return allTasksList_; }
  void SetCurrentTask(CRUTask *pTask) { pCurrentTask_ = pTask; }
...
class REFRESH_LIB_CLASS CRUTopologicalDGIterator : public CRUDependenceGraphIterator {
 private:
 ...
 public:
  CRUTopologicalDGIterator(CRUDependenceGraph &dg, IterationDir dir);

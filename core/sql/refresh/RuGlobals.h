...
class REFRESH_LIB_CLASS CRUGlobals {
 ...
 public:
  ...
  static void Init(CRUOptions &options, CRUJournal &journal, CUOFsTransManager &transManger);
 ...
 public:
  ...
  //-- Accessors
 public:
  CRUOptions &GetOptions() const { return options_; }

  CRUJournal &GetJournal() const { return journal_; }

  CUOFsTransManager &GetTransactionManager() const { return transManager_; }
 ...
 private:
  ...
  CRUGlobals();
  ~CRUGlobals();
  CRUGlobals(CRUOptions &options, CRUJournal &journal, CUOFsTransManager &transManger);

...
LongColumnPrinter::LongColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), data(nullptr) {
  // PASS
}
...
DoubleColumnPrinter::DoubleColumnPrinter(std::string &buffer, const Type &type)
    : ColumnPrinter(buffer), data(nullptr), isFloat(type.getKind() == FLOAT) {
  // PASS
}
...
Decimal64ColumnPrinter::Decimal64ColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), data(nullptr), scale(0) {
  // PASS
}
...
Decimal128ColumnPrinter::Decimal128ColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), data(nullptr), scale(0) {
  // PASS
}
...
StringColumnPrinter::StringColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), start(nullptr), length(nullptr) {
  // PASS
}
...
ListColumnPrinter::ListColumnPrinter(std::string &buffer, const Type &type) : ColumnPrinter(buffer), offsets(nullptr) {
...
MapColumnPrinter::MapColumnPrinter(std::string &buffer, const Type &type) : ColumnPrinter(buffer), offsets(nullptr) {
...
StructColumnPrinter::StructColumnPrinter(std::string &buffer, const Type &type) : ColumnPrinter(buffer) {
  for (unsigned int i = 0; i < type.getSubtypeCount(); ++i) {
...
DateColumnPrinter::DateColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), data(nullptr) {
  // PASS
}
...
BooleanColumnPrinter::BooleanColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), data(nullptr) {
  // PASS
}
...
BinaryColumnPrinter::BinaryColumnPrinter(std::string &buffer) : ColumnPrinter(buffer), start(nullptr), length(nullptr) {
  // PASS
}
...
void TimestampColumnPrinter::printRow(uint64_t rowId) {
  ...
  if (hasNulls && !notNull[rowId]) {
    ...
    char numBuffer[64];
    snprintf(numBuffer, sizeof(numBuffer), "%0*" INT64_FORMAT_STRING "d\"", static_cast<int>(NANO_DIGITS - zeroDigits),

...
void TDBDlgExprList::DisplayExprList() 
{
  ...
  for (int i = 0; i < imax; i++)
  {
      ...
      QTableWidgetItem * pItem0 = new QTableWidgetItem(QIcon(":/file/Resource/Main/Exprlist.bmp"), QString::fromLatin1(buf));
#else
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
      QTableWidgetItem *pItem2 = new QTableWidgetItem(QString::fromLatin1(buf));
#else
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
      QTableWidgetItem *pItem3 = new QTableWidgetItem(QString::fromLatin1(buf));
#else
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
      QTableWidgetItem *pItem4 = new QTableWidgetItem(QString::fromLatin1(buf));
#else
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
      QTableWidgetItem *pItem5 = new QTableWidgetItem(QString::fromLatin1(buf));
#else

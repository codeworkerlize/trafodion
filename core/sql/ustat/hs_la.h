...
class HSTableDef : public NABasicObject
  ...
  public:
    ...
    NAString * getAnsiName() { return ansiName_; }

    const NAString * getCatalog() { return catalog_; }
  ...
  public:
    ...
    Int64 getRowCount(NABoolean &isEstimate,
                      ...
                      NABoolean estimateIfNecessary = TRUE)
      {
        ...
        if ( getNATable()->isORC() || getNATable()->isParquet() ) {
          isEstimate = FALSE; // no estimate for ORC or Parquet

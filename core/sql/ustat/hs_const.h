...
#define IF_NOT_EXISTS_OPT 0x00400000               /* IF NOT EXISTS options   */
#define GEN_STATS_LIKE    0x00800000               /* GENERATE STATS LIKE     */
...
enum USTAT_ERROR_CODES {UERR_SYNTAX_ERROR                    = 15001,
                        ...
                        USERR_GENERATE_STATS_TABLE_NOT_SAME  = 9253,
                        USERR_GENERATE_STATS_INVALID_TABLE   = 9254,
                        USERR_GENERATE_STATS_HIST_EMPTY      = 9255,
                        USERR_CONFLICT_ERROR                 = 9256,
                        UERR_EXPRESSION_SYNTAX               = 9257,
                        UERR_EXPRESSION_SYNTAX_1             = 9258,
                        UERR_EXPRESSION_SEMANTICS            = 9259,
                        UERR_EXPRESSION_HISTOGRAMS_IGNORED_FOR_IUS = 9260,
                        UERR_CANT_LOCK                       = 9261,
                        UERR_LOCK_METHOD_FAILURE             = 9262,
                        UERR_PAR_TABLE_NOT_SUPPORT1          = 9263,
                        UERR_PAR_TABLE_NOT_SUPPORT2          = 9264,
                        UERR_PAR_TABLE_NOT_SUPPORT3          = 9265,
                        UERR_WARNING_PAR_TABLE1              = 9266,
                        UERR_NO_ERROR                        = 9267,
                        UERR_LAST_ERROR                      = 9267
                       };

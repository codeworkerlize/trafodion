...
// A class that manages a distributed lock for tables undergoing
// an UPDATE STATISTICS operation that has write semantics

class HSLongHeldLockController : public LongHeldLockController
{
  public:

    HSLongHeldLockController(const char * tableName, const char * commandText, NAHeap * heap);
    ~HSLongHeldLockController() {};

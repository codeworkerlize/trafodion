...
public:
  ...
  BeforeAndAfterTriggers(TriggerList *beforeTriggers,
			 TriggerList *beforeStatementTriggers,
			 TriggerList *beforeRowTriggers,
			 TriggerList *afterStatementTriggers,
			 TriggerList *afterRowTriggers,
			 int triggerCount,
			 ComTimestamp subjectTableTimestamp,
  ...
  // Accessors
  inline int getTtiggerCount() const
  { return triggerCount_; }
  inline TriggerList *getBeforeTriggers()	  const 
    { return beforeTriggers_; }
  inline TriggerList *getBeforeStatementTriggers() const
  { return beforeStatementTriggers_;  }
  inline TriggerList *getBeforeRowTriggers()      const
  { return beforeRowTriggers_;  }

                                 ...
                                 CollHeap * h)
{
  ...
  if (NAColumn::createNAType(column->columnsDesc(), NULL, 0, type, NULL))
    return NULL;
                           ...
                           ComDiagsArea * diagsArea)
{
  ...
  itemExpr = new(expGen->wHeap()) CompEncode(itemExpr, desc_flag, -1, CollationInfo::Sort,
                                             column->columnsDesc()->isNullable());

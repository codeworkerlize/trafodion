...
public:
  ...
  void setCompColInfo(NABoolean isCompCol, NABoolean isResolved,
                      UInt32 numCompParts, UInt32 numTotalParts,
                      NAList<NAString> &compNames, 
                      NAList<UInt32> &compArrIndexes)
  {

...
IsolatedScalarUDF::IsolatedScalarUDF(const QualifiedName &routineName, ItemExprList *inParams,
...
const NAString QueryInvalidationFunc::getText() const
{

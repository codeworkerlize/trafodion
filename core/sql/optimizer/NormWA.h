...
public:
  ...
  NormWA(CmpContext* cmpContext)
    : currentCmpContext_(cmpContext), subqUnderExprTreeCount_(0),
      ...
      nullCount_(0), notCount_(0), orCount_(0),
      dontAddRedundantPredicatesCount_(0), inConstraintsCount_(0),
  ...
  { walkingAnExprTreeCount_ = 
    ...
    nullCount_ = notCount_ = orCount_ = dontAddRedundantPredicatesCount_ = 
  ...
  // --------------------------------------------------------------------
  void setDontAddRedundantPredicatesFlag()
   { dontAddRedundantPredicatesCount_++; } 
  void restoreDontAddRedundantPredicatesFlag()
   { dontAddRedundantPredicatesCount_--; } 
  NABoolean dontAddRedundantPredicatesFlag() const    
   { return dontAddRedundantPredicatesCount_ > 0; }
  ...
  NABoolean createPredicateForFirstN()
          { return createPredicateForFirstN_;}
  void setCreatePredicateForFirstN(NABoolean val)
          {createPredicateForFirstN_ = val;}

...
public:
  ...
  static BeforeAndAfterTriggers *getAllTriggers(QualifiedName &subjectTable,
						Int64 tableId = -1,
  ...
  static BeforeAndAfterTriggers *getTriggers(QualifiedName &subjectTable,
                                             ComOperation   operation);

  static void putTriggers(QualifiedName &subjectTable,
                          ComOperation   operation,
                          BeforeAndAfterTriggers *triggers);

  static void removeTriggers(QualifiedName &subjectTable,
			     ComOperation   operation);

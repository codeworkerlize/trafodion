                       ...
                       )
{
  ...
  clusterInfo_ = new(&executorMemory_) NAClusterInfoLinux(&executorMemory_,
                                                          FALSE);
  ...
  if (! espProcess)
  {
    ...
    if (statsGlobals_ == NULL)
    {
      snprintf(msg, sizeof(msg),
               "shareStatsSegmentWithRetry return NULL");
...
int CliGlobals::createLocalCGroup(const char *tenantName,
                                  ComDiagsArea &diags)
{

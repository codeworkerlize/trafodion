...
static const SessionDefaults::SessionDefaultMap sessionDefaultMap[] = 
{
  ...
  SDEntry(SessionDefaults::AUTO_QUERY_RETRY_WARNINGS,MULTI_THREADED_ESP,         SessionDefaults::SDT_BOOLEAN,        TRUE,    TRUE,  FALSE, FALSE),
  ...
  SDEntry(SessionDefaults::SKIP_END_VALID_DDL_CHECK, SKIP_END_VALID_DDL_CHECK,   SessionDefaults::SDT_BOOLEAN,        FALSE,   FALSE, TRUE,  FALSE),
       ...
       exsmTraceFilePrefix_(NULL)
{
  ...
  if (gSkipEndValidDDLCheck == 1)
    skipEndValidDDLCheck_ = TRUE;
...
, {"FIRSTN_PREDICATE_SAFETY_FACTOR"}, {"0"}
};

  ...
  if (jc)
  {
    ...
    if (utilityClass_ != NULL)
    {
      ...
      utilityGetRSInfoId_ = jni->GetStaticMethodID((jclass)utilityClass_,
                                              "getRSInfo", "(Ljava/lang/Object;[J[J[Ljava/lang/Object;[I[Ljava/lang/String;)V");
  ...
  ComDiagsArea *diagsArea)
{
  ...
  *handle = NULL;
  ...
  if (result != LM_ERR)
  {
    ...
    if (str_cmp_ne(containerName, SEABASE_SPSQL_CONTAINER) == 0 &&
	str_cmp_ne(externalName, SEABASE_SPSQL_CALL) == 0)
    {
    ...
    if (jm != NULL)
    {
      ...
      LmRoutineJava *h = new (collHeap()) 
        LmRoutineJava(sqlName, externalName, librarySqlName, numSqlParam, returnValue,
                      ...
                      externalSecurity, 
		      routineOwnerId,
                      parentQid, clientInfo, inputRowLen, outputRowLen,

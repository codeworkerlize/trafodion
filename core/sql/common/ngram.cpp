...
static trgm *make_trigrams(trgm *tptr, char *str, int bytelen, int charlen)
{
  ...
  if (bytelen > charlen)
  {
    ...
    int lenfirst = pg_mblen((const unsigned char *)str),
        lenmiddle = pg_mblen((const unsigned char *)(str + lenfirst)),
...
lc_ctype_is_c(Oid collation)
{
  ...
  */
  if (collation == DEFAULT_COLLATION_OID)
  {
    ...
    if (!localeptr)
      printf("invalid LC_CTYPE setting\n");
 ...
 */
static const char *get_wildcard_part(const char *str, int lenstr,

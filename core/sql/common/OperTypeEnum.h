...
enum OperatorTypeEnum {
  ...
  INVALID_OPERATOR_TYPE = FALSE,
                        ...
                        REL_TABLE_MAPPING_BUILTIN_GENERATE_NGRAM, // ngram
                        REL_TABLE_MAPPING_BUILTIN_GENERATE_WILDCARD_NGRAM,
                        ...
                        ITM_BITMAP_OR = 2063,
                        ITM_BITMAP_INSERT = 2064,
                        ITM_BITMAP_IN = 2065,
                        ITM_BITMAP_COPY = 2066,
                        ITM_BITMAP_UNPACK = 2067,
                        ...
                        ITM_ORC_SUM_NV = 2079,
                        ITM_GROUPING = 2080,
                        ITM_AGGR_GROUPING_FUNC = 2081,
                        ITM_GROUPING_ID = 2081,

                        ITM_RANGE_VALUES_MERGE = 2082,
                        ITM_RANGE_VALUES_INSERT = 2083,
                        ITM_RANGE_VALUES_COPY = 2084,
                        ITM_RANGE_VALUES_UNPACK = 2085,
                        ITM_RANGE_VALUES_IN = 2086,

                        ITM_BLOOM_FILTER_MERGE = 2087,
                        ITM_BLOOM_FILTER_INSERT = 2088,
                        ITM_BLOOM_FILTER_COPY = 2089,
                        ITM_BLOOM_FILTER_UNPACK = 2090,
                        ITM_BLOOM_FILTER_IN = 2091,
                        ...
                        ITM_NVL               = 2150,
                        //If expr1 is not null, then returns expr2. If expr1 is null, then returns expr3.
                        ITM_NVL2              = 2151,
                        ...
                        ITM_OLAP_FIRST_VALUE = 2182,
                        ITM_OLAP_LAST_VALUE = 2183,

                        ITM_CURRENT_CATALOG = 2184,
                        ITM_CURRENT_SCHEMA = 2185,

                        ITM_OLAP_PIVOT_GROUP = 2186,
                        ITM_RUNNING_PIVOT_GROUP = 2187,

                        // Regular Expression
                        ITM_REGEXP = 2190,
			ITM_UNIX_TIMESTAMP = 2191,
			ITM_SLEEP = 2192,
			ITM_UNIQUE_SHORT_ID = 2193,
                        ...
                        // for max_bytes function
                        ITM_UTF8_MAXBYTES     = 2296,
                        ITM_MAXBYTES          = 2297, 
                        ITM_NCHAR_MP_MAXBYTES = 2298,
                        ITM_UNICODE_MAXBYTES  = 2299,
                        ...
                        ITM_GREATEST = 2385,
                        ITM_LEAST = 2386,
                        ITM_FIRSTNGRAM = 2387,  // firstngram
                        ITM_NGRAMCOUNT = 2388,
                        ITM_CONNECT_BY = 2389,
			...
			ITM_VSBBROWCOUNT = 2396,
                       ...
                       // Just interpret source as the specified type.
                        ITM_CAST_TYPE = 2460,

                        // create a composite type (ARRAY or ROW)
                        ITM_COMPOSITE_CREATE = 2461,

                        // display composite elements in string format
                        ITM_COMPOSITE_DISPLAY = 2462,

                        // cast of composite to composite
                        ITM_COMPOSITE_CAST = 2463,

                        // extract particular field from composite expr
                        ITM_COMPOSITE_EXTRACT = 2464,

                        // concat 2 composite fields
                        ITM_COMPOSITE_CONCAT = 2465,

                        ITM_COMPOSITE_ARRAY_CAST = 2466,

                        ITM_COMPOSITE_ARRAY_LENGTH = 2467,

                        ITM_COMPOSITE_HIVE_CAST = 2468,

                        ITM_TO_BINARY          = 2469,
                        ITM_ENCODE_BASE64      = 2470,
                        ITM_DECODE_BASE64      = 2471,
                        ITM_TO_CHAR            = 2472,
                        ...
                        // a dummy node; used only to generate ValueIds for
                        // expression histogram identification purposes
                        ITM_EXPR_HIST_DUMMY = 2599,
                        ...
                        ITM_NUMBERFORMAT = 2644,
                        ITM_REGEXP_SUBSTR = 2645,
                        ITM_REGEXP_COUNT = 2646,
                        ...
                        DDL_ALTER_TABLE_ADD_PARTITION,
                        DDL_ALTER_TABLE_MOUNT_PARTITION,
                        DDL_ALTER_TABLE_UNMOUNT_PARTITION,
                        DDL_ALTER_TABLE_TRUNCATE_PARTITION,
                        DDL_ALTER_TABLE_DROP_PARTITION,
                        DDL_ALTER_TABLE_MERGE_PARTITION,
                        DDL_ALTER_TABLE_EXCHANGE_PARTITION,
                        DDL_ALTER_TABLE_RENAME_PARTITION,
                        DDL_ALTER_TABLE_SPLIT_PARTITION,
                        DDL_ALTER_TABLE_RENAME,
                        DDL_ALTER_TABLE_STORED_DESC,
                        DDL_ALTER_TABLE_SET_CONSTRAINT,
                        DDL_ALTER_TABLE_DROPPABLE,
                        DDL_ALTER_TABLE_RESET_DDL_LOCK,
                        ...
                        DDL_REVOKE_ROLE,
                        DDL_CREATE_ROLE,
                        DDL_CREATE_RESOURCE_GROUP,
                        DDL_ALTER_RESOURCE_GROUP,
                        DDL_DROP_RESOURCE_GROUP,
                        DDL_CLEANUP_OBJECTS,
                        DDL_LAST_STMT_OP,
                        DDL_INITIALIZE_SECURITY,
                        DDL_COMMENT_ON,
                        DDL_ALTER_SHARED_CACHE,
                        ...
                        ELM_FILE_ATTR_NAMESPACE_ELEM,
                        ELM_FILE_ATTR_ENCRYPT_ELEM,
                        ELM_FILE_ATTR_INCR_BACKUP_ELEM,
                        ELM_FILE_ATTR_READ_ONLY_ELEM,
                       ...
                       // default column family for columns specified in CREATE stmt
                        ...
                        ELM_FILE_ATTR_STORED_DESC_ELEM,
                        ...
                        ELM_LIKE_OPT_WITHOUT_INDEXES_ELEM,
                        ...
                        ELM_LIKE_OPT_WITHOUT_NAMESPACE,
                        ELM_LIKE_OPT_WITH_DATA,
                        ELM_LIKE_OPT_WITHOUT_REGION_REPLICATION,
                        ELM_LIKE_OPT_WITHOUT_INCREMENTAL_BACKUP,
                        ELM_LOCATION_ELEM,
                        ELM_OPTION_LIST,
                        ...
                        // V2 is used for new partition table implement
                        ELM_PARTITION_CLAUSE_V2_ELEM,
                        ...
                        ELM_PARTITION_NAME_AND_FOR_VALUES,
                        ...
                        ELM_TENANT_SCHEMA_ELEM,
                        ELM_TENANT_OPTION_ELEM,
                        ELM_TENANT_GROUP_ELEM,
                        ELM_TENANT_RGROUP_ELEM,
                        ...
                        ELM_SG_OPT_ORDER_OPTION_ELEM,
                        ELM_SG_OPT_SYSTEM_OPTION_ELEM,
                        ELM_SG_OPT_DATATYPE_ELEM,
                        ELM_SG_OPT_RESET_OPTION_ELEM,
                        ELM_SG_OPTS_DEFAULT_ELEM,
                        ELM_SG_OPT_NEXTVAL_OPTION_ELEM,

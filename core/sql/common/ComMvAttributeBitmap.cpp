...
ComSInt32 ComMvAttributeBitmap::getBitmap() const { return bitmap_; }
...
void ComMvAttributeBitmap::trace() {
  ...
  if (IsBitSet(NO_LOGS)) cout << "NO_LOGS" << endl;
  if (IsBitSet(LOGS_CREATED)) cout << "LOGS_CREATED" << endl;
  if (IsBitSet(LOGS_ON_CREATION)) cout << "LOGS_ON_CREATION" << endl;
  if (IsBitSet(LOGGING_REQUIRED)) cout << "LOGGING_REQUIRED" << endl;
  if (IsBitSet(MVS_ON_ME)) cout << "MVS_ON_ME" << endl;
...
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setLogsCreatedOnMVCreation() {
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setLogCreated() {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setLastOnRequestMvOnMe() {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setIsAnMv(NABoolean value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setInitOnStmtMvOnMe(NABoolean value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
void ComMvAttributeBitmap::clearBaseTableAttributes() { ClearBit(BASE_TABLE_ATTRIBUTES_MASK); }

//----------------------------------------------------------------------------
void ComMvAttributeBitmap::clearMvAttributes() { ClearBit(MV_ATTRIBUTES_MASK); }

//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setRangeLogType(ComRangeLogType rangeLogType) {
  ComSInt32 initialVal = bitmap_;
  ...
  if (TRUE == wasManualRangeLog && TRUE == setToOtherThanManualRangeLog && IsBitSet(MVS_ON_ME)) {
    SetBit(LOGGING_REQUIRED);
  }
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setInsertLog(NABoolean value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setLockOnRefresh(NABoolean value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setEnableRewrite(NABoolean value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setMvsAllowed(ComMvsAllowed mvsAllowedType) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setMvStatus(ComMVStatus value) {
  ComSInt32 initialVal = bitmap_;
...
//----------------------------------------------------------------------------
ComMvAttributeBitmap::Result ComMvAttributeBitmap::setMvAudit(ComMvAuditType value) {
  ComSInt32 initialVal = bitmap_;
...
ComMvsAllowed ComMvAttributeBitmap::getMvsAllowed() const {
  if (IsBitSet(ONSTATEMENT_MVS_ALLOWED) && IsBitSet(ONREQUEST_MVS_ALLOWED) && IsBitSet(RECOMPUTE_MVS_ALLOWED)) {
...
//----------------------------------------------------------------------------
ComMVStatus ComMvAttributeBitmap::getMvStatus() const {
...
//----------------------------------------------------------------------------
ComMvAuditType ComMvAttributeBitmap::getMvAuditType() const {

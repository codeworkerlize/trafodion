...
DgCustomSQLState::DgCustomSQLState(const char *const cName) : theCharStr_(cName) {}
...
DgConstraintName::DgConstraintName(const char *const cName) : theCharStr_(cName) {}

DgConstraintCatalog::DgConstraintCatalog(const char *const cName) : theCharStr_(cName) {}
...
DgTriggerSchema::DgTriggerSchema(const char *const cName) : theCharStr_(cName) {}
...
DGTYPE DgConstraintCatalog::getTypeName() const { return DGCONSTRAINTCATALOG; }

DGTYPE DgConstraintSchema::getTypeName() const { return DGCONSTRAINTSCHEMA; }

DGTYPE DgConstraintName::getTypeName() const { return DGCONSTRAINTNAME; }

DGTYPE DgRowNumber::getTypeName() const { return DGROWNUMBER; }

DGTYPE DgTriggerCatalog::getTypeName() const { return DGTRIGGERCATALOG; }

DGTYPE DgTriggerSchema::getTypeName() const { return DGTRIGGERSCHEMA; }

DGTYPE DgTriggerName::getTypeName() const { return DGTRIGGERNAME; }

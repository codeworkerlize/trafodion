...
public:
  ...
  SequenceGeneratorAttributes(const Int64                     psgStartValue,
                  ...
                  const NABoolean                 psgOrderOption,
			      const Int64                         psgEndValue = 0,
                              const Int64                         psgRedefTime = 0,
                              const Int64                    psgTimeout = -1,
                              CollHeap * h=0)
 ...
 SequenceGeneratorAttributes(CollHeap * h=0)
  ...
  void setSGUseDlockImpl(const NABoolean v) 
  { sgUseDlockImpl_ = v; }

  void setSGUseDtmImpl(const NABoolean v) 
  { sgUseDtmImpl_ = v; }

  void setSGReplType(const ComReplType type) 
  { sgReplType_ = type; }
  ...
  void setSGType(const ComSequenceGeneratorType psgSGType)
  { sgSGType_ = psgSGType; }
 ...
 void setSGObjectUID(const ComUID psgObjectUID)
  ...
  void setSGOrder(const NABoolean sgOrder)
  { sgOrder_ = sgOrder; }
  ...
  const void display (ComSpace *space, NAString * nas, 
                      NABoolean noNext = FALSE, NABoolean inShowDDL = FALSE,
                      NABoolean commentOut = FALSE) const;
 
  NABoolean operator==(const SequenceGeneratorAttributes& other) const
  {  
     return (
        sgStartValue_ == other.sgStartValue_ &&
        sgIncrement_ == other.sgIncrement_ &&
        sgMaxValue_ == other.sgMaxValue_ &&
        sgMinValue_ == other.sgMinValue_ &&
        sgSGType_ == other.sgSGType_ &&
        sgSQLDataType_ == other.sgSQLDataType_ &&
        sgFSDataType_ == other.sgFSDataType_ &&
        sgCycleOption_ == other.sgCycleOption_ &&
        sgResetOption_ == other.sgResetOption_ &&
        sgObjectUID_ == other.sgObjectUID_ &&
        sgCache_ == other.sgCache_ &&
        sgNextValue_ == other.sgNextValue_ &&
        sgEndValue_ == other.sgEndValue_ &&
        sgRedefTime_ == other.sgRedefTime_ &&
        sgRetryNum_ == other.sgRetryNum_ &&
        sgUseDlockImpl_== other.sgUseDlockImpl_ &&
        sgOrder_ == other.sgOrder_ &&
        sgUseDtmImpl_== other.sgUseDtmImpl_ &&
        sgReplType_== other.sgReplType_ &&

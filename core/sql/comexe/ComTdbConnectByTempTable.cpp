...
****************************************************************************
*
* File:         ComTdbConnectByTempTable.cpp
* Description:  
*
* Created:      8/20/2019
* Language:     C++
...
:ComTdb(ComTdb::ex_CONNECT_BY_TEMP_TABLE, eye_CONNECT_BY_TEMP_TABLE), 
 tdbChild_(NULL)
{
}
 ...
 ComTdbConnectByTempTable::ComTdbConnectByTempTable(
      ...
      ex_expr *scanExpr)
      : ComTdb(ComTdb::ex_CONNECT_BY_TEMP_TABLE,
           eye_CONNECT_BY_TEMP_TABLE,
           0,
           givenCriDesc,
           returnedCriDesc,
           down,

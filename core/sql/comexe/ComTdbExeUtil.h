...
protected:
  ...
  // ptr to ExpLobOperV2::DMLOptions struct.
...
private:
  ...
  char fillersComTdbExeUtilLobExtract_[36];            
};
...
public:
  ...
  {(v ? flags_ |= USE_HDFS_WRITE_LOCK : flags_ &= ~USE_HDFS_WRITE_LOCK); };
  NABoolean useHdfsWriteLock() const { return (flags_ & USE_HDFS_WRITE_LOCK) != 0; };
  ...
  void setHdfsWriteLockTimeout(Int16 n) { hdfsWriteLockTimeout_ = n; }
  Int16 hdfsWriteLockTimeout() const { return hdfsWriteLockTimeout_; }
  ...
  enum
    {
      ...
      REPLACE_=0x0008,
      LOB_LOCKING_=0x0010,
      USE_HDFS_WRITE_LOCK=0x0020,
      STRING_FORMAT      =0x0040,
    };
  NABasicPtr handle_;
  Int32 handleLen_;
  short fromType_;
  short hdfsWriteLockTimeout_;
  Int32 flags_;
  Int64 updateSize_;
  Int64 totalBufSize_;
  Int64 bufAddr_;
...
{                                                                                    
  { "CATALOG_NAME",   0,      COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "SCHEMA_NAME",   1,      COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "VIEW_NAME",    2,     COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0}
};
...
{                                                                                    
  ...
  { "SCHEMA_NAME",    1,     COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "TABLE_NAME",    2,     COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},
  { "ALIAS_NAME",   3,   COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",NULL,NULL
...
{                                                                                    
  ...
  { "SCHEMA_NAME",   1,      COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "TABLE_NAME",    2,     COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},
  { "SYN_NAME",   3,   COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",NULL,NULL
,COM_UNKNOWN_DIRECTION_LIT, 0}
};
...
static const ComTdbVirtTableColumnInfo hiveMDObjectNameTypesColInfo[] =
{                                                                                    
  { "CATALOG_NAME",  0,       COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "SCHEMA_NAME",   1,      COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},  
  { "TABLE_NAME",    2,     COM_USER_COLUMN, REC_BYTE_F_ASCII,    256, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "" ,NULL,NULL,COM_UNKNOWN_DIRECTION_LIT, 0},
  { "HIVE_TABLE_TYPE",   3,   COM_USER_COLUMN, REC_BYTE_F_ASCII,    128, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",NULL,NULL
,COM_UNKNOWN_DIRECTION_LIT, 0}
};

struct HiveMDObjectNameTypesColInfoStruct
{
  char catName[256];
  char schName[256];
  char tblName[256];
...
public:
 ...
 enum {
   SPECIAL_OBJECTNAMETYPE = 0x0001,
   SCHEMAS_SPECIFIED      = 0x0002,
 };
  ...
  void setSpecialObjectnametype(NABoolean v)
  {(v ? flags_ |= SPECIAL_OBJECTNAMETYPE : flags_ &= ~SPECIAL_OBJECTNAMETYPE); };
  NABoolean specialObjectnametype() { return (flags_ & SPECIAL_OBJECTNAMETYPE) != 0; };

  void setSchemasSpecified(NABoolean v)
  {(v ? flags_ |= SCHEMAS_SPECIFIED : flags_ &= ~SCHEMAS_SPECIFIED); };
  NABoolean schemasSpecified() { return (flags_ & SCHEMAS_SPECIFIED) != 0; };
  ...
  static Int32 getVirtTableNumCols(char * name)
  {
    ...
    else if (strcmp(name, "OBJECTNAMETYPES") == 0)
      return sizeof(hiveMDObjectNameTypesColInfo)/sizeof(ComTdbVirtTableColumnInfo);
    else
      return -1;
  }
  ...
  static ComTdbVirtTableColumnInfo * getVirtTableColumnInfo (char * name)
  {
    if (strcmp(name, "TABLES") == 0)
      ...
      return (ComTdbVirtTableColumnInfo*)hiveMDObjectNameTypesColInfo;
    else
      return NULL;
  }
...
class ComTdbExeUtilAvroStats : public ComTdbExeUtil
{
  friend class ExExeUtilAvroStatsTcb;
  friend class ExExeUtilAvroStatsPrivateState;
...
public:
  ...
  // Redefine virtual functions required for Versioning.
  //----------------------------------------------------------------------
  virtual short getClassSize() {return (short)sizeof(ComTdbExeUtilAvroStats);}

  virtual const char *getNodeName() const 
  { 
    return "GET_AVRO_STATS";
  };

  int getVirtTableNumCols()
  {
    return 
      sizeof(comTdbAvroStatsVirtTableColumnInfo)/sizeof(ComTdbVirtTableColumnInfo);
  }

  ComTdbVirtTableColumnInfo * getVirtTableColumnInfo()
  {
    return (ComTdbVirtTableColumnInfo*)comTdbAvroStatsVirtTableColumnInfo;
  }
...
private:
  ...
  char fillersComTdbExeUtilAvroStats_[76];        // 12-87
};

///////////////////////////////////////////////////////////
// class ComTdbExeUtilGetExtSchema
///////////////////////////////////////////////////////////
class ComTdbExeUtilGetExtSchema : public ComTdbExeUtil
{
  friend class ExExeUtilGetExtSchemaTcb;
  friend class ExExeUtilGetExtSchemaPrivateState;
...
public:
  ...
  // Redefine virtual functions required for Versioning.
  //----------------------------------------------------------------------
  virtual short getClassSize() {return (short)sizeof(ComTdbExeUtilGetExtSchema);}

  virtual const char *getNodeName() const 
  { 
    return "GET_EXT_SCHEMA";
  };
  ...
  char * getRootDirLoc() const {return rootDirLoc_;}
  char  * parqSchStr() { return parqSchStr_; }

  const NABoolean isParquet() const 
  { return (type_ == PARQUET);}
  const NABoolean isAvro() const 
  { return (type_ == AVRO);}

  Queue* getColNameList()       { return colNameList_; }
  Queue* getColTypeList()       { return colTypeList_; }

  void setIsRead(NABoolean v)
  {(v ? flags_ |= IS_READ : flags_ &= ~IS_READ); };
  NABoolean isRead() { return (flags_ & IS_READ) != 0; };

  void setIsWrite(NABoolean v)
  {(v ? flags_ |= IS_WRITE : flags_ &= ~IS_WRITE); };
  NABoolean isWrite() { return (flags_ & IS_WRITE) != 0; };
...
private:
  ...
  char filler0_[2];                                  // 14-15

  QueuePtr colNameList_;                             // 16-23
...
public:
  ...
  // Redefine virtual functions required for Versioning.
  //----------------------------------------------------------------------
  virtual short getClassSize() {return (short)sizeof(ComTdbExeUtilLobInfo);}
...
private:
  ...
  // array of Int32
  NABasicPtr lobInlineMaxLenArray_;

...
public:
  ...
  NABoolean ddlValidationRequired()
  { return (otherFlags_ & DDL_VALIDATION_REQUIRED) != 0; }
  
  NABoolean isUserBaseTable()
  { return (otherFlags_ & USER_BASE_TABLE) != 0; }

  void setUserBaseTable(NABoolean v)
  { (v ? otherFlags_ |= USER_BASE_TABLE : otherFlags_ &= ~USER_BASE_TABLE); }

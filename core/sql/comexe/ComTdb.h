...
public:
  ...
  enum ex_node_type
  {
    ...
    ex_HBASE_LOAD = 148,
    ex_HBASE_UNLOAD = 149,
    ex_EXT_STORAGE_SCAN    = 150,
    ex_EXT_STORAGE_AGGR    = 151,
...
class ComTdbVirtTablePartitionV2Info : public ComTdbVirtTableBase
{
 public:
  ...
  ComTdbVirtTablePartitionV2Info()
    : ComTdbVirtTableBase()
    {
      init();

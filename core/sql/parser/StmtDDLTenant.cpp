...
StmtDDLTenant::StmtDDLTenant(const NAString & tenantName,
...
StmtDDLTenant::StmtDDLTenant(const Int32 alterType,
...
StmtDDLTenant::StmtDDLTenant(const NAString & tenantName,
                             const NABoolean dropDependencies,
                                   CollHeap * heap)
...
//
StmtDDLTenant *
StmtDDLTenant::castToStmtDDLTenant()
{
  return this;
}

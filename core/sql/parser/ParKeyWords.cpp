...
ParKeyWord ParKeyWords::keyWords_[] = {
  ...
  ParKeyWord("ABSENT",             TOK_ABSENT,      NONRESTOKEN_),
  ...
  ParKeyWord("ACTUAL",             TOK_ACTUAL,      NONRESTOKEN_),
  ...
  ParKeyWord("AFFINITY",           TOK_AFFINITY,    NONRESTOKEN_),
  ...
  ParKeyWord("ALL",                TOK_ALL,         ANS_|RESWORD_|SECOND_),
  ...
  ParKeyWord("ARRAY_LENGTH",       TOK_ARRAY_LENGTH,      NONRESTOKEN_),
  ...
  ParKeyWord("AVRO",               TOK_AVRO,        NONRESTOKEN_),
  ParKeyWord("BACKUP",             TOK_BACKUP,      NONRESTOKEN_|SECOND_),
  ...
  ParKeyWord("BEGINKEY",           TOK_BEGINKEY,    NONRESTOKEN_),
  ParKeyWord("BERNOULLI",          TOK_BERNOULLI,   NONRESTOKEN_),
  ParKeyWord("BETWEEN",            TOK_BETWEEN,     SECOND_|ANS_|RESWORD_),
  ParKeyWord("BIGINT",             TOK_BIGINT,      NONRESTOKEN_),
  ParKeyWord("BIGTABLE",           TOK_BIGTABLE,    NONRESTOKEN_),
  ...
  ParKeyWord("BODY",               TOK_BODY,        NONRESTOKEN_),
  ...
  ParKeyWord("CLUSTERSTATS",       TOK_CLUSTERSTATS,NONRESTOKEN_),
  ParKeyWord("COMPILE",            TOK_COMPILE,     NONRESTOKEN_),
  ParKeyWord("COMPOSITE_DISPLAY",  TOK_COMPOSITE_DISPLAY,      NONRESTOKEN_),
  ParKeyWord("COMPOSITE_EXTRACT",  TOK_COMPOSITE_EXTRACT,      NONRESTOKEN_),
  ParKeyWord("CONDITIONAL",        TOK_CONDITIONAL,     NONRESTOKEN_),
  ...
  ParKeyWord("CONVERTLOBTOHANDLE", TOK_CONVERTLOBTOHANDLE, NONRESTOKEN_),
  ...
  ParKeyWord("COT",                TOK_COT,         NONRESTOKEN_),
  ...
  ParKeyWord("CURRENT_CATALOG",            TOK_CURRENT_CATALOG,     ANS_|RESWORD_),
  ...
  ParKeyWord("CURRENT_SCHEMA",    TOK_CURRENT_SCHEMA,     ANS_|RESWORD_),
  ParKeyWord("CURRENT_TENANT",       TOK_CURRENT_TENANT, ANS_|RESWORD_),
  ...
  ParKeyWord("DATABASES",          TOK_DATABASES,   NONRESTOKEN_),
  ...
  ParKeyWord("DATEPART",           TOK_DATE_PART,   NONRESTOKEN_),
  ...
  ParKeyWord("DESCRIBE",           TOK_DESCRIBE,     NONRESTOKEN_|FIRST_),
  ...
  ParKeyWord("DROP",               TOK_DROP,        FIRST_|ANS_|RESWORD_),
  ...
  ParKeyWord("DUMP",               TOK_DUMP,        NONRESTOKEN_),  
  ...
  ParKeyWord("EMPTY",              TOK_EMPTY,       NONRESTOKEN_),
  ...
  ParKeyWord("ENCODING",           TOK_ENCODING,    NONRESTOKEN_),
  ParKeyWord("ENCRYPTION",         TOK_ENCRYPTION,  NONRESTOKEN_),  
  ParKeyWord("END",                TOK_END,         ANS_|RESWORD_|NONRESTOKEN_),
  ParKeyWord("ENDKEY",             TOK_ENDKEY,      NONRESTOKEN_),
  ...
  ParKeyWord("EXEC",               TOK_EXEC,        NONRESTOKEN_),
  ...
  ParKeyWord("EXPORT",             TOK_EXPORT,      NONRESTOKEN_),
  ...
  ParKeyWord("FIRSTNGRAM",         TOK_FIRSTNGRAM, NONRESTOKEN_),
  ParKeyWord("NGRAMCOUNT",         TOK_NGRAMCOUNT, NONRESTOKEN_),
  ParKeyWord("FIRST_FSCODE",       TOK_FIRST_FSCODE, NONRESTOKEN_),
  ParKeyWord("FIRST_VALUE",       TOK_FIRST_VALUE, NONRESTOKEN_),
  ...
  ParKeyWord("FROM_UNIXTIME",      TOK_FROM_UNIXTIME,   NONRESTOKEN_),
  ...
  ParKeyWord("GROUP",              TOK_GROUP,       ANS_|RESWORD_|SECOND_),
  ParKeyWord("GROUPS",             TOK_GROUPS,      NONRESTOKEN_),
  ...
  ParKeyWord("HASH",               TOK_HASH,        THIRD_|NONRESTOKEN_),
  ...
  ParKeyWord("HBASE_ROWID",        TOK_HBASE_ROWID,    NONRESTOKEN_),
  ...
  ParKeyWord("IDENTIFIED",         TOK_IDENTIFIED,  NONRESTOKEN_),
  ...
  ParKeyWord("IMPORT",             TOK_IMPORT,      NONRESTOKEN_),
  ...
  ParKeyWord("JSON",               TOK_JSON,        NONRESTOKEN_),
  ParKeyWord("JSON_ARRAY",        TOK_JSON_ARRAY,  NONRESTOKEN_),
  ParKeyWord("JSON_ARRAYAGG",     TOK_JSON_ARRAYAGG,  NONRESTOKEN_),
  ParKeyWord("JSON_EXISTS",        TOK_JSON_EXISTS,  NONRESTOKEN_),
  ParKeyWord("JSON_OBJECT",        TOK_JSON_OBJECT,  NONRESTOKEN_),
  ParKeyWord("JSON_OBJECTAGG",     TOK_JSON_OBJECTAGG,  NONRESTOKEN_),
  ParKeyWord("JSON_OBJECT_FIELD_TEXT",  TOK_JSONOBJECTFIELDTEXT, NONRESTOKEN_),
  ParKeyWord("JSON_QUERY",         TOK_JSON_QUERY,  NONRESTOKEN_),
  ParKeyWord("JSON_TABLE",         TOK_JSON_TABLE,  NONRESTOKEN_),
  ParKeyWord("JSON_VALUE",         TOK_JSON_VALUE,  NONRESTOKEN_),
  ParKeyWord("JULIANTIMESTAMP",    TOK_JULIANTIMESTAMP, NONRESTOKEN_),
  ParKeyWord("K",                  TOK_K,           NONRESTOKEN_),
  ParKeyWord("KEEP",               TOK_KEEP,           NONRESTOKEN_),
  ParKeyWord("KEY",                TOK_KEY,         ANS_|RESWORD_),
  ParKeyWord("KEYS",               TOK_KEYS,         NONRESTOKEN_),
  ...
  ParKeyWord("LAST_VALUE",        TOK_LAST_VALUE, NONRESTOKEN_),  
  ...
  ParKeyWord("LESS",               TOK_LESS,        NONRESTOKEN_),
  ...
  ParKeyWord("LISTAGG",            TOK_LISTAGG, NONRESTOKEN_),
  ParKeyWord("LN",                 TOK_LOG,     NONRESTOKEN_),
  ...
  ParKeyWord("LOCKED",             TOK_LOCKED,      NONRESTOKEN_),
  ...
  ParKeyWord("LIST",               TOK_LIST,        THIRD_|NONRESTOKEN_),
  ...
  ParKeyWord("MAX_BYTES",          TOK_MAX_BYTES,  NONRESTOKEN_),
  ...
  ParKeyWord("MINUS",              TOK_EXCEPT,      ANS_|RESWORD_),
  ...
  ParKeyWord("MODIFY",             TOK_MODIFY,         NONRESTOKEN_),
  ...
  ParKeyWord("MOUNT",              TOK_MOUNT,       NONRESTOKEN_),
  ...
  ParKeyWord("NAMESPACES",         TOK_NAMESPACES,  NONRESTOKEN_),
  ...
  ParKeyWord("NESTED",             TOK_NESTED,    NONRESTOKEN_),
  ...
  ParKeyWord("NOORDER",            TOK_NOORDER,     NONRESTOKEN_),
  ...
  ParKeyWord("NULLS",              TOK_NULLS,       NONRESTOKEN_),
  ...
  ParKeyWord("NVL2",               TOK_NVL2,        NONRESTOKEN_),
  ParKeyWord("OBJECT",             TOK_OBJECT,      NONRESTOKEN_),
  ParKeyWord("OBJECTS",            TOK_OBJECTS,     NONRESTOKEN_),
  ParKeyWord("OBSOLETE",           TOK_OBSOLETE,    NONRESTOKEN_|SECOND_),
  ...
  ParKeyWord("OMIT",               TOK_OMIT,        NONRESTOKEN_),
  ...
  ParKeyWord("PACKAGE",            TOK_PACKAGE,     NONRESTOKEN_),
  ParKeyWord("PACKAGES",           TOK_PACKAGES,    NONRESTOKEN_),
  ...
  ParKeyWord("PARQUET",            TOK_PARQUET,     NONRESTOKEN_),
  ParKeyWord("PARSERFLAGS",        TOK_PARSERFLAGS, NONRESTOKEN_),
  ParKeyWord("PARTIAL",            TOK_PARTIAL,     ANS_|RESWORD_),
  ParKeyWord("PARTITION",          TOK_PARTITION,   FIRST_|SECOND_|RESWORD_),
  ParKeyWord("PARTITIONING",       TOK_PARTITIONING, RESWORD_),
  ParKeyWord("PARTITIONS",         TOK_PARTITIONS,  SECOND_|RESWORD_),
...
// PATH is already used in CQS ...
  ...
  ParKeyWord("QUOTES",             TOK_QUOTES, NONRESTOKEN_),
  ...
  ParKeyWord("QUERYINVALIDATIONSTATS",  TOK_QUERYINVALIDATIONSTATS, NONRESTOKEN_),
  ...
  ParKeyWord("RANGE",              TOK_RANGE,       THIRD_ | NONRESTOKEN_),
  ...
  ParKeyWord("READ_ONLY",          TOK_READ_ONLY,   NONRESTOKEN_),
  ...
  ParKeyWord("REGEXP_REPLACE",     TOK_REGEXP_REPLACE,      NONRESTOKEN_),
  ParKeyWord("REGEXP_SUBSTR",      TOK_REGEXP_SUBSTR,       NONRESTOKEN_),
  ParKeyWord("REGEXP_COUNT",       TOK_REGEXP_COUNT,        NONRESTOKEN_),
  ParKeyWord("REGION",             TOK_REGION,      NONRESTOKEN_),
  ParKeyWord("REGIONS",            TOK_REGIONS,     NONRESTOKEN_),
  ParKeyWord("REGIONSTATS",        TOK_REGIONSTATS, NONRESTOKEN_),
  ...
  ParKeyWord("RELEASE",            TOK_RELEASE,     NONRESTOKEN_),
  ...
  ParKeyWord("RESOURCE",           TOK_RESOURCE,    NONRESTOKEN_),
  ...
  ParKeyWord("RETURNING",          TOK_RETURNING,   NONRESTOKEN_),
  ...
  ParKeyWord("RGROUP",             TOK_RGROUP,      NONRESTOKEN_),
  ParKeyWord("RGROUPS",            TOK_RGROUPS,     NONRESTOKEN_),
  ...
  ParKeyWord("ROUTINE",            TOK_ROUTINE,     POTANS_|RESWORD_),
  ParKeyWord("ROUTINES",           TOK_ROUTINES,    NONRESTOKEN_),
  ParKeyWord("ROW",                TOK_ROW,         ANS_|RESWORD_|SECOND_),
  ParKeyWord("ROWNUM",                TOK_ROWNUM,     COMPAQ_|RESWORD_),
  ...
  ParKeyWord("SAVEPOINT",          TOK_SAVEPOINT,   POTANS_|RESWORD_),
  ...
  ParKeyWord("STRUCT",             TOK_STRUCT,      NONRESTOKEN_),
  ...
  ParKeyWord("STRING",             TOK_STRING,   NONRESTOKEN_),
  ...
  ParKeyWord("SHOW",               TOK_SHOW,        RESWORD_),
  ParKeyWord("SHOWCONTROL",        TOK_SHOWCONTROL, NONRESTOKEN_),
  ParKeyWord("SHOWDDL",            TOK_SHOWDDL,     NONRESTOKEN_|FIRST_),
  ParKeyWord("SHOWENV",            TOK_SHOWENV,     NONRESTOKEN_),
  ParKeyWord("SHOWINFO",           TOK_SHOWINFO,    NONRESTOKEN_),
  ...
  ParKeyWord("SNAPSHOT",           TOK_SNAPSHOT,    RESWORD_),
  ParKeyWord("SNAPSHOTS",          TOK_SNAPSHOTS,   RESWORD_),
  ...
  ParKeyWord("RESTART",            TOK_RESTART,     COMPAQ_|NONRESWORD_),
...
// used in QAT tests
  ...
  ParKeyWord("SUBERROR",    TOK_SUBERROR, NONRESTOKEN_),
  ParKeyWord("SUBPARTITION",       TOK_SUBPARTITION, NONRESTOKEN_),
  ParKeyWord("SUBPARTITIONS",      TOK_SUBPARTITIONS, NONRESTOKEN_),
  ...
  ParKeyWord("TAGS",                TOK_TAGS,         NONRESTOKEN_),
  ParKeyWord("TABLE",              TOK_TABLE,       ANS_|RESWORD_),
  ParKeyWord("TABLES",             TOK_TABLES,      FLAGSNONE_),
  ParKeyWord("TABLESAMPLE",        TOK_TABLESAMPLE, ANS_|RESWORD_),
  ...
  ParKeyWord("TENANT",             TOK_TENANT,      NONRESTOKEN_|SECOND_),
  //ParKeyWord("TENANT",             TOK_TENANT,      NONRESTOKEN_),
  ParKeyWord("TENANTS",            TOK_TENANTS,     NONRESTOKEN_),
  ...
  ParKeyWord("TM",              TOK_TM,       NONRESTOKEN_),
  ...
  ParKeyWord("UNCONDITIONAL",      TOK_UNCONDITIONAL, NONRESTOKEN_),
  ...
  ParKeyWord("UNMOUNT",            TOK_UNMOUNT,     NONRESTOKEN_),
  ...
  ParKeyWord("VALIDATION",   TOK_VALIDATION,  NONRESTOKEN_),
  ...
  ParKeyWord("VARCHAR2",           TOK_VARCHAR2,    ANS_|RESWORD_|NONRESTOKEN_),
  ...
  ParKeyWord("V_DOLLAR_DYNAMICVIEW",TOK_V_DOLLAR_DYNAMICVIEW,    ANS_|RESWORD_),
  ...
  ParKeyWord("WAYS",               TOK_WAYS,        NONRESTOKEN_),
  ...
  ParKeyWord("WITHIN",             TOK_WITHIN,      NONRESTOKEN_),
  ...
  ParKeyWord("WRAPPER",            TOK_WRAPPER,     NONRESTOKEN_),
  ParKeyWord("WRITE",              TOK_WRITE,       ANS_|RESWORD_),
  ParKeyWord("XDC",                TOK_XDC,         NONRESTOKEN_),
  ...
  ParKeyWord("MEMBERS",            TOK_MEMBERS,     ANS_|NONRESWORD_|SECOND_),

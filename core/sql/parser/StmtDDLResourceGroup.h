...
public:
  ...
  enum RGroupAlterType { NOT_ALTER = 0,
                         ALTER_ADD_NODE = 1,
                         ALTER_DROP_NODE = 2,
                         ALTER_OFFLINE = 3,
                         ALTER_ONLINE = 4 };
  ...
  StmtDDLResourceGroup(const NAString & rGroupName,
                       const ConstStringList *nodeList,
                       NAString * owner,
                       CollHeap * heap)
  ...
  StmtDDLResourceGroup(const Int32 alterType,
                       const NAString & rGroupName,
                       const ConstStringList *nodeList,
                       CollHeap * heap)

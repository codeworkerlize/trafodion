...
public:
  ...
  ElemDDLPartitionClauseV2(ElemDDLNode* pPartitionDefBody
                           , ElemDDLNode* pPartitionColList
                           , ComPartitioningSchemeV2 partitionType
                           , NABoolean isSubpartition = false)
  : ElemDDLNode(ELM_PARTITION_CLAUSE_V2_ELEM)
  , partitionType_(partitionType)
  ...
  inline ComPartitioningSchemeV2 getPartitionType() const
  { return partitionType_; }
...
inline ElemDDLNode *
ElemDDLPartitionClauseV2::getPartitionDefBody() const
{
  return children_[INDEX_PARTITION_DEFINITION_BODY];
}

inline ElemDDLNode *
ElemDDLPartitionClauseV2::getPartitionColList() const
{
  return children_[INDEX_PARTITION_COLUMN_LIST];
}

inline ElemDDLNode *
ElemDDLPartitionClauseV2::getSubpartitionClause() const
{

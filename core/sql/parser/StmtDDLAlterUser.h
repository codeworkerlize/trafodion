...
inline const NAString &
StmtDDLAlterUser::getConfig() const
{
  return config_;
}

inline const NAString &
StmtDDLAlterUser::getAuthPassword() const
{
...
inline ElemDDLList* StmtDDLAlterUser::getUserGroupList() const
{
    return (ElemDDLList*)groupList_;
}

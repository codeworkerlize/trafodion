  ...
  if (createTokStr EQU "REPLACE")
    {
      ...
      ComASSERT(ParScannedTokens->isQueueIndexWithinRange(prevTokIndex));
      const ParScannedTokenQueue::scannedTokenInfo &prevTokInfo1
	= ParScannedTokens->getScannedTokenInfo(prevTokIndex);
      NAString prevTokStr1(&pInputStr[prevTokInfo1.tokenStrPos],
			   prevTokInfo1.tokenStrLen);
	...
	= ParScannedTokens->getScannedTokenInfo(createTokIndex);
      NAString createTokStr1(&pInputStr[createTokInfo1.tokenStrPos],
			     createTokInfo1.tokenStrLen);
      ...
      ComASSERT(ParScannedTokens->isQueueIndexWithinRange(prevTokIndex));
      const ParScannedTokenQueue::scannedTokenInfo &prevTokInfo2
	= ParScannedTokens->getScannedTokenInfo(prevTokIndex);
      NAString prevTokStr2(&pInputStr[prevTokInfo2.tokenStrPos],
			   prevTokInfo2.tokenStrLen);
	...
	= ParScannedTokens->getScannedTokenInfo(createTokIndex);
      NAString createTokStr2(&pInputStr[createTokInfo2.tokenStrPos],
			     createTokInfo2.tokenStrLen);
...
NABoolean ParSetTextEndPos(StmtDDLCreateTable * pCreateCTParseNode)
{
  ...
  pCreateCTParseNode->
   ...
   pCreateCTParseNode->
    setEndOfCreateTableAsWithClausePosition(ParEndOfCreateTableAsWithClausePos);
  pCreateCTParseNode->	

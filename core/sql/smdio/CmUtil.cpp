...
#define defXLateE2L(E2L, eType, array)                \
  void E2L(const eType e, char *l) {                  \
    NABoolean found;                                  \
...
#define defXLateL2E(L2E, eType, array)                                   \
  eType L2E(const char *l) {                                             \
    NABoolean found;                                                     \
...
// Define both
#define defXLateFuncs(L2E, E2L, eType, array) \
  defXLateL2E(L2E, eType, array);             \
  defXLateE2L(E2L, eType, array)

//
//----------------------------------------------------------------------------
// ComObjectClass translation
//
const literalAndEnumStruct ObjectClassXlateArray[] = {{COM_CLASS_USER_TABLE, COM_CLASS_USER_TABLE_LIT},
...
defXLateFuncs(CmGetComComponentPrivilegeClassAsComponentPrivilegeClass, CmGetComComponentPrivilegeClassAsLit,
              ComComponentPrivilegeClass, ComponentPrivilegeClassXlateArray);
...
defXLateFuncs(CmGetComAccPathTypeAsAccessPathType, CmGetComAccPathTypeAsLit, ComAccessPathType,
              AccessPathTypeXlateArray);

//
//----------------------------------------------------------------------------
// ComRowFormat translation
//
const literalAndEnumStruct RowFormatXlateArray[] = {{COM_ALIGNED_FORMAT_TYPE, COM_ALIGNED_FORMAT_LIT},
...
//
const literalAndEnumStruct CompressionTypeXlateArray[] = {{COM_UNKNOWN_COMPRESSION, COM_UNKNOWN_COMPRESSION_LIT},
...
defXLateFuncs(CmGetComCompressionTypeAsCompressionType, CmGetCompressionTypeAsLit, ComCompressionType,
              CompressionTypeXlateArray);
...
//
const literalAndEnumStruct ColumnOrderingXlateArray[] = {{COM_ASCENDING_ORDER, COM_ASCENDING_ORDER_LIT},
...
//
const literalAndEnumStruct ColumnDirectionXlateArray[] = {{COM_INPUT_COLUMN, COM_INPUT_COLUMN_LIT},
...
defXLateFuncs(CmGetComDirectionAsComColumnDirection, CmGetComDirectionAsLit, ComColumnDirection,
              ColumnDirectionXlateArray);
...
defXLateFuncs(CmGetComDirectionAsComParamDirection, CmGetComParamDirectionAsLit, ComParamDirection,
              ParamDirectionXlateArray);

//----------------------------------------------------------------------------
// ComColumnClass translation
//
const literalAndEnumStruct ColumnClassXlateArray[] = {{COM_USER_COLUMN, COM_USER_COLUMN_LIT},
...
defXLateFuncs(CmGetStoreByDetailsAsComStoreByDetails, CmGetComStoreByDetailsAsLit, ComStoreByDetails,
              StoreByDetailsXlateArray);

//----------------------------------------------------------------------------
// ComODBCDataType translation
//
const literalAndEnumStruct ODBCDataTypeXlateArray[] = {{COM_CHARACTER_ODT, COM_CHARACTER_ODT_LIT},
...
const literalAndEnumStruct ColumnDefaultClassXlateArray[] = {
    ...
    {COM_CATALOG_FUNCTION_DEFAULT, COM_CATALOG_FUNCTION_DEFAULT_LIT},
    {COM_SCHEMA_FUNCTION_DEFAULT, COM_SCHEMA_FUNCTION_DEFAULT_LIT}};

defXLateFuncs(CmGetComColDefaultAsColDefault, CmGetComColDefaultAsLit, ComColumnDefaultClass,
              ColumnDefaultClassXlateArray);
...
const literalAndEnumStruct ParamDefaultClassXlateArray[] = {
    ...
    {COM_ALWAYS_COMPUTE_COMPUTED_PARAM_DEFAULT,
     COM_ALWAYS_COMPUTE_COMPUTED_PARAM_DEFAULT_LIT},  // for future internal use only
    {COM_ALWAYS_DEFAULT_COMPUTED_PARAM_DEFAULT,
     COM_ALWAYS_DEFAULT_COMPUTED_PARAM_DEFAULT_LIT}  // for future internal use only
};

defXLateFuncs(CmGetParamDefaultClassAsComParamDefaultClass, CmGetComParamDefaultClassAsLit, ComParamDefaultClass,
              ParamDefaultClassXlateArray);

//----------------------------------------------------------------------------
// ComGrantorType translation
//
const literalAndEnumStruct GrantorTypeXlateArray[] = {{COM_SYSTEM_GRANTOR, COM_SYSTEM_GRANTOR_LIT},
...
//
const literalAndEnumStruct GranteeTypeXlateArray[] = {{COM_PUBLIC_GRANTEE, COM_PUBLIC_GRANTEE_LIT},
...
//
const literalAndEnumStruct RCMatchOptionXlateArray[] = {{COM_FULL_MATCH_OPTION, COM_FULL_MATCH_OPTION_LIT},
...
//
const literalAndEnumStruct RCUpdateRuleXlateArray[] = {{COM_CASCADE_UPDATE_RULE, COM_CASCADE_UPDATE_RULE_LIT},
...
//
const literalAndEnumStruct RCDeleteRuleXlateArray[] = {{COM_CASCADE_DELETE_RULE, COM_CASCADE_DELETE_RULE_LIT},
...
//
const literalAndEnumStruct ConstraintTypeXlateArray[] = {{COM_CHECK_CONSTRAINT, COM_CHECK_CONSTRAINT_LIT},
...
//
const literalAndEnumStruct ViewCheckOptionXlateArray[] = {{COM_CASCADE_CHECK_OPTION, COM_CASCADE_CHECK_OPTION_LIT},
...
defXLateFuncs(CmGetComViewCheckAsViewCheckOption, CmGetComViewCheckAsLit, ComViewCheckOption,
              ViewCheckOptionXlateArray);

//----------------------------------------------------------------------------
// ComViewType translation -- added in v2500
//
const literalAndEnumStruct ViewTypeXlateArray[] = {{COM_USER_VIEW_TYPE, COM_USER_VIEW_TYPE_LIT},
...
//
const literalAndEnumStruct PartnStatusXlateArray[] = {{COM_PARTN_AVAILABLE, COM_PARTN_AVAILABLE_LIT},
...
//
const literalAndEnumStruct DdlStatusXlateArray[] = {{COM_NO_DDL_IN_PROGRESS, COM_NO_DDL_IN_PROGRESS_LIT},
...
defXLateFuncs(CmGetComRoutineLanguageAsRoutineLanguage, CmGetComRoutineLanguageAsLit, ComRoutineLanguage,
              RoutineLanguageXlateArray);
...
defXLateFuncs(CmGetComRoutineParamStyleAsRoutineParamStyle, CmGetComRoutineParamStyleAsLit, ComRoutineParamStyle,
...
defXLateFuncs(CmGetRoutineParamTypeAsComRoutineParamType, CmGetComRoutineParamTypeAsLit, ComRoutineParamType,
...
defXLateFuncs(CmGetComRoutineSQLAccessAsRoutineSQLAccess, CmGetComRoutineSQLAccessAsLit, ComRoutineSQLAccess,
              RoutineSQLAccessXlateArray);
...
defXLateFuncs(CmGetComRoutineTransactionAttributesAsRoutineTransactionAttributes,
              CmGetComRoutineTransactionAttributesAsLit, ComRoutineTransactionAttributes,
              RoutineTransactionAttributesXlateArray);

//----------------------------------------------------------------------------
// ComRoutineType translation
//
const literalAndEnumStruct RoutineTypeXlateArray[] = {
    {COM_PROCEDURE_TYPE, COM_PROCEDURE_TYPE_LIT},   {COM_SCALAR_UDF_TYPE, COM_SCALAR_UDF_TYPE_LIT},
    {COM_TABLE_UDF_TYPE, COM_TABLE_UDF_TYPE_LIT},   {COM_UNIVERSAL_UDF_TYPE, COM_UNIVERSAL_UDF_TYPE_LIT},
    {COM_ACTION_UDF_TYPE, COM_ACTION_UDF_TYPE_LIT}, {COM_UNKNOWN_ROUTINE_TYPE, COM_UNKNOWN_ROUTINE_TYPE_LIT}};
...
//
const literalAndEnumStruct ParallelismXlateArray[] = {{COM_ROUTINE_NO_PARALLELISM, COM_ROUTINE_NO_PARALLELISM_LIT},
                                                      {COM_ROUTINE_ANY_PARALLELISM, COM_ROUTINE_ANY_PARALLELISM_LIT}};

defXLateFuncs(CmGetRoutineParallelismAsComRoutineParallelism, CmGetComRoutineParallelismAsLit, ComRoutineParallelism,
...
defXLateFuncs(CmGetRoutineExternalSecurityAsComRoutineExternalSecurity, CmGetComRoutineExternalSecurityAsLit,
              ComRoutineExternalSecurity, ExternalSecurityXlateArray);
...
defXLateFuncs(CmGetRoutineExecutionModeAsComRoutineExecutionMode, CmGetComRoutineExecutionModeAsLit,
              ComRoutineExecutionMode, RoutineExecutionModeXlateArray);

//----------------------------------------------------------------------------
// ComBoolean translation
//
const literalAndEnumStruct BooleanXlateArray[] = {{TRUE, COM_YES_LIT}, {FALSE, COM_NO_LIT}};
...
const literalAndEnumStruct ActivationTimeXlateArray[] = {
    {COM_BEFORE, COM_BEFORE_LIT}, {COM_AFTER, COM_AFTER_LIT}, {COM_UNKNOWN_TIME, COM_UNKNOWN_TIME_LIT}};
...
const literalAndEnumStruct OperationXlateArray[] = {
    {COM_INSERT, COM_INSERT_LIT}, {COM_DELETE, COM_DELETE_LIT},   {COM_UPDATE, COM_UPDATE_LIT},
    {COM_SELECT, COM_SELECT_LIT}, {COM_ROUTINE, COM_ROUTINE_LIT}, {COM_UNKNOWN_IUD, COM_UNKNOWN_IUD_LIT}};
...
const literalAndEnumStruct GranularityXlateArray[] = {
    {COM_ROW, COM_ROW_LIT}, {COM_STATEMENT, COM_STATEMENT_LIT}, {COM_UNKNOWN_GRANULARITY, COM_UNKNOWN_GRANULARITY_LIT}};
...
//
const literalAndEnumStruct YesNoXlateArray[] = {{COM_YES, COM_YES_LIT}, {COM_NO, COM_NO_LIT}, {COM_NULL, COM_NULL_LIT}};
...
//
const literalAndEnumStruct MVTypeXlateArray[] = {{COM_MJV, COM_MJV_LIT},
                                                 {COM_MAV, COM_MAV_LIT},
...
//
const literalAndEnumStruct MVStatusXlateArray[] = {{COM_MVSTATUS_INITIALIZED, COM_MVSTATUS_INITIALIZED_LIT},
...
//
const literalAndEnumStruct RangeLogTypeXlateArray[] = {{COM_NO_RANGELOG, COM_NO_RANGELOG_LIT},
...
//
const literalAndEnumStruct MvsAllowedXlateArray[] = {{COM_NO_MVS_ALLOWED, COM_NO_MVS_ALLOWED_LIT},
...
//
const literalAndEnumStruct MvAuditTypeXlateArray[] = {{COM_MV_AUDIT, COM_MV_AUDIT_LIT},
...
//
const literalAndEnumStruct MVRefreshTypeXlateArray[] = {{COM_ON_STATEMENT, COM_ON_STATEMENT_LIT},
...
//
const literalAndEnumStruct LeftJoinTableTypeXlateArray[] = {{COM_NO_LEFT_JOIN, COM_NO_LEFT_JOIN_LIT},
                                                            {COM_LEFT_INNER, COM_LEFT_INNER_LIT},
                                                            {COM_LEFT_OUTER, COM_LEFT_OUTER_LIT},
                                                            {COM_LEFT_JOIN_UNKNOWN, COM_LEFT_JOIN_UNKNOWN_LIT}};

defXLateFuncs(CmGetComLeftJoinTableType, CmGetComLeftJoinTableTypeAsLit, ComLeftJoinTableType,
              LeftJoinTableTypeXlateArray);
...
const literalAndEnumStruct MVColTypeXlateArray[] = {
    {COM_MVCOL_GROUPBY, COM_MVCOL_GROUPBY_LIT},     {COM_MVCOL_CONST, COM_MVCOL_CONST_LIT},
    {COM_MVCOL_AGGREGATE, COM_MVCOL_AGGREGATE_LIT}, {COM_MVCOL_DUPLICATE, COM_MVCOL_DUPLICATE_LIT},
    {COM_MVCOL_OTHER, COM_MVCOL_OTHER_LIT},         {COM_MVCOL_FUNCTION, COM_MVCOL_FUNCTION_LIT},
    {COM_MVCOL_BASECOL, COM_MVCOL_BASECOL_LIT},     {COM_MVCOL_REDUNDANT, COM_MVCOL_REDUNDANT_LIT},
    {COM_MVCOL_COMPLEX, COM_MVCOL_COMPLEX_LIT},     {COM_MVCOL_UNKNOWN, COM_MVCOL_UNKNOWN_LIT}};
...
//
const literalAndEnumStruct OperatorTypeXlateArray[] = {{ITM_COUNT, COM_COUNT_LIT},
...
void CmGetMVOperatorTypeAsLit(const OperatorTypeEnum e, char *l) {
  ...
  if (!found) strcpy(l, COM_UNKNOWN_AGG_LIT);
}

OperatorTypeEnum CmGetMVOperatorTypeEnum(const char *l) {
  NABoolean found;
  OperatorTypeEnum result =
      (OperatorTypeEnum)literalToEnum(OperatorTypeXlateArray, occurs(OperatorTypeXlateArray), l, found);
  if (!found) result = ITM_IS_UNKNOWN;
  return result;
}
...
//
const literalAndEnumStruct MVSUsedTableAttributeXlateArray[] = {{COM_IGNORE_CHANGES, COM_IGNORE_CHANGES_LIT},
                                                                {COM_INSERT_ONLY, COM_INSERT_ONLY_LIT},
                                                                {COM_NO_ATTRIBUTE, COM_NO_ATTRIBUTE_LIT}};

defXLateFuncs(CmGetMVSUsedTableAttribute, CmGetMVSUsedTableAttributeAsLit, ComMVSUsedTableAttribute,
              MVSUsedTableAttributeXlateArray);

//----------------------------------------------------------------------------
// ComMVSUsageType translation
//
const literalAndEnumStruct MVSUsageTypeXlateArray[] = {{COM_USER_SPECIFIED, COM_USER_SPECIFIED_LIT},
...
//
const literalAndEnumStruct MVAttributeXlateArray[] = {{COM_MVATTRIBUTE_UNKNOWN, COM_MV_ATTRIBUTE_UNKNOWN_LIT}};
...
//
const literalAndEnumStruct HistReasonTypeXlateArray[] = {{COM_HIST_MANUAL, COM_HIST_MANUAL_LIT},
...
defXLateFuncs(CmGetExceptionTableType, CmGetExceptionTableTypeAsLit, ComExceptionTableType,
              ExceptionTableTypeXlateArray);

//----------------------------------------------------------------------------
// ComRoleIdStatus translation
//
const literalAndEnumStruct RoleIdStatusXlateArray[] = {{COM_AVAILABLE_STATUS, COM_AVAILABLE_STATUS_LIT},
...
defXLateFuncs(CmGetSequenceGeneratorType, CmGetSequenceGeneratorTypeAsLit, ComSequenceGeneratorType,
              SequenceGeneratorTypeXlateArray);

//----------------------------------------------------------------------------
// ComSchemaType translation
//
const literalAndEnumStruct schemaTypeArray[] = {
    {COM_USER_TYPE, COM_USER_TYPE_LIT}, {COM_PUBLIC_TYPE, COM_PUBLIC_TYPE_LIT}, {COM_SYSTEM_TYPE, COM_SYSTEM_TYPE_LIT}};
...
void CmTranslateV1200ToV2000Privs(ComGrantorType &grantorType, ComGranteeType &granteeType, const ComUserID &grantor,
                                  const ComUserID &objectOwner, const ComUserID &schemaOwner) {
  if (grantorType == COM_SYSTEM_GRANTOR && granteeType == COM_USER_GRANTEE) granteeType = COM_SCHEMA_OWNER_GRANTEE;

  if (grantor == schemaOwner) grantorType = COM_SCHEMA_OWNER_GRANTOR;
}
...
//
const literalAndEnumStruct IdClassXlateArray[] = {{COM_ROLE_CLASS, COM_ROLE_CLASS_LIT},
...
const literalAndEnumStruct IdStatusXlateArray[] = {{COM_AVAILABLE_ID_STATUS, COM_AVAILABLE_ID_STATUS_LIT},
...
void CmAnsiNameToUCS2(const NAString &inMbs, NAWString &outWcs) {
  ...
  NAWString *pTargetNAWString = charToUnicode((int)ComGetNameInterfaceCharSet()  // in - int        strCharSet
                                              ...
                                              ,
                                              (int)inMbs.length()  // in - int        len
                                              ,
                                              (NAMemory *)STMTHEAP  // in - NAMemory *   h
  );
  ComASSERT(pTargetNAWString != NULL AND pTargetNAWString->length() > 0 AND pTargetNAWString->length() <=
                                    ComMAX_ANSI_IDENTIFIER_INTERNAL_LEN /*in NAWchars*/);
...
void CmAnsiNameToUTF8(const NAWString &inWcs, NAString &outMbs) {
  ...
  NAString *pConvStr = unicodeToChar(inWcs.data()  // in - const char * str
                                     ,
                                     (int)inWcs.length()  // in - int        len
                                     ,
...
void CatInternalError(char const *, int, char const *, int) { abort(); }

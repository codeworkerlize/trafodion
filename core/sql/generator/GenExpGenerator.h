...
public:
  ...
  short generateBulkMoveAligned(const ValueIdList &inValIdList,
  ...
  short generateBulkMove(const ValueIdList &inValIdList,
			 ValueIdList &outValIdList,
			 ULng32 tupleLength,
...

{
 ...
 //
  ...
  inline void addTempsLength(Int64 length) 
    {
      temps_length += length;
    }
  ...
  NABoolean forceLinkConstant()
    { return (flags_ & FORCE_LINK_CONST) != 0; }
  void setForceLinkConstant(NABoolean v)
    { (v ? flags_ |= FORCE_LINK_CONST : flags_ &= ~FORCE_LINK_CONST); }

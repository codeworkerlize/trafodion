...
short PhysUnPackRows::codeGen(Generator *generator) {
  ...
  if (indexValue() != NULL_VALUE_ID) {
    ...
    GenAssert(indexValueTupleLen == sizeof(Int32), "UnPackRows::codeGen: Internal Error");
  }
  ...
  if (packingFactor().entries() > 0) {
    ...
    GenAssert(packingFactorTupleLen == sizeof(Int32), "UnPackRows::codeGen: Internal Error");
  }

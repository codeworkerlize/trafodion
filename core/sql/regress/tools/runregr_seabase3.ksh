...
# if disable row-level lock function, exclude related test cases.
if [ "$ENABLE_ROW_LEVEL_LOCK" == "0" ]; then
  prettyfiles=`echo $prettyfiles | xargs -n1 | grep -v "TEST200\|TEST201\|TEST202"`
fi

...
namespace tmudr
{
  ...
  public:
    ...
    int deserializeInt8(uint8_t& i,
      ConstBytes& inputBuffer,
      int& inputBufferLength);
    int deserializeInt(int &i,
                       ConstBytes &inputBuffer,
                       int &inputBufferLength);
    int deserializeShort(short& s,
                       ConstBytes& inputBuffer,
                       int& inputBufferLength);
    int deserializeDouble(double& d,
                       ConstBytes& inputBuffer,
                       int& inputBufferLength);
    ...
    int deserializeStringSafe(const char*& s,
      int& stringLength,
      bool makeACopy,
      ConstBytes& inputBuffer,
      int& inputBufferLength);

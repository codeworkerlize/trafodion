...
enum SP_STATUS { SP_FAIL = 0, SP_MOREDATA = 1, SP_SUCCESS = 2, SP_SUCCESS_WARNING = 3 };
...
enum SP_PROCESS_ACTION { SP_PROC_OPEN = 1, SP_PROC_FETCH = 2, SP_PROC_CLOSE = 3 };

/* The action flag for SP_xxx_COMPILE interface routine. */

enum SP_COMPILE_ACTION { SP_COMP_INIT = 1, SP_COMP_EXIT = 2 };
...
typedef SP_HELPER_STATUS (*SP_EXTRACT_FUNCPTR)(Lng32 fieldNo,       /* input, index to the field to be extracted */
...
typedef SP_HELPER_STATUS (*SP_FORMAT_FUNCPTR)(Lng32 fieldNo,       /* input, index to the field to put the data in */
                                              SP_ROW_DATA rowData, /* input, data passed into SP_PROCESS_FUNCPTR */
...
typedef SP_HELPER_STATUS (*SP_KEYVALUE_FUNCPTR)(Lng32 keyIndex,   /* input, key index starts from 0 */
...
typedef SP_STATUS (*SP_COMPILE_FUNCPTR)(SP_COMPILE_ACTION action,     /* input */
...
typedef SP_STATUS (*SP_PARSE_FUNCPTR)(char *param,                 /* first input parameter, null terminated string */
...
typedef SP_STATUS (*SP_NUM_OUTPUTFIELDS_FUNCPTR)(Lng32 *numFields,            /* output */
                                                 SP_COMPILE_HANDLE cmpHandle, /* input */
                                                 SP_HANDLE spHandle,          /* input */
                                                 SP_ERROR_STRUCT *error       /* output */
);
...
typedef SP_STATUS (*SP_PROCESS_FUNCPTR)(SP_PROCESS_ACTION action,                  /* input */
                                        ...
                                        SP_HANDLE spHandle, SP_ERROR_STRUCT *error /* output */
);

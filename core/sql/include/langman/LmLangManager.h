...
class SQLLM_LIB_FUNC LmLanguageManager : public NABasicObject {
 public:
  LmLanguageManager(NABoolean commandLineMode) : commandLineMode_(commandLineMode) {}
  ...
  virtual LmResult validateRoutine(ComUInt32 numParam, ComFSDataType paramType[], ComUInt32 paramSubType[],
                                   ...
                                   const char *optionalSig = NULL, ComDiagsArea *diagsArea = NULL) = 0;
  ...
  //////////////////////////////////////////////////////////////////////
  virtual LmResult convertIn(NAType *src, NAType **dst, NAMemory *mem);
  ...
  //////////////////////////////////////////////////////////////////////
  virtual LmResult convertOut(NAType *src, NAType **dst, NAMemory *mem);
  ...
  //////////////////////////////////////////////////////////////////////
  virtual LmResult putRoutine(LmRoutine *handle, ComDiagsArea *diagsArea = NULL) = 0;
  ...
  //////////////////////////////////////////////////////////////////////
  virtual LmResult invokeRoutine(LmRoutine *handle, void *inputRow, void *outputRow,
                                 ComDiagsArea *diagsArea = NULL) = 0;
  ...
  virtual LmHandle loadContainer(const char *containerName, const char *externalPath, LmHandle extLoader,
                                 ComUInt32 *containerSize, ComDiagsArea *diagsArea) = 0;
  ...
  virtual LmResult setSystemProperty(const char *key, const char *value, ComDiagsArea *diagsArea = NULL) = 0;

...
class SQLLM_LIB_FUNC LmConnection : public NABasicObject {
 ...
 private:
  ...
  // Constructor
  LmConnection(LmLanguageManagerJava *lm, jobject connRef, LmConnectionType connType,
 ...
 private:
  ...
  ComRoutineTransactionAttributes transactionAttrs_;  // COM_UNKNOWN_ROUTINE_TRANSACTION_ATTRIBUTE or
                                                      // COM_NO_TRANSACTION_REQUIRED or COM_TRANSACTION_REQUIRED
};

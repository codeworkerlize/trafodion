...
class NABasicPtrTempl {
 public:
  ...
  // Constructors
  // -------------------------------------------------------------------
  NABasicPtrTempl(Type *ptr = (Type *)NULL) : ptr_(ptr) {
    // -----------------------------------------------------------------
  ...
  inline NABasicPtrTempl<Type> &operator=(const NABasicPtrTempl<Type> &ptr) {
    ptr_ = ptr.ptr_;
    return *this;
  }
  ...
  inline NABasicPtrTempl<Type> operator+(const UInt32 n) const { return NABasicPtrTempl<Type>(ptr_ + n); }

  inline NABasicPtrTempl<Type> operator+(const unsigned short n) const { return NABasicPtrTempl<Type>(ptr_ + n); }
  ...
  inline Type &operator[](const UInt32 i) const { return ptr_[i]; }
  inline Type &operator[](const unsigned short i) const { return ptr_[i]; }

  inline Type &operator[](const ULong i) const { return ptr_[i]; }
...
class NAOpenObjectPtrTempl {
 public:
  ...
  // Constructors
  // -------------------------------------------------------------------
  NAOpenObjectPtrTempl(Type *ptr = (Type *)NULL) : ptr_(ptr) {
    // -----------------------------------------------------------------
    // This ensures that size of the class remains to be 64 bits. No
    // virtual functions should be added to this class because of this
    // requirement.
  ...
  inline NAOpenObjectPtrTempl<Type> &operator=(const void *const ptr) {
    ptr_ = (Type *)ptr;
    return *this;
  }
  ...
  inline NAOpenObjectPtrTempl<Type> &operator=(const Type *const ptr) {
    ptr_ = (Type *)((long)ptr);
    return *this;
  }

  inline NAOpenObjectPtrTempl<Type> &operator=(const NAOpenObjectPtrTempl<Type> &ptr) {
    ptr_ = ptr.ptr_;
    return *this;
  }
  ...
  inline NAOpenObjectPtrTempl<Type> operator+(const Long n) const { return NAOpenObjectPtrTempl<Type>(ptr_ + n); }

  inline NAOpenObjectPtrTempl<Type> operator+(const UInt32 n) const { return NAOpenObjectPtrTempl<Type>(ptr_ + n); }

  inline NAOpenObjectPtrTempl<Type> operator+(const unsigned short n) const {
  ...
  inline NAOpenObjectPtrTempl<Type> &operator+=(const UInt32 n) {
    ptr_ += n;
    return *this;
  }

  inline NAOpenObjectPtrTempl<Type> &operator+=(const unsigned short n) {
    ptr_ += n;
    return *this;
  }

  inline NAOpenObjectPtrTempl<Type> &operator+=(const ULong n) {
    ptr_ += n;
    return *this;
  }
...
template <class Type>
class NAVersionedObjectPtrTempl {
 public:
  // -------------------------------------------------------------------
  // public member functions
  // -------------------------------------------------------------------
  ...
  // Constructors
  // -------------------------------------------------------------------
  NAVersionedObjectPtrTempl(Type *ptr = (Type *)NULL) : ptr_(ptr) {
    // -----------------------------------------------------------------
    // This ensures that size of the class remains to be 64 bits. No
    // virtual functions should be added to this class because of this
    // requirement.
  ...
  inline NAVersionedObjectPtrTempl<Type> &operator=(const void *const ptr) {
    ptr_ = (Type *)ptr;
    return *this;
  }

  inline NAVersionedObjectPtrTempl<Type> &operator=(const Long ptr) {
    ptr_ = (Type *)ptr;
    return *this;
  }
  ...
  inline NAVersionedObjectPtrTempl<Type> &operator=(const Type *const ptr) {
    ptr_ = (Type *)ptr;
    return *this;
  }

  inline NAVersionedObjectPtrTempl<Type> &operator=(const NAVersionedObjectPtrTempl<Type> &ptr) {
    ptr_ = ptr.ptr_;
    return *this;
  }
  ...
  inline NAVersionedObjectPtrTempl<Type> operator+(const short n) const {
    return NAVersionedObjectPtrTempl<Type>(ptr_ + n);
  }

  inline NAVersionedObjectPtrTempl<Type> operator+(const Long n) const {
    return NAVersionedObjectPtrTempl<Type>(ptr_ + n);
  }

  inline NAVersionedObjectPtrTempl<Type> operator+(const UInt32 n) const {
    return NAVersionedObjectPtrTempl<Type>(ptr_ + n);
  }

  inline NAVersionedObjectPtrTempl<Type> operator+(const unsigned short n) const {
    return NAVersionedObjectPtrTempl<Type>(ptr_ + n);
  }

  inline NAVersionedObjectPtrTempl<Type> operator+(const ULong n) const {
    return NAVersionedObjectPtrTempl<Type>(ptr_ + n);
  }
  ...
  inline NAVersionedObjectPtrTempl<Type> &operator+=(const UInt32 n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrTempl<Type> &operator+=(const unsigned short n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrTempl<Type> &operator+=(const ULong n) {
    ptr_ += n;
    return *this;
  }
...
class NAVersionedObjectPtrArrayTempl {
 public:
  // -------------------------------------------------------------------
  // public member functions
  // -------------------------------------------------------------------
  ...
  // Constructors
  // -------------------------------------------------------------------
  NAVersionedObjectPtrArrayTempl(PtrType *ptr = (PtrType *)NULL) : ptr_(ptr) {
    // -----------------------------------------------------------------
    // This ensures that size of the class remains to be 64 bits. No
    // virtual functions should be added to this class because of this
    // requirement.
  ...
  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator=(const void *const ptr) {
    ptr_ = (PtrType *)ptr;
    return *this;
  }
  ...
  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator=(const PtrType *const ptr) {
    ptr_ = (PtrType *)ptr;
    return *this;
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator=(const NAVersionedObjectPtrArrayTempl<PtrType> &ptr) {
    ptr_ = ptr.ptr_;
    return *this;
  }
  ...
  inline NAVersionedObjectPtrArrayTempl<PtrType> operator+(const short n) const {
    return NAVersionedObjectPtrArrayTempl<PtrType>(ptr_ + n);
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> operator+(const Long n) const {
    return NAVersionedObjectPtrArrayTempl<PtrType>(ptr_ + n);
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> operator+(const UInt32 n) const {
    return NAVersionedObjectPtrArrayTempl<PtrType>(ptr_ + n);
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> operator+(const unsigned short n) const {
    return NAVersionedObjectPtrArrayTempl<PtrType>(ptr_ + n);
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> operator+(const ULong n) const {
    return NAVersionedObjectPtrArrayTempl<PtrType>(ptr_ + n);
  }
  ...
  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator+=(const short n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator+=(const Long n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator+=(const UInt32 n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator+=(const unsigned short n) {
    ptr_ += n;
    return *this;
  }

  inline NAVersionedObjectPtrArrayTempl<PtrType> &operator+=(const ULong n) {
    ptr_ += n;
    return *this;
  }
  ...
  inline PtrType &operator[](const UInt32 i) const { return ptr_[i]; }
  inline PtrType &operator[](const unsigned short i) const { return ptr_[i]; }

  inline PtrType &operator[](const ULong i) const { return ptr_[i]; }
  ...
  // -------------------------------------------------------------------
  inline void allocatePtrArray(Space *space, UInt32 numEntries) {
    if (numEntries != 0) {
      ptr_ = (PtrType *)space->allocateAlignedSpace(numEntries * sizeof(PtrType));
    } else
      ptr_ = (PtrType *)NULL;
  }

  inline void copyPtrArray(void **ptrArray, UInt32 numEntries) {
    for (UInt32 i = 0; i < numEntries; i++) ptr_[i] = (PtrType *)(ptrArray[i]);
  }

  inline void allocateAndCopyPtrArray(Space *space, void **ptrArray, UInt32 numEntries) {
...
class NAVersionedObject {
 public:
  ...
  inline void setClassID(Int16 classID) { classID_ = classID; }

  inline unsigned char *getImageVersionIDArray() { return versionIDArray_; }
  ...
  void setImageVersionID(unsigned short ix, unsigned char versionID) {
    assert(ix < VERSION_ID_ARRAY_SIZE);
    // add the following to prevent false alarm on "ix"
    // without considering the above assert
    // coverity[overrun_local]
  ...
  inline NAVersionedObjectPtr getReallocatedAddress() const { return reallocatedAddress_; }
  inline void setReallocatedAddress(NAVersionedObjectPtr address) { reallocatedAddress_ = address; }
  inline void setReallocatedAddress(NAVersionedObject *address) { reallocatedAddress_ = address; }

  inline Int16 getImageSize() const { return imageSize_; }
  inline void setImageSize(Int16 size) { imageSize_ = size; }

  inline void setVTblPtr(char *ptr) { *((char **)this) = ptr; }

  inline NABoolean isPacked() const { return (flags_ & VOBJ_PACKED) != 0; }
  inline void markAsPacked() { flags_ |= VOBJ_PACKED; }
  inline void markAsNotPacked() { flags_ &= ~VOBJ_PACKED; }

  inline NABoolean isBigEndian() const { return (flags_ & VOBJ_BIG_ENDIAN) != 0; }
  inline void markAsBigEndian() { flags_ |= VOBJ_BIG_ENDIAN; }
  inline void markAsLittleEndian() { flags_ &= ~VOBJ_BIG_ENDIAN; }

  NABoolean isSpacePtr() { return (flags_ & IS_SPACE_PTR) != 0; }

  void setIsSpacePtr(NABoolean v) { (v ? flags_ |= IS_SPACE_PTR : flags_ &= ~IS_SPACE_PTR); }
  ...
  // object sizes.
  // -------------------------------------------------------------------
  virtual short getClassSize() { return (short)sizeof(NAVersionedObject); }
  ...
  // make this expansion.
  // -------------------------------------------------------------------
  void makeRoomForNewVersion(Int16 oldSubClassSize, Int16 newSubClassSize);
  ...
  //
  // -------------------------------------------------------------------
  NAVersionedObject *driveUnpack(void *base, char *vtblPtr, void *reallocator);
  NAVersionedObject *driveUnpack(void *base, NAVersionedObject *ptrToAnchorClass, void *reallocator);

 private:
  // ---------------------------------------------------------------------
  // Bit patterns defined for use in *(char *)(&NAVersionedObject::flags_)
  // ---------------------------------------------------------------------
  enum { VOBJ_PACKED = 0x0080, VOBJ_BIG_ENDIAN = 0x0040, IS_SPACE_PTR = 0x0020 };
  ...
  inline void clearVersionIDArray() { memset(versionIDArray_, 0, VERSION_ID_ARRAY_SIZE); }

  inline void copyFlags(const NAVersionedObject &obj) { flags_ = obj.flags_; }
  ...
  inline void copyVersionIDArray(const NAVersionedObject &obj) {
    str_cpy_all((char *)versionIDArray_, (char *)obj.versionIDArray_, VERSION_ID_ARRAY_SIZE);
  }

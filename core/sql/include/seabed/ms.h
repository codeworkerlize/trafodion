...
typedef int (*MS_Mon_Tmlib2_Cb_Type)(MS_Mon_Tmlib_Fun_Type  fun,
                                     ...
                                     SB_Int64_Type          svptid_in,
                                     SB_Int64_Type         *svptid_out,
                                     SB_Int64_Type          psvptid_in,
                                     SB_Int64_Type         *psvptid_out);
...
//
SB_Export int msg_seqid_get_id(long *id,
                               int   timeout)
SB_DIAG_UNUSED;
...
SB_Export short BMSG_BREAK_(int                msgid,
                            ...
                            SB_Phandle_Type   *phandle)
SB_DIAG_UNUSED;
SB_Export short BMSG_BREAK_TIMEOUT_(int        msgid,
                            short             *results,
                            SB_Phandle_Type   *phandle,
                            int               timeout)
SB_DIAG_UNUSED;

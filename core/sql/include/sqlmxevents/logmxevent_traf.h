...
class SQLMXLoggingArea {
 public:
  ...
  static void logSQLMXEventForError(ULng32 eventId, const char *msgtxt, const char *sqlId = NULL,
  ...
  static void logPrivMgrInfo(const char *filename, ULng32 lineNo, const char *msg, int level);
  ...
  static void logCommonLoggerErrorEvent(ULng32 eventId, const char *msg);
  static void logCommonLoggerFailureEvent(ULng32 eventId, const char *msg);

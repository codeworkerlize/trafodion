...
#pragma SRLExportClassMembers ZEVNTSRL *
  ...
  SQLEVENTS_LIB_FUNC static Int32 logSQLMXEventForError(
      ...
      const char *msgtxt, const char *sqlId = NULL, const Lng32 Int0 = 0, const Lng32 Int1 = 0, const Lng32 Int2 = 0,
      const Lng32 Int3 = 0, const Lng32 Int4 = 0, const char *String0 = NULL, const char *String1 = NULL,
      ...
      const char *tableName = NULL, const char *columnName = NULL, const Int64 currTransid = 0,
      const Lng32 rowNumber = 0, const Lng32 platformCode = 0, NABoolean isWarning = FALSE);
  ...
  SQLEVENTS_LIB_FUNC static void logPOSErrorEvent(const Lng32 errorCode, const char *msg1, const char *msg2,
  ...
  SQLEVENTS_LIB_FUNC static void logUtilErrorsEvent(const char *utilName, const Int32 numOfErrors,
                                                    const Lng32 errorCode, const char *msg1, const char *msg2 = NULL,
...
// These are not currently needed
  ...
  SQLEVENTS_LIB_FUNC static void logCliReclaimSpaceEvent(Lng32 freeSize, Lng32 totalSize, Lng32 totalContexts,

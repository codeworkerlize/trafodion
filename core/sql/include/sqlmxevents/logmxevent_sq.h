...
#pragma SRLExportClassMembers ZEVNTSRL *
  ...
  SQLEVENTS_LIB_FUNC static void logSQLMXPredefinedEvent(int eventId, SQLMXLoggingArea::Category category);
  ...
  SQLEVENTS_LIB_FUNC static void logCommonLoggerInfoEvent(int eventId, const char *msg);
  SQLEVENTS_LIB_FUNC static void logCommonLoggerErrorEvent(int eventId, const char *msg);
  SQLEVENTS_LIB_FUNC static void logCommonLoggerFailureEvent(int eventId, const char *msg);
...
// These are not currently needed
  ...
  SQLEVENTS_LIB_FUNC static void logPMEventWithInterval(int eventId,
							TInt64 interval);
  ...
  SQLEVENTS_LIB_FUNC static void logPMAudInitEvent(int eventId,
                                                   TInt64 interval);

  SQLEVENTS_LIB_FUNC static void logPMAudStartEvent(int eventId,
                                                    const short audNum);

  SQLEVENTS_LIB_FUNC static void logPMAudDoneEvent(int eventId,
                                                   const short audNum,
                                                   TInt64 interval);
#endif  // 0

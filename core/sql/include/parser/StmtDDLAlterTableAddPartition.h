...
public:
  ...
  StmtDDLAlterTableMergePartition(ElemDDLNode* beginPartition, ElemDDLNode* endPartition,
  ...
  NAPartition * getNAPartitionFromElem(BindWA *pBindWA,
                                           TableDesc *tableDesc,
...
public:
  ...
  // constructor
  StmtDDLAlterTableExchangePartition(NABoolean isSubpart,
                     ElemDDLNode* srcPartition, QualifiedName tgtPartition);

...
class StmtDDLCreateTable : public StmtDDLNode
{
  ...
  friend void StmtDDLCreateTable_visitPartitionV2Element(
       ElemDDLNode * pThisNode,
       CollIndex index,
       ElemDDLNode * pElement);

  friend void StmtDDLPartition_visitSubpartitionElement(
       ElemDDLNode * pPartition,
       CollIndex index ,
       ElemDDLNode *pElement);
...
inline ElemDDLPartitionV2Array &
StmtDDLCreateTable::getPartitionV2Array()
{
  return partitionV2Array_;
}

inline NABoolean
StmtDDLCreateTable::isPartitionByClauseV2Spec()
{ return isPartitionByClauseV2Spec_; }

inline const ElemDDLColRefArray &
StmtDDLCreateTable::getPartitionV2ColRefArray() const
{ return partitionV2ColRefArray_; }

inline const ElemDDLColRefArray &
StmtDDLCreateTable::getSubpartitionColRefArray() const
{ return subpartitionColRefArray_; }

inline void
StmtDDLCreateTable::setPartitionType(ComPartitioningSchemeV2 val)
{ partitionType_ = val; }

inline void
StmtDDLCreateTable::setSubpartitionType(ComPartitioningSchemeV2 val)
{ subpartitionType_ = val; }

inline const ComPartitioningSchemeV2
StmtDDLCreateTable::getPartitionType() const
{ return partitionType_; }

inline const ComPartitioningSchemeV2
StmtDDLCreateTable::getSubpartitionType() const
{ return subpartitionType_; }
...
inline NABoolean StmtDDLCreateTable::isLobStorageOptionsSpecified() const
{
  return isLobStorageOptionsSpec_;
}
...
inline ElemDDLReplicateClause * StmtDDLCreateTable::getReplicateClause()
{
  return pReplicateClause_;
}
...
inline 
const StringPos StmtDDLCreateTable::getEndOfCreateTableAsWithClausePosition() const
{
  return endOfCreateTableAsWithClause_ ;
}

inline void 
StmtDDLCreateTable::setEndOfCreateTableAsWithClausePosition(const StringPos endPos)
{

...
class ElemDDLColDef : public ElemDDLNode {
 public:
  enum defaultClauseStatusType { DEFAULT_CLAUSE_NOT_SPEC = 0, NO_DEFAULT_CLAUSE_SPEC = 1, DEFAULT_CLAUSE_SPEC = 2 };
  enum { INDEX_ELEM_DDL_COL_ATTR_LIST = 0, MAX_ELEM_DDL_COL_DEF_ARITY = 1 };

  // default constructor
  ElemDDLColDef(const NAString *columnFamily, const NAString *columnName, NAType *pColumnDataType,
                ElemDDLNode *pColAttrList = NULL, CollHeap *heap = PARSERHEAP());
  ...
  void setDefaultClauseStatus(defaultClauseStatusType d) { defaultClauseStatus_ = d; }
  ...
  inline ComLobsStorageType getLobStorage() { return lobStorage_; }
  inline void setLobStorage(ComLobsStorageType s) { lobStorage_ = s; }
  ...
  NABoolean isLobStorageSpecified() { return isLobAttrsSpec_; }

  NABoolean isColCharsetSpecified() { return isColCharsetSpec_; }
  void setColCharsetSpecified(NABoolean bVal) { isColCharsetSpec_ = bVal; }
  //
  // methods for tracing
  //
...
class ElemProxyColDef : public ElemDDLColDef {
 public:
  ElemProxyColDef(QualifiedName *tableName, NAString &colName, NAType *type, ElemDDLNode *colAttrs, CollHeap *heap);
...
inline NAType *ElemDDLColDef::getColumnDataType() const { return columnDataType_; }

inline const NAString &ElemDDLColDef::getColumnFamily() const { return columnFamily_; }

inline const NAString &ElemDDLColDef::getColumnName() const { return columnName_; }

//
// Note that columnConstraintArray_ does not include either
// Not Null or Primary Key column constraint definition.
//
inline const ElemDDLConstraintArray &ElemDDLColDef::getConstraintArray() const { return columnConstraintArray_; }

inline ElemDDLConstraintArray &ElemDDLColDef::getConstraintArray() { return columnConstraintArray_; }

inline ElemDDLConstraintNotNull *ElemDDLColDef::getConstraintNotNull() const { return pConstraintNotNull_; }

inline ElemDDLConstraintPK *ElemDDLColDef::getConstraintPK() const { return pConstraintPK_; }

inline const ElemDDLColDef::defaultClauseStatusType ElemDDLColDef::getDefaultClauseStatus() const {
  return defaultClauseStatus_;
}

inline ItemExpr *ElemDDLColDef::getDefaultValueExpr() const { return pDefault_; }

inline const NAString &ElemDDLColDef::getComputedDefaultExpr() const { return computedDefaultExpr_; }

inline const NAString &ElemDDLColDef::getDefaultExprString() const { return defaultExprString_; }

inline const NAString &ElemDDLColDef::getHeading() const { return heading_; }

inline const NABoolean ElemDDLColDef::getIsConstraintNotNullSpecified() const { return isNotNullSpec_; }

inline const NABoolean ElemDDLColDef::getIsConstraintPKSpecified() const { return isPrimaryKeySpec_; }

inline const NABoolean ElemDDLColDef::getIsHeadingSpecified() const { return isHeadingSpec_; }

inline const ComColumnClass ElemDDLColDef::getColumnClass() const { return columnClass_; }

inline ElemDDLSGOptions *ElemDDLColDef::getSGOptions() const { return pSGOptions_; }

inline NAString *ElemDDLColDef::getSGLocation() const { return pSGLocation_; }

//
// get list of column names specified in PRIMARY KEY clause
//
inline const ElemDDLColRefArray &ElemDDLColDef::getPrimaryKeyColRefArray() const { return primaryKeyColRefArray_; }

inline ElemDDLColRefArray &ElemDDLColDef::getPrimaryKeyColRefArray() { return primaryKeyColRefArray_; }

inline const NABoolean ElemDDLColDef::isHeadingSpecified() const { return getIsHeadingSpecified(); }

inline const NABoolean ElemDDLColDef::isNotNullConstraintSpecified() const { return getIsConstraintNotNullSpecified(); }

inline const NABoolean ElemDDLColDef::isNotNullNondroppable() const { return isNotNullNondroppable_; }

inline const NABoolean ElemDDLColDef::getIsLoggableSpecified() const { return isLoggableSpec_; }

inline const NABoolean ElemDDLColDef::getIsLoggable() const { return isLoggable_; }

inline const NABoolean ElemDDLColDef::isPrimaryKeyConstraintSpecified() const { return getIsConstraintPKSpecified(); }

inline const ComColumnDirection ElemDDLColDef::getDirection() const { return direction_; }

inline NABoolean ElemDDLColDef::isDivisionColumn() const { return isDivisionColumn_; }

inline ComSInt32 ElemDDLColDef::getDivisionColumnSequenceNumber() const { return divisionColumnSeqNum_; }

//
// mutators
//

inline void ElemDDLColDef::setHeading(const NAString &heading) { heading_ = heading; }

inline void ElemDDLColDef::setIsHeadingSpecified(const NABoolean isHeadingSpec) { isHeadingSpec_ = isHeadingSpec; }

inline void ElemDDLColDef::setColumnClass(ComColumnClass columnClass) { columnClass_ = columnClass; }

inline void ElemDDLColDef::setDirection(const ComColumnDirection direction) { direction_ = direction; }

inline void ElemDDLColDef::setDivisionColumnFlag(NABoolean bVal) { isDivisionColumn_ = bVal; }

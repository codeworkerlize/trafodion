...
enum MvInitializationType { MVINIT_EMPTY = 0, MVINIT_ON_CREATE, MVINIT_ON_REFRESH, MVINIT_NO_INIT, MVINIT_BY_USER };
...
class StmtDDLCreateMV : public StmtDDLNode {
 public:
  // constructor
  StmtDDLCreateMV(const QualifiedName &MVQualName, const ParNameLocList &nameLocList, ElemDDLNode *optionalMVColumnList,
                  ComMVRefreshType refreshType, ElemDDLNode *pAttributeTableLists,
                  //		  ComMVStatus          mvStatus,
                  MvInitializationType initType, ComBoolean isRewriteEnabled, ElemDDLNode *optionalFileOptionsClause,
                  RelExpr *queryExpression, ElemDDLNode *pOptionalOwner, CollHeap *heap = PARSERHEAP());
  ...
  ElemDDLCreateMVOneAttributeTableList *getIgnoreChangesList() { return pIgnoreChangesList_; }
  ...
  int getCommitEachNRows() { return commitEachNRows_; }
  ...
  inline void setFileOptionsPositions(const StringPos startPos, const StringPos endPos);
...
inline QualifiedName &StmtDDLCreateMV::getMVNameAsQualifiedName() { return MVQualName_; }

inline const QualifiedName &StmtDDLCreateMV::getMVNameAsQualifiedName() const { return MVQualName_; }

inline CollIndex StmtDDLCreateMV::getCurViewColNum() const { return getViewUsages().getCurViewColNum(); }

inline const StringPos StmtDDLCreateMV::getEndPosition() const { return endPos_; }

inline const ParNameLocList &StmtDDLCreateMV::getNameLocList() const { return nameLocList_; }

inline ParNameLocList &StmtDDLCreateMV::getNameLocList() { return nameLocList_; }

inline ElemDDLNode *StmtDDLCreateMV::getOptionalColumnNames() { return pMVColumnList_; }

inline ElemDDLNode *StmtDDLCreateMV::getFileOptions() { return pFileOptions_; }

inline ElemDDLStoreOptKeyColumnList *StmtDDLCreateMV::getStoreByOption() const { return pStoreByOption_; }

inline const RelExpr *StmtDDLCreateMV::getQueryExpression() const { return pQueryExpression_; }

inline RelExpr *StmtDDLCreateMV::getQueryExpression() { return pQueryExpression_; }

inline const StringPos StmtDDLCreateMV::getStartPosition() const { return startPos_; }

inline const ElemDDLColViewDefArray &StmtDDLCreateMV::getMVColDefArray() const { return columnDefArray_; }

inline ElemDDLColViewDefArray &StmtDDLCreateMV::getMVColDefArray() { return columnDefArray_; }

inline const NAString StmtDDLCreateMV::getMVName() const { return MVQualName_.getQualifiedNameAsAnsiString(); }

inline const ParViewUsages &StmtDDLCreateMV::getViewUsages() const { return viewUsages_; }

inline ParViewUsages &StmtDDLCreateMV::getViewUsages() { return viewUsages_; }

inline const LIST(OptUDFInfo *) & StmtDDLCreateMV::getUDFList() const { return udfList_; }

inline LIST(OptUDFInfo *) & StmtDDLCreateMV::getUDFList() { return udfList_; }

inline NABoolean StmtDDLCreateMV::isItmColRefInColInRowVals() const {
  return getViewUsages().isItmColRefInColInRowVals();
}

inline NABoolean StmtDDLCreateMV::isProcessingViewColList() const { return getCurViewColNum() NEQ NULL_COLL_INDEX; }

//
// mutators
//

inline void StmtDDLCreateMV::resetCurViewColNum() { getViewUsages().setCurViewColNum(NULL_COLL_INDEX); }

inline void StmtDDLCreateMV::setCurViewColNum(const CollIndex curVwCol) { getViewUsages().setCurViewColNum(curVwCol); }

inline void StmtDDLCreateMV::setEndPosition(const StringPos endPos) { endPos_ = endPos; }

inline void StmtDDLCreateMV::setItmColRefInColInRowValsFlag(const NABoolean isItmColRef) {
  getViewUsages().setItmColRefInColInRowValsFlag(isItmColRef);
}
inline void StmtDDLCreateMV::setStartPosition(const StringPos startPos) { startPos_ = startPos; }
inline const StringPos StmtDDLCreateMV::getEndOfOptionalColumnListPosition() const { return endOfOptionalColumnList_; }
inline const StringPos StmtDDLCreateMV::getEndOfSelectColumnListPosition() const { return endOfSelectColumnList_; }
inline const StringPos StmtDDLCreateMV::getStartOfMVQueryPosition() const { return startOfMVQuery_; }
inline const StringPos StmtDDLCreateMV::getStartOfFileOptionsPosition() const { return startOfFileOptions_; }
inline const StringPos StmtDDLCreateMV::getEndOfFileOptionsPosition() const { return endOfFileOptions_; }

inline void StmtDDLCreateMV::setEndOptionalColumnListPosition(const StringPos endPos) {
  endOfOptionalColumnList_ = endPos;
}

inline void StmtDDLCreateMV::setFileOptionsPositions(const StringPos startPos, const StringPos endPos) {
  startOfFileOptions_ = startPos;
  endOfFileOptions_ = endPos;
}

inline void StmtDDLCreateMV::setEndSelectColumnListPosition(const StringPos endPos) { endOfSelectColumnList_ = endPos; }
inline void StmtDDLCreateMV::setStartOfMVQueryPosition(const StringPos startPos) { startOfMVQuery_ = startPos; }

// get column name list in partition by clause
inline const ElemDDLColRefArray &StmtDDLCreateMV::getPartitionKeyColRefArray() const {
  return partitionKeyColRefArray_;
}

// get column name list in partition by clause
inline ElemDDLColRefArray &StmtDDLCreateMV::getPartitionKeyColRefArray() { return partitionKeyColRefArray_; }

inline NABoolean StmtDDLCreateMV::isOwnerSpecified() const { return pOwner_ ? TRUE : FALSE; }

inline const ElemDDLGrantee *StmtDDLCreateMV::getOwner() const { return pOwner_; }

inline NABoolean StmtDDLCreateMV::isDivisionClauseSpecified() const { return isDivisionByClauseSpecified_; }
...
inline ElemDDLDivisionClause *StmtDDLCreateMV::getDivisionClause() { return pDivisionByClauseParseNode_; }

...
public:
  ...
  ElemDDLFileAttrNamespace(NAString &namespace1)
       : ElemDDLFileAttr(ELM_FILE_ATTR_NAMESPACE_ELEM),
...
public:
  ...
  // default constructor
  ElemDDLFileAttrEncrypt(NAString *encryptionOptions,
                         CollHeap *heap)
       : ElemDDLFileAttr(ELM_FILE_ATTR_ENCRYPT_ELEM),
         encryptionOptions_(NULL)
  {
    if (encryptionOptions)
      encryptionOptions_ = new(heap) NAString(*encryptionOptions);
  }
...
public:
  ...
  // default constructor
  ElemDDLFileAttrIncrBackup(NABoolean e)
       : ElemDDLFileAttr(ELM_FILE_ATTR_INCR_BACKUP_ELEM),
         enabled_(e)
  {
  }
...
class ElemDDLLobStorageOptions : public ElemDDLNode
{
 ...
 public:
  ...
  ElemDDLLobStorageOptions(NAList<LobStorageOption*> * lobStorageOptions,
                           CollHeap * heap);
...
public:
  ...
  // default constructor
  ElemDDLFileAttrReadOnly(NABoolean e)
       : ElemDDLFileAttr(ELM_FILE_ATTR_READ_ONLY_ELEM),
         enabled_(e)
  {
  }

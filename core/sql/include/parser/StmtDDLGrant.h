...
class StmtDDLGrant : public StmtDDLNode {
 public:
  // constructor
  StmtDDLGrant(ElemDDLNode *pPrivileges, const QualifiedName &objectName, ElemDDLNode *pGranteeList,
...
// accessors
//
inline QualifiedName &StmtDDLGrant::getGrantNameAsQualifiedName() { return objectQualName_; }

inline const QualifiedName &StmtDDLGrant::getGrantNameAsQualifiedName() const { return objectQualName_; }
inline NAString StmtDDLGrant::getObjectName() const { return objectName_; }

inline ElemDDLGranteeArray &StmtDDLGrant::getGranteeArray() { return granteeArray_; }

inline const ElemDDLGranteeArray &StmtDDLGrant::getGranteeArray() const { return granteeArray_; }

inline ElemDDLPrivActArray &StmtDDLGrant::getPrivilegeActionArray() { return privActArray_; }

inline const ElemDDLPrivActArray &StmtDDLGrant::getPrivilegeActionArray() const { return privActArray_; }

inline NAString StmtDDLGrant::getTableName() const { return objectName_; }

inline const QualifiedName *StmtDDLGrant::getActionNameAsQualifiedName() const { return actionQualName_; }

inline NABoolean StmtDDLGrant::isAllPrivilegesSpecified() const { return isAllPrivileges_; }

inline NABoolean StmtDDLGrant::isWithGrantOptionSpecified() const { return isWithGrantOptionSpec_; }

inline NABoolean StmtDDLGrant::isByGrantorOptionSpecified() const { return isByGrantorOptionSpec_; }

inline const ElemDDLGrantee *StmtDDLGrant::getByGrantor() const { return byGrantor_; }

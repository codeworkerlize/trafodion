...
inline const NAString &
StmtDDLAlterTableDisableIndex::getPartitionName() const
{
...
inline const NABoolean
StmtDDLAlterTableDisableIndex::isProcessIndexOnPartition() const
{
...
inline void 
StmtDDLAlterTableDisableIndex::setIndexOnPartition(NABoolean v)
{

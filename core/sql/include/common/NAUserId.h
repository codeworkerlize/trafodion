...
static const SystemAuthsStruct systemRoles[]{
    {DB__HIVEROLE, false, HIVE_ROLE_ID},         {DB__HBASEROLE, false, HBASE_ROLE_ID},
    {DB__ROOTROLE, false, ROOT_ROLE_ID},         {DB__ADMINROLE, false, NA_UserIdDefault},
    {DB__SERVICESROLE, false, NA_UserIdDefault}, {DB__LIBMGRROLE, false, NA_UserIdDefault},
    {PUBLIC_AUTH_NAME, true, PUBLIC_USER},       {SYSTEM_AUTH_NAME, true, SYSTEM_USER}};
...
static const SystemAuthsStruct systemTenants[]{{DB__SYSTEMTENANT, false, SYSTEM_TENANT_ID}};

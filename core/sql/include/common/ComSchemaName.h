...
class ComSchemaName {
 ...
 public:
  ...
  ComSchemaName(const NAString &externalSchemaName, size_t &count);
  ...
  ComSchemaName(const ComAnsiNamePart &catalogNamePart, const ComAnsiNamePart &schemaNamePart);
...
NABoolean ComSchemaName::isEmpty() const { return (schemaNamePart_.isEmpty() AND catalogNamePart_.isEmpty()); }

NABoolean ComSchemaName::isValid() const {
  //
...
void ComSchemaName::setCatalogNamePart(const ComAnsiNamePart &catalogNamePart) { catalogNamePart_ = catalogNamePart; }

void ComSchemaName::setSchemaNamePart(const ComAnsiNamePart &schemaNamePart) { schemaNamePart_ = schemaNamePart; }

inline NABoolean ComSchemaName::operator==(const ComSchemaName &rhs) const {
  return (getSchemaNamePart()
              .getInternalName() EQU rhs.getSchemaNamePart()
              .getInternalName() AND getCatalogNamePart()
              .getInternalName() EQU rhs.getCatalogNamePart()
              .getInternalName());
}

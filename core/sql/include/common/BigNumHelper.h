...
class BigNumHelper {
 public:
  ...
  static short AddHelper(Lng32 dataLength, char *leftData, char *rightData, char *resultData);

  // The following method subtracts one Big Num from another (without signs).
  static short SubHelper(Lng32 dataLength, char *leftData, char *rightData, char *resultData);

  // The following method multiplies two Big Nums (without signs).
  // The assumption is that the result is big enough to hold the
  // product.
  static short MulHelper(Lng32 resultLength, Lng32 leftLength, Lng32 rightLength, char *leftData, char *rightData,
                         char *resultData);
  ...
  static short SimpleDivHelper(Lng32 dividendLength, Lng32 divisorLength, char *dividendData, char *divisorData,
                               char *quotientData);

  // The following method divides one Big Num by another (both without signs).
  // It returns 1 if there is a remainder, 0 if there is no remainder.
  static short DivHelper(Lng32 dividendLength, Lng32 divisorLength, char *dividendData, char *divisorData,
                         char *quotientData, char *tempData);

  // The following method rounds a Big Num (without signs).
  static short RoundHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, Int64 roundingValue,
                           char *targetData);
  ...
  static short ConvBigNumToBcdHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, char *targetData,
                                     NAMemory *heap);
  ...
  static short ConvBcdToBigNumHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, char *targetData);
  ...
  static short ConvBigNumWithSignToBcdHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, char *targetData,
                                             NAMemory *heap);
  ...
  static short ConvBcdToBigNumWithSignHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData,
                                             char *targetData);

  // The following method converts a given Big Num (without sign) into
  // its equivalent ASCII string representation (with the more significant
  // decimal digits in the lower addresses).
  static short ConvBigNumToAsciiHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, char *targetData,
                                       NAMemory *heap);
  ...
  // addresses) into its equivalent Big Num representation.
  static short ConvAsciiToBigNumHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData, char *targetData);

  // The following method converts a given Big Num (with sign) into
  // its equivalent ASCII string representation (with the more significant
  // decimal digits in the lower addresses).
  static short ConvBigNumWithSignToAsciiHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData,
                                               char *targetData, NAMemory *heap);

  // The following method converts a given ASCII string representation
  // (with sign, and with the more significant decimal digits in the lower
  // addresses) into its equivalent Big Num representation.
  static short ConvAsciiToBigNumWithSignHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData,
                                               char *targetData);
  ...
  static short ConvPowersOfTenToBigNumHelper(Lng32 exponent, Lng32 targetLength, Lng32 *finalTargetLength,
                                             char *targetData);

  // The following converts an Int64 to a Big Num (with sign).
  static short ConvInt64ToBigNumWithSignHelper(Lng32 targetLength, Int64 sourceData, char *targetData,
                                               NABoolean isUnsigned);

  // The following converts a Big Num (with sign) into an Int64.
  static short ConvBigNumWithSignToInt64Helper(Lng32 sourceLength, char *sourceData, void *targetData,
                                               NABoolean isUnsigned);
  ...
  static short ConvBigNumWithSignToInt64AndScaleHelper(Lng32 sourceLength, char *sourceData, Int64 *targetData,
                                                       Lng32 exponent, NAMemory *heap);

  // The following converts a Big Num to a Big Num.
  static short ConvBigNumWithSignToBigNumWithSignHelper(Lng32 sourceLength, Lng32 targetLength, char *sourceData,
                                                        char *targetData);
};

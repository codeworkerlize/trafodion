...
enum {
  ...
  ComMAX_1_PART_INTERNAL_UCS2_NAME_LEN_IN_BYTES =
      ComMAX_1_PART_INTERNAL_UCS2_NAME_LEN_IN_NAWCHARS * 2 /*BYTES_PER_NAWCHAR*/
  ...
  ,
  ComMAX_1_PART_INTERNAL_UTF8_NAME_LEN_IN_BYTES =
      COM_COMPUTE_UTF8_BYTE_LEN_FROM_UCS2_NAWCHAR_LEN(ComMAX_1_PART_INTERNAL_UCS2_NAME_LEN_IN_NAWCHARS),
  ...
  ComMAX_1_PART_EXTERNAL_UCS2_NAME_LEN_IN_BYTES =
      ComMAX_1_PART_EXTERNAL_UCS2_NAME_LEN_IN_NAWCHARS * 2 /*BYTES_PER_NAWCHAR*/
  ,

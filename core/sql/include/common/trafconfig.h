...
#define TC_NODES_MAX \
  1536  // This can be higher when needed and
...
TC_Export int tc_close(void) TC_DIAG_UNUSED;

TC_Export const char *tc_errmsg(int err) TC_DIAG_UNUSED;

TC_Export int tc_initialize(bool traceEnabled, const char *traceFileName = NULL, const char *instanceNode = NULL,
                            const char *rootNode = NULL) TC_DIAG_UNUSED;

TC_Export int tc_delete_nameserver(const char *node_name) TC_DIAG_UNUSED;

TC_Export int tc_get_nameservers(int *count, int max, char **nodeNames) TC_DIAG_UNUSED;

TC_Export int tc_get_nameserver(const char *node_name) TC_DIAG_UNUSED;

TC_Export int tc_put_nameserver(const char *node_name) TC_DIAG_UNUSED;

TC_Export TcStorageType_t tc_get_storage_type(void) TC_DIAG_UNUSED;

TC_Export int tc_delete_node(int nid, const char *node_name) TC_DIAG_UNUSED;

TC_Export int tc_get_node(const char *node_name, TcNodeConfiguration_t *node_config) TC_DIAG_UNUSED;

TC_Export int tc_put_node(TcNodeConfiguration_t *node_config) TC_DIAG_UNUSED;

TC_Export int tc_get_pnode(const char *node_name, TcPhysicalNodeConfiguration_t *pnode_config) TC_DIAG_UNUSED;

TC_Export int tc_put_pnode(TcPhysicalNodeConfiguration_t *pnode_config) TC_DIAG_UNUSED;
...
//
TC_Export int tc_get_nodes(int *count, int max, TcNodeConfiguration_t *node_config) TC_DIAG_UNUSED;
...
//
TC_Export int tc_get_snodes(int *count, int max, TcPhysicalNodeConfiguration_t *pnode_config) TC_DIAG_UNUSED;

TC_Export int tc_delete_persist_keys(void) TC_DIAG_UNUSED;

TC_Export int tc_get_persist_keys(const char *persist_keys) TC_DIAG_UNUSED;

TC_Export int tc_put_persist_keys(const char *persist_keys) TC_DIAG_UNUSED;

TC_Export int tc_delete_persist_process(const char *persist_key_prefix) TC_DIAG_UNUSED;

TC_Export int tc_get_persist_process(const char *persist_key_prefix,
                                     TcPersistConfiguration_t *persist_config) TC_DIAG_UNUSED;
...
//
TC_Export int tc_get_registry_cluster_set(int *count, int max,
                                          TcRegistryConfiguration_t *registry_config) TC_DIAG_UNUSED;
...
//
TC_Export int tc_get_registry_process_set(int *count, int max,
                                          TcRegistryConfiguration_t *registry_config) TC_DIAG_UNUSED;

TC_Export int tc_get_registry_key(const char *key) TC_DIAG_UNUSED;

TC_Export int tc_put_registry_key(const char *key) TC_DIAG_UNUSED;

TC_Export int tc_get_registry_process(const char *process_name) TC_DIAG_UNUSED;

TC_Export int tc_put_registry_process(const char *process_name) TC_DIAG_UNUSED;

TC_Export int tc_get_registry_cluster_data(const char *key, const char *data) TC_DIAG_UNUSED;

TC_Export int tc_put_registry_cluster_data(const char *key, const char *data) TC_DIAG_UNUSED;

TC_Export int tc_get_registry_process_data(const char *process_name, const char *key, const char *data) TC_DIAG_UNUSED;

TC_Export int tc_put_registry_process_data(const char *process_name, const char *key, const char *data) TC_DIAG_UNUSED;

TC_Export TcStorageType_t tc_get_storage_type(void) TC_DIAG_UNUSED;

TC_Export int tc_delete_unique_strings(int nid) TC_DIAG_UNUSED;

TC_Export int tc_get_unique_string(int nid, int id, const char *unique_string) TC_DIAG_UNUSED;

TC_Export int tc_put_unique_string(int nid, int id, const char *unique_string) TC_DIAG_UNUSED;

TC_Export int tc_get_unique_string_id(int nid, const char *unique_string, int *id) TC_DIAG_UNUSED;

TC_Export int tc_get_unique_string_id_max(int nid, int *id) TC_DIAG_UNUSED;

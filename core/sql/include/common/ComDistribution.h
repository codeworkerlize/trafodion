...
//  32 characters.
//
void ComNameSpaceEnumToText(const ComAnsiNameSpace nameSpace, char *typeOfObject);
...
//  26 characters.
//
void ComObjectTypeEnumToText(const ComObjectType objectType, char *typeOfObject);
...
//  be at least 3 characters.
//
void ComNameSpaceEnumToLiteral(const ComAnsiNameSpace nameSpace, char *nameSpaceLiteral);
...
//  be at least 3 characters.
//
void ComObjectTypeEnumToLiteral(const ComObjectType objectType, char *objectTypeLiteral);
...
//
void ComPrivTypeEnumToLiteral(const ComPrivilegeType privType, char *privTypeLiteral);
...
void ComVersionInfoSPInputTypeToLiteral(const VersionInfoSPInputType inputType, char *inputTypeLiteral);
...
void ComRelatednessSPInputTypeToLiteral(const RelatednessSPInputType inputType, char *inputTypeLiteral);
...
void ComFeatureVersionInfoSPInputTypeToLiteral(const FeatureVersionInfoSPInputType inputType, char *inputTypeLiteral);

FeatureVersionInfoSPInputType ComFeatureVersionInfoSPLiteralToInputType(const char *inputTypeLiteral);
...
class VisibilityErrorTranslator : public ComDiagsTranslator {
 public:
  VisibilityErrorTranslator(const char *ansiName, const char *guardianName);
  const NABoolean translateCondition(ComDiagsArea &diags, const ComCondition &cond);
...
class MetaDataErrorTranslator : public ComDiagsTranslator {
 public:
  ...
  MetaDataErrorTranslator(const char *tableName, const NABoolean isSystemSchemaTable = FALSE,

...
// -----------------------------------------------------------------------
//
char ComGetGuardianLocationNamePartSeparator();
...
class ComLocationName {
 public:
  enum locationNameFormat { UNKNOWN_LOCATION_NAME_FORMAT, GUARDIAN_LOCATION_NAME_FORMAT, OSS_LOCATION_NAME_FORMAT };
  ...
  ComLocationName(const char *locationName, locationNameFormat locNameFormat);
  ...
  ComLocationName(const ComNodeName &nodeName, const ComVolumeName &volumeName, const char *fileSuffix);
  ...
  NABoolean expand(const ComNodeName &defaultSystemName, const ComVolumeName &defaultVolumeName);
...
// accessors
//
inline const ComNodeName &ComLocationName::getGuardianSystemNamePart() const { return systemNamePart_; }

inline const ComVolumeName &ComLocationName::getGuardianVolumeNamePart() const { return volumeNamePart_; }

inline const ComSubvolumeName &ComLocationName::getSubvolumeNamePart() const { return subvolumeNamePart_; }

inline const ComFileName &ComLocationName::getFileNamePart() const { return fileNamePart_; }

inline ComLocationName::inputFormat ComLocationName::getInputFormat() const { return inputFormat_; }

inline const char *ComLocationName::getSystemNamePartWithoutBackslashPrefix() const {
  return systemNamePart_.getNodeNameWithoutBackslash();
}

inline const char *ComLocationName::getVolumeNamePartWithoutDollarPrefix() const {
  return volumeNamePart_.getVolumeNameWithoutDollar();
}

inline NABoolean ComLocationName::isEmpty() const {
  //
...
inline NABoolean ComLocationName::isExpanded() const { return isExpanded_; }

inline NABoolean ComLocationName::isValid() const { return (inputFormat_ NEQ UNKNOWN_INPUT_FORMAT); }

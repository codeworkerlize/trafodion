...
_declspec(dllimport) int ACTIVATERECEIVETRANSID(short msgnum)  // IN
    ;

_declspec(dllimport) int AWAITIOX(short *filenum_,                    // IN/OUT
...
_declspec(dllimport) short BEGINTRANSACTION(int *tag = NULL)  // OUT OPTIONAL
...
_declspec(dllimport) int COMPUTEJULIANDAYNO(short year,           // IN
                                            short month,          // IN
                                            short day,            // IN
...
_declspec(dllimport) _int64 CONVERTTIMESTAMP(_int64 fromtimestamp,         // IN
...
_declspec(dllimport) short FILENAME_FINDFINISH_(short search_id)  // IN
    ;

_declspec(dllimport) short FILENAME_FINDNEXT_(short search_id,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) short FILE_CLOSE_(short filenum,                       // IN
...
_declspec(dllimport) short FILE_GETINFOLIST_(short filenum,             // IN
                                             short *itemlist,           // IN
                                             short numberitems,         // IN
                                             short *result,             // OUT
                                             short resultmax,           // IN
...
_declspec(dllimport) short FILE_GETINFO_(short filenum,            // IN
...
_declspec(dllimport) short FILE_RENAME_(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                        unsigned char *name,  // IN
#else
                                        char *name,                         // IN
...
_declspec(dllimport) short GETSYSTEMNAME(short sysid,     // IN
                                         short *sysname)  // OUT
    ;
...
_declspec(dllimport) _int64 JULIANTIMESTAMP(short type = OMITSHORT,  // IN OPTIONAL
                                            short *tuid = NULL,      // OUT OPTIONAL
                                            short *error = NULL,     // OUT OPTIONAL
                                            short node = OMITSHORT)  // IN OPTIONAL
    ;

_declspec(dllimport) int KEYPOSITIONX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) short MESSAGESTATUS(short msgnum = OMITSHORT)  // IN OPTIONAL
    ;

_declspec(dllimport) short MESSAGESYSTEMINFO(short itemcode,  // IN
                                             short *value)    // OUT
    ;
...
_declspec(dllimport) short NODENUMBER_TO_NODENAME_(int sysnum = OMITINT,  // IN OPTIONAL
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) short PROCESSHANDLE_GETMINE_(short *phandle)  // OUT
    ;

_declspec(dllimport) short PROCESSHANDLE_NULLIT_(short *prochand)  // OUT
                                                                   // PROCESSHANDLE
    ;
...
_declspec(dllimport) short PROCESS_GETINFO_(short *phandle = NULL,  // IN/OUT OPTIONAL
                                                                    //[0:9]
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) int READLOCKX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) int READUPDATELOCKX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                         unsigned char *buf,  // OUT
#else
                                         void *buf,                         // OUT
...
_declspec(dllimport) int READUPDATEX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                     unsigned char *buf,  // OUT
#else
                                     void *buf,                             // OUT
...
_declspec(dllimport) int READX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                               unsigned char *buf,  // OUT
#else
                               void *buf,                                   // OUT
...
_declspec(dllimport) short SERVERCLASS_DIALOG_ABORT_(int dialogid)  // IN
    ;

_declspec(dllimport) short SERVERCLASS_DIALOG_BEGIN_(int *dialogid,  // OUT
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) short SERVERCLASS_DIALOG_END_(int dialogid)  // IN
    ;

_declspec(dllimport) short SERVERCLASS_DIALOG_SEND_(int dialogid,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                                    unsigned char *messagebuffer,  // IN/OUT
#else
                                                    void *messagebuffer,    // IN/OUT
...
_declspec(dllimport) short SERVERCLASS_SEND_INFO_(short *serverclasserror,  // OUT
...
_declspec(dllimport) int WRITEUPDATEUNLOCKX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
...
_declspec(dllimport) int WRITEUPDATEX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                      unsigned char *buf,  // IN
#else
                                      void *buf,        // IN
...
_declspec(dllimport) int WRITEX(short filenum,  // IN
#ifdef TDM_ROSETTA_COMPATIBILITY_
                                unsigned char *buf,  // IN
#else
                                void *buf,              // IN
...
_declspec(dllimport) short TDM_NTAWAITIOX_(short *filenum,                    // IN/OUT
                                           void **bufptr = NULL,              // OUT OPTIONAL
    ...
    ;
_declspec(dllimport) short SETTMFAFFINITY(const short TmfSegmentNumber  // IN
);
}
...
_declspec(dllimport) short BEGINTRANSACTION(int *tag)  // OUT OPTIONAL
                                                       // TAG FOR RESUMETRANSACTION RETURNED HERE
    ;
...
_declspec(dllimport) _int64 JULIANTIMESTAMP(short type,    // IN OPTIONAL
...
_declspec(dllimport) short NODENUMBER_TO_NODENAME_(int sysnum,              // IN OPTIONAL
#ifdef TDM_ROSETTA_COMPATIBILITY_

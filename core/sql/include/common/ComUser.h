   ...
   public:
    ...
    enum AuthTypeChar { AUTH_PUBLIC = 'P',
     ...
     static Int16 getCurrentUserRoles(NAList <Int32> &roleIDs,
                                      ...
                                      ComDiagsArea *diags);
     static Int16 getUserGroups (const char *userName,
                                 bool allowMDAccess,
                                 NAList <Int32> &groupIDs,
                                 ComDiagsArea *diags);
     static bool currentUserHasElevatedPrivs(ComDiagsArea *diags);
     static Int16 userHasElevatedPrivs(const Int32 userID,
                                       const std::vector <int32_t> &roleIDs,
                                       bool &hasElevatedPrivs,
                                       ComDiagsArea *diags);
     static Int16 getSystemRoleList (char *roleList,
                                     Int32 &actualLen,
                                     const Int32 maxLen,

...
class SockControlConnection : public IpcControlConnection {
 public:
  ...
  SockControlConnection(IpcEnvironment *env, Int32 inheritedSocket, Int32 passedPort,
...
class IpcEnvironment : public NABasicObject {
 public:
  ...
  void addIpcMsgTrace(IpcConnection *conn, const char mtype, void *bufAddr, Int32 length, char isLast, UInt32 seqNum) {

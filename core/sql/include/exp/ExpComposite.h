...
public:
  ...
  CompositeAttributes(Lng32 length)
       : length_(length),
         numElements_(0),
         elements_(NULL)
  {
  ...
  CompositeAttributes(Int16 datatype, 
                      Int32 length,
  ...
  void copyAttrs(Attributes *source_)
  {
    *this = *(CompositeAttributes *)source_;
  }
...
public:
  ExpCompositeBase(OperatorTypeEnum oper_type,
                   short type,
                   ULng32 numElements,
                   short numAttrs,
                   Attributes ** attr,
  ...
  virtual ex_expr::exp_return_type fixup(Space * space,
                                         CollHeap * exHeap,
                                         char * constantsArea,
                                         char * tempsArea,
                                         char * persistentArea,
...
public:
  ExpCompositeArrayLength(OperatorTypeEnum oper_type,
                          short type,
                          Attributes ** attr,
                          Space * space);
...
public:
  ExpCompositeArrayCast(OperatorTypeEnum oper_type,
                        short type,
                        Attributes ** attr,
                        AttributesPtr compAttrs,
...
public:
  ExpCompositeHiveCast(OperatorTypeEnum oper_type,
                       NABoolean fromHive,
                       short type,
                       Attributes ** attr,
                       AttributesPtr compAttrs,
  ...
  ex_expr::exp_return_type copyHiveSrcToTgt(
     Attributes *tgtAttr,
  ...
  inline void setFromHive(NABoolean v) 
  {(v)? flags_ |= FROM_HIVE: flags_ &= ~FROM_HIVE;}

protected:
  enum
  {
    FROM_HIVE = 0x00000001
  };
...
public:
  ExpCompositeConcat(OperatorTypeEnum oper_type,
                     short type,
                     Attributes ** attr,
                     AttributesPtr compAttrs,
                     AttributesPtr compAttrsChild1,
                     AttributesPtr compAttrsChild21,
                     Space * space);
  ExpCompositeConcat(){};
...
public:
  ExpCompositeCreate(OperatorTypeEnum oper_type,
                     short type,
                     ULng32 numElements,
                     short numAttrs,
                     Attributes ** attr,
...
public:
  ExpCompositeDisplay(OperatorTypeEnum oper_type,
                      short type,
                      ULng32 numElements,
                      short numAttrs,
                      Attributes ** attr,
...
public:
  ExpCompositeExtract(OperatorTypeEnum oper_type,
                      short type,
                      ULng32 numElements,
                      Lng32 elemNum,
                      short numAttrs,
  ...
  static ex_expr::exp_return_type extractValue(Attributes * compAttrs,
                                               Lng32 elemNum,
                                               char * tgtPtr,
                                               char * srcPtr,
                                               Int32 maxNumElems,
 ...
 private:
  ex_expr::exp_return_type searchAndExtractValue(Attributes * inAttrs,
                                                 char * tgtPtr,
                                                 char * srcPtr,
                                                 NABoolean &isNullVal,
                                                 ULng32 &attrLen,

...
class ExpDP2Expr : public NAVersionedObject {
 ...
 public:
  ExpDP2Expr(ex_expr_base *expr, ex_cri_desc *work_cri_desc, Space *space, short allocateWorkAtpAtRunTime = 0);
...
#define FILLERS_EXP_DP2_KE_EXPR_SIZE 24
 ...
 public:
  ExpDP2KeyEncodeExpr(ex_expr_base *expr, ex_cri_desc *work_cri_desc, Space *space, short allocateWorkAtpAtRunTime = 0);
  ...
  void setKeyEncodeOpt1(NABoolean v) { (v ? flags_ |= KEY_ENCODE_OPT_1 : flags_ &= ~KEY_ENCODE_OPT_1); }
};

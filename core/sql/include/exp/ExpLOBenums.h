...
#define LOB_HANDLE_LEN        LOB_V1_EXT_HANDLE_LEN
...
typedef enum {
  ...
  LOB_DATA_WRITE_ERROR_RETRY,
  LOB_DATA_FILE_DELETE_ERROR,
  LOB_DEST_FILE_OPEN_ERROR,
  LOB_DESC_FILE_DELETE_ERROR = 520,
...
typedef enum { EX_LOB_CREATE = 500, EX_LOB_RW } Ex_Lob_Mode;
...
typedef enum { Lob_Commit, Lob_UnCommit, Lob_Rollback } LobsTrans;
...
typedef enum { Lob_Hdfs_Cursor_Prefetch, Lob_Hdfs_Read, Lob_Hdfs_Write, Lob_Hdfs_Shutdown } LobsHdfsRequestType;

typedef enum { Lob_Cursor_Simple } LobsCursorType;

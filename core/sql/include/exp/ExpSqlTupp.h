...
class tupp_descriptor {
 ...
 private:
  ...
  enum TuppType { DATA_TUPP = 0, CONTROL_TUPP = 1, DIAGS_TUPP = 2, STATS_TUPP = 3, INVALID_DATA_VSBB_TUPP = 4 };
 ...
 public:
  ...
  ////////////////////////////////////////////////////////////////////
  NABoolean isControlTuple() { return (flags_ == CONTROL_TUPP); };

  NABoolean isDataTuple() { return (flags_ == DATA_TUPP); };

  NABoolean isDiagsTuple() { return (flags_ == DIAGS_TUPP); };

  NABoolean isStatsTuple() { return (flags_ == STATS_TUPP); };

  NABoolean isInvalidTuple() { return (flags_ == INVALID_DATA_VSBB_TUPP); };

  void setControlTupleType() { flags_ = CONTROL_TUPP; };

  void setDataTupleType() { flags_ = DATA_TUPP; };

  void setDiagsTupleType() { flags_ = DIAGS_TUPP; };

  void setStatsTupleType() { flags_ = STATS_TUPP; };
  void setInvalidTupleType() { flags_ = INVALID_DATA_VSBB_TUPP; };
};
...
inline void tupp::release() {
  ...
  if (tuppDescPointer) {
    ExSqlTuppAssert(tuppDescPointer->referenceCount_ > 0, "Releasing a free tuple descriptor");
...
inline void tupp::operator=(const tupp &source) {
  ...
  if (this != &source) {
    ...
    if (source.tuppDescPointer) {
      ExSqlTuppAssert(source.tuppDescPointer->referenceCount_ > 0, "Copying a free tuple descriptor");
...
inline tupp_descriptor *tupp::get_tupp_descriptor() { return tuppDescPointer; }

/////////////////////////////////////////////////
// class tupp_decriptor
/////////////////////////////////////////////////
inline unsigned short tupp_descriptor::getReferenceCount() const { return referenceCount_; }

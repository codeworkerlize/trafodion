...
class ex_hash_grby_tcb : public ex_tcb {
  ...
  enum HashGrbyPhase { HGB_READ_PHASE, HGB_RETURN_PHASE, HGB_READ_SPILL_PHASE, PHASE_END };
 ...
 public:
  ...
  ex_hash_grby_tcb(const ex_hash_grby_tdb &hash_grby_tdb, const ex_tcb &childTcb, ex_globals *glob);
...
inline ex_hash_grby_tdb &ex_hash_grby_tcb::hashGrbyTdb() const { return (ex_hash_grby_tdb &)tdb; };

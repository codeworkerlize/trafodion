...
class ExConnectByTempTableTcb : public ex_tcb {
  ...
  enum ConnectByTempTableStep { INITIAL_, POPULATE_DATA_, PROCESS_REQUEST_, DONE_, CANCEL_, ERROR_ };
  ...
  static ExWorkProcRetcode sCancel(ex_tcb *tcb) { return ((ExConnectByTempTableTcb *)tcb)->cancel(); }
 ...
 public:
  ...
  inline ex_expr *encodeProbeExpr() const { return connectbytemptableTdb().encodeProbeExpr_; };

  inline ex_expr *hashInputProbeExpr() const { return connectbytemptableTdb().hashInputExpr_; };
  inline ex_expr *encodeInputProbeExpr() const { return connectbytemptableTdb().encodeInputExpr_; };
  inline ex_expr *selectPred() const { return connectbytemptableTdb().scanExpr_; };

  inline ex_expr *moveInnerExpr() const { return connectbytemptableTdb().moveInnerExpr_; };
  ...
  void makeReplyToParentUp(ex_queue_entry *pentry_down, ExConnectByTempTablePrivateState &pstate,

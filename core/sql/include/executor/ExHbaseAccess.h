...
protected:
  ...
  inline ex_expr *partQualPreCondExpr() const
    { return hbaseAccessTdb().partQualPreCondExpr_; }
    
  inline ex_expr *insDelPreCondExpr() const
    { return hbaseAccessTdb().insDelPreCondExpr_; }

  inline ex_expr *scanPreCondExpr() const
    { return hbaseAccessTdb().scanPreCondExpr_; }

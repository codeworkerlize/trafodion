...
public:
  ...
  NABoolean dynamicUnlimited()
  { return ((flags_ & DYNAMIC_UNLIMITED ) != 0); }

  void setDynamicUnlimited(NABoolean v)
  { ( v ? flags_ |= DYNAMIC_UNLIMITED : flags_ &= ~DYNAMIC_UNLIMITED ); }

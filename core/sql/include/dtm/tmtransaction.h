...
public:
    ...
    short resume();
    short register_region(long startid, int port, char *hostname, int hostname_length, long startcode, char *regionInfo, int regionInfoLength, int peerId, int pv_tmFlags); //TOPL

...
enum upgradeErrNum {ERR_REVOKE_PRIVS = -1,
                    ERR_DROP_NEW_TBLS = -2,
...
static const MDUpgradeInfo allPrivMgrUpgradeInfo[] = {
 ...
 { PRIVMGR_OBJECT_PRIVILEGES,  PRIVMGR_OBJECT_PRIVILEGES_OLD,
   objectPrivilegesDDL,  sizeof(objectPrivilegesDDL),
   oldMDv210ObjectPrivilegesDDL, sizeof(oldMDv210ObjectPrivilegesDDL),
   NULL, 0,
   TRUE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

 // PRIVMGR_COLUMN_PRIVILEGES
  { PRIVMGR_COLUMN_PRIVILEGES,  PRIVMGR_COLUMN_PRIVILEGES_OLD,
    columnPrivilegesDDL,  sizeof(columnPrivilegesDDL),
    oldMDv210ColumnPrivilegesDDL, sizeof(oldMDv210ColumnPrivilegesDDL),
    NULL, 0,
    TRUE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  // PRIVMGR_COMPONENTS 
  { PRIVMGR_COMPONENTS,  PRIVMGR_COMPONENTS_OLD,
    componentsDDL,  sizeof(componentsDDL),
    oldMDv210ComponentsDDL, sizeof(oldMDv210ComponentsDDL), 
    NULL, 0,
    TRUE,
    "component_uid, component_name, is_system, component_description",
    "component_uid, component_name, cast (is_system as char(2) character set iso88591), component_description",
    NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  // PRIVMGR_COMPONENT_OPERATIONS  
  { PRIVMGR_COMPONENT_OPERATIONS,  PRIVMGR_COMPONENT_OPERATIONS_OLD,
    componentOperationsDDL,  sizeof(componentOperationsDDL),
    oldMDv210ComponentOperationsDDL, sizeof(oldMDv210ComponentOperationsDDL), 
    NULL, 0,
    TRUE, 
    "component_uid, operation_code, operation_name, is_system, operation_description",
    "component_uid, operation_code, operation_name, cast (is_system as char(2) character set iso88591), operation_description",
    NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  // PRIVMGR_COMPONENT_PRIVILEGES
  { PRIVMGR_COMPONENT_PRIVILEGES,  PRIVMGR_COMPONENT_PRIVILEGES_OLD,
    componentPrivilegesDDL,  sizeof(componentPrivilegesDDL),
    oldMDv210ComponentPrivilegesDDL, sizeof(oldMDv210ComponentPrivilegesDDL),
    NULL, 0,
    TRUE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  // PRIVMGR_ROLE_USAGE  
  { PRIVMGR_ROLE_USAGE,  PRIVMGR_ROLE_USAGE_OLD,
    roleUsageDDL,  sizeof(roleUsageDDL),
   oldMDv210RoleUsageDDL, sizeof(oldMDv210RoleUsageDDL),
    NULL, 0,
    TRUE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  // PRIVMGR_SCHEMA_PRIVILEGES  
  { PRIVMGR_SCHEMA_PRIVILEGES,  PRIVMGR_SCHEMA_PRIVILEGES_OLD,
    schemaPrivilegesDDL,  sizeof(schemaPrivilegesDDL),
    oldMDv210SchemaPrivilegesDDL, sizeof(oldMDv210SchemaPrivilegesDDL),
    NULL, 0,
    TRUE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE}
};

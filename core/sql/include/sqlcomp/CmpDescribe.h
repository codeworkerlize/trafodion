...
extern short CmpDescribeSeabaseTable ( 
     ...
     ULng32 &outbuflen,
     CollHeap *heap,
     NABoolean isCreatePartition = FALSE,
     ...
     NABoolean withoutNamespace = FALSE,
     NABoolean withoutRegionReplication = FALSE,
     NABoolean withoutIncrBackup = FALSE,
...
extern short CmpGenUniqueConstrStr(AbstractRIConstraint * ariConstr,
                                   Space *space, char *buf,
                                   NABoolean outputLine,
                                   NABoolean unnamed = FALSE,
                                   const CorrName *likeCorrName = NULL);

extern short CmpGenRefConstrStr(AbstractRIConstraint * ariConstr,
                                Space *space, char *buf,
                                NABoolean outputLine,
                                NABoolean unnamed = FALSE,
                                const CorrName *likeCorrName = NULL);

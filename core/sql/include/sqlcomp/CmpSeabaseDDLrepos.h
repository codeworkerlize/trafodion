 ...
 *               Currently includes query repository and backup(BR) repos.
 *
 * *****************************************************************************
 */
...
static const QString createMetricQueryTable[] = {
    ...
    {" query_id                               char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific no default not null not droppable serialized, "},
    {" query_signature_id                     char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific default null serialized, "},
    {" user_name                              char(256 bytes) character set utf8 casespecific default null "
     "serialized, "},
    {" role_name                              char(256 bytes) character set utf8 casespecific default null "
     "serialized, "},
    {" start_priority                         integer unsigned default null serialized, "},
    {" master_process_id                      char(64) character set iso88591 casespecific       default null "
     "serialized, "},
    {" session_id                             char(108) character set iso88591 casespecific      default null "
     "serialized, "},
    {" client_name                            varchar(1024) character set iso88591 casespecific  default null "
     "serialized, "},
    {" application_name                       char(130) character set iso88591 casespecific      default null "
     "serialized, "},
    {" statement_id                           char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific      default null serialized, "},
    {" statement_type                         char(36) character set iso88591 casespecific       default null "
     "serialized, "},
    {" statement_subtype                      char(36) character set iso88591 casespecific       default null "
     "serialized, "},
    ...
    {" cmp_compiler_id				   char(28) character set iso88591 casespecific default null "
     "serialized, "},
    ...
    {" transaction_id                         char(25) character set iso88591 casespecific       default null "
     "serialized, "},
    ...
    {" parent_query_id                        char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific      default null serialized, "},
    {" parent_system_name                     char(128) character set iso88591 casespecific      default null "
     "serialized, "},
    ...
    {" query_text                             varchar(50000) character set utf8 casespecific default null "
     "serialized, "},
    {" explain_plan                           varchar(" REPOS_MAX_EXPLAIN_PLAN_LEN_STR
     ") character set iso88591 casespecific default null serialized, "},
...
static const QString createMetricSessionTable[] = {
    ...
    {" sequence_number                        integer unsigned default null serialized, "},
    {" process_name                           char(32) character set iso88591 casespecific default null serialized, "},
    {" session_id                             char(108)     character set iso88591 casespecific no default not null "
     "not droppable serialized, "},
    {" session_status                         char(5)       character set iso88591 casespecific  default null "
     "serialized, "},
    ...
    {" client_user_name                       char(256 bytes)     character set utf8 casespecific  default null "
     "serialized, "},
    {" application_name                       char(130)     character set iso88591 casespecific  default null "
     "serialized, "},
...
static const QString createOldTrafv11MetricQueryTable[] = {
    ...
    {" query_text                             varchar(50000) character set utf8 casespecific default null "
     "serialized, "},
    {" explain_plan                           varchar(200000) character set iso88591 casespecific default null "
     "serialized, "},
    {" last_error_before_aqr                  integer                           default null serialized, "},
    {" delay_time_before_aqr_sec              largeint                          default null serialized, "},
    {" total_num_aqr_retries                  largeint                          default null serialized, "},
...
static const QString createOldv23ReposMetricQueryTable[] = {
    ...
    {" ip_address_id                          char(32) character set iso88591 casespecific default null not "
     "serialized, "},
    {" sequence_number                        integer unsigned default null not serialized, "},
    {" process_name                           char(32) character set iso88591 casespecific default null not "
     "serialized, "},
    {" exec_start_utc_ts                      timestamp(6) no default not null not droppable not serialized, "},
    {" query_id                               char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific no default not null not droppable not serialized, "},
    {" user_name                              char(256 bytes) character set utf8 casespecific default null not "
     "serialized, "},
    {" role_name                              char(256 bytes) character set utf8 casespecific default null not "
     "serialized, "},
    {" start_priority                         integer unsigned default null not serialized, "},
    {" master_process_id                      char(64) character set iso88591 casespecific       default null not "
     "serialized, "},
    {" session_id                             char(108) character set iso88591 casespecific      default null not "
     "serialized, "},
    {" client_name                            varchar(1024) character set iso88591 casespecific  default null not "
     "serialized, "},
    {" application_name                       char(130) character set iso88591 casespecific      default null not "
     "serialized, "},
    {" statement_id                           char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific      default null not serialized, "},
    {" statement_type                         char(36) character set iso88591 casespecific       default null not "
     "serialized, "},
    {" statement_subtype                      char(36) character set iso88591 casespecific       default null not "
     "serialized, "},
    {" submit_utc_ts				   timestamp(6) default null not serialized, "},
    {" compile_start_utc_ts			   timestamp(6) default null not serialized, "},
    {" compile_end_utc_ts			   timestamp(6) default null not serialized, "},
    ...
    {" est_accessed_rows       		   double precision default null not serialized, "},
    {" est_used_rows				   double precision default null not serialized, "},
    {" cmp_compiler_id				   char(28) character set iso88591 casespecific default null not "
     "serialized, "},
    ...
    {" transaction_id                         char(25) character set iso88591 casespecific       default null not "
     "serialized, "},
    ...
    {" parent_query_id                        char(" MAX_QUERY_ID_LEN_STR
     ") character set iso88591 casespecific      default null not serialized, "},
    {" parent_system_name                     char(128) character set iso88591 casespecific      default null not "
     "serialized, "},
    {" exec_end_utc_ts                        timestamp(6)                      default null not serialized, "},
    ...
    {" error_text                             varchar(2000) character set utf8 casespecific default null not "
     "serialized, "},
    {" query_text                             varchar(50000) character set utf8 casespecific default null not "
     "serialized, "},
    {" explain_plan                           varchar(50000) character set utf8 casespecific default null not "
     "serialized, "},
...
static const QString createOldv23ReposMetricSessionTable[] = {
    ...
    {" session_status                         char(5)       character set iso88591 casespecific  default null not "
     "serialized, "},
    ...
    {" role_name                              char(256 bytes)     character set utf8 casespecific  default null not "
     "serialized, "},
    {" client_name                            varchar(256) character set utf8 casespecific  default null not "
     "serialized, "},
    {" client_user_name                       char(256 bytes)     character set utf8 casespecific  default null not "
     "serialized, "},
    {" application_name                       char(130)     character set iso88591 casespecific  default null not "
     "serialized, "},
...
static const MDUpgradeInfo allReposUpgradeInfo[] = {
    {REPOS_METRIC_QUERY_TABLE, TRAF_METRIC_QUERY_TABLE_OLD_REPOS, createMetricQueryTable,
     sizeof(createMetricQueryTable), NULL, 0, NULL, 0, FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE},
    // REPOS_METRIC_SESSION_TABLE
    {REPOS_METRIC_SESSION_TABLE, TRAF_METRIC_SESSION_TABLE_OLD_REPOS, createMetricSessionTable,
     sizeof(createMetricSessionTable), NULL, 0, NULL, 0, FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE},
    // REPOS_METRIC_QUERY_AGGR_TABLE
    {REPOS_METRIC_QUERY_AGGR_TABLE, TRAF_METRIC_QUERY_AGGR_TABLE_OLD_REPOS, createMetricQueryAggrTable,
     sizeof(createMetricQueryAggrTable), NULL, 0, NULL, 0, FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE,
     FALSE},
    // REPOS_METRIC_TEXT_TABLE
    {REPOS_METRIC_TEXT_TABLE, NULL, createMetricTextTable, sizeof(createMetricTextTable), NULL, 0, NULL, 0, FALSE, NULL,
...
static const MDUpgradeInfo allReposv110Tov210UpgradeInfo[] = {
    ...
    {REPOS_METRIC_QUERY_TABLE, TRAF_METRIC_QUERY_TABLE_OLD_REPOS, createMetricQueryTable,
     sizeof(createMetricQueryTable), createOldTrafv11MetricQueryTable, sizeof(createOldTrafv11MetricQueryTable), NULL,
     0, TRUE,
    ...
    // REPOS_METRIC_SESSION_TABLE
    {REPOS_METRIC_SESSION_TABLE, TRAF_METRIC_SESSION_TABLE_OLD_REPOS, createMetricSessionTable,
     sizeof(createMetricSessionTable), createOldTrafv11MetricSessionTable, sizeof(createOldTrafv11MetricSessionTable),
     NULL, 0, TRUE,
    ...
    // REPOS_METRIC_QUERY_AGGR_TABLE
    {REPOS_METRIC_QUERY_AGGR_TABLE, TRAF_METRIC_QUERY_AGGR_TABLE_OLD_REPOS, createMetricQueryAggrTable,
     sizeof(createMetricQueryAggrTable), createOldTrafv11MetricQueryAggrTable,
     sizeof(createOldTrafv11MetricQueryAggrTable), NULL, 0, TRUE,
...
//////////////////////////////////////////////////////////////////////////
// Repository tables for backup related operations
//////////////////////////////////////////////////////////////////////////
#define TRAF_BACKUP_OPERATION_METRICS "BACKUP_OPERATION_METRICS"
#define TRAF_BACKUP_OBJECTS_METRICS   "BACKUP_OBJECTS_METRICS"

#define BACKUP_TRAFODION_LIT  "BACKUP"
#define RESTORE_TRAFODION_LIT "RESTORE"
#define DROP_BACKUP_LIT       "DROP"
#define EXPORT_BACKUP_LIT     "EXPORT"
#define IMPORT_BACKUP_LIT     "IMPORT"

#define OPER_TYPE_ALL            "ALL"
#define OPER_TYPE_SYSTEM         "SYSTEM"
#define OPER_TYPE_REGULAR_SUBSET "SUBSET_REGULAR"
#define OPER_TYPE_INCR_SUBSET    "SUBSET_INCREMENTAL"

#define OPER_STATUS_IN_PROGRESS "IN_PROGRESS"
#define OPER_STATUS_COMPLETED   "COMPLETED"
#define OPER_STATUS_ERROR       "ERROR"
#define OPER_STATUS_INCOMPLETE  "INCOMPLETE"

//----------------------------------------------------------------
//-- BACKUP_OPERATION_METRICS
//----------------------------------------------------------------
static const QString createBackupOperationMetricsTable[] = {
    {" create table %s.\"%s\"." TRAF_BACKUP_OPERATION_METRICS " "},
    {" ( "},
    {"   user_tag char(128 bytes) character set iso88591 not null, "},
    {"   br_id largeint not null, "},
    {"   oper_start_time_utc timestamp not null, "},
    {"   oper_end_time_utc timestamp, "},
    {"   oper_elapsed_time largeint, "},
    {"   operation char(32), "},
    {"   oper_type char(32), "},
    {"   status char(32), "},
    {"   num_objects largeint, "},
    {"   total_size largeint, "},
    {"   flags largeint not null "},
    //    {"   user_command varchar(4096 bytes) character set utf8 "},
    {" ) "},
    {" primary key ( user_tag, oper_start_time_utc ) salt using 8 partitions "},
    {" hbase_options ( DATA_BLOCK_ENCODING = 'FAST_DIFF', COMPRESSION = 'GZ' ) "},
    {" attribute aligned format storage hbase "},
    {" ; "}};

//----------------------------------------------------------------
//-- BACKUP_OBJECTS_METRICS
//----------------------------------------------------------------
static const QString createBackupObjectsMetricsTable[] = {
    {" create table %s.\"%s\"." TRAF_BACKUP_OBJECTS_METRICS " "},
    {" ( "},
    {"   object_uid largeint not null, "},
    {"   br_id largeint not null, "},
    {"   object_size largeint, "},
    {"   object_status char(32), "},
    {"   flags largeint not null "},
    {" ) "},
    {" primary key ( object_uid, br_id ) salt using 8 partitions "},
    {" hbase_options ( DATA_BLOCK_ENCODING = 'FAST_DIFF', COMPRESSION = 'GZ' ) "},
    {" attribute aligned format storage hbase "},
    {" ; "}};

static const MDUpgradeInfo allBackupReposInfo[] = {

    // TRAF_BACKUP_OPERATION_METRICS
    {TRAF_BACKUP_OPERATION_METRICS, NULL, createBackupOperationMetricsTable, sizeof(createBackupOperationMetricsTable),
     NULL, 0, NULL, 0, FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

    // TRAF_BACKUP_OBJECTS_METRICS
    {TRAF_BACKUP_OBJECTS_METRICS, NULL, createBackupObjectsMetricsTable, sizeof(createBackupObjectsMetricsTable), NULL,
     0, NULL, 0, FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE}

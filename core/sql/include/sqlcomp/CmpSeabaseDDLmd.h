...
static const ComTdbVirtTableRoutineInfo seabaseMDCreateSPSQLInfo =
  {
    "CREATESPSQL", COM_PROCEDURE_TYPE_LIT,  COM_LANGUAGE_JAVA_LIT, 1, COM_READS_SQL_LIT, 0, 0, COM_STYLE_JAVA_CALL_LIT, COM_NO_TRANSACTION_REQUIRED_LIT, 0, 0, "org.trafodion.sql.udr.spsql.SPSQL.createSPSQL", COM_ROUTINE_NO_PARALLELISM_LIT, " ", COM_ROUTINE_EXTERNAL_SECURITY_INVOKER_LIT, COM_ROUTINE_SAFE_EXECUTION_LIT, " ", 1, "(Ljava/lang/String;)V", " ",0
  };

static const ComTdbVirtTableColumnInfo seabaseMDCreateSPSQLColInfo[] =
  {
    { "BODY", 0,  COM_USER_COLUMN, REC_BYTE_V_ASCII, 4000000, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"1", COM_INPUT_COLUMN_LIT, 0},
  };

static const ComTdbVirtTableRoutineInfo seabaseMDDropSPSQLInfo =
  {
    "DROPSPSQL", COM_PROCEDURE_TYPE_LIT,  COM_LANGUAGE_JAVA_LIT, 1, COM_READS_SQL_LIT, 0, 0, COM_STYLE_JAVA_CALL_LIT, COM_NO_TRANSACTION_REQUIRED_LIT, 0, 0, "org.trafodion.sql.udr.spsql.SPSQL.dropSPSQL", COM_ROUTINE_NO_PARALLELISM_LIT, " ", COM_ROUTINE_EXTERNAL_SECURITY_INVOKER_LIT, COM_ROUTINE_SAFE_EXECUTION_LIT, " ", 1, "(Ljava/lang/String;)V", " ",0
  };

static const ComTdbVirtTableColumnInfo seabaseMDDropSPSQLColInfo[] =
  {
    { "NAME", 0,  COM_USER_COLUMN, REC_BYTE_V_ASCII, 1024, FALSE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"1", COM_INPUT_COLUMN_LIT, 0},
  };

static const ComTdbVirtTableRoutineInfo seabaseMDCallSPSQLInfo =
  {
    "CALLSPSQL", COM_PROCEDURE_TYPE_LIT,  COM_LANGUAGE_JAVA_LIT, 1, COM_MODIFIES_SQL_LIT, 0, 0, COM_STYLE_JAVA_CALL_LIT, COM_NO_TRANSACTION_REQUIRED_LIT, 0, 0, "org.trafodion.sql.udr.spsql.SPSQL.callSPSQL", COM_ROUTINE_NO_PARALLELISM_LIT, " ", COM_ROUTINE_EXTERNAL_SECURITY_INVOKER_LIT, COM_ROUTINE_SAFE_EXECUTION_LIT, " ", 1, "(Ljava/lang/String;)V", " ",0
  };
...
static const ComTdbVirtTableRoutineInfo seabaseMDCallSPSQLTriggerInfo =
  {
   "CALLSPSQLTRIGGER", COM_PROCEDURE_TYPE_LIT,  COM_LANGUAGE_JAVA_LIT, 1, COM_MODIFIES_SQL_LIT, 0, 0, COM_STYLE_JAVA_CALL_LIT, COM_TRANSACTION_REQUIRED_LIT, 0, 0, "org.trafodion.sql.udr.spsql.SPSQL.callSPSQLTrigger", COM_ROUTINE_NO_PARALLELISM_LIT, " ", COM_ROUTINE_EXTERNAL_SECURITY_INVOKER_LIT, COM_ROUTINE_SAFE_EXECUTION_LIT, " ", 1, "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;)V", " ",0
  };

// now support max values length is 16M
static const ComTdbVirtTableColumnInfo seabaseMDCallSPSQLTriggerColInfo[] =
  {
    { "NAME", 0,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_NAME_LEN, FALSE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"1", COM_INPUT_COLUMN_LIT, 0},
    { "ISCALLBEFORE", 1,  COM_USER_COLUMN, REC_BIN32_SIGNED, TRIGGER_INT_LEN, FALSE , SQLCHARSETCODE_UNKNOWN, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"2", COM_INPUT_COLUMN_LIT, 0},
    { "OPTYPE", 2,  COM_USER_COLUMN, REC_BIN32_SIGNED, TRIGGER_INT_LEN, FALSE , SQLCHARSETCODE_UNKNOWN, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"3", COM_INPUT_COLUMN_LIT, 0},
    { "OLDSKVBUFFER", 3,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ROW_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"4", COM_INPUT_COLUMN_LIT, 0},
    { "OLDSBUFSIZE", 4,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ID_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"5", COM_INPUT_COLUMN_LIT, 0},
    { "OLDROWIDS", 5,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ROW_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"6", COM_INPUT_COLUMN_LIT, 0},
    { "OLDROWIDSLEN", 6,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ID_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"7", COM_INPUT_COLUMN_LIT, 0},
    { "NEWROWIDLEN", 7,  COM_USER_COLUMN, REC_BIN32_SIGNED, TRIGGER_INT_LEN, FALSE , SQLCHARSETCODE_UNKNOWN, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"8", COM_INPUT_COLUMN_LIT, 0},
    { "NEWROWIDS", 8,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ROW_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"9", COM_INPUT_COLUMN_LIT, 0},
    { "NEWROWIDSLEN", 9,  COM_USER_COLUMN, REC_BIN32_SIGNED, TRIGGER_INT_LEN, FALSE , SQLCHARSETCODE_UNKNOWN, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"10", COM_INPUT_COLUMN_LIT, 0},
    { "NEWROWS", 10,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ROW_LEN, TRUE , SQLCHARSETCODE_ISO88591, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"11", COM_INPUT_COLUMN_LIT, 0},
    { "NEWROWSLEN", 11,  COM_USER_COLUMN, REC_BIN32_SIGNED, TRIGGER_INT_LEN, FALSE , SQLCHARSETCODE_UNKNOWN, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"12", COM_INPUT_COLUMN_LIT, 0},
    { "CUREXECSQL", 12,  COM_USER_COLUMN, REC_BYTE_V_ASCII, TRIGGER_ID_LEN, TRUE , SQLCHARSETCODE_UTF8, 0, 0, 0, 0, 0, 0, 0, COM_NO_DEFAULT, "",SEABASE_DEFAULT_COL_FAMILY,"13", COM_INPUT_COLUMN_LIT, 0},    
  };

static const ComTdbVirtTableRoutineInfo seabaseMDExecuteSPSQLInfo =
  {
    "EXECUTESPSQL", COM_PROCEDURE_TYPE_LIT,  COM_LANGUAGE_JAVA_LIT, 1, COM_READS_SQL_LIT, 0, 0, COM_STYLE_JAVA_CALL_LIT, COM_TRANSACTION_REQUIRED_LIT, 0, 0, "org.trafodion.sql.udr.spsql.SPSQL.executeSPSQL", COM_ROUTINE_NO_PARALLELISM_LIT, " ", COM_ROUTINE_EXTERNAL_SECURITY_INVOKER_LIT, COM_ROUTINE_SAFE_EXECUTION_LIT, " ", 1, "(Ljava/lang/String;)V", " ", 0
  };
...
static const MDTableInfo allMDtablesInfo[] = {
  ...
  {SEABASE_LOB_COLUMNS, 
   seabaseLobColumnsDDL, sizeof(seabaseLobColumnsDDL),
   NULL, 0, FALSE, FALSE},
...
static const MDUpgradeInfo allMDPartTablesUpgradeInfo[] = {
  { SEABASE_PARTITIONS,  SEABASE_PARTITIONS_OLD_MD,
    seabasePartitionsDDL,  sizeof(seabasePartitionsDDL),
    NULL, 0,
    NULL, 0,
    FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},

  { SEABASE_TABLE_PARTITION,  SEABASE_TABLE_PARTITION_OLD_MD,
    seabaseTablePartitionDDL,  sizeof(seabaseTablePartitionDDL),
    NULL, 0,
    NULL, 0,
    FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE}

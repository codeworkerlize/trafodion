...
class RoutineDesc : public NABasicObject {
 ...
 public:
  ...
  inline NARoutine *getEffectiveNARoutine() const { return isUUDF_ ? action_ : routine_; }

  const RoutineAnalysis *getRoutineAnalysis() const { return analysis_; }
  ...
  inline ValueIdList &getInParamColumnList() { return isUUDF_ ? colActionInParamList_ : colUDFInParamList_; }

  //! getOutputColumnList accessor function
  //  returns a constant reference to a list of formal output parameters
  inline const ValueIdList &getOutputColumnList() const { return isUUDF_ ? colActionOutputList_ : colUDFOutputList_; }

  //! getOutputColumnList accessor function
  //  returns a reference to a list of formal output parameters
  inline ValueIdList &getOutputColumnList() { return isUUDF_ ? colActionOutputList_ : colUDFOutputList_; }

  // Accessor functions that looks at the UDF formal parameters
  //! getUDFInParamColumnList accessor function
  //  returns a constant reference to a list of formal input parameters
  inline const ValueIdList &getUDFInParamColumnList() const { return colUDFInParamList_; }

  //! getUDFInParamColumnList accessor function
  //  returns a list of formal input parameters
  inline ValueIdList &getUDFInParamColumnList() { return colUDFInParamList_; }

  //! getUDFInParamColumnListCount accessor function
  //  returns a count of formal input parameters
  inline const ComUInt32 getUDFInParamColumnListCount() const { return colUDFInParamList_.entries(); }

  //! getUDFOutputColumnList accessor function
  //  returns a constant reference to a list of formal output parameters
  inline const ValueIdList &getUDFOutputColumnList() const { return colUDFOutputList_; }

  //! getUDFOutputColumnList accessor function
  //  returns a reference to a list of formal output parameters
  inline ValueIdList &getUDFOutputColumnList() { return colUDFOutputList_; }

  //! getUDFOutputParamColumnListCount accessor function
  //  returns a list of formal input parameters
  inline const ComUInt32 getUDFOutputColumnListCount() const { return colUDFOutputList_.entries(); }

  // Accessor functions that looks at the Action formal parameters
  //! getActionInParamColumnList accessor function
  //  returns a constant reference to a list of formal input parameters
  inline const ValueIdList &getActionInParamColumnList() const { return colActionInParamList_; }

  //! getActionInParamColumnList accessor function
  //  returns a list of formal input parameters
  inline ValueIdList &getActionInParamColumnList() { return colActionInParamList_; }

  //! getActionInParamColumnListCount accessor function
  //  returns a count of formal input parameters
  inline const ComUInt32 getActionInParamColumnListCount() const { return colActionInParamList_.entries(); }

  //! getActionOutputColumnList accessor function
  //  returns a constant reference to a list of formal output parameters
  inline const ValueIdList &getActionOutputColumnList() const { return colActionOutputList_; }

  //! getActionOutputColumnList accessor function
  //  returns a reference to a list of formal output parameters
  inline ValueIdList &getActionOutputColumnList() { return colActionOutputList_; }

  //! getActionOutputParamColumnListCount accessor function
  //  returns a list of formal input parameters
  inline const ComSInt32 getActionOutputParamColumnListCount() const { return colActionOutputList_.entries(); }
  ...
  //  output column.
  inline ColStatDescList &getUdfOutParamColStatDescList() { return udfOutColStatDescList_; }

  //! getUDFInitialRowCostVector accessor function
  inline SimpleCostVector &getUdfInitialRowCostVector() { return udfInitialRowCost_; }
  ...
  //  returns a pointer to a StatsList holding UEC values for each
  //  output column.
  inline ColStatDescList &getActionOutParamColStatDescList() { return actionOutColStatDescList_; }

  //! getActionInitialRowCostVector accessor function
  inline SimpleCostVector &getActionInitialRowCostVector() { return actionInitialRowCost_; }
  ...
  inline ColStatDescList &getEffOutParamColStatDescList() {
    return isUUDF_ == FALSE ? udfOutColStatDescList_ : actionOutColStatDescList_;
  }

  //! getEffInitialRowCostVector accessor function
  inline SimpleCostVector &getEffInitialRowCostVector() {
    return isUUDF_ == FALSE ? udfInitialRowCost_ : actionInitialRowCost_;
  }
  ...
  inline void setNARoutine(NARoutine *routine) {
    routine_ = routine;
    processRoutineCosting(&udfInitialRowCost_, &udfNormalRowCost_, &udfFanOut_, routine);
  }
  ...
  inline void setActionNARoutine(NARoutine *action) {
    isUUDF_ = TRUE;
    action_ = action;
    processRoutineCosting(&actionInitialRowCost_, &actionNormalRowCost_, &actionFanOut_, action);
  }
  ...
  // --------------------------------------------------------------------
  NABoolean populateRoutineDesc(BindWA *bindWA, NABoolean createRETDesc = FALSE);
  ...
  NABoolean createRoutineParam(BindWA *bindWA, CollIndex i, NARoutine *routine, ValueIdList *inParamList,
  ...
  //! print function
  //  used for debugging
  virtual void print(FILE *ofd = stdout, const char *indent = DEFAULT_INDENT, const char *title = "RoutineDesc");

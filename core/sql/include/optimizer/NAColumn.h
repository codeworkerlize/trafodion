...
class NAColumn : public NABasicObject {
 ...
 private:
  ...
  // ---------------------------------------------------------------
  // Set to TRUE if this was additional table col added to an index
  // ---------------------------------------------------------------
  NABoolean addnlColumn_;
  ...
  NABoolean isReplicaColumn_;

  // next 5 fields are for lob columns. They identify where

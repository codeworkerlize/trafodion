...
class HbaseDeleteRule : public Rule {
 public:
  HbaseDeleteRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HbaseDeleteCursorRule : public HbaseDeleteRule {
 public:
  HbaseDeleteCursorRule(const char *name, RelExpr *pattern, RelExpr *substitute)
...
class HbaseUpdateRule : public Rule {
 public:
  HbaseUpdateRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HbaseUpdateCursorRule : public HbaseUpdateRule {
 public:
  HbaseUpdateCursorRule(const char *name, RelExpr *pattern, RelExpr *substitute)
...
class HiveInsertRule : public Rule {
 public:
  HiveInsertRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HbaseScanRule : public Rule {
 public:
  HbaseScanRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HbaseInsertRule : public Rule {
 public:
  HbaseInsertRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class ExchangeEnforcerRule : public Rule {
 public:
  ExchangeEnforcerRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class FileScanRule : public Rule {
 public:
  FileScanRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HashGroupByRule : public Rule {
 public:
  HashGroupByRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class HashJoinRule : public Rule {
 public:
  HashJoinRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class MergeJoinRule : public Rule {
 public:
  MergeJoinRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class NestedJoinRule : public Rule {
 public:
  NestedJoinRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class NestedJoinFlowRule : public Rule {
 public:
  NestedJoinFlowRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysCompoundStmtRule : public Rule {
 public:
  PhysCompoundStmtRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalMapValueIdsRule : public Rule {
 public:
  PhysicalMapValueIdsRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalRelRootRule : public Rule {
 public:
  PhysicalRelRootRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalSequenceRule : public Rule {
 public:
  PhysicalSequenceRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalTupleRule : public Rule {
 public:
  PhysicalTupleRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalTupleListRule : public Rule {
 public:
  PhysicalTupleListRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalExplainRule : public Rule {
 public:
  PhysicalExplainRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalPackRule : public Rule {
 public:
  PhysicalPackRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalTransposeRule : public Rule {
 public:
  PhysicalTransposeRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalUnPackRowsRule : public Rule {
 public:
  PhysicalUnPackRowsRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class SortEnforcerRule : public Rule {
 public:
  SortEnforcerRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class SortGroupByRule : public Rule {
 public:
  SortGroupByRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class AggregateRule : public SortGroupByRule {
 public:
  AggregateRule(const char *name, RelExpr *pattern, RelExpr *substitute) : SortGroupByRule(name, pattern, substitute) {}
...
class PhysShortCutGroupByRule : public Rule {
 public:
  PhysShortCutGroupByRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class UnionRule : public Rule {
 public:
  UnionRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalSampleRule : public Rule {
 public:
  PhysicalSampleRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalInterpretAsRowRule : public Rule {
 public:
  PhysicalInterpretAsRowRule(const char *name, RelExpr *pattern, RelExpr *substitute)
...
class PhysicalSPProxyFuncRule : public Rule {
 public:
  PhysicalSPProxyFuncRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}
...
class PhysicalIsolatedScalarUDFRule : public Rule {
 public:
  PhysicalIsolatedScalarUDFRule(const char *name, RelExpr *pattern, RelExpr *substitute)
      : Rule(name, pattern, substitute) {}
...
class PhysicalTMUDFRule : public Rule {
 public:
  PhysicalTMUDFRule(const char *name, RelExpr *pattern, RelExpr *substitute) : Rule(name, pattern, substitute) {}

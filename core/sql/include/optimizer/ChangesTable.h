...
class MvIudLog : public ChangesTable {
 public:
  MvIudLog(CorrName &name, BindWA *bindWA, OperatorTypeEnum opType);

  MvIudLog(const GenericUpdate *baseNode, BindWA *bindWA);
  ...
  inline NABoolean needsRangeLogging() const { return needsRangeLogging_; }
  inline void setUpdatedColumns(UpdateColumns *updatedColumns) { updatedColumns_ = updatedColumns; }
  inline void setDeltaDefinition(DeltaDefinition *deltaDef) { deltaDef_ = deltaDef; }

  inline NABoolean getAddOrigScanPredicateFlag() const { return addOrigScanPredicate_; }
  inline void setAddOrigScanPredicateFlag(NABoolean flag) { addOrigScanPredicate_ = flag; }
 ...
 protected:
  ...
  virtual ItemExpr *createColExprForOpType(NABoolean isInsert, NABoolean isUpdate, NABoolean isUndo = FALSE) const;
  virtual ItemExpr *createColExprForIgnore() const;
  virtual ItemExpr *createColExprForBitmap(const NAColumn *naColumn, NABoolean isUpdate) const;
  ...
  virtual ItemExpr *createColExprForAtTimestamp(NABoolean isInsert, NABoolean isUpdate, NABoolean isUndo) const;
...
class MvIudLogForMvLog : public MvIudLog {
 public:
  MvIudLogForMvLog(CorrName &tableName, BindWA *bindWA);

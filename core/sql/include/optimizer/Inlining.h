...
enum InliningInfoEnum {
  ...
  // is this Left join used for efficient upsert
  II_isEffUpsertLj = 0x0000000400000000LL,
  II_isEffDeleteAsj = 0x0000000800000000LL
...
class InliningInfo {
 public:
  // Default constructor
  InliningInfo() : flags_(0), triggerObject_(NULL), forceCardinalityInfo_(NULL), triggerBindInfo_(NULL){};

  virtual ~InliningInfo();

  // Accessors
  inline NABoolean isDrivingTempInsert() const { return forceBool(II_DrivingTempInsert); }
  inline NABoolean isDrivingPipelinedActions() const { return forceBool(II_DrivingPipelinedActions); }
  inline NABoolean isDrivingRowTrigger() const { return forceBool(II_DrivingRowTrigger); }
  inline NABoolean isDrivingStatementTrigger() const { return forceBool(II_DrivingStatementTrigger); }
  inline NABoolean isDrivingTempDelete() const { return forceBool(II_DrivingTempDelete); }
  inline NABoolean isDrivingBeforeTriggers() const { return forceBool(II_DrivingBeforeTriggers); }
  inline NABoolean isDrivingRI() const { return forceBool(II_DrivingRI); }
  inline NABoolean isDrivingIM() const { return forceBool(II_DrivingIM); }
  inline NABoolean isTriggerRoot() const { return forceBool(II_TriggerRoot); }
  inline NABoolean isBeforeTriggersExist() const { return forceBool(II_BeforeTriggersExist); }
  inline NABoolean isAccessSetNeeded() const { return forceBool(II_AccessSetNeeded); }
  inline NABoolean isDummy() const { return forceBool(II_DummyStatement); }
  inline NABoolean hasPipelinedActions() const { return forceBool(II_hasPipelinedActions); }
  inline NABoolean isEffectiveGU() const { return forceBool(II_EffectiveGU); }
  inline NABoolean isActionOfRI() const { return forceBool(II_ActionOfRI); }
  inline NABoolean isAvoidSecurityCheck() const { return forceBool(II_AvoidSecurityChecks); }
  inline NABoolean isMVLoggingInlined() const { return forceBool(II_isMVLoggingInlined); }
  inline NABoolean isDrivingMvLogInsert() const { return forceBool(II_DrivingMvLogInsert); }
  inline NABoolean isProjectMidRangeRows() const { return forceBool(II_ProjectMidRangeRows); }
  inline NABoolean isNeedGuOutputs() const { return forceBool(II_NeedGuOutputs); }
  inline NABoolean isJoinOrderForcedByInlining() const { return forceBool(II_JoinChildsOrder); }
  inline NABoolean isMdamForcedByInlining() const { return forceBool(II_MdamForcedByInlining); }
  inline NABoolean isSingleExecutionForTSJ() const { return forceBool(II_SingleExecutionForTSJ); }
  inline NABoolean isSingleExecutionForTriggersTSJ() const { return forceBool(II_SingleExecutionForTriggersTSJ); }
  inline NABoolean isInActionOfRowTrigger() const { return forceBool(II_InActionOfRowTrigger); }
  inline NABoolean isEnableFirstNRows() const { return forceBool(II_EnableFirstNRows); }
  inline NABoolean isMaterializeNodeForbidden() const { return forceBool(II_MaterializeNodeForbidden); }
  inline NABoolean hasIM() const { return forceBool(II_hasIM); }
  inline NABoolean hasRI() const { return forceBool(II_hasRI); }
  inline NABoolean hasTriggers() const { return forceBool(II_hasTriggers); }
  inline NABoolean hasInlinedActions() const { return forceBool(II_hasInlinedActions); }
  inline NABoolean isForceCardinality() const { return forceCardinalityInfo_ != NULL; }
  inline NABoolean isUsedForMvLogging() const { return forceBool(II_isUsedForMvLogging); }

  inline NABoolean isTopOfTriggerBackbone() const {
    return (isDrivingBeforeTriggers() || (isDrivingTempDelete() && !isDrivingBeforeTriggers()));
  }
  inline NABoolean isIMGU() const { return forceBool(II_isIMGU); }

  inline NABoolean isIMUnion() const { return forceBool(II_isIMUnion); }

  inline NABoolean isEffUpsertLj() const { return forceBool(II_isEffUpsertLj); }

  inline NABoolean isEffDeleteAsj() const { return forceBool(II_isEffDeleteAsj); }
  ...
  void BuildForceCardinalityInfo(double cardinalityFactor, Cardinality cardinality, CollHeap *heap);

  void buildTriggerBindInfo(BindWA *bindWA, RETDesc *RETDesc, CollHeap *heap);
...
class TriggerBindInfo : public NABasicObject {
 public:
  // default Ctor
  TriggerBindInfo(CollHeap *heap) : heap_(heap), exeId_(NULL), backboneIudNum_(0L), origIudColumnList_(NULL){};

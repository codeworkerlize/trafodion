...
class BindContext : public NABasicObject {
 ...
 private:
  ...
  // --------------------------------------------------------------------
  NABoolean inDualConnectby_;

  NABoolean inStartWith_;
...
class BindWA : public NABasicObject {
 ...
 private:
  ...
  // like select *, c1 , c2 from ta;
  // ta is ca, cb, cc
  // now list is 3, 1, 1
  LIST(int) extendedSelList_;
  NABoolean recodeExtendSelectList_;
  ...
  // --------------------------------------------------------------------
  NABoolean inDDL_;
  NABoolean inSubqueryStartWith_;

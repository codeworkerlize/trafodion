...
class UnPackRows : public RelExpr {
 public:
  // The constructor
  //
  UnPackRows(int maxPackingFactor = 0, ItemExpr *UnPackExpr = NULL, ItemExpr *packingFactor = NULL,
             TableDesc *unPackedTable = NULL, RelExpr *child = NULL, ValueId indexHostVarValueId = NULL_VALUE_ID,
             CollHeap *oHeap = CmpCommon::statementHeap());

  UnPackRows(int rwrsMaxSize, ItemExpr *rwrsInputSizeExpr, ItemExpr *rwrsMaxInputRowlen, ItemExpr *rwrsBuffer,
  ...
  //
  inline int getMaxPackingFactor() { return maxPackingFactor_; };

...
class PhysicalProperty : public NABasicObject {
 public:
  ...
  PhysicalProperty(const ValueIdList &sortKey, SortOrderTypeEnum sortOrderType,
                   PartitioningFunction *dp2SortOrderPartFunc = NULL, PartitioningFunction *actualPartFunc = NULL,
                   const PlanExecutionEnum plenum = DEFAULT_LOCATION,
                   const DataSourceEnum dsenum = SOURCE_PERSISTENT_TABLE, const IndexDesc *indexDesc = NULL,
                   const SearchKey *partSearchKey = NULL, const PushDownProperty *pdp = NULL,
  ...
  PhysicalProperty(PartitioningFunction *actualPartFunc, const PlanExecutionEnum plenum = DEFAULT_LOCATION,
  ...
  PhysicalProperty(const PhysicalProperty &other, const ValueIdList &sortKey, SortOrderTypeEnum sortOrderType,
  ...
  PhysicalProperty(const PhysicalProperty &other, const ValueIdList &sortKey, SortOrderTypeEnum sortOrderType,
                   PartitioningFunction *dp2SortOrderPartFunc, DataSourceEnum sourceOfData)
      : sortKey_(sortKey),
        sortOrderType_(sortOrderType),
        dp2SortOrderPartFunc_(dp2SortOrderPartFunc),
        actualPartFunc_(other.actualPartFunc_),
  ...
  PhysicalProperty(const PhysicalProperty &other, const ValueIdList &sortKey, SortOrderTypeEnum sortOrderType,
                   PartitioningFunction *dp2SortOrderPartFunc, PartitioningFunction *actualPartFunc)
      : sortKey_(sortKey),
        sortOrderType_(sortOrderType),
        dp2SortOrderPartFunc_(dp2SortOrderPartFunc),
        actualPartFunc_(actualPartFunc),
  ...
  const NABoolean getexplodedOcbJoinProperty() const { return explodedOcbJoin_; }
  ...
  // accessors
  inline SortOrderTypeEnum getSortOrderType() const { return sortOrderType_; }
  inline PartitioningFunction *getDp2SortOrderPartFunc() const { return dp2SortOrderPartFunc_; }
  ...
  void setSortOrderType(SortOrderTypeEnum sortOrderType) {
    ...
    DCMPASSERT((sortOrderType >= NO_SOT) AND(sortOrderType <= DP2_SOT))
    sortOrderType_ = sortOrderType;
  }
  void setDp2SortOrderPartFunc(PartitioningFunction *dp2SortOrderPartFunc) {
    dp2SortOrderPartFunc_ = dp2SortOrderPartFunc;
  }

  void setLocation(PlanExecutionEnum location) { location_ = location; }
  ...
  inline const ValueIdSet &getPartitioningKey() const { return actualPartFunc_->getPartitioningKey(); }

  // --- For plan execution
  inline NABoolean executeInMasterOrESP() const { return (location_ == EXECUTE_IN_MASTER_OR_ESP); }
  inline NABoolean executeInMasterOnly() const { return (location_ == EXECUTE_IN_MASTER); }
  inline NABoolean executeInESPOnly() const { return (location_ == EXECUTE_IN_ESP); }
  inline NABoolean executeInDP2() const { return (location_ == EXECUTE_IN_DP2); }
  inline PlanExecutionEnum getPlanExecutionLocation() const { return location_; }

  // -- For the source of the data
  inline DataSourceEnum getDataSourceEnum() const { return sourceOfData_; }
  inline void setDataSourceEnum(DataSourceEnum s) { sourceOfData_ = s; }
  ...
  inline const SearchKey *getPartSearchKey() const { return partSearchKey_; }
  ...
  // ---------------------------------------------------------------------
  inline NABoolean operator>(const PhysicalProperty &other) const { return compareProperties(other) == MORE; }
  inline NABoolean operator<(const PhysicalProperty &other) const { return compareProperties(other) == LESS; }
  inline NABoolean operator==(const PhysicalProperty &other) const { return compareProperties(other) == SAME; }

  // -----------------------------------------------------------------------
  // For costing data that gets computed at synthesis time:
  // -----------------------------------------------------------------------
  const DP2CostDataThatDependsOnSPP *getDP2CostThatDependsOnSPP() const { return dp2CostInfo_; }

  void setDP2CostThatDependsOnSPP(DP2CostDataThatDependsOnSPP *dp2Cost) { dp2CostInfo_ = dp2Cost; }
  ...
  //  Utility functions
  // ---------------------------------------------------------------------
  void print(FILE *ofd = stdout, const char *prefix = DEFAULT_INDENT, const char *suffix = "") const;

  void display();

  void setPushDownProperty(const PushDownProperty *pdp) { pushDownProperty_ = pdp; };
  const PushDownProperty *getPushDownProperty() const { return pushDownProperty_; };

  void setBigMemoryEstimationProperty(CurrentFragmentBigMemoryProperty *c) { memoryNeedsinCurrentFragment_ = c; }

  const CurrentFragmentBigMemoryProperty *getBigMemoryEstimationProperty() { return memoryNeedsinCurrentFragment_; }
...
class ReqdPhysicalProperty : public NABasicObject {
 public:
  ...
  ReqdPhysicalProperty(const ValueIdSet *const arrangedBy = NULL, const ValueIdList *const orderedBy = NULL,
  ...
  // NOTE: mustMatch_ is not propagated from one reqd prop to another
  // ---------------------------------------------------------------------
  inline ReqdPhysicalProperty(const ReqdPhysicalProperty &other, const ValueIdSet *const arrangedBy,
  ...
  // ---------------------------------------------------------------------
  ReqdPhysicalProperty(const ReqdPhysicalProperty &other, RelExpr *mustMatch)
      : arrangedBy_(other.arrangedBy_),
        orderedBy_(other.orderedBy_),
        sortOrderTypeReq_(other.sortOrderTypeReq_),
        dp2SortOrderPartReq_(other.dp2SortOrderPartReq_),
  ...
  // ---------------------------------------------------------------------
  NABoolean satisfied(EstLogPropSharedPtr inputLogProp, const RelExpr *const physExpr,
  ...
  // ---------------------------------------------------------------------
  inline const PerformanceGoal *getPerformanceGoal() const { return perfGoal_; }
  // ---------------------------------------------------------------------
  ...
  // accessors
  SortOrderTypeEnum getSortOrderTypeReq() const { return sortOrderTypeReq_; }
  PartitioningRequirement *getDp2SortOrderPartReq() const { return dp2SortOrderPartReq_; }
  ...
  void setSortOrderTypeReq(SortOrderTypeEnum sortOrderTypeReq) {
    ...
    DCMPASSERT((sortOrderTypeReq >= NO_SOT) AND(sortOrderTypeReq <= DP2_OR_ESP_NO_SORT_SOT))
    sortOrderTypeReq_ = sortOrderTypeReq;
  }
  void setDp2SortOrderPartReq(PartitioningRequirement *dp2SortOrderPartReq) {
    dp2SortOrderPartReq_ = dp2SortOrderPartReq;
  }

  NABoolean sortOrderTypeReqAndSynthCompatible(const SortOrderTypeEnum synthesizedSortOrderType) const;
  COMPARE_RESULT compareSortOrderTypeReqToReq(const SortOrderTypeEnum otherSortOrderTypeReq) const;
  NABoolean dp2SortOrderPartReqAndSynthCompatible(const PhysicalProperty *const spp) const;

  inline NABoolean getLogicalOrderOrArrangementFlag() const { return logicalOrderOrArrangement_; }
  inline void setLogicalOrderOrArrangementFlag(const NABoolean newValue) { logicalOrderOrArrangement_ = newValue; }

  // ---------------------------------------------------------------------
  // Location for plan execution
  // ---------------------------------------------------------------------
  PlanExecutionEnum getPlanExecutionLocation() const { return location_; }

  // translate the location for plan execution as a requirement
  // to a location as a property
  PlanExecutionEnum translatePlanExecutionLocation() const;
  ...
  // ---------------------------------------------------------------------
  LogicalPartitioningRequirement *getLogicalPartRequirement() const { return logicalPartReq_; }
  void setLogicalPartRequirement(LogicalPartitioningRequirement *lpr) { logicalPartReq_ = lpr; }
  ...
  NABoolean getNoEspExchangeRequirement() const { return noEspExchangeRequirement_; };
  void setNoEspExchangeRequirement(const NABoolean b) { noEspExchangeRequirement_ = b; };
  NABoolean getOcbEnabledCostingRequirement() const { return ocbEnabledCostingRequirement_; };
  void setOcbEnabledCostingRequirement(const NABoolean b) { ocbEnabledCostingRequirement_ = b; };
  // ---------------------------------------------------------------------
  //  Utility functions
  // ---------------------------------------------------------------------
  void display() const;
 ...
 private:
  ...
  void performConsistencyCheck() const {
    DCMPASSERT((availableCPUs_ > 0) AND(pipelinesPerCPU_ > 0) AND(costWeight_ != NULL) AND(perfGoal_ != NULL));
  ...
  void performSortOrderTypeConsistencyCheck() const {
    if ((arrangedBy_ == NULL) AND(orderedBy_ == NULL)) {
      ...
      DCMPASSERT((sortOrderTypeReq_ != NO_SOT) OR(location_ == EXECUTE_IN_DP2));
    }

    if ((dp2SortOrderPartReq_ != NULL) OR(sortOrderTypeReq_ == DP2_OR_ESP_NO_SORT_SOT)
            OR(sortOrderTypeReq_ == DP2_SOT)) {
      DCMPASSERT(dp2SortOrderPartReq_ != NULL);
      DCMPASSERT((location_ == EXECUTE_IN_DP2 AND sortOrderTypeReq_ == NO_SOT)
                     OR(sortOrderTypeReq_ == DP2_OR_ESP_NO_SORT_SOT) OR(sortOrderTypeReq_ == DP2_SOT));
    }
  }  // performSortOrderTypeConsistencyCheck()
...
class CurrentFragmentBigMemoryProperty : public NABasicObject {
 public:
  CurrentFragmentBigMemoryProperty()
      : currentFileSize_(0), cumulativeFileSizeofFragment_(0), noBigMemOpsSoFar_(0), Op_(NO_OPERATOR_TYPE){};
  ...
  double getCumulativeFileSize() { return cumulativeFileSizeofFragment_; }

  void incrementCumulativeMemSize(double d) { cumulativeFileSizeofFragment_ += d; }

  void setOperatorType(OperatorTypeEnum op) { Op_ = op; }
...
class PushDownProperty : public NABasicObject {
 public:
  ...
  virtual const PushDownColocationProperty *castToPushDownColocationProperty() const { return NULL; };

  // dynamic type checking help function for PushDownCSProperty
  virtual const PushDownCSProperty *castToPushDownCSProperty() const { return NULL; };
...
class PushDownColocationProperty : public PushDownProperty {
 public:
  ...
  const PushDownColocationProperty *castToPushDownColocationProperty() const { return this; };
...
class PushDownCSProperty : public PushDownColocationProperty {
 public:
  PushDownCSProperty(const PartitioningFunction *func = 0, const SearchKey *key = 0)
      : PushDownColocationProperty((func) ? func->getNodeMap() : 0), partFunc_(func), searchKey_(key){};
  ~PushDownCSProperty(){};
...
class PushDownRequirement : public NABasicObject {
 public:
  ...
  virtual const PushDownColocationRequirement *castToPushDownColocationRequirement() const { return NULL; };

  // dynamic type checking on PushDownCSRequirement.
  virtual const PushDownCSRequirement *castToPushDownCSRequirement() const { return NULL; };
...
class PushDownColocationRequirement : public PushDownRequirement {
 public:
  ...
  const PushDownColocationRequirement *castToPushDownColocationRequirement() const { return this; };
...
class PushDownCSRequirement : public PushDownColocationRequirement {
 public:
  PushDownCSRequirement(const PartitioningFunction *func = NULL, const SearchKey *key = NULL)
      : PushDownColocationRequirement((func) ? func->getNodeMap() : NULL), partFunc_(func), searchKey_(key){};
  ...
  const PushDownCSRequirement *castToPushDownCSRequirement() const { return this; };

  // test whether an instance of PushDownRequirement class is
  // actually a PushDownCSRequirement.
  static NABoolean isInstanceOf(const PushDownRequirement *x) { return (x AND x->castToPushDownCSRequirement()); };
...
class InputPhysicalProperty : public NABasicObject {
 public:
  ...
  InputPhysicalProperty(const ValueIdSet &outerCharOutputs, const ValueIdList *const outerOrder = NULL,
                        const PartitioningFunction *const outerOrderPartFunc = NULL,
                        const PartitioningFunction *const dp2SortOrderPartFunc = NULL,
                        const NABoolean assumeSortedForCosting = FALSE, NABoolean explodedOcbJoinForCosting = FALSE)
  ...
  InputPhysicalProperty(const NABoolean assumeSortedProbesForCosting, NABoolean explodedOcbJoinForCosting = FALSE)
  ...
  InputPhysicalProperty(const NABoolean assumeSortedProbesForCosting, const PartitioningFunction *const njOuterPartFunc,
  ...
  // Accessors
  const ValueIdSet &getNjOuterCharOutputs() const { return njOuterCharOutputs_; }

  const ValueIdList *getNjOuterOrder() const { return njOuterOrder_; }

  const PartitioningFunction *getNjOuterOrderPartFunc() const { return njOuterOrderPartFunc_; }

  const PartitioningFunction *getNjDp2OuterOrderPartFunc() const { return njDp2OuterOrderPartFunc_; }

  NABoolean getAssumeSortedForCosting() const { return assumeSortedForCosting_; }

  // Comparison method for use when comparing contexts
  COMPARE_RESULT compareInputPhysicalProperties(const InputPhysicalProperty &other) const;

  const PartitioningFunction *getNjOuterOrderPartFuncForNonUpdates() const { return njOuterPartFuncForNonUpdates_; }
  NABoolean getExplodedOcbJoinForCosting() const { return explodedOcbJoinForCosting_; }

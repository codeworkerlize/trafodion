...
public class MessageColumnIO extends GroupColumnIO {
  ...
  public <T> RecordReader<T> getRecordReader(final PageReadStore columns,
    ...
    /*
     * From the following:
     * recordMaterializer class: org.trafodion.sql.parquet.TrafRecordConverter (for fastserialize)
     * filter: org.trafodion.sql.parquet.TrafFilter

     System.out.println("MessageColumnIO"
     + ", recordMaterializer class: " + recordMaterializer.getClass().getName()
    ...
    */
    ...
    return filter.accept(new Visitor<RecordReader<T>>() {
	  ...
	  //	  System.out.print("RR Filter");
	    ...
	    //		     + ", materializer: " + filteringRecordMaterializer
	    //		     );
	...
	//	  System.out.println(" RRI");
	  ...
	  //	  System.out.println("RR UnboundRecord");

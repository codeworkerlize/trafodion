...
public class IncrementallyUpdatedFilterPredicateEvaluator implements Visitor {
  ...
  public static boolean evaluate(IncrementallyUpdatedFilterPredicate pred) {
    ...
    /*
     * IUFPEvaluator, 
     * pred: org.apache.parquet.filter2.recordlevel.IncrementallyUpdatedFilterPredicateBuilder$45@3902bd2c
     * System.out.println("IUFPEvaluator"
     + ", pred: " + pred
     );
    */
  ...
  public boolean visit(ValueInspector p) {
    ...
    /*
     * IUFPEvaluator.visit(value inspector), 
     * vi: org.apache.parquet.filter2.recordlevel.IncrementallyUpdatedFilterPredicateBuilder$45@3902bd2c
    System.out.println("IUFPEvaluator.visit(value inspector)"
		       + ", vi: " + p
		       );
    */
    return p.getResult();
  ...
  public boolean visit(And and) {
      /*
	System.out.println("IUFPEvaluator.visit(And)"
	+ ", arg: " + and
	);
      */
  ...
  public boolean visit(Or or) {
      /*
	System.out.println("IUFPEvaluator.visit(Or)"
	+ ", arg: " + or
	);
      */

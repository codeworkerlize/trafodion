...
int RunDirectory::startNewRun(SBN scrblocknum) {
  ...
  if (numRunsGenerated_ > currentMaxRuns_) {
    ...
    RunDirectoryEntry *newRDListPtr =
        (RunDirectoryEntry *)heap_->allocateMemory(currentMaxRuns_ * sizeof(RunDirectoryEntry), FALSE);
    ...
    memcpy(newRDListPtr, rdListPtr_, (numRunsGenerated_ - 1) * sizeof(RunDirectoryEntry));
    heap_->deallocateMemory((void *)rdListPtr_);

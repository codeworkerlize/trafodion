...
// esgyn port, use boost since out thrift uses boost
// Refer /opt/traf/tools/thrift-0.9.0/include/thrift/protocol/TCompactProtocol.h
#define PARQUET_THRIFT_USE_BOOST

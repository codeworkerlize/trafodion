...
class ARROW_EXPORT ArrayBuilder {
 public:
  ...
  void setIsSelected(std::shared_ptr<PoolBuffer> isSelected) 
   { is_selected_bitmap_ = isSelected; }

  void appendToIsSelected(int64_t start, int64_t len, skipVecType*);
 ...
 protected:
  ...
  std::shared_ptr<PoolBuffer> is_selected_bitmap_;

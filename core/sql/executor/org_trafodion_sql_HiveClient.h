...
#undef org_trafodion_sql_HiveClient_Table_SERIALIZE_LIB
#define org_trafodion_sql_HiveClient_Table_SERIALIZE_LIB 15L
#undef org_trafodion_sql_HiveClient_Table_FIELD_COUNT
#define org_trafodion_sql_HiveClient_Table_FIELD_COUNT 16L
#undef org_trafodion_sql_HiveClient_ORC
#define org_trafodion_sql_HiveClient_ORC 3L
#undef org_trafodion_sql_HiveClient_PARQUET
#define org_trafodion_sql_HiveClient_PARQUET 4L
...
#define org_trafodion_sql_HiveClient_Col_FIELD_COUNT 2L
/*
...
JNIEXPORT void JNICALL Java_org_trafodion_sql_HiveClient_setStripeOrRowgroupInfo
  (JNIEnv *, jobject, jlong, jint, jstring, jstring, jstring, jboolean, jlong, jlong, jshort, jlong, jlong, jint, jlongArray, jlongArray, jlongArray, jint, jobjectArray);

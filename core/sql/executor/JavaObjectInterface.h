...
protected:
  ...
  // Must be called.
  JOI_RetCode    init(const char *className, jclass &javaclass, JavaMethodInit* JavaMethods, Int32 howManyMethods, bool methodsInitialized);
  ...
  static void logError(std::string &cat, const char* file, int line, const char *methodName, const char *tableName, const char *error_msg);

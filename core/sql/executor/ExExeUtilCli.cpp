...
OutputInfo::OutputInfo(Lng32 numEntries) : numEntries_(numEntries) {
...
void OutputInfo::insert(Lng32 index, char *data) { data_[index] = data; }
...
Lng32 ExeCliInterface::deallocStuff(SQLMODULE_ID *&module, SQLSTMT_ID *&stmt, SQLDESC_ID *&sql_src,
...
Lng32 ExeCliInterface::dealloc() { return deallocStuff(module_, stmt_, sql_src_, input_desc_, output_desc_); }

void ExeCliInterface::clearGlobalDiags() { SQL_EXEC_ClearDiagnostics(NULL); }

Lng32 ExeCliInterface::allocStuff(SQLMODULE_ID *&module, SQLSTMT_ID *&stmt, SQLDESC_ID *&sql_src,
...
Lng32 ExeCliInterface::prepare(const char *stmtStr, SQLMODULE_ID *module, SQLSTMT_ID *stmt, SQLDESC_ID *sql_src,
                               ...
                               Lng32 *uniqueStmtIdLen, SQL_QUERY_COST_INFO *query_cost_info,
...
Lng32 ExeCliInterface::setupExplainData(SQLMODULE_ID *module, SQLSTMT_ID *stmt) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::setupExplainData() { return setupExplainData(module_, stmt_); }
...
Lng32 ExeCliInterface::setInputValue(short entry, char *ptr, Lng32 len) {
  Lng32 fsType = -1;
  Lng32 length = -1;
  Lng32 vcIndLen = -1;
  Lng32 indOffset = -1;
...
Lng32 ExeCliInterface::getAttributes(short entry, NABoolean forInput, Lng32 &fsDatatype, Lng32 &length, Lng32 &vcIndLen,
...
Lng32 ExeCliInterface::getDataOffsets(short entry, Lng32 forInput, Lng32 *indOffset, Lng32 *varOffset) {
  Lng32 temp;
  if (forInput) {
...
Lng32 ExeCliInterface::getStmtAttr(char *stmtName, Lng32 attrName, Lng32 *numeric_value, char *string_value) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::close(NABoolean ignoreIfNotOpen) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::executeImmediatePrepare(const char *stmtStr, char *outputBuf, Lng32 *outputBufLen,
                                               Int64 *rowsAffected, NABoolean monitorThis, char *stmtName) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::executeImmediatePrepare2(const char *stmtStr, char *uniqueStmtId, Lng32 *uniqueStmtIdLen,
                                                SQL_QUERY_COST_INFO *query_cost_info,
                                                SQL_QUERY_COMPILER_STATS_INFO *comp_stats_info, char *outputBuf,
                                                Lng32 *outputBufLen, Int64 *rowsAffected, NABoolean monitorThis,
...
Lng32 ExeCliInterface::getGeneratedCode(char *genCodeBuf, Int32 genCodeSize) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::executeImmediateExec(const char *stmtStr, char *outputBuf, Lng32 *outputBufLen,
                                            NABoolean nullTerminate, Int64 *rowsAffected, ComDiagsArea **diagsArea) {
  Lng32 retcode = 0;
  Lng32 diagsCount = 0;
...
Lng32 ExeCliInterface::executeImmediate(const char *stmtStr, char *outputBuf, Lng32 *outputBufLen,
                                        NABoolean nullTerminate, Int64 *rowsAffected, NABoolean monitorThis,
...
short ExeCliInterface::fetchAllRows(Queue *&infoList, const char *query, Lng32 inNumOutputEntries,
...
short ExeCliInterface::clearExecFetchClose(char *inputBuf, Lng32 inputBufLen,

                                           // ptr to buf where output values will be copied to.
                                           // Caller need to allocate this.
                                           char *outputBuf, Lng32 *outputBufLen) {
  Lng32 retcode = 0;
...
short ExeCliInterface::clearExecFetchCloseOpt(char *inputBuf, Lng32 inputBufLen,

                                              // ptr to buf where output values will be copied to.
                                              // Caller need to allocate this.
                                              char *outputBuf, Lng32 *outputBufLen, Int64 *rowsAffected) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::executeImmediateCEFC(const char *stmtStr, char *inputBuf, Lng32 inputBufLen, char *outputBuf,
                                            Lng32 *outputBufLen, Int64 *rowsAffected) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::cwrsAllocStuff(SQLMODULE_ID *&module, SQLSTMT_ID *&stmt, SQLDESC_ID *&sql_src,
                                      SQLDESC_ID *&input_desc, SQLDESC_ID *&output_desc,
...
Lng32 ExeCliInterface::cwrsDeallocStuff(SQLMODULE_ID *&module, SQLSTMT_ID *&stmt, SQLDESC_ID *&sql_src,
                                        SQLDESC_ID *&input_desc, SQLDESC_ID *&output_desc,
...
Lng32 ExeCliInterface::cwrsPrepare(const char *stmtStr, Lng32 rs_maxsize, NABoolean monitorThis) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::cwrsExec(char *inputRow, Int32 inputRowLen, Int64 *rowsAffected) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::cwrsClose(Int64 *rowsAffected) {
  ...
  Lng32 retcode2 = cwrsDeallocStuff(module_, stmt_, sql_src_, input_desc_, output_desc_, rs_input_maxsize_desc_);
  return retcode;
}
...
Lng32 ExeCliInterface::rwrsExec(char *inputRow, Int32 inputRowLen, Int64 *rowsAffected) {
  Lng32 retcode = 0;
...
short ExeCliInterface::prepareAndExecRowsPrologue(const char *sqlInitialStrBuf, char *sqlSecondaryStrBuf,
                                                  ...
                                                  Int64 &rowsAffected, NABoolean monitorThis) {
  Lng32 retcode = 0;
...
short ExeCliInterface::execContinuingRows(Queue *continuingOutputVarPtrList, Int64 &rowsAffected) {
  Lng32 retcode = 0;
...
Lng32 ExeCliInterface::beginWork() { return executeImmediate("begin work;"); }

Lng32 ExeCliInterface::commitWork() { return executeImmediate("commit work;"); }

Lng32 ExeCliInterface::rollbackWork() { return executeImmediate("rollback work;"); }
...
Lng32 ExeCliInterface::statusXn() { return SQL_EXEC_Xact(SQLTRANS_STATUS, NULL); }

Lng32 ExeCliInterface::suspendXn() { return SQL_EXEC_Xact(SQLTRANS_SUSPEND, 0); }

Lng32 ExeCliInterface::resumeXn() { return SQL_EXEC_Xact(SQLTRANS_RESUME, 0); }

Lng32 ExeCliInterface::saveXnState0() {
  ExTransaction *ta = GetCliGlobals()->currContext()->getTransaction();
  ta->saveXnState0();
  return 0;
}

Lng32 ExeCliInterface::restoreXnState0() {
  ExTransaction *ta = GetCliGlobals()->currContext()->getTransaction();
  ta->restoreXnState0();
  return 0;
}
...
Lng32 ExeCliInterface::holdAndSetCQDs(const char *holdStr, const char *setStr, ComDiagsArea *globalDiags) {
  Lng32 cliRC;
...
Lng32 ExeCliInterface::restoreCQDs(const char *restoreStr, ComDiagsArea *globalDiags)
...
Lng32 ExeCliInterface::getCQDval(const char *defaultName, char *val, ComDiagsArea *globalDiags) {
  Lng32 cliRC = 0;
  char buf[1000];

...
MdamInterval::MdamInterval(const tupp &beginTupp, const MdamEnums::MdamInclusion beginInclusion, const tupp &endTupp,
...
// Constructor without a disjunctNum.  Building of MdamRefList is deferred.
MdamInterval::MdamInterval(MdamEndPoint &beginEndPointRef, MdamEndPoint &endEndPointRef)
    : beginPoint_(beginEndPointRef), endPoint_(endEndPointRef), mdamRefList_(), nextMdamIntervalPtr_(0) {}
...
void MdamInterval::operator delete(void *) { ex_assert(0, "MdamInterval::operator delete(void *) called."); }
...
MdamPoint *MdamInterval::getPointPtr(const MdamEnums::MdamEndPointType endPointType) {

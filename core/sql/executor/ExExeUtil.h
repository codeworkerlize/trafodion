...
public:
 ...
 protected:
  ...
  ExeCliInterface *extractCliInterface_;
  ...
  // params used to extract lob value into a file
  ExLobV2 *lobPtr_;
  LobInputOutputFileType fileType_;
  Int32 localFileFD_;
  HdfsClient *hdfsFileClient_;
  Int64 localFileWriteOffset_;
  Int64 bytesWritten_;
};
...
public:
 ...
 protected:
  ...
  ExLobGlobals *exLobGlobals_;
  ExeCliInterface *dmlInterface_;
  ExeCliInterface *dmlInterface2_;
  ExpLobOperV2 lobOperV2_;
...
//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilGetExtSchemaTdb
// -----------------------------------------------------------------------
class ExExeUtilGetExtSchemaTdb : public ComTdbExeUtilGetExtSchema
{
public:
  ...
  virtual ~ExExeUtilGetExtSchemaTdb()
  {}
...
//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilGetExtSchemaTcb
// -----------------------------------------------------------------------
class ExExeUtilGetExtSchemaTcb : public ExExeUtilTcb
{
  friend class ExExeUtilGetExtSchemaTdb;
  friend class ExExeUtilPrivateState;

public:
  // Constructor
  ExExeUtilGetExtSchemaTcb(const ComTdbExeUtilGetExtSchema & exe_util_tdb,
                           ex_globals * glob = 0);
  ...
  ExExeUtilGetExtSchemaTdb & getExtSchemaTdb() const
  {
    return (ExExeUtilGetExtSchemaTdb &) tdb;
  };
...
private:
  ...
  char* schemas_[NUM_SCHEMAS_];
  Lng32 currSchemaIdx_;
...
public:	
  ...
  ~ExExeUtilParquetStatsPrivateState();	// destructor
protected:
};

//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilAvroStatsTdb
// -----------------------------------------------------------------------
class ExExeUtilAvroStatsTdb : public ComTdbExeUtilAvroStats
{
public:
...
//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilAvroStatsTcb
// -----------------------------------------------------------------------
class ExExeUtilAvroStatsTcb : public ExExeUtilTcb
{
  friend class ExExeUtilAvroStatsTdb;
  friend class ExExeUtilPrivateState;

public:
  // Constructor
  ExExeUtilAvroStatsTcb(const ComTdbExeUtilAvroStats & exe_util_tdb,
                           ex_globals * glob = 0);
  ...
  ExExeUtilAvroStatsTdb & getPStdb() const
  {
    return (ExExeUtilAvroStatsTdb &) tdb;
  };
...
protected:
  ...
  char * statsBuf_;
  Lng32 statsBufLen_;
  ComTdbAvroStatsVirtTableColumnStruct* stats_;  

  ExpAvroInterface * ehi_;
  NAArray<HbaseStr> *fileStats_;

  Int32 currIndex_;
  Int32 currFileNum_;

  Int32 numAvroStatsEntries_;
...
//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilAvroStatsFormatTcb
// -----------------------------------------------------------------------
class ExExeUtilAvroStatsFormatTcb : public ExExeUtilAvroStatsTcb
{
  friend class ExExeUtilAvroStatsTdb;
  friend class ExExeUtilPrivateState;
...
public:
  // Constructor
  ExExeUtilAvroStatsFormatTcb(const ComTdbExeUtilAvroStats & exe_util_tdb,
                                 ex_globals * glob = 0);
...
private:
  ...
  char * statsTotalsBuf_;
  ComTdbAvroStatsVirtTableColumnStruct* statsTotals_;  
...
////////////////////////////////////////////////////////////////////////////
class ExExeUtilAvroStatsPrivateState : public ex_tcb_private_state
{
  friend class ExExeUtilAvroStatsTcb;
  
public:	
  ExExeUtilAvroStatsPrivateState();
  ~ExExeUtilAvroStatsPrivateState();	// destructor
protected:
};
...
protected:
  ...
  short collectAndReturnLobInfoV2(char * tableName, Int32 currLobNum, ContextCli *context);
...
protected:
  Int64 getEmbeddedNumValue(char* &sep, char endChar, 
                            NABoolean adjustLen = TRUE);
  short collectAndReturnLobTableInfo(char * tableName, Int32 currLobNum, 
                                ContextCli *context);

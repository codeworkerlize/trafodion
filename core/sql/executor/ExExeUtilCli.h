...
private:
 ...
 public:
  ...
  inline Lng32 setInputValue(short entry, Lng32 val)
  {
    return setInputValue(entry, (char *)&val, 4);
  }
  ...
  void setCursorOpen(NABoolean v)
    {(v ? flags_ |= CURSOR_OPEN : flags_ &= ~CURSOR_OPEN); };

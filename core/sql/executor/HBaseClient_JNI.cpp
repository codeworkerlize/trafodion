...
static const char *const hbcErrorEnumStr[] = {"Preparing parameters for initConnection().",
  ...
  do {                                                                   \
    if (jenv_->ExceptionCheck()) {                                       \
      ...
      if (gEnableRowLevelLock) {                                         \
        ...
        if (ret_lock != HTC_OK) retValue = ret_lock;                     \
      }                                                                  \
      goto errorLabel;                                                   \
    }                                                                    \
  } while (false)
...
#define CHECK_RESULT_AND_SET_RETURN_ERROR(retobj, srcobj, errid, reterr)                                    \
  do {                                                                                                      \
    if ((retobj) == NULL) {                                                                                 \
      char buffer[1024];                                                                                    \
      snprintf(buffer, sizeof(buffer), "%s %s %s:%d", getErrorText((errid)), (srcobj), __FILE__, __LINE__); \
...
#define CHECK_AND_NEW_GLOBAL_REF(excepted, jvalue, jtype, value) \
  do {                                                           \
    if (!(excepted)) {                                           \
      ...
      if (jenv_->ExceptionCheck()) excepted = TRUE;              \
    }                                                            \
  } while (false)
...
#define ENTRY_FUNCTION()        FUNCTION_DEBUG("%s() called.", __FUNCTION__)
#define EXIT_FUNCTION(retValue) FUNCTION_DEBUG("exit %s(%d) %s:%d.", __FUNCTION__, (retValue), __FILE__, __LINE__)
#else
#define FUNCTION_DEBUG(fmt, ...)
...
HBaseClient_JNI::HBaseClient_JNI(NAHeap *heap, NABoolean bigTable) : JavaObjectInterface(heap), isConnected_(FALSE) {
...
HBaseClient_JNI *HBaseClient_JNI::getInstance(NABoolean bigtable) {
  ...
  if (hbaseClient_JNI == NULL) {
    hbaseClient_JNI = new (heap) HBaseClient_JNI(heap, bigtable);
    if (bigtable)
...
HBC_RetCode HBaseClient_JNI::init() {
  ...
  if (javaMethodsInitialized_)
    ...
    JavaMethods_[JM_START_GET].jm_signature =
        "(JLjava/lang/String;ZZIZJJJI[B[Ljava/lang/Object;JLjava/lang/String;IZZLjava/lang/String;)I";
    JavaMethods_[JM_START_GETS].jm_name = "startGet";
    JavaMethods_[JM_START_GETS].jm_signature =
        "(JLjava/lang/String;ZZIZZJJJI[Ljava/lang/Object;[Ljava/lang/Object;JLjava/lang/String;ILjava/lang/String;)I";
    JavaMethods_[JM_START_DIRECT_GETS].jm_name = "startGet";
    JavaMethods_[JM_START_DIRECT_GETS].jm_signature =
        "(JLjava/lang/String;ZZIZZJJJISLjava/lang/Object;[Ljava/lang/Object;Ljava/lang/String;ILjava/lang/String;)I";
    ...
    JavaMethods_[JM_INCR_COUNTER].jm_signature =
        "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)J";
    ...
    JavaMethods_[JM_HBC_DIRECT_INSERT_ROW].jm_signature =
        "(JLjava/lang/String;JJJ[BLjava/lang/Object;JZSIILjava/lang/String;)Z";
    JavaMethods_[JM_HBC_DIRECT_INSERT_ROWS].jm_name = "insertRows";
    JavaMethods_[JM_HBC_DIRECT_INSERT_ROWS].jm_signature =
        "(JLjava/lang/String;JJJSLjava/lang/Object;Ljava/lang/Object;JILjava/lang/String;)Z";
    JavaMethods_[JM_HBC_DIRECT_UPDATE_TAGS].jm_name = "updateVisibility";
    JavaMethods_[JM_HBC_DIRECT_UPDATE_TAGS].jm_signature =
        "(JLjava/lang/String;ZJ[BLjava/lang/Object;Ljava/lang/String;)Z";
    ...
    JavaMethods_[JM_HBC_DIRECT_CHECKANDUPDATE_ROW].jm_signature =
        "(JLjava/lang/String;JJJ[BLjava/lang/Object;[B[BJIILjava/lang/String;)Z";
    JavaMethods_[JM_HBC_DELETE_ROW].jm_name = "deleteRow";
    JavaMethods_[JM_HBC_DELETE_ROW].jm_signature =
        "(JLjava/lang/String;JJJ[B[Ljava/lang/Object;JLjava/lang/String;ILjava/lang/String;)Z";
    JavaMethods_[JM_HBC_DIRECT_DELETE_ROWS].jm_name = "deleteRows";
    JavaMethods_[JM_HBC_DIRECT_DELETE_ROWS].jm_signature =
        "(JLjava/lang/String;JJJSLjava/lang/Object;[Ljava/lang/Object;JLjava/lang/String;ILjava/lang/String;)Z";
    JavaMethods_[JM_HBC_CHECKANDDELETE_ROW].jm_name = "checkAndDeleteRow";
    JavaMethods_[JM_HBC_CHECKANDDELETE_ROW].jm_signature =
        "(JLjava/lang/String;JJJ[B[Ljava/lang/Object;[B[BJLjava/lang/String;ILjava/lang/String;)Z";
    ...
    JavaMethods_[JM_NAMESPACE_OPERATION].jm_signature =
        "(ILjava/lang/String;[Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/String;";
    ...
    JavaMethods_[JM_GET_NEXT_VALUE].jm_signature =
        "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JZ)J";
...
HBC_RetCode HBaseClient_JNI::initConnection(const char *connectParam1, const char *connectParam2, NABoolean bigtable) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::initConnection(%s, %s) called.", connectParam1,
                connectParam2);
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_INIT].methodID, js_connectParam1,
                                              js_connectParam2, j_bigtable);
...
HBC_RetCode HBaseClient_JNI::reconnectHBase() {
  ...
  if (initJNIEnv() != JOI_OK) return HBC_ERROR_RECONNECT_PARAM;
...
HTableClient_JNI *HBaseClient_JNI::getHTableClient(NAHeap *heap, const char *tableName, bool useTRex,
                                                   NABoolean replSync, NABoolean incrBackupEnabled,
  ...
  j_htc = jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_HTC].methodID, (jlong)htc, js_tblName,
                                  (jboolean)useTRex, (jboolean)replSync, (jboolean)incrBackupEnabled);
...
HBC_RetCode HBaseClient_JNI::create(const char *fileName, HBASE_NAMELIST &colFamilies, NABoolean isMVCC) {
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_CREATE].methodID, js_fileName, j_fams, j_isMVCC);
...
HBC_RetCode HBaseClient_JNI::create(const char *fileName, NAText *createOptionsArray, int numSplits, int keyLength,
  ...
  jobjectArray j_opts = convertToStringObjectArray(createOptionsArray, HBASE_MAX_OPTIONS);
  if (j_opts == NULL) {
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_CREATEK].methodID, js_fileName, j_opts, j_keys,
                                              j_tid, j_numSplits, j_keyLength, j_isMVCC, (jboolean)incrBackupEnabled);
...
HBC_RetCode HBaseClient_JNI::alter(const char *fileName, NAText *createOptionsArray, Int64 transID) {
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_ALTER].methodID, js_fileName, j_opts, j_tid);
...
HBaseClientRequest::HBaseClientRequest(NAHeap *heap, HBaseClientReqType reqType)
    : heap_(heap), reqType_(reqType), fileName_(NULL) {}
...
HBC_RetCode HBaseClient_JNI::truncate(const char *fileName, NABoolean preserveSplits, Int64 transID) {
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_TRUNCATE].methodID, js_fileName, j_preserveSplits, j_tid);
...
NAArray<HbaseStr> *HBaseClient_JNI::listAll(NAHeap *heap, const char *pattern) {
  ...
  jarray j_hbaseTables = (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_LIST_ALL].methodID, js_pattern);
...
HBC_RetCode HBaseClient_JNI::namespaceOperation(short oper, const char *nameSpace, Lng32 numKeyValEntries,
  ...
  jobjectArray j_keys = NULL;
  if (keyArray != NULL) {
    j_keys = convertToStringObjectArray(keyArray, numKeyValEntries);
  ...
  if (valArray != NULL) {
    j_vals = convertToStringObjectArray(valArray, numKeyValEntries);
  ...
  jobjectArray j_namespaceObjs = (jobjectArray)jenv_->CallObjectMethod(
      javaObj_, JavaMethods_[JM_NAMESPACE_OPERATION].methodID, j_oper, js_nameSpace, j_keys, j_vals);

  if (jenv_->ExceptionCheck()) {
    getExceptionDetails(__FILE__, __LINE__, "HBaseClient_JNI::namespaceOperation()");
    jenv_->PopLocalFrame(NULL);

    if ((oper == COM_CHECK_NAMESPACE_EXISTS) || (oper == COM_GET_NAMESPACE_OBJECTS))
  ...
  if ((j_namespaceObjs != NULL) && (retNames != NULL)) {
    jint retcode = convertStringObjectArrayToNAArray(heap, j_namespaceObjs, retNames);
    if (retcode == 0) {
      jenv_->PopLocalFrame(NULL);
      return HBC_ERROR_NAMESPACE_OPER_ERROR;
    }
...
HBC_RetCode HBaseClient_JNI::savepointCommitOrRollback(Int64 transId, Int64 savepointId, Int64 tgtSavepointId,
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_SAVEPOINT_COMMIT_OR_ROLLBACK].methodID, j_tid,
                                              j_sid, j_tgt_sid, j_isCommit);
  ...
  if (jresult == false) {
    logError(CAT_SQL_HBASE, "HBaseClient_JNI::savepointCommitOrRollback()", getLastError());
    jenv_->PopLocalFrame(NULL);
    return HBC_ERROR_SAVEPOINT_COMMIT_OR_ROLLBACK;
  }
...
//
//////////////////////////////////////////////////////////////////////////////
HBC_RetCode HBaseClient_JNI::copy(const char *srcTblName, const char *tgtTblName, NABoolean force) {
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_COPY].methodID, js_srcTblName, js_tgtTblName, j_force);
...
HBC_RetCode HBaseClient_JNI::grant(const Text &user, const Text &tblName, const TextVec &actions) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::grant(%s, %s, %s) called.", user.data(), tblName.data(),
                actions.data());
  if (initJNIEnv() != JOI_OK) return HBC_ERROR_INIT_PARAM;
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_GRANT].methodID, jba_user, jba_tblName, j_actionCodes);
...
HBC_RetCode HBaseClient_JNI::estimateRowCount(const char *tblName, Int32 partialRowSize, Int32 numCols,
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[method].methodID, js_tblName, jPartialRowSize,
                                              jNumCols, jRetryLimitMilliSeconds, jRowCount);
  jboolean isCopy;
  jlong *arrayElems = jenv_->GetLongArrayElements(jRowCount, &isCopy);
  rowCount = *arrayElems;
  if (isCopy == JNI_TRUE) jenv_->ReleaseLongArrayElements(jRowCount, arrayElems, JNI_ABORT);
...
HBC_RetCode HBaseClient_JNI::getLatestSnapshot(const char *tblName, char *&snapshotName, NAHeap *heap) {
  ...
  jstring jresult =
      (jstring)jenv_->CallStaticObjectMethod(javaClass_, JavaMethods_[JM_GET_LATEST_SNP].methodID, js_tblName);
  if (jenv_->ExceptionCheck()) {
...
HBC_RetCode HBaseClient_JNI::getBlockCacheFraction(float &frac) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::getBlockCacheFraction() called.");
  if (initJNIEnv() != JOI_OK) return HBC_ERROR_INIT_PARAM;

  tsRecentJMFromJNI = JavaMethods_[JM_GET_CAC_FRC].jm_full_name;
  jfloat jresult = jenv_->CallFloatMethod(javaObj_, JavaMethods_[JM_GET_CAC_FRC].methodID);
...
HBLC_RetCode HBulkLoadClient_JNI::init() {
  ...
  if (javaMethodsInitialized_)
    ...
    JavaMethods_[JM_INIT_HFILE_PARAMS].jm_signature =
        "(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;F)Z";
...
static short encryptRowId(const char *encryptionInfo, NAHeap *heap, Int32 numRows, const char *rowId, Int32 rowIdLen,
  ...
  rc = ComEncryption::extractEncryptionInfo(*(ComEncryption::EncryptionInfo *)encryptionInfo, header, rowidCipherType,
                                            dataCipherType, rowIdKey, rowIdKeyLen, dataKey, dataKeyLen, rowidInitVec,
    ...
    *(short *)encRowsPtr = bswap_16(numCols);
    ...
    for (short colIndex = 0; colIndex < numCols; colIndex++) {
      ...
      *(short *)encRowsPtr = bswap_16(colNameLen);
      ...
      rc = ComEncryption::encryptData(dataCipherType, (unsigned char *)rowsPtr, dataLen, dataKey, dataInitVec,
...
HBLC_RetCode HBulkLoadClient_JNI::initHFileParams(const HbaseStr &tblName, const Text &hFileLoc, const Text &hfileName,
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_hFileLoc, hFileLoc.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_CREATE_HFILE_PARAM);

  js_hfileName = jenv_->NewStringUTF(hfileName.c_str());
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_hfileName, hfileName.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_CREATE_HFILE_PARAM);

  js_tabName = jenv_->NewStringUTF(tblName.val);
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_tabName, tblName.val, (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_CREATE_HFILE_PARAM);

  js_sampleFileLoc = jenv_->NewStringUTF(hFileSampleLoc.c_str());
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_sampleFileLoc, hFileSampleLoc.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_CREATE_HFILE_PARAM);

  js_hfileSampleName = jenv_->NewStringUTF(hfileSampleName.c_str());
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_hfileSampleName, hfileSampleName.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_CREATE_HFILE_PARAM);
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_INIT_HFILE_PARAMS].methodID, js_hFileLoc, js_hfileName,
                                     j_maxSize, js_tabName, js_sampleFileLoc, js_hfileSampleName, j_sampleRate);
...
HBLC_RetCode HBulkLoadClient_JNI::addToHFile(short rowIDLen, HbaseStr &rowIDs, HbaseStr &rows, ExHbaseAccessStats *hbs,
                                             const char *encryptionInfo, NAHeap *heap) {
  ENTRY_FUNCTION();
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(HBLC_ERROR_INIT_PARAM);
    return HBLC_ERROR_INIT_PARAM;
  ...
  if (encryptionInfo) {
    ...
    short rc = encryptRowsData(encryptionInfo, heap, numRows, rows.val, rows.len, encRowsData, encRowsLen);
    if (rc) {
  ...
  if (hbs) hbs->getHbaseTimer().start();
...
errorLabel:
  if (encRowsData && (encRowsData != encDataBuffer)) NADELETEBASIC(encRowsData, heap);
  if (encRowsData && (encRowsData != encDataBuffer)) NADELETEBASIC(encRowsData, heap);
...
HBLC_RetCode HBulkLoadClient_JNI::closeHFile(const HbaseStr &tblName) {
...
HBLC_RetCode HBulkLoadClient_JNI::doBulkLoad(const HbaseStr &tblName, const Text &prepLocation, const Text &tableName,
                                             NABoolean quasiSecure, NABoolean snapshot) {
  FUNCTION_DEBUG("%s(%s, %s, %s) called.", __FUNCTION__, tblName.val, prepLocation.data(), tableName.data());
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_PrepLocation, prepLocation.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_DO_BULKLOAD_PARAM);
  js_TableName = jenv_->NewStringUTF(tableName.c_str());
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_TableName, tableName.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
                                    HBLC_ERROR_DO_BULKLOAD_PARAM);
  tsRecentJMFromJNI = JavaMethods_[JM_DO_BULK_LOAD].jm_full_name;
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_DO_BULK_LOAD].methodID, js_PrepLocation, js_TableName,
                                     j_quasiSecure, j_snapshot);
...
HBLC_RetCode HBulkLoadClient_JNI::bulkLoadCleanup(const HbaseStr &tblName, const Text &location) {
  FUNCTION_DEBUG("%s(%s, %s) called.", __FUNCTION__, tblName.val, location.data());
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(HBLC_ERROR_INIT_PARAM);
    return HBLC_ERROR_INIT_PARAM;
  }
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_location, location.c_str(), (HBLC_RetCode)JOI_ERROR_NEWOBJ,
...
BRC_RetCode BackupRestoreClient_JNI::init() {
  ...
  if (javaMethodsInitialized_)
    ...
    JavaMethods_[JM_VALIDATE_BACKUP_OBJECTS].jm_signature =
    ...
    JavaMethods_[JM_BACKUP_OBJECTS].jm_signature =
        "([Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/"
        "String;II)Z";
    ...
    JavaMethods_[JM_RESTORE_OBJECTS].jm_signature =
        "(Ljava/lang/String;[Ljava/lang/Object;[Ljava/lang/Object;Ljava/lang/String;ZZZII)[[B";
...
//
//////////////////////////////////////////////////////////////////////////////
BRC_RetCode BackupRestoreClient_JNI::backupObjects(const TextVec &tables, const TextVec &tableFlags,
                                                   const TextVec &lobLocList, const char *backuptag,
                                                   const char *extendedBackupAttributes, const char *backupType,
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_extendedBackupAttributes, extendedBackupAttributes,
                                    (BRC_RetCode)JOI_ERROR_NEWOBJ, BRC_ERROR_BACKUP_NONFATAL);

  js_backupType = jenv_->NewStringUTF(backupType);
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_backupType, backupType, (BRC_RetCode)JOI_ERROR_NEWOBJ,
                                    BRC_ERROR_BACKUP_NONFATAL);

  tsRecentJMFromJNI = JavaMethods_[JM_VALIDATE_BACKUP_OBJECTS].jm_full_name;
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_VALIDATE_BACKUP_OBJECTS].methodID, j_tables,
                                     j_tableFlags, js_backuptag, js_backupType);
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_BACKUP_OBJECTS].methodID, j_tables, j_tableFlags,
                                     j_lobLocList, js_backuptag, js_extendedBackupAttributes, js_backupType,
                                     ji_backupThreads, ji_progressUpdateDelay);
...
//
//////////////////////////////////////////////////////////////////////////////
BRC_RetCode BackupRestoreClient_JNI::setHiatus(const char *tableName, NABoolean lockOperation,
  ...
  jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_SET_HIATUS].methodID, js_tableName, (jboolean)lockOperation,
                               (jboolean)createSnapIfNotExist, (jboolean)ignoreSnapIfNotExist, ji_parallelThreads);
...
BRC_RetCode BackupRestoreClient_JNI::clearHiatus(const char *tableName) {
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_CLEAR_HIATUS].methodID, js_tableName);
...
//
//////////////////////////////////////////////////////////////////////////////
BRC_RetCode BackupRestoreClient_JNI::createSnapshotForIncrBackup(const TextVec &tables) {
  ENTRY_FUNCTION();
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(BRC_ERROR_INIT_PARAM);
    return BRC_ERROR_INIT_PARAM;
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_SNAPSHOT_INCR_BACKUP].methodID, j_tables);
...
//
//////////////////////////////////////////////////////////////////////////////
NAArray<HbaseStr> *BackupRestoreClient_JNI::restoreObjects(const char *backuptag, const TextVec *schemas,
                                                           const TextVec *tables, const char *restoreToTS,
                                                           NABoolean showObjects, NABoolean saveObjects,
                                                           NABoolean restoreSavedObjects, int parallelThreads,
                                                           const int progressUpdateDelay, NAHeap *heap) {
  FUNCTION_DEBUG("%s(%s) called.", __FUNCTION__, (backuptag ? backuptag : " "));
  if (initJNIEnv() != JOI_OK) {
  ...
  j_backupList =
      (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_RESTORE_OBJECTS].methodID, js_backuptag, j_schemas,
                                      j_tables, js_timestamp, (jboolean)showObjects, (jboolean)saveObjects,
                                      (jboolean)restoreSavedObjects, ji_parallelThreads, ji_progressUpdateDelay);
...
BRC_RetCode BackupRestoreClient_JNI::finalizeBackup(const char *backuptag, const char *backupType) {
  FUNCTION_DEBUG("%s(%s) called.", __FUNCTION__, (backuptag ? backuptag : " "));
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(BRC_ERROR_INIT_PARAM);
    return BRC_ERROR_INIT_PARAM;
  ...
  jstring js_backupType = NULL;
  jstring js_backuptag = jenv_->NewStringUTF(backuptag);
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_backuptag, backuptag, (BRC_RetCode)JOI_ERROR_NEWOBJ,
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_FINALIZE_BACKUP].methodID, js_backuptag, js_backupType);
...
BRC_RetCode BackupRestoreClient_JNI::finalizeRestore(const char *backuptag, const char *backupType) {
  FUNCTION_DEBUG("%s(%s) called.", __FUNCTION__, (backuptag ? backuptag : " "));
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(BRC_ERROR_INIT_PARAM);
    return BRC_ERROR_INIT_PARAM;
  ...
  js_backupType = jenv_->NewStringUTF(backupType);
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_backuptag, backupType, (BRC_RetCode)JOI_ERROR_NEWOBJ,
                                    BRC_ERROR_RESTORE_SNAPSHOT_EXCEPTION);

  tsRecentJMFromJNI = JavaMethods_[JM_FINALIZE_RESTORE].jm_full_name;
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_FINALIZE_RESTORE].methodID, js_backuptag, js_backupType);
...
//
//////////////////////////////////////////////////////////////////////////////
BRC_RetCode BackupRestoreClient_JNI::deleteBackup(const char *backuptag, NABoolean timestamp, NABoolean cascade,
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_DELETE_BACKUP].methodID, js_backuptag, j_timestamp,
                                     (jboolean)cascade, (jboolean)force, (jboolean)skipLock);
...
//
//////////////////////////////////////////////////////////////////////////////
BRC_RetCode BackupRestoreClient_JNI::exportOrImportBackup(const char *backuptag, NABoolean isExport, NABoolean override,
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(js_location, location, (BRC_RetCode)JOI_ERROR_NEWOBJ,
                                    BRC_ERROR_EXPORT_IMPORT_BACKUP_EXCEPTION);

  tsRecentJMFromJNI = JavaMethods_[JM_EXPORT_IMPORT_BACKUP].jm_full_name;
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_EXPORT_IMPORT_BACKUP].methodID, js_backuptag,
                                     (jboolean)isExport, (jboolean) override, js_location, ji_parallelThreads,
...
BRC_RetCode BackupRestoreClient_JNI::listAllBackups(NAArray<HbaseStr> **backupList, NABoolean shortFormat,
                                                    NABoolean reverseOrder, NAHeap *heap) {
  ENTRY_FUNCTION();
  if (initJNIEnv() != JOI_OK) {
    EXIT_FUNCTION(BRC_ERROR_INIT_PARAM);
    return BRC_ERROR_INIT_PARAM;
  ...
  jarray j_backupList = (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_LIST_ALL_BACKUPS].methodID,
...
NAString BackupRestoreClient_JNI::getBackupType(const char *backuptag) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_BACKUP_TYPE].methodID, js_backuptag);

  CHECK_EXCEPTION_AND_RETURN_ERROR(backuptag, NAString(""));
  char_result = jenv_->GetStringUTFChars(jresult, 0);
  if (char_result != NULL) retValue = char_result;
...
NAString BackupRestoreClient_JNI::getExtendedAttributes(const char *backuptag) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_EXTENDED_ATTRIBUTES].methodID, js_backuptag);
...
NAString BackupRestoreClient_JNI::getBackupStatus(const char *backuptag) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_BACKUP_STATUS].methodID, js_backuptag);
...
NAString BackupRestoreClient_JNI::getPriorBackupTag(const char *restoreToTimestamp) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_PRIOR_BACKUP_TAG].methodID, js_rtt);
...
NAString BackupRestoreClient_JNI::getRestoreToTsBackupTag(const char *restoreToTimestamp) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_RESTORE_TO_TS_BACKUP_TAG].methodID, js_rtt);
...
NAString BackupRestoreClient_JNI::lockHolder() {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_LOCK_HOLDER].methodID);
...
BRC_RetCode BackupRestoreClient_JNI::operationLock(const char *backuptag) {
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_OPERATION_LOCK].methodID, js_backuptag);
...
BRC_RetCode BackupRestoreClient_JNI::operationUnlock(const char *backuptag, NABoolean recoverMeta,
  ...
  jresult = (jstring)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_OPERATION_UNLOCK].methodID, js_backuptag,
...
//////////////////////////////////////////////////////////////////////////////
NAArray<HbaseStr> *BackupRestoreClient_JNI::getLinkedBackupTags(const char *backuptag, NAHeap *heap) {
  FUNCTION_DEBUG("%s(%s) called.", __FUNCTION__, (backuptag ? backuptag : " "));
  if (initJNIEnv() != JOI_OK) return NULL;
  ...
  j_backupList = (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_GET_LINKED_BACKUPS].methodID, js_backuptag);
...
HBC_RetCode HBaseClient_JNI::incrCounter(const char *tabName, const char *rowId, const char *famName,
  ...
  jcount = jenv_->CallLongMethod(javaObj_, JavaMethods_[JM_INCR_COUNTER].methodID, js_tabName, js_rowId, js_famName,
                                 js_qualName, j_incr);
...
HBC_RetCode HBaseClient_JNI::revoke(const Text &user, const Text &tblName, const TextVec &actions) {
  FUNCTION_DEBUG("%s(%s, %s, %s) called.", __FUNCTION__, user.data(), tblName.data(), actions.data());
  if (initJNIEnv() != JOI_OK) return HBC_ERROR_INIT_PARAM;
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_REVOKE].methodID, jba_user, jba_tblName, j_actionCodes);
...
HBC_RetCode HBaseClient_JNI::startGet(NAHeap *heap, const char *tableName, bool useTRex, NABoolean replSync,
  ...
  if (encryptionInfo &&
      ComEncryption::isFlagSet(*(ComEncryption::EncryptionInfo *)encryptionInfo, ComEncryption::ROWID_ENCRYPT)) {
  ...
  jint jresult = jenv_->CallIntMethod(
      javaObj_, JavaMethods_[JM_START_GET].methodID, (jlong)htc, js_tblName, (jboolean)useTRex, (jboolean)replSync,
      j_lockMode, (jboolean)skipReadConflict, j_tid, j_sid, j_psid, j_isolationLevel, jba_rowID, j_cols, j_ts,
      js_hbaseAuths, j_replicaId, (jboolean)waitOnSelectForUpdate, (jboolean)firstReadBypassTm, js_QueryContext);
  if (hbs) {
    hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
    hbs->incHbaseCalls();
  }
...
HBC_RetCode HBaseClient_JNI::startGets(NAHeap *heap, const char *tableName, bool useTRex, NABoolean replSync,
  ...
  if (js_QueryContext == NULL) {
    GetCliGlobals()->setJniErrorStr(getErrorText(HBC_ERROR_STARTGETS_PARAM));
    if (htc != NULL) NADELETE(htc, HTableClient_JNI, heap);
    jenv_->PopLocalFrame(NULL);
    return HBC_ERROR_GET_HTC_EXCEPTION;
  }
  if (hbs) hbs->getHbaseTimer().start();
  ...
  if (rowIDs != NULL) {
    ...
    jresult = jenv_->CallIntMethod(javaObj_, JavaMethods_[JM_START_GETS].methodID, (jlong)htc, js_tblName,
                                   (jboolean)useTRex, (jboolean)replSync, j_lockMode, (jboolean)skipReadConflict,
                                   (jboolean)skipTransactionForBatchGet, j_tid, j_sid, j_psid, j_isolationLevel, j_rows,
                                   j_cols, j_ts, js_hbaseAuths, j_replicaId, js_QueryContext);
  } else {
    tsRecentJMFromJNI = JavaMethods_[JM_START_DIRECT_GETS].jm_full_name;
    jresult = jenv_->CallIntMethod(javaObj_, JavaMethods_[JM_START_DIRECT_GETS].methodID, (jlong)htc, js_tblName,
                                   (jboolean)useTRex, (jboolean)replSync, j_lockMode, (jboolean)skipReadConflict,
                                   (jboolean)skipTransactionForBatchGet, j_tid, j_sid, j_psid, j_isolationLevel,
                                   jRowIDLen, jRowIDs, j_cols, js_hbaseAuths, j_replicaId, js_QueryContext);
  }
  if (hbs) {
    hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
    hbs->incHbaseCalls();
...
HBC_RetCode HBaseClient_JNI::getRegionsNodeName(const char *tblName, Int32 partns, ARRAY(const char *) & nodeNames) {
  ...
  jobjectArray jNodeNames =
      jenv_->NewObjectArray(partns, jenv_->FindClass("java/lang/String"), jenv_->NewStringUTF(""));

  tsRecentJMFromJNI = JavaMethods_[JM_GET_REGN_NODES].jm_full_name;
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_GET_REGN_NODES].methodID, js_tblName, jNodeNames);
  NAHeap *heap = getHeap();
  if (jresult) {
    jstring strObj = NULL;
    char *node = NULL;
...
HBC_RetCode HBaseClient_JNI::getHbaseTableInfo(const char *tblName, Int32 &indexLevels, Int32 &blockSize) {
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_GET_HBTI].methodID, js_tblName, jHtabInfo);
  if (jenv_->ExceptionCheck()) {
  ...
  if (isCopy == JNI_TRUE) jenv_->ReleaseIntArrayElements(jHtabInfo, arrayElems, JNI_ABORT);
  jenv_->PopLocalFrame(NULL);
  return HBC_OK;  // Table exists.
}

NABoolean HBaseClient_JNI::isExistTrigger(BeforeAndAfterTriggers *triggers) {
  if (triggers != NULL && (triggers->getBeforeRowTriggers() != NULL || triggers->getAfterRowTriggers() != NULL))
    return TRUE;
  else
    return FALSE;
}

NABoolean HBaseClient_JNI::matchTriggerOperation(Trigger *trigger, ComOperation type) {
  ComOperation op = trigger->getOperation();
  if (type == COM_INSERT) {
    if (op == COM_INSERT || op == COM_INSERT_UPDATE || op == COM_INSERT_DELETE || op == COM_INSERT_UPDATE_DELETE)
      return TRUE;
  } else if (type == COM_UPDATE) {
    if (op == COM_UPDATE || op == COM_INSERT_UPDATE || op == COM_INSERT_UPDATE_DELETE || op == COM_UPDATE_DELETE)
      return TRUE;
  } else if (type == COM_DELETE) {
    if (op == COM_DELETE || op == COM_INSERT_DELETE || op == COM_INSERT_UPDATE_DELETE || op == COM_UPDATE_DELETE)
      return TRUE;
  }
  return FALSE;
}

void HBaseClient_JNI::getTriggerInfo(NAString &triggerInfo, ComOperation type, NABoolean isBefore,
                                     BeforeAndAfterTriggers *triggers, NABoolean isStatement) {
 ...
 */
HBC_RetCode HBaseClient_JNI::execTriggers(NAHeap *heap, const char *tableName, ComOperation type, NABoolean isBefore,
  ...
  if (triggers == NULL || (type != COM_INSERT && type != COM_UPDATE && type != COM_DELETE)) {
    return HBC_OK;
  }
  ...
  getTriggerInfo(triggerInfo, type, isBefore, triggers, isStatement);
  ...
  if (!isStatement) {
    ...
    if (type == COM_INSERT || type == COM_UPDATE) {
      if (base64RowLen + 1 > TRIGGER_ROW_LEN || base64ValLen + 1 > TRIGGER_ROW_LEN) {
        return HBC_ERROR_TRIGGER_PARAMETER_EXCEPTION;
      }
    ...
    if (type == COM_DELETE || type == COM_UPDATE) {
      if (strlen(skvBuffer_) + 1 > TRIGGER_ROW_LEN || strlen(sBufSize_) + 1 > TRIGGER_ID_LEN ||
          strlen(srowIDs_) + 1 > TRIGGER_ROW_LEN || strlen(srowIDsLen_) + 1 > TRIGGER_ID_LEN) {
        return HBC_ERROR_TRIGGER_PARAMETER_EXCEPTION;
      }
  ...
  cliRC = GetCliGlobals()->currContext()->executeCallTrigger(
      (char *)triggerInfo.data(), isBefore, type, oldSKVBuffer, oldBufSize, oldRowIDs, oldRowIDsLen, newRowIDLen,
      newRowIDs, newRowIDsLen, newRows, newRowsLen, (char *)curExecSql);
  if (cliRC < 0) {
    return HBC_ERROR_TRIGGER_EXECUTE_EXCEPTION;
  }
  return HBC_OK;
...
HBC_RetCode HBaseClient_JNI::insertRow(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs, Int64 transID,
  ...
  if (ddlValidator && !ddlValidator->isDDLValid()) return HBC_ERROR_INSERTROW_INVALID_DDL;
  ...
  HBC_RetCode reCode = execTriggers(heap, tableName, gettrigger_operation() == COM_UPDATE ? COM_UPDATE : COM_INSERT,
                                    TRUE, (BeforeAndAfterTriggers *)triggers, rowID, row, base64rowVal, base64ValLen,
                                    base64rowIDVal, base64RowLen, 0, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    if (base64rowVal != NULL) {
  ...
  if (encryptionInfo) {
    ...
    if (rc) {
      if (encRowData && (encRowData != encDataBuffer)) NADELETEBASIC(encRowData, heap);
      GetCliGlobals()->setJniErrorStr(getErrorText(HBC_ERROR_INSERTROW_PARAM));
      if (htc != NULL) NADELETE(htc, HTableClient_JNI, heap);
      if (base64rowVal != NULL) {
        NADELETEBASIC(base64rowVal, heap);
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DIRECT_INSERT_ROW].methodID, j_htc,
                                              js_tblName, j_tid, j_sid, j_psid, jba_rowID, jRow, j_ts, j_checkAndPut,
                                              j_colIndexToCheck, (jint)flags, j_nodeId, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    if (!htc->asyncOper(flags)) hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
  ...
  if (hbs) hbs->incBytesRead(rowID.len + row.len);
  if (jresult == false) {
    jenv_->PopLocalFrame(NULL);
    if (htc != NULL) NADELETE(htc, HTableClient_JNI, heap);
    if (base64rowVal != NULL) {
  ...
  *outHtc = htc;
  ...
  // call trigger
  reCode = execTriggers(heap, tableName, gettrigger_operation() == COM_UPDATE ? COM_UPDATE : COM_INSERT, FALSE,
                        (BeforeAndAfterTriggers *)triggers, rowID, row, base64rowVal, base64ValLen, base64rowIDVal,
                        base64RowLen, 0, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    if (base64rowVal != NULL) {
      NADELETEBASIC(base64rowVal, heap);
...
HBC_RetCode HBaseClient_JNI::insertRows(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs, Int64 transID,
  ...
  if (ddlValidator && !ddlValidator->isDDLValid()) return HBC_ERROR_INSERTROWS_INVALID_DDL;
  ...
  HBC_RetCode reCode = execTriggers(heap, tableName, gettrigger_operation() == COM_UPDATE ? COM_UPDATE : COM_INSERT,
                                    TRUE, (BeforeAndAfterTriggers *)triggers, rowIDs, rows, base64rowVal, base64ValLen,
                                    base64rowIDVal, base64RowLen, rowIDLen, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    if (base64rowVal != NULL) {
      NADELETEBASIC(base64rowVal, heap);
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DIRECT_INSERT_ROWS].methodID, j_htc, js_tblName, j_tid,
                               j_sid, j_psid, j_rowIDLen, jRowIDs, jRows, j_ts, (jint)flags, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    if (!htc->asyncOper(flags)) hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
  ...
  if (hbs) hbs->incBytesRead(rowIDs.len + rows.len);
  *outHtc = htc;
  jenv_->PopLocalFrame(NULL);

  reCode = execTriggers(heap, tableName, gettrigger_operation() == COM_UPDATE ? COM_UPDATE : COM_INSERT, FALSE,
                        (BeforeAndAfterTriggers *)triggers, rowIDs, rows, base64rowVal, base64ValLen, base64rowIDVal,
                        base64RowLen, rowIDLen, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    if (base64rowVal != NULL) {
      NADELETEBASIC(base64rowVal, heap);
...
HBC_RetCode HBaseClient_JNI::updateVisibility(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs,
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DIRECT_UPDATE_TAGS].methodID, j_htc,
                                              js_tblName, j_useTRex, j_tid, jba_rowID, jTagsRow, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
...
HBC_RetCode HBaseClient_JNI::checkAndUpdateRow(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs,
  ...
  if (encryptionInfo) {
    ...
    if (encRowData) {
      jRow = jenv_->NewDirectByteBuffer(encRowData, encRowLen);
      if (encRowData != encDataBuffer) NADELETEBASIC(encRowData, heap);
    }
  } else
    jRow = jenv_->NewDirectByteBuffer(row.val, row.len);
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DIRECT_CHECKANDUPDATE_ROW].methodID, j_htc,
                                              js_tblName, j_tid, j_sid, j_psid, jba_rowID, jRow, jba_columnToCheck,
                                              jba_columnValToCheck, j_ts, (jint)flags, j_nodeId, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    if (!htc->asyncOper(flags)) hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
...
HBC_RetCode HBaseClient_JNI::deleteRow(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs, Int64 transID,
  ...
  if (ddlValidator && !ddlValidator->isDDLValid()) return HBC_ERROR_DELETEROW_INVALID_DDL;
  ...
  HBC_RetCode reCode = execTriggers(heap, tableName, COM_DELETE, TRUE, (BeforeAndAfterTriggers *)triggers, rowID, rowID,
                                    NULL, 0, base64RowIdVal, base64RowIdLen, 0, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    return reCode;
  }
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DELETE_ROW].methodID, j_htc, js_tblName, j_tid, j_sid,
                               j_psid, jba_rowID, j_cols, j_ts, js_hbaseAuths, (jint)flags, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    if (!htc->asyncOper(flags)) hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
  ...
  if (hbs) hbs->incBytesRead(rowID.len);
  *outHtc = htc;
  jenv_->PopLocalFrame(NULL);

  // call trigger
  reCode = execTriggers(heap, tableName, COM_DELETE, FALSE, (BeforeAndAfterTriggers *)triggers, rowID, rowID, NULL, 0,
                        base64RowIdVal, base64RowIdLen, 0, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    return reCode;
  }
...
HBC_RetCode HBaseClient_JNI::deleteRows(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs, Int64 transID,
  ...
  if (ddlValidator && !ddlValidator->isDDLValid()) return HBC_ERROR_DELETEROWS_INVALID_DDL;
  ...
  HBC_RetCode reCode = execTriggers(heap, tableName, COM_DELETE, TRUE, (BeforeAndAfterTriggers *)triggers, rowIDs,
                                    rowIDs, NULL, 0, base64RowIdsVal, base64RowIdsLen, rowIDLen, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    return reCode;
  }
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_DIRECT_DELETE_ROWS].methodID, j_htc,
                                              js_tblName, j_tid, j_sid, j_psid, j_rowIDLen, jRowIDs, j_cols, j_ts,
  ...
  if (hbs) hbs->incBytesRead(rowIDs.len);
  *outHtc = htc;
  jenv_->PopLocalFrame(NULL);

  // call trigger
  reCode = execTriggers(heap, tableName, COM_DELETE, FALSE, (BeforeAndAfterTriggers *)triggers, rowIDs, rowIDs, NULL, 0,
                        base64RowIdsVal, base64RowIdsLen, rowIDLen, curExecSql);
  if (reCode != HBC_OK) {
    NADELETE(htc, HTableClient_JNI, heap);
    return reCode;
  }
...
HBC_RetCode HBaseClient_JNI::checkAndDeleteRow(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs,
  ...
  if (ddlValidator && !ddlValidator->isDDLValid()) return HBC_ERROR_CHECKANDDELETEROW_INVALID_DDL;
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_CHECKANDDELETE_ROW].methodID, j_htc,
                                              js_tblName, j_tid, j_sid, j_psid, jba_rowID, j_cols, jba_columnToCheck,
                                              jba_columnValToCheck, j_ts, js_hbaseAuths, (jint)flags, js_QueryContext);
  if (hbs) {
    hbs->incHbaseCalls();
    if (!htc->asyncOper(flags)) hbs->incMaxHbaseIOTime(hbs->getHbaseTimer().stop());
  }
...
HBC_RetCode HBaseClient_JNI::addTablesToHDFSCache(const TextVec &tables, const char *poolName) {
  ...
  jint jresult =
      jenv_->CallIntMethod(javaObj_, JavaMethods_[JM_ADD_TABLES_TO_HDFS_CACHE].methodID, j_tables, js_poolName);
  ...
  if (j_tables != NULL) jenv_->DeleteLocalRef(j_tables);

  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "Exit HBaseClient_JNI::addTablesToHDFSCache() called.");
  jenv_->PopLocalFrame(NULL);
...
HBC_RetCode HBaseClient_JNI::removeTablesFromHDFSCache(const TextVec &tables, const char *poolName) {
  ...
  jint jresult =
      jenv_->CallIntMethod(javaObj_, JavaMethods_[JM_REMOVE_TABLES_FROM_HDFS_CACHE].methodID, j_tables, js_poolName);
...
NAArray<HbaseStr> *HBaseClient_JNI::showTablesHDFSCache(NAHeap *heap, const TextVec &tables) {
  ...
  jarray j_tableHdfsCacheStats =
      (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_SHOW_TABLES_HDFS_CACHE].methodID, j_tables);
...
HBC_RetCode HBaseClient_JNI::createSnapshot(const NAString &tableName, const NAString &snapshotName) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::createSnapshot(%s, %s) called.", tableName.data(),
                snapshotName.data());
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_CREATE_SNAPSHOT].methodID, js_tableName, js_snapshotName);
...
HBC_RetCode HBaseClient_JNI::restoreSnapshot(const NAString &snapshotName, const NAString &tableName) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::restoreSnapshot(%s, %s) called.", snapshotName.data(),
                tableName.data());
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_RESTORE_SNAPSHOT].methodID, js_snapshotName, js_tableName);
...
HBC_RetCode HBaseClient_JNI::verifySnapshot(const NAString &tableName, const NAString &snapshotName, NABoolean &exist) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::verifySnapshot(%s, %s) called.", tableName.data(),
                snapshotName.data());
  ...
  jboolean jresult =
      jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_HBC_VERIFY_SNAPSHOT].methodID, js_tableName, js_snapshotName);
...
HBC_RetCode HBaseClient_JNI::deleteSnapshot(const NAString &snapshotName) {
  QRLogger::log(CAT_SQL_HBASE, LL_DEBUG, "HBaseClient_JNI::deleteSnapshot(%s) called.", snapshotName.data());
...
HBC_RetCode HBaseClient_JNI::getNextValue(NAString &tabName, NAString &rowId, NAString &famName, NAString &qualName,
  ...
  jlong jnextVal = jenv_->CallLongMethod(javaObj_, JavaMethods_[JM_GET_NEXT_VALUE].methodID, js_tabName, js_rowId,
                                         js_famName, js_qualName, j_incrBy, j_skipWAL);
...
HBC_RetCode HBaseClient_JNI::getTableDefForBinlog(NAString &tabName, NAHeap *heap, NAArray<HbaseStr> **retNames) {
  ...
  jobjectArray j_tableDefObjs =
      (jobjectArray)jenv_->CallLongMethod(javaObj_, JavaMethods_[JM_GET_TBL_DEF_BINLOG].methodID, js_tabName);
  ...
  if ((j_tableDefObjs != NULL) && (retNames != NULL)) {
    jint retcode = convertStringObjectArrayToNAArray(heap, j_tableDefObjs, retNames);
    if (retcode == 0) {
      jenv_->PopLocalFrame(NULL);
...
HBC_RetCode HBaseClient_JNI::updateTableDefForBinlog(NAString &tabName, NAString &cols, NAString &keys, long ts) {
  ...
  jenv_->CallLongMethod(javaObj_, JavaMethods_[JM_UPDATE_TBL_DEF_BINLOG].methodID, js_tabName, js_cols, js_keys,
                        (jlong)ts);
...
HBC_RetCode HBaseClient_JNI::lockRequired(NAHeap *heap, const char *tableName, ExHbaseAccessStats *hbs,
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_LOCKREQUIRED].methodID, js_tableName,
                                              (jlong)transactionId, (jlong)savepointId, (jlong)pSavepointId,
                                              (jint)lockMode, (jboolean)registerRegion, js_QueryContext);
  if (jenv_->ExceptionCheck()) {
...
static const char *const htcErrorEnumStr[] = {"Preparing parameters for initConnection().",
                                              "Java exception in initConnection().",
...
//
//////////////////////////////////////////////////////////////////////////////
void HTableClient_JNI::setFlags(UInt32 &flags, NABoolean useTRex, NABoolean syncRepl, NABoolean useRegionXn,
                                NABoolean incrBackup, NABoolean asyncOper, NABoolean noConflictCheck,
                                NABoolean updateIsUpsert) {
...
HTableClient_JNI::~HTableClient_JNI() {
  ...
  if (colNameAllocLen_ != 0) NADELETEBASIC(colName_, heap_);
...
HTC_RetCode HTableClient_JNI::init() {
  ...
  if (javaMethodsInitialized_)
    ...
    JavaMethods_[JM_SCAN_OPEN].jm_signature =
        "(JJJI[B[B[Ljava/lang/Object;JZZI[Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;FFZIZZZILjava/lang/"
        "String;Ljava/lang/String;IIJJLjava/lang/String;IZZLjava/lang/String;)Z";
...
HTC_RetCode HTableClient_JNI::startScan(Int64 transID, Int64 savepointID, Int64 pSavepointId, Int32 isolationLevel,
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_startRowID, startRowidData, (HTC_RetCode)JOI_ERROR_NEWOBJ,
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_stopRowID, stopRowidData, (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                    HTC_ERROR_SCANOPEN_PARAM);
...

  {
    ...
    if (hbaseAuths) {
      js_hbaseAuths = jenv_->NewStringUTF(hbaseAuths);
      CHECK_RESULT_AND_SET_RETURN_ERROR(js_hbaseAuths, hbaseAuths, (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                        HTC_ERROR_SCANOPEN_PARAM);
    }
    ...
    CHECK_RESULT_AND_SET_RETURN_ERROR(js_QueryContext, queryContext, (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                      HTC_ERROR_SCANOPEN_PARAM);
    j_replicaId = HBaseClient_JNI::getReplicaId(numReplications);
    if (hbs_) hbs_->getHbaseTimer().start();

    tsRecentJMFromJNI = JavaMethods_[JM_SCAN_OPEN].jm_full_name;
    jresult = jenv_->CallBooleanMethod(
        javaObj_, JavaMethods_[JM_SCAN_OPEN].methodID, j_tid, j_sid, j_psid, j_isolationLevel, jba_startRowID,
        jba_stopRowID, j_cols, j_ts, j_cb, j_smallScanner, j_ncr, j_colnamestofilter, j_compareoplist,
        j_colvaluestocompare, j_dopParallelScanner, j_smplPct, j_preFetch, j_lockMode, (jboolean)skipReadConflict,
        (jboolean)skipTransaction, j_useSnapshotScan, j_snapTimeout, js_snapName, js_tmp_loc, j_espNum, j_versions,
        j_minTS, j_maxTS, js_hbaseAuths, j_replicaId, false, j_firstReadBypassTm, js_QueryContext);
...
HTC_RetCode HTableClient_JNI::deleteRow(Int64 transID, Int64 savepointID, Int64 pSavepointId, HbaseStr &rowID,
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_DELETE].methodID, j_tid, j_sid, j_psid, jba_rowID,
                                     j_cols, j_ts, js_hbaseAuths, (jint)flags, js_QueryContext);
  if (hbs_) {
    hbs_->incMaxHbaseIOTime(hbs_->getHbaseTimer().stop());
    hbs_->incHbaseCalls();
  }
  ...
  if (hbs_) hbs_->incBytesRead(rowID.len);
                                         ...
                                         Text &aggrVal)  // returned value
{
  ...
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_startrowid, startRowID.data(), (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                    HTC_ERROR_COPROC_AGGR_PARAM);
  jenv_->SetByteArrayRegion(jba_startrowid, 0, len, (const jbyte *)startRowID.data());

  len = stopRowID.size();
  jba_stoprowid = jenv_->NewByteArray(len);
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_stoprowid, stopRowID.data(), (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                    HTC_ERROR_COPROC_AGGR_PARAM);
  jenv_->SetByteArrayRegion(jba_stoprowid, 0, len, (const jbyte *)stopRowID.data());

  len = colFamily.size();
  jba_colfamily = jenv_->NewByteArray(len);
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_colfamily, colFamily.data(), (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                    HTC_ERROR_COPROC_AGGR_PARAM);
  jenv_->SetByteArrayRegion(jba_colfamily, 0, len, (const jbyte *)colFamily.data());

  len = colName.size();
  jba_colname = jenv_->NewByteArray(len);
  CHECK_RESULT_AND_SET_RETURN_ERROR(jba_colname, colName.data(), (HTC_RetCode)JOI_ERROR_NEWOBJ,
                                    HTC_ERROR_COPROC_AGGR_PARAM);
...

  {
    ...
    jresult = (jarray)jenv_->CallObjectMethod(javaObj_, JavaMethods_[JM_COPROC_AGGR].methodID, j_tid, j_svptId,
                                              j_pSvptId, j_isolationLevel, j_lockMode, j_aggrtype, jba_startrowid,
                                              jba_stoprowid, jba_colfamily, jba_colname, j_cb, j_ncr, js_QueryContext);
    if (hbs_) {
      hbs_->incMaxHbaseIOTime(hbs_->getHbaseTimer().stop());
      hbs_->incHbaseCalls();
    }
...
JNIEXPORT jint JNICALL Java_org_trafodion_sql_HTableClient_setResultInfo(
    JNIEnv *jenv, jobject jobj, jlong jniObject, jintArray jKvValLen, jintArray jKvValOffset, jintArray jKvQualLen,
    jintArray jKvQualOffset, jintArray jKvFamLen, jintArray jKvFamOffset, jlongArray jTimestamp, jobjectArray jKvBuffer,
    jobjectArray jKvTag, jobjectArray jKvFamArray, jobjectArray jkvQualArray, jobjectArray jRowIDs,
    jintArray jKvsPerRow, jint numCellsReturned, jint numRowsReturned) {
  HTableClient_JNI *htc = (HTableClient_JNI *)jniObject;
  if (htc->getFetchMode() == HTableClient_JNI::GET_ROW || htc->getFetchMode() == HTableClient_JNI::BATCH_GET)
    htc->setJavaObject(jobj);
  htc->setResultInfo(jKvValLen, jKvValOffset, jKvQualLen, jKvQualOffset, jKvFamLen, jKvFamOffset, jTimestamp, jKvBuffer,
                     jKvTag, jKvFamArray, jkvQualArray, jRowIDs, jKvsPerRow, numCellsReturned, numRowsReturned);
  return 0;
}

JNIEXPORT jint JNICALL Java_org_trafodion_sql_HTableClient_setJavaObject(JNIEnv *jenv, jobject jobj, jlong jniObject) {
  HTableClient_JNI *htc = (HTableClient_JNI *)jniObject;
  htc->setJavaObject(jobj);
  return 0;
}

JNIEXPORT void JNICALL Java_org_trafodion_sql_HTableClient_cleanup(JNIEnv *jenv, jobject jobj, jlong jniObject) {
  HTableClient_JNI *htc = (HTableClient_JNI *)jniObject;
  NADELETE(htc, HTableClient_JNI, htc->getHeap());
}
...
void HTableClient_JNI::setResultInfo(jintArray jKvValLen, jintArray jKvValOffset, jintArray jKvQualLen,
                                     jintArray jKvQualOffset, jintArray jKvFamLen, jintArray jKvFamOffset,
                                     jlongArray jTimestamp, jobjectArray jKvBuffer, jobjectArray jKvTag,
                                     jobjectArray jKvFamArray, jobjectArray jKvQualArray, jobjectArray jRowIDs,
                                     jintArray jKvsPerRow, jint numCellsReturned, jint numRowsReturned) {
  if (numRowsReturned_ > 0) cleanupResultInfo();
...
void HTableClient_JNI::setOldValueInfo(HbaseStr rowID) {
  ...
  if (numCellsReturned_ == 0 || jKvValLen_ == NULL || jKvValOffset_ == NULL) return;
  ...
  for (i = 0; i < numRowsReturned_; i++) {
    ...
    if (jba_rowID == NULL) continue;
    rowId = jenv_->GetByteArrayElements(jba_rowID, NULL);
    rowIDLen = jenv_->GetArrayLength(jba_rowID);
    itoa(rowIDLen, sz, 10);
    if (rowID.len != 0) {
      if (rowID.len != rowIDLen || memcmp(rowID.val, (char *)rowId, rowIDLen) != 0) {
        cellNum += kvsPerRow[i];
        continue;
      } else
        FindRow = TRUE;
    ...
    if ((maxRowIDSize < curUseRowIDSize + rowIDLen) && szRowIDs != NULL) {
      ...
      while (1) {
        ...
        if (maxRowIDSize > curUseRowIDSize + rowIDLen) break;
      }
    ...
    for (j = 0; j < kvsPerRow[i]; j++) {
      ...
      if (maxRowSize == 0) {
        ...
        while (1) {
          ...
          if (maxRowSize > curUseRowSize + kvValLen[cellNum]) break;
        }
...
void HBaseClient_JNI::setOldValueInfo(char *skvBuffer, char *sbufsize, char *srowIDs, char *srowIDsLen) {
  long sz = 0;
  cleanupOldValueInfo();
...
void HTableClient_JNI::getResultInfo() {
  ...
  if (numCellsAllocated_ == 0 || numCellsAllocated_ < numCellsReturned_) {
    NAHeap *heap = getHeap();
    if (numCellsAllocated_ > 0) {
...
HTC_RetCode HTableClient_JNI::getColName(int colNo, char **outColName, short &colNameLen, Int64 &timestamp) {
  ...
  if ((retcode = prepareForNextCell(idx)) != HTC_OK) return retcode;
  ...
  jenv_->GetByteArrayRegion(jba_kvFamArray_, kvFamOffset, kvFamLen, (jbyte *)colName);
  colName[kvFamLen] = ':';
  char *temp = colName + kvFamLen + 1;
  jenv_->GetByteArrayRegion(jba_kvQualArray_, kvQualOffset, kvQualLen, (jbyte *)temp);
  timestamp = p_timestamp_[idx];
  *outColName = colName;
  if (hbs_) hbs_->incBytesRead(sizeof(timestamp) + colNameLen);
  return HTC_OK;
}
...
HTC_RetCode HTableClient_JNI::getColVal(int colNo, BYTE *colVal, Lng32 &colValLen, NABoolean nullable, BYTE &nullVal,
  ...
  if ((nullable) && (encryptionInfo)) return HTC_GET_COLVAL_EXCEPTION;
  ...
  // on heap.
  if (encryptionInfo) {
    ComEncryption::EncryptionInfo *ei = (ComEncryption::EncryptionInfo *)encryptionInfo;
    unsigned char encDataBuffer[ENC_STATIC_BUFFER_LEN];
    ...
    jenv_->GetByteArrayRegion(jba_kvBuffer_, kvValOffset, kvValLen, (jbyte *)encData);
    ...
    jenv_->GetByteArrayRegion(jba_kvBuffer_, kvValOffset + adjust, copyLen, (jbyte *)colVal);
  }
  ...
  if (dataLen > colValLen)
    ...
    colValLen = copyLen;
  if (hbs_) hbs_->incBytesRead(copyLen);
  return HTC_OK;
}
...
HTC_RetCode HTableClient_JNI::getColVal(NAHeap *heap, int colNo, BYTE **colVal, Lng32 &colValLen,
  ...
  if (heap == NULL) {
    ...
    if (colValLenTmp > kvValLen) colValLenTmp = kvValLen;
  } else {
    colValTmp = new (heap) BYTE[kvValLen];
    colValLenTmp = kvValLen;
  }
  jenv_->GetByteArrayRegion(jba_kvBuffer_, kvValOffset, colValLenTmp, (jbyte *)colValTmp);
  *colVal = colValTmp;
  colValLen = colValLenTmp;
  if (hbs_) hbs_->incBytesRead(colValLen);
  return HTC_OK;
}
...
HTC_RetCode HTableClient_JNI::getRowID(HbaseStr &rowID, const char *encryptionInfo) {
  jint kvsPerRow = p_kvsPerRow_[currentRowNum_];
  if (p_rowID_ != NULL) {
    jenv_->ReleaseByteArrayElements(jba_rowID_, p_rowID_, JNI_ABORT);
    p_rowID_ = NULL;
...
HTC_RetCode HTableClient_JNI::fetchRows() {
  ...
  jint jRowsReturned = jenv_->CallIntMethod(javaObj_, JavaMethods_[JM_FETCH_ROWS].methodID, jniObject);
  if (hbs_) {
    hbs_->incMaxHbaseIOTime(hbs_->getHbaseTimer().stop());
    hbs_->incHbaseCalls();
  }
  ...
  if (costTh >= 0) {
    ...
    if (timeCost >= costTh)
      QRLogger::log(CAT_SQL_HBASE, LL_WARN, "fetchRows PID %ld txID %ld TC %ld %s ", pid,
                    (GetCliGlobals() ? GetCliGlobals()->getTransactionId() : -1), timeCost, tableName_);
  }
  ...
  if (hbs_) hbs_->incAccessedRows(numRowsReturned_);
  jenv_->PopLocalFrame(NULL);
  return HTC_OK;
}
...
HTC_RetCode HTableClient_JNI::nextCell(HbaseStr &rowId, HbaseStr &colFamName, HbaseStr &colQualName, HbaseStr &colVal,
  ...
  timestamp = p_timestamp_[idx];
  retcode = getColVal(NULL, currentRowCellNum_, (BYTE **)&colVal.val, colVal.len);
  if (retcode != HTC_OK) return retcode;
  currentRowCellNum_++;
  return HTC_OK;
}
...
HTC_RetCode HTableClient_JNI::completeAsyncOperation(Int32 timeout, NABoolean *resultArray, Int16 resultArrayLen) {
  ...
  if (initJNIEnv() != JOI_OK) {
    if (hbs_) hbs_->incMaxHbaseIOTime(hbs_->getHbaseTimer().stop());
    EXIT_FUNCTION(HTC_ERROR_INIT_PARAM);
    return HTC_ERROR_INIT_PARAM;
  }
  ...
  jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_COMPLETE_PUT].methodID, jtimeout, jresultArray);
  ...
  for (int i = 0; i < resultArrayLen; i++) resultArray[i] = returnArray[i];
...
jobjectArray convertToByteArrayObjectArray(const LIST(NAString) & vec) {
  ...
  for (; i < vec.entries(); i++) {
    ...
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(vecLen, jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
...
jobjectArray convertToByteArrayObjectArray(const char **array, int numElements, int elementLen) {
  int i = 0;
  jobjectArray j_objArray = NULL;
  for (i = 0; i < numElements; i++) {
    ...
    jenv_->SetByteArrayRegion(j_obj, 0, elementLen, (const jbyte *)(array[i]));
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(numElements, jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
        jenv_->DeleteLocalRef(j_obj);
        return NULL;
      }
...
jobjectArray convertToStringObjectArray(const TextVec &vec) {
  ...
  int i = 0;
  jobjectArray j_objArray = NULL;
  for (std::vector<Text>::const_iterator it = vec.begin(); it != vec.end(); ++it, i++) {
...
jobjectArray convertToStringObjectArray(const HBASE_NAMELIST &nameList) {
  ...
  for (i = 0; i < listLen; i++) {
    ...
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(listLen, jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
        jenv_->DeleteLocalRef(j_obj);
        return NULL;
      }
...
jobjectArray convertToStringObjectArray(const NAText *textArray, int arrayLen) {
  ...
  for (i = 0; i < arrayLen; i++) {
    ...
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(arrayLen, jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
        jenv_->DeleteLocalRef(j_obj);
        return NULL;
      }
...
jobjectArray convertToStringObjectArray(const set<string> &setOfNames) {
  ...
  for (set<string>::const_iterator it = setOfNames.begin(); it != setOfNames.end(); ++it) {
    ...
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(setOfNames.size(), jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
        jenv_->DeleteLocalRef(j_obj);
        return NULL;
      }
...
jobjectArray convertMapToStringObjectArray(const map<Lng32, char *> &columnNumberToNameMap,
  ...
  for (map<Lng32, char *>::const_iterator it = columnNumberToNameMap.begin(); it != columnNumberToNameMap.end(); ++it) {
    ...
    if (j_objArray == NULL) {
      j_objArray = jenv_->NewObjectArray(columnNumberToNameMap.size(), jenv_->GetObjectClass(j_obj), NULL);
      if (jenv_->ExceptionCheck()) {
        jenv_->DeleteLocalRef(j_obj);
        return NULL;
      }
...
HBC_RetCode HBaseClient_JNI::putData(Int64 eventID, const char *query, int eventType, const char *schemaName,
  ...
  jboolean jresult = jenv_->CallBooleanMethod(javaObj_, JavaMethods_[JM_PUT_SQL_TO_HBASE].methodID, j_tid, js_query,
                                              js_sqltype, js_objNmae, js_sqlparms);
  if (jenv_->ExceptionCheck()) {

...
class PrivMgr
{
  public:
    ...
    static bool isTenantID(int_32 authID){ return CmpSeabaseDDLauth::isTenantID(authID); }
    static bool isUserGroupID(int_32 authID){ return CmpSeabaseDDLauth::isUserGroupID(authID); }
    ...
    static bool isSecurableObject(const ComObjectType objectType)
    {
      return (objectType == COM_BASE_TABLE_OBJECT ||
              ...
              objectType == COM_TRIGGER_OBJECT ||
              objectType == COM_PACKAGE_OBJECT ||
   ...
   static PrivStatus buildPrivText(
    ...
    // -------------------------------------------------------------------
    PrivStatus getEffectiveGrantor(

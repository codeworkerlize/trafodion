...
ValidateUIntForOptimizedScan::ValidateUIntForOptimizedScan()
    : ValidateNumericRange(VALID_UINT, 
          (float)BloomFilterRT::minPackedLength(), (float)UINTmax_
                          ) 
{
}
...
SDDkwd__(ALLOW_DP2_ROW_SAMPLING,               "SYSTEM"),
 ...
 // See binder(BindItemExpr.cpp, SynthType.cpp) for details.
  ...
  DDkwd__(ALLOW_TENANT_RESOURCE_GROUPS,          "ON"),
  DDkwd__(ALLOW_TRUNCATE_IN_USER_XN,          "OFF"),
...
// Precompute statistics in ASM
  ...
  DDint__(AS_AFFINITY_VALUE,                    "-2"),
  DDui___(AS_CYCLIC_ESP_PLACEMENT,              "1"),
  DDui___(AS_FRAGMENT_SIZE_THRESHOLD,           "2"),
  DDkwd__(AS_SHIFT_FULL_FRAGMENTS,              "OFF"),

  DDkwd__(AS_TOLERATE_ILL_DEFINED_TENANTS,      "SYSTEM"),
  DDkwd__(ATTEMPT_ASYNCHRONOUS_ACCESS,		"ON"),
 XDDkwd__(ATTEMPT_ESP_PARALLELISM,		"ON"),
  DDkwd__(ATTEMPT_REVERSE_SYNCHRONOUS_ORDER,    "ON"),

  DDkwd__(AUTOMATIC_RECOMPILATION,		"OFF"),

  DDkwd__(AUTO_ADJUST_CACHEROWS,		"ON"),
 ...
 // see comments in DefaultConstants.h
  ...
  DD_____(BIGTABLE_INSTANCE_ID,                 ""),
  DD_____(BIGTABLE_PROJECT_ID,                  ""),
 ...
 XDDui___(BMO_MEMORY_LIMIT_PER_NODE_IN_MB,	     "10240"),
  DDui___(BMO_MEMORY_LIMIT_UPPER_BOUND,              "800"),
...
// Controls how pathnames for routines/procedures/SPJs are interpreted
  ...
  DDkwd__(COMP_BOOL_206,		"OFF"), // For ROS cardinality
...
//DEF_MAX_HISTORY_ROWS made external RV 06/21/01 CR 10-010425-2440
 ...
 XDDkwd__(DISPLAY_DIVISION_BY_COLUMNS,          "OFF"),
  ...
  //   0 off
  //   2 by run-time stats
  DDui___(DOP_ADJUST,	                        "0"),
  DDkwd__(DOP_ADJUST_DEBUG,		        "OFF"),
  DDflt0_(DOP_ADJUST_MIN_NUM_ESPS_PER_NODE,	"1.0"),
  DDflt0_(DOP_ADJUST_ROWCOUNT_THRESHOLD,	"0.0"),
  DD_____(DOP_ADJUST_RTSTATS_HDFS_PATH,         "/user/trafodion/rtstats" ),
  DD_____(DOP_ADJUST_RTSTATS_LOCAL_FILE,	""),
  DDflt0_(DOP_ADJUST_WORK_UNIT,	                "67108864"),
...
SDDkwd__(EXE_DIAGNOSTIC_EVENTS,		"OFF"),
 ...
 // upper and lower limit (2,10) must be in sync with error values in 
  ...
  DDkwd__(FIND_COLUMN_SUBEXPRS_IN_OR,		"ON"),
 ...
 // WARNING 2997. Predicate will not be actually used in query.
  DDint__(FIRSTN_PREDICATE_SAFETY_FACTOR,         "0"),
 ...
 // is ON for static compiles and OFF for dynamic queries.
  ...
  DDkwd__(GENERATE_USER_QUERYCACHE, "OFF"),
  DDkwd__(GENERATE_USER_QUERYCACHE_AUTOCOMMIT_FILTER, "ON"),
  DDkwd__(GENERATE_USER_QUERYCACHE_DEBUG, "OFF"),
  DD_____(GENERATE_USER_QUERYCACHE_KEYWORD, "ALL"), 
  DD_____(GENERATE_USER_QUERYCACHE_LOG, "NONE"),
  DD0_400000(GENERATE_USER_QUERYCACHE_MAX_FILE_IN_MB, "3900"),
  DD1_1024(GENERATE_USER_QUERYCACHE_MAX_PLANSIZE_IN_MB, "16"),
  DD1_40000(GENERATE_USER_QUERYCACHE_NUM_PRELOAD, "5000"),
  DDkwd__(GENERATE_USER_QUERYCACHE_PRIV_CHECK, "ON"),
  DDkwd__(GENERATE_USER_QUERYCACHE_REPLACE, "OFF"),
 ...
 // Controls use of the hash join min/max optimization.
  ...
  DDkwd__(GROUP_BY_PUSH_BELOW_UNION,            "SYSTEM"),
 ...
 XDDkwd__(HASH_JOINS,				"ON"),
  ...
  DDkwd__(HBASE_ASYNC_OPERATIONS,		"ALL"),
 ...
 DDui1__(HBASE_NUM_CACHE_ROWS_MIN,	"100"),
  ...
  DDkwd__(HBASE_READ_REPLICA,                   "OFF"),
 ...
 DDkwd__(HBASE_SERIALIZATION,		"ON"),
  ...
  DDkwd__(HBASE_SMALL_SCANNER,      "SYSTEM"),
...
//HIST_BASE_REDUCTION and HIST_PREFETCH externalized 08/21/01 CR 10-010713-3895
 ...
 //                             Note that this is really per SeaQuest node
  ...
  DDui___(HIVE_APPLY_LOCALITY_MIN_NODES,         "10"),
  DDui___(HIVE_APPLY_LOCALITY_NODE_RATIO,        "2"),

  DDkwd__(HIVE_ARRAY_INDEX_MODE,	         "OFF"),

  DD_____(HIVE_CATALOG,                          "HIVE"),
  DDkwd__(HIVE_COMPATIBILITY_MODE,               "OFF"),
  ...
  DDint__(HIVE_HDFS_STATS_MAX_SAMPLE_FILES,     "2000"),
 ...
 // such as no permission, wrong file type for table
  DDui___(HIVE_MAX_ERROR_FILES,                  "0"),
 ...
 SDDflte_(HIVE_MEMORY_UNIT_ESP,                 "300"),
  DDint__(HIVE_METADATA_REFRESH_INTERVAL,       "0"),
  DDflt0_(HIVE_MIN_BYTES_PER_ESP_PARTITION,     "67108864"),
  DDflt0_(HIVE_MIN_NUM_ESPS_PER_DATANODE,       "1"),
  DDkwd__(HIVE_NATABLE_CACHE_S3_TABLES,         "OFF"),
  DDkwd__(HIVE_NO_REGISTER_OBJECTS,             "OFF"),
  DDflte_(HIVE_NUM_ESPS_PER_DATANODE,           "8.0"),
  DDpct__(HIVE_NUM_ESPS_ROUND_DEVIATION,        "34"),
  DDkwd__(HIVE_PARTITION_AUTO_CREATE,           "ON"),
  DDkwd__(HIVE_PARTITION_ELIMINATION_CT,        "ON"),
  DDkwd__(HIVE_PARTITION_ELIMINATION_MM,        "ON"),
  DDkwd__(HIVE_PARTITION_ELIMINATION_RT,        "ON"),
  DDkwd__(HIVE_PARTITION_INSERT_DIST_LOCK,      "SYSTEM"),
  DDui___(HIVE_PARTITION_INSERT_REPART,         "0"),
  DDkwd__(HIVE_REPORT_FILESTATS_READ_ET,        "OFF"),
  DDkwd__(HIVE_SCAN_RESOURCES_INCLUSION,        "ON"),
  DDui0_2(HIVE_SCAN_SPECIAL_MODE,                "1"),
  DDkwd__(HIVE_SIMULATE_REAL_NODEMAP,           "OFF"),
  DDkwd__(HIVE_SORT_HDFS_HOSTS,                 "ON"),
  DDkwd__(HIVE_STATS_CACHING,                   "OFF"),
  DDkwd__(HIVE_STRAW_SCAN,                      "OFF"),
  DDint__(HIVE_STRAW_SCAN_MAX_NODES,            "20"),
  DDkwd__(HIVE_SUPPORTS_SUBDIRECTORIES,         "OFF"),
  DDkwd__(HIVE_TIMESTAMP_PRECISION_IN_USEC,     "OFF"),
 ...
 //10-040621-7139-end
  DDflt__(INTERSECT_PUSH_GRBY_RATIO,            "-1.0"),
...
SDDkwd__(ISO_MAPPING,           (char *)SQLCHARSETSTRING_ISO88591),
 ...
 // DF_ token constants (this can be considered either clever or kludgy coding).
  ...
  DDint__(NCM_ESP_FIXUP_WEIGHT,                 "3000"),
  DDkwd__(NCM_ESP_STARTUP_FIX,                  "OFF"),
  ...
  DDflt__(NCM_MP_ORC_SCAN_COST_ADJ_FACTOR,      "1000.00"),
  DDflt__(NCM_MP_PARQUET_SCAN_COST_ADJ_FACTOR,      "1000.00"),
  ...
  DDansi_(NCM_ORC_COSTING_DEBUG_TABLE,          ""),  

  DDkwd__(NCM_PARQUET_COSTING,                      "ON"),  
  DDkwd__(NCM_PARQUET_COSTING_APPLY_SKIP_RATIO,      "OFF"),
  DDkwd__(NCM_PARQUET_COSTING_DEBUG,                "OFF"),  
  DDansi_(NCM_PARQUET_COSTING_DEBUG_TABLE,          ""),  
 ...
 SDDkwd__(OPTIMIZER_PRUNING,			"ON"),
  ...
  DDint__(ORC_METADATA_READ_MAX_FILENUM,        "5"), 
  DDint__(ORC_METADATA_READ_MAX_THREADS,        "1"), 
  DDkwd__(ORC_METADATA_READ_WITH_JAVA_THREADS , "ON"), 
  DDkwd__(ORC_NJS,                              "OFF"),
  // CPS is the abbreviation for "compute probe stats"
  DDkwd__(ORC_NJS_CPS_DEBUG,                    "OFF"),
  DDflt__(ORC_NJS_CPS_MAXCARDINALITY,            "502000"),
  DDansi_(ORC_NJS_CPS_TABLE,                    ""),
  DDflt__(ORC_NJS_CPS_THRESHOLD,                 "-1"),
  DDui___(ORC_NJS_OUTER_TABLES_THRESHOLD,         "1"),
  DDui___(ORC_NJS_PROBES_MAXCARD_FACTOR,         "10"),
  DDint__(ORC_NJS_PROBES_THRESHOLD,             "150"),
  DDkwd__(ORC_PARTITION_ONLY_PUSHDOWN,          "ON"),
  ...
  DDint__(ORC_STATS_MAX_SAMPLE_FILES,           "5000"),
  DDkwd__(ORC_VECTORIZED_SCAN,                  "ON"),
  DDui___(ORC_VECTOR_BATCH_SIZE,                "1024"),

  DDui___(ORC_WRITER_BUFFER_SIZE,               "262144"),
...
// replaced by a target schema
 ...
 // files for which batch read is used. More than limit implies serial read
  DDint__(PARQUET_BATCH_READ_FILESTATS,             "2000"),
  DDkwd__(PARQUET_COLUMNS_PUSHDOWN,                 "ON"),
  ...
  DD_____(PARQUET_HDFS_STATS_LOG_FILE,                ""),
  DDkwd__(PARQUET_IN_SUPPORT,                       "OFF"),
  DDkwd__(PARQUET_LEGACY_TIMESTAMP_FORMAT,          "ON"),
  DDkwd__(PARQUET_METADATA_READ_WITH_JAVA_THREADS , "ON"), 
  DDkwd__(PARQUET_NJS,                              "OFF"),

  // CPS is the abbreviation for "compute probe stats"
  DDkwd__(PARQUET_NJS_CPS_DEBUG,                    "OFF"),
  DDflt__(PARQUET_NJS_CPS_MAXCARDINALITY,            "502000"),
  DDansi_(PARQUET_NJS_CPS_TABLE,                    ""),
  DDflt__(PARQUET_NJS_CPS_THRESHOLD,                 "-1"),
  DDui___(PARQUET_NJS_OUTER_TABLES_THRESHOLD,         "1"),
  DDui___(PARQUET_NJS_PROBES_MAXCARD_FACTOR,         "10"),
  DDint__(PARQUET_NJS_PROBES_THRESHOLD,             "150"),

  DDkwd__(PARQUET_PRED_PUSHDOWN,                    "ON"),
  DDkwd__(PARQUET_READ_NUM_ROWS,                    "ON"),
  DDkwd__(PARQUET_READ_ROWGROUP_INFO,               "ON"),
  DDkwd__(PARQUET_STRINGS_SIGNED_MIN_MAX,           "OFF"),
  ...
  DDint__(PASSWORD_ERROR_COUNT,      "5"),
  DDint__(PASSWORD_LIFE_TIME,        "180"),
...
//PREFERRED_PROBING_ORDER_FOR_NESTED_JOIN made external RV 06/21/01 CR 10-010425-2440
  ...
  DDui___(PRIV_SENTRY_RECHECK_INTERVAL,                 "60"),
  DDkwd__(PRIV_SENTRY_USE_USERNAME_API,                 "ON"),
  DDkwd__(PSHOLD_CLOSE_ON_ROLLBACK,	"OFF"),
  DDkwd__(PSHOLD_UPDATE_BEFORE_FETCH,	"OFF"),
 SDDpsch_(PUBLIC_SCHEMA_NAME, ""),
  DDkwd__(PUSHDOWN_LIMIT_OPT,                                   "OFF"),
 ...
 DD0_255(QUERY_CACHE_SELECTIVITY_ABOSOLUTE, "25"),
 ...
 SDDui___(ROUNDING_MODE,			"0"),
  ...
  DDkwd__(SALT_ON_UPSHIFT_ALLOWED,              "OFF"),
 ...
 SDDkwd__(SHOWCONTROL_SHOW_SUPPORT,		"OFF"),
  ...
  DDkwd__(SHOWDDL_DISPLAY_TENANT_GROUPS,        "OFF"),
  DDkwd__(SHOWWARN_OPT,		"ON"),

 DDkwd__(SHOW_CACHE_KEY,	               "OFF"),
 ...
 XDDflt__(SKEW_SENSITIVITY_THRESHOLD,           "0.1"),
  ...
  //  interbal use only
  DDkwd__(SKIP_CHECK_FOR_TABLE_IB,              "OFF"),
  DDkwd__(SKIP_CONFLICT_CHECK_FOR_INDEX,        "ON"),
  DDkwd__(SKIP_CONFLICT_FOR_NOUPDATE_SCAN,      "ON"),
  DDkwd__(SKIP_QUERY_CACHE,                     "OFF"),
...
XDDkwd__(SUBQUERY_UNNESTING,			"ON"),
 DDkwd__(SUBQUERY_UNNESTING_EARLY_GROUP,	"OFF"),
 ...
 XDDkwd__(TABLELOCK,				"SYSTEM"),
  ...
  DDui___(TENANT_DEFAULT_SIZE,                  "4"),
  DDflt1_(TENANT_OVERSUBSCRIBE_ERR_NODE_RATIO,  "1.0"),
  DDflt1_(TENANT_OVERSUBSCRIBE_WARN_NODE_RATIO, "1.0"),
  ...
  DDkwd__(TRAF_AUTO_REGISTER_GROUP,              "OFF"),
  DDkwd__(TRAF_AUTO_REGISTER_USER,               "OFF"),

  DDkwd__(TRAF_AVRO_AGGR_PUSHDOWN,                    "ON"),
  DDkwd__(TRAF_AVRO_COLUMNS_PUSHDOWN,                 "ON"),
  ...
  DDkwd__(TRAF_ENABLE_DATA_LOAD_IN_CACHE,     "OFF"),   
  DDkwd__(TRAF_ENABLE_DATA_LOAD_IN_SHARED_CACHE,  "OFF"),

  DDkwd__(TRAF_ENABLE_METADATA_LOAD_IN_CACHE,     "OFF"),   
  DDkwd__(TRAF_ENABLE_METADATA_LOAD_IN_SHARED_CACHE,  "OFF"),   
  ...
  DD_____(TRAF_HIVEMD_SCHEMAS,                  ""),
  DDkwd__(TRAF_HIVEMD_SPECIAL_OBJECTNAMETYPE,   "ON"),   
 ...
 //  DDkwd__(TRAF_LOB_VERSION2,        "OFF"),
  ...
  DDui___(TRAF_MAX_COMPOSITE_ARRAY_SIZE,   "250"),
  DDui___(TRAF_MAX_COMPOSITE_LEVELS,       "3"),
 ...
 //  DDint__(TRAF_MAX_TABLES_PER_SELECT,     "120"),
  ...
  DDkwd__(TRAF_OBJECT_LOCK,              "ON"),
  DDui1__(TRAF_OBJECT_LOCK_DDL_DIST_LOCK_TIMEOUT,  "60000"), // in MilliSeconds
  ...
  DDui1__(TRAF_OBJECT_LOCK_DML_RETRY_LIMIT,           "30"),
  DDkwd__(TRAF_OBJECT_LOCK_FORCE,                    "OFF"), // internal use only
  ...
  DDkwd__(TRAF_SEQUENCE_USE_DLOCK,       "OFF"),
  DDkwd__(TRAF_SEQUENCE_USE_DTM,         "OFF"),

  DD_____(TRAF_SET_SEQUENCE_ID,                 ""),
  ...
  DDkwd__(TRAF_TENANT_DROP_MINIMAL,                    "OFF"),
  DDkwd__(TRAF_TENANT_GROUP_CHECK,                     "OFF"),
  ...
  DDkwd__(TRAF_UPDATE_TO_UPSERT,                       "ON"),
  ...
  DDkwd__(TRAF_USE_STORED_STATS,               "ALL"),   
  DDkwd__(TRAF_USTAT_GENERATE_STORED_STATS,    "OFF"),   
 ...
 DDkwd__(UNION_MAP_REDUCTION,			"ON"),
...
// Specify the number of partitions before invoking parallel label operations
 ...
 XDDui1__(USTAT_MIN_ROWCOUNT_FOR_SAMPLE,        "10000"),
  ...
  DDkwd__(USTAT_REQUIRE_DISTRIBUTED_LOCK,       "ON"),   // require a distributed lock on table name for write UPDATE STATS operations
 ...
 XDDflt1_(USTAT_YOULL_LIKELY_BE_SORRY,          "100000000"),  // guard against unintentional long-running UPDATE STATS
  ...
  DDkwd__(WAIT_ON_SELECT_FOR_UPDATE,                   "ON"),
        ...
        case MAX_ESPS_PER_CPU_PER_OP:
           {
              ...
              if ( CURRSTMT_OPTDEFAULTS &&
                   !CURRSTMT_OPTDEFAULTS->canUseAllClusterResources()) 
              {
                 espsPerCore = ActiveSchemaDB()-> getDefaults().
                                 computeNumESPsPerCoreForTenant();
              }
        ...
        case DEF_NUM_BM_CHUNKS:
           {
              UInt32 numChunks = (UInt32)
                  (nac->physicalMemoryAvailableInKB() / def_DEF_CHUNK_SIZE / 4);
  ...
  NABoolean sch = FALSE;
      ...
      else
	{
	  ...
	  if (errNum != -1393    // 1393 equals TRAF_NOT_INITIALIZED
	    ...
	    {
	      LOGERROR(CAT_SQL_CI, "Failed to validate versions, process will exit. ErrNum: %d , ErrStr: %s", 
	               errNum, hbaseErrStr.data());
	      exit(0);
	    }
	}
    }
...
NABoolean NADefaults::isReadonlyAttribute(const char* attrName) const
{
   if ((( stricmp(attrName, "ISO_MAPPING") == 0 ) ||
	...
	( stricmp(attrName, "SORT_ALGO") == 0 ) || 
        ( stricmp(attrName, "MAINTENANCE_WINDOW") == 0 ) ||
...
void NADefaults::setMultiCQDSValue(DefaultConstants attrEnum, NAString &rqoValue, Int32 errOrWarn)
{
  ...
  switch (tk) {
    ...
    case DF_SYSTEM:
    {
      ...
      {
        if (isSynonymOfSYSTEM(rqoGroupArray[i], rqoValue))
          val = getDefaultDefaultValue(rqoGroupArray[i]);
						    ...
						    Provenance overwriteIfNotYet)
{
  ...
  if (attrEnum >= 0) {				// valid attrName
    ...
    case PASSWORD_LIFE_TIME:
    {
        ...
        {
            bool isAuthorization = CmpCommon::context()->isAuthorizationEnabled() && CmpCommon::context()->isAuthorizationReady();
            Int32 adminRole = NA_UserIdDefault;
            CmpSeabaseDDLauth authInfo;
            bool hasPriv = authInfo.verifyAuthority(SQLOperation::MANAGE_PRIVILEGES);//chenge MANAGE_USERS to MANAGE_SECURE
...
float NADefaults::computeNumESPsPerCoreForTenant() 
{
   return computeNumESPsPerCore(NAWNODESET_CORES_PER_SLICE);
}
  ...
  if (tok != DF_noSuchToken)
	...
	*/
    ...
    case TRAF_TABLE_SNAPSHOT_SCAN:
      if (tok  == DF_NONE || tok == DF_SUFFIX || tok == DF_LATEST || tok == DF_FORCE)
        isValid = TRUE;
    break;
    ...
    case TRAF_USE_STORED_STATS:
      if (tok == DF_ON || tok == DF_ALL || tok == DF_OFF|| tok == DF_MINIMUM)
        isValid = TRUE;
      break;
    ...
    case DOP_ADJUST_DEBUG:
      if (tok == DF_FILE || tok == DF_OFF || tok == DF_STDOUT )
        isValid = TRUE;
      break;
    ...
    case TRAF_UPDATE_TO_UPSERT:
      if (tok == DF_ALL || tok == DF_OFF || tok == DF_ON || tok == DF_FORCE)
	isValid = TRUE;
      break;

    case GENERATE_USER_QUERYCACHE:
      if (tok == DF_OFF || tok == DF_ON || tok == DF_PRELOAD)
        isValid = TRUE;
      break;

    case GENERATE_USER_QUERYCACHE_DEBUG:
      //if (tok == DF_OFF || tok == DF_ON || tok == DF_REPLACE || tok == DF_READONLY)
      if (tok == DF_OFF || tok == DF_ON || tok == DF_ALL)
        isValid = TRUE;
      break;
...
bool NADefaults::moduleCheck(const Int32 attrEnum) const
{
  ...
  switch (attrEnum)
  {
    case TRAF_OBJECT_LOCK :
      if (NOT isModuleOpen(LM_DDL_ONLINE))
        ret = -1;
    break;
    default : break;
  }

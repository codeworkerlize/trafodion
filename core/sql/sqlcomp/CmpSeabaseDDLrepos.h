...
static const MDUpgradeInfo allBackupReposInfo[] = {
  ...
  { TRAF_BACKUP_OPERATION_METRICS,  NULL,
    createBackupOperationMetricsTable,  sizeof(createBackupOperationMetricsTable),
    NULL, 0,
    NULL, 0,
    FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE
  },
  ...
  { TRAF_BACKUP_OBJECTS_METRICS,  NULL,
    createBackupObjectsMetricsTable,  sizeof(createBackupObjectsMetricsTable),
    NULL, 0,
    NULL, 0,
    FALSE, NULL, NULL, NULL, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE
  }

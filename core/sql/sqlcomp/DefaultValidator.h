...
public:
  Validate_0_400000()
    : ValidateNumericRange(VALID_UINT, 0, (float)400000) {}
};

class Validate_0_524288 : public ValidateNumericRange
{public:
  Validate_0_524288()
    : ValidateNumericRange(VALID_UINT, 0, (float)524288) {}
};
...
{
public:
  ValidateUIntFrom0To2() 
    : ValidateNumericRange(VALID_UINT, (float)0, (float)2) {}
...
{public:
  Validate_1_8192()
    : ValidateNumericRange(VALID_UINT, 1, (float)8192) {}
};
...
public:
  Validate_1_40000()
    : ValidateNumericRange(VALID_UINT, 1, (float)40000) {}
};

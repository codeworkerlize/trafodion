...
{
public:
   SystemObjectInfoKey(const char* cName,
                 const char* sName,
                 const char* oName,
                 ComObjectType oType = ComObjectType::COM_UNKNOWN_OBJECT,
                 NABoolean cvd = FALSE,
                 NAHeap* heap = NULL) :
       catName(cName, heap),
       schName(sName, heap),
   ...
   {
     return this->catName == other.catName &&
            this->schName == other.schName &&
            this->objName == other.objName &&
            this->objectType == other.objectType &&
            this->checkForValidDef == other.checkForValidDef;
   }
...
typedef NAHashDictionary<SystemObjectInfoKey, SystemObjectInfoValue>  
        SystemObjectInfoHashTableType;
...
{
public:
  UpdateObjRefTimeParam(
     Int64 rt = -1,
     Int64 objUID = -1,
     NABoolean force = FALSE,
     NABoolean genStats = FALSE,
...
public:
  RemoveNATableParam
  (ComQiScope qiScope, NABoolean ddlXns,
...
class CmpSeabaseDDL
{
 ...
 public:
  ...
  static NABoolean isREPOSSchema(const NAString &catName,
			              const NAString &schName);

  static ComBoolean isREPOSSchema(const ComObjectName &name);

  static NABoolean isXDCSchema(const NAString &catName,
			              const NAString &schName);
  ...
  static NABoolean isTrafBackupSchema(
       const NAString &catName,
       const NAString &schName);

  static short isSPSQLPackageRoutine(
  ...
  static short getPartIndexName(ExeCliInterface * cliInterface,
  ...
  static void getPartitionTableName(char* buf, int bufLen,
                                    const NAString &baseTableName,
                                    const NAString &partitionName);

  static void getPartitionIndexName(char* buf, int bufLen,
  ...
  static Int32 modifyObjectEpochCacheStartDDL(ObjectEpochCacheEntryName * name, UInt32 expectedCurrentEpoch, bool readsAllowed);
  ...
  static short ddlResetObjectEpochs(NABoolean doAbort, 
                                    NABoolean clearList, 
                                    ComDiagsArea *diags = NULL);
  short ddlSetObjectEpoch(const NATable *naTable, NAHeap *heap, bool allowReads = false, bool isContinue = false);
  short ddlSetObjectEpoch(const StmtDDLCreateTable *createTableNode,
                          NAHeap *heap,
                          bool allowReads = false,
                          bool isContinue = false);
  short ddlSetObjectEpochHelper(const QualifiedName &qualName,
                                ComObjectType objectType,
                                Int64 objectUID,
                                Int64 redefTime,
                                bool isVolatile,
  ...
  short lockObjectDDL(const QualifiedName &qualName,
		      ComObjectType objectType,
		      bool isVolatile,
		      bool isExternal);
  short lockObjectDDL(const ComObjectName &objectName,
		      ComObjectType objectType,
		      bool isVolatile,
		      bool isExternal);
  short unlockObjectDDL(const QualifiedName &qualName,
                        ComObjectType objectType,
                        bool isVolatile,
                        bool isExternal);
  short lockObjectDDL(const NATable *naTable, NAString &catalogPart,
                      NAString &schemaPart, NABoolean isPartitionV2Table);
...
public:
  ...
  Lng32 tableIsEmpty(const NAString &objName,
                     ExpHbaseInterface * ehi);
  ...
  static NABoolean isSampleExist(const NAString &catName,
                                 const NAString &schName,
  ...
  short dropSample(const NAString &catalogNamePart,
  ...
  short getObjectOwner(ExeCliInterface *cliInterface,
                        ...
                        const char * objType,
                        Int32 * objectOwner);
  short getObjectFlags(ExeCliInterface *cliInterface,
                        const char * catName,
                        const char * schName,
                        const char * objName,
                        const char * objType,
  ...
  short getTrafReplicaNum(ExeCliInterface *cliInterface,
                          const char * catName,
                          const char * schName,
                          const char * objName,
                          const char * inObjType,
  ...
  static NABoolean getOldMDPrivInfo(const PrivMgrTableStruct  &mdti,
                                    const char* &oldName,
                                    const QString* &oldDDL, Lng32 &sizeOfoldDDL);
  ...
  int32_t verifyDDLCreateOperationAuthorized(
     ...
     Int32 & objectOwner,
     Int32 & schemaOwner,
     Int64 * schemaUID = NULL,
     Int64 * schemaObjectFlags = NULL);
  ...
  static Int64 authIDOwnsResources( 
     Int32 authID,
...
Lng32 getIndexInfo(ExeCliInterface &cliInterface,
                              NABoolean includeInvalidDefs,
                              Int64 objUID,
                              Queue * &indexQueue);

  static short getObjectName(
       ExeCliInterface *cliInterface,
       Int64 objUID,
       NAString &catName,
       NAString &schName,
  ...
  short ddlInvalidateNATables(NABoolean isAbort,
                              Int32 processSP = 0,
                              Int64 svptId = 0);
  short deleteFromSharedCache (ExeCliInterface *cliInterface,
                               const NAString objName,
                               ComObjectType objType,
                               NAString cmd);
  short finalizeSharedCache();
  void insertIntoSharedCacheList(const NAString & catName,
                                 const NAString & schName,
                                 const NAString & objName,
                                 ComObjectType objType,
  ...
  short createNamespace(ExpHbaseInterface * ehi, NAString &ns,
...
public:
  ...
  static short createHbaseTable(ExpHbaseInterface *ehi, 
                                HbaseStr *table,
                                ...
                                NABoolean createIfNotExists = FALSE,
...
public:
  static short dropHbaseTable(ExpHbaseInterface *ehi, 
...
protected:
  ...
  short updateSeabaseMDTable(
			     ...
			     const ComTdbVirtTableIndexInfo * indexInfo,
                             Int64 &inUID,
                             NABoolean updPrivs = TRUE);
  short updateSeabaseMDPartition(ExeCliInterface *cliInterface,
  ...
  short updateSeabaseTablePartitions(ExeCliInterface *cliInterface,
                                    Int64 parentUid,
                                    const char* partName,
                                    ...
                                    const char* readonly = NULL,
                                    const char* inMemory = NULL,
                                    Int64 flags = 0);

  short addSeabaseMDPartition(ExeCliInterface* cliInterface,
    ElemDDLPartitionV2* pPartition,
    const char* catName, const char* schName,
    const char* entityName, Int64 btUid, int index, 
    Int64 partUid = -1, const char* partName = NULL);
  ...
  short validatePartitionByExpr(ElemDDLPartitionV2Array *partitionV2Array,
                                TrafDesc *colDescs,
                                TrafDesc *partitionColDescs,
                                Int32 partColCnt,
                                Int32 pLength,
                                NAHashDictionary<NAString, Int32>*
                                partitionNameMap = NULL);

  short validatePartitionRange(ElemDDLPartitionV2Array *partitionV2Array,
                               Int32 colCnt);
  ...
  short populateNgramIndexFromTable(
				      ExeCliInterface * cliInterface,
				      NABoolean uniqueIndex,
				      const NAString &indexName, 
				      const ComObjectName &tableName,
  ...
  int addSchemaObject(
       ...
       NAString namespace1,
       NABoolean rowIdEncrypt,
       NABoolean dataEncrypt,
       NABoolean storedDesc,
  ...
  short isLockedForBR(Int64 objUID, Int64 schUID,
                      ExeCliInterface *cliInterface,
  ...
  short setupAndErrorChecks(NAString &tabName, QualifiedName &origTableName, 
                            ...
                            NABoolean processHiatus = FALSE,
                            NABoolean createHiatusIfNotExist = FALSE);
  
  Lng32 purgedataObjectAfterError(
                                  ExeCliInterface &cliInterface,
                                  const NAString &catName, 
                                  const NAString &schName,
                                  const NAString &objName,
  ...
  void createSeabaseTable(
			  ...
			  NAString &currCatName, NAString &currSchName,
                          ...
                          NABoolean * genStoredDesc = NULL,
                          NABoolean * schemaIncBack= NULL);

  Lng32 createSeabasePartitionTable(ExeCliInterface * cliInterface,
                                    const NAString &partName,
                                    const NAString &currCatName,
                                    const NAString &currSchName,
                                    const NAString &baseTableName);

  Lng32 createSeabasePartitionTableWithInfo(ExeCliInterface * cliInterface,
                                    const NAString &partName,
                                    const NAString &currCatName,
                                    const NAString &currSchName,
                                    const NAString &baseTableName,
  ...
  void createSeabaseTriggers(ExeCliInterface *cliInterface,
			     StmtDDLCreateTrigger * CreateTrigger,
			     NAString &currCatName, NAString &currSchName);

  short dropTriggerFromMDAndSPSQL(ExeCliInterface * cliInterface,
				  ExpHbaseInterface * ehi,
				  NAString &currCatName,
				  NAString &currSchName,
				  const NAString &triggerName,
				  NABoolean ddlXns,
				  Int64 objUID);

  void dropSeabaseTriggers(ExeCliInterface *cliInterface,
			   StmtDDLDropTrigger * DropTrigger,
			   NAString &currCatName,
			   NAString &currSchName);
  
  short checkAndFixupAuthIDs(
                             ExeCliInterface *cliInterface,
                             NABoolean checkOnly,
                             NASet<NAString> &authIDList);

  short setLockError(short retcode);

  short lockRequired(ExpHbaseInterface *ehi,
                     NATable *naTable,
  ...
  short lockRequired(const NATable *naTable,
                     const NAString catalogNamePart,
                     const NAString schemaNamePart,
                     const NAString objectNamePart,
                     HBaseLockMode lockMode,
...
protected:
  ...
  short dropIBAttrForTable(
     const NATable * naTable,
     ExeCliInterface * cliInterface);
  NABoolean isTableHasIBAttr(
    const NATable * naTable,
    ExpHbaseInterface * ehi );

  short addIBAttrForTable(
     const NATable * naTable,
     ExeCliInterface * cliInterface);
  ...
  void dropSeabaseTable(
			StmtDDLDropTable                  * dropTableNode,
			NAString &currCatName, NAString &currSchName);
  Lng32 dropSeabasePartitionTable(ExeCliInterface * cliInterface,
      NAString &currCatName, NAString &currSchName, const NAString &btTableName, NABoolean needCascade = FALSE);
  ...
  Lng32 deleteSeabasePartitionMDData(ExeCliInterface * cliInterface,
      const Int64 tableUID);
  Lng32 updateSeabasePartitionbtMDDataPosition(ExeCliInterface * cliInterface,
      const Int64 partitionUID);
  Lng32 deleteSeabasePartitionbtMDData(ExeCliInterface * cliInterface,
      const Int64 partitionUID);
  ...
  Lng32 createSeabasePartitionIndex(ExeCliInterface * cliInterface,
                                    StmtDDLCreateIndex *createIndexNode,
  ...
  Lng32 dropSeabasePartitionIndex(ExeCliInterface * cliInterface,
                                NAString &currCatName, NAString &currSchName, const NAString &baseIndexName,
                                const char * partitionTableName);

  int populateSeabasePartIndex(
            NABoolean ispopulateForAll, 
            NABoolean isPurgedataSpecified, 
            NABoolean isUnique,
  ...
  void alterSeabaseTableAttribute(
			  ...
			  NAString &currCatName, NAString &currSchName);
  Int32 alterSeabaseIndexAttributes(
                          ExeCliInterface *cliInterface,
                          ParDDLFileAttrsAlterTable &fileAttrs,
                          NATable *naTable,
  ...
  void addConstraints(
       ...
       Int32 unnamedConstrNum,
       NABoolean isCompound = FALSE,
       NABoolean isPartitionV2 = FALSE);

  void alterTablePartition(StmtDDLAlterTablePartition* alterPartition,
    NAString& currCatName, NAString& currSchName);

  void alterTableAddPartition(StmtDDLAlterTableAddPartition* alterAddPartition,
    NAString& currCatName, NAString& currSchName);

  Lng32 unmountSeabasePartitionTable(ExeCliInterface* cliInterface, NAPartition* partInfo,
    NAString& currCatName, NAString& currSchName, NAString& nameSpace, 
    ExpHbaseInterface* ehi, NABoolean ddlXns);

  void alterTableMountPartition(StmtDDLAlterTableMountPartition* alterMountPartition,
    NAString& currCatName, NAString& currSchName);

  void alterTableUnmountPartition(StmtDDLAlterTableUnmountPartition* alterUnmountPartition,
    NAString& currCatName, NAString& currSchName);

  void alterTableMergePartition(StmtDDLAlterTableMergePartition* mergePartition,
    NAString& currCatName, NAString& currSchName);

  void alterTableExchangePartition(StmtDDLAlterTableExchangePartition* exchangePartition,
    NAString& currCatName, NAString& currSchName);
 ...
 short hbaseFormatTableDropColumn(
  ...
  void alterSeabaseTableDropPartition(
       StmtDDLAlterTableDropPartition * alterDropPartition,
       NAString &currCatName, NAString &currSchName);
  ...
  short mdOnlyAlterColumnAttr(
       ...
       NAList<NAString> &viewNameList,
       NAList<NAString> &viewDefnList,
       NABoolean isAlterForSample = FALSE,
  ...
  Lng32 updatePKeysTable(ExeCliInterface *cliInterface,
                         const char* renamedColName,
                         Int64 objectUid,
                         const char* colName,
                         NABoolean isIndexColumn = FALSE);
  ...
  short alterSeabaseIndexStoredDesc(ExeCliInterface &cliInterface,
                                    const NAString &btCatName,
                                    const NAString &btSchName,
                                    const NAString &btObjName,
                                    const NABoolean &enable);

  void alterSeabaseTableResetDDLLock (
       ExeCliInterface *cliInterface,
       StmtDDLAlterTableResetDDLLock * alterResetLock,
       NAString &currCatName, NAString &currSchName);
  ...
  void createSeabasePackage(ExeCliInterface * cliInterface,
                            StmtDDLCreatePackage  * createPackageNode,
                            NAString &currCatName, NAString &currSchName);

  short dropPackageFromMDAndSPSQL(ExeCliInterface * cliInterface,
                                  NAString &currCatName,
                                  NAString &currSchName,
                                  const NAString & routineName,
                                  NABoolean ddlXns);

  void dropSeabasePackage(ExeCliInterface * cliInterface,
                          StmtDDLDropPackage  * dropPackageNode,
                          NAString &currCatName, NAString &currSchName);
  ...
  short createSPSQLRoutine(ExeCliInterface * cliInterface,
			   NAString *quotedSql);

  void dropSeabaseRoutine(StmtDDLDropRoutine  * dropRoutineNode,
                          NAString &currCatName, NAString &currSchName);

  short dropRoutineFromMDAndSPSQL(ExeCliInterface * cliInterface,
                                  ExpHbaseInterface * ehi,
                                  NAString &currCatName,
                                  NAString &currSchName,
                                  const NAString &routineName,
                                  ComRoutineType routineType,
                                  NABoolean ddlXns,
                                  Int64 &objUID);
  ...
  short createSeabaseTenant(
    ExeCliInterface * cliInterface, 
    NABoolean addCompPrivs,
    NABoolean reportNotEnabled);
  short dropSeabaseTenant(ExeCliInterface * cliInterface);
  short getTenantNSList(
    ExeCliInterface *cliInterface,
    NAList<NAString *> *&tenantNSList);
  short getTenantNodeList(
    ExeCliInterface *cliInterface,
    NAList<NAString *> *&tenantNodeList);
  short getTenantSchemaList(
    ExeCliInterface * cliInterface,
    TenantSchemaInfoList *&tenantSchemaList);
  short isTenantMetadataInitialized(ExeCliInterface * cliInterface);
  short isTenantSchema(
    ExeCliInterface * cliInterface,
    const Int64 &schemaUID);
  void registerSeabaseTenant(
    ExeCliInterface * cliInterface,
    StmtDDLTenant *pNode);
  void unregisterSeabaseTenant(
    ExeCliInterface * cliInterface,
    StmtDDLTenant *pNode);
  ...
  void createSeabaseRGroup(
    ExeCliInterface * cliInterface,
    StmtDDLResourceGroup *pNode);
  void alterSeabaseRGroup(
    ExeCliInterface * cliInterface,
    StmtDDLResourceGroup *pNode);
  void dropSeabaseRGroup(
    ExeCliInterface * cliInterface,
    const StmtDDLResourceGroup *pNode);
  // End rgroup commands
  ...
  void grantRevokeSchema( StmtDDLNode                  * stmtDDLNode,
			  NABoolean isGrant,
			  NAString &currCatName, NAString &currSchName);
  
  void dropSeabaseSchema(StmtDDLDropSchema * dropSchemaNode);
  bool dropOneTable(ExeCliInterface & cliInterface,
                    const char * catalogName,
  ...
  Lng32 alterSchemaTableDesc (ExeCliInterface *cliInterface,
 ...
 void dropNativeHbaseTable(
  ...
  short recreateHbaseTable(const NAString &catalogNamePart, 
                           const NAString &schemaNamePart, 
                           const NAString &objectNamePart,
                           NATable * naTable,
                           ExpHbaseInterface * ehi);
  ...
  void alterSeabaseTableSplitPartition(StmtDDLAlterTableSplitPartition* alterTableSplitPartNode,
                                                    NAString &currCatName,
                                                    NAString &currSchName);

  short updateTablePartitionsPartitionName(ExeCliInterface * cliInterface,
                                                      NAString &currCatName,
                                                      NAString &currSchName,
                                                      NAString &oldPtNm,
                                                      NAString &newPtNm,
  ...
  NABoolean isExistsPartitionName(ExeCliInterface *cliInterface,
                                  const NAString& currCatName,
                                  const NAString& currSchName,
...
public:
  ...
  static NAString genHBaseObjName(const NAString &catName, 
                                  const NAString &schName,
                                  const NAString &objName,
                                  const NAString &nameSpace,
                                  Int64 dataUID = 0);
...
protected:
  ...
  short updateBackupOperationMetrics(RelBackupRestore * brExpr, 
                                     ExeCliInterface * cliInterface,
                                     Int64 operStartTime,
                                     Int64 operEndTime);
  short updateBackupObjectsMetrics(RelBackupRestore * brExpr, 
                                   ExeCliInterface * cliInterface);
  ...
  void processBackupRepository(NABoolean createR, 
                               NABoolean dropR, NABoolean upgradeR);
  ...
  TrafDesc * getTrafBackupMDTableDesc(const NAString &catName, 
                                      const NAString &schName, 
                                      const NAString &objName);
  ...
  TrafDesc * getSeabaseSchemaDesc(const NAString &catName,
                                  const NAString &schName,
  ...
  Lng32 createNATableFromStoredDesc(NATableDB* natDB,
                                    BindWA &bindWA,
                                    PreloadInfo &info,
                                    NABoolean doNotReloadIfExists);

  Lng32 createNATableForSystemObjects(BindWA &bindWA,
                                      NAString &catName,
                                      NAString &schName,
                                      NAString &objName,
                                      NABoolean isIndex,
  ...
  Lng32 generatePreloadInfoForUserTables(QualifiedName &inSchName,
                                      ExeCliInterface &cliInterface,
                                      NAList<PreloadInfo>& userTables,
                                      NAList<PreloadInfo>& statsTables);

  Lng32 loadTrafSystemMetadataInCache(CmpContext* metaContext,
                                      NABoolean doNotReloadIfExists);

  Lng32 loadTrafMDSystemTableIntoCache(NAString& tableName, 
                                       CmpContext* context, 
                                       NABoolean doNotReloadIfExists);

  Lng32 loadTrafUserMetadataInCache(CmpContext* cmpContext,
                                    NAList<PreloadInfo>& tables,
                                    NABoolean doNotReloadIfExists);

  Lng32 loadTrafMetadataInCache(QualifiedName &schName);

  void generateQueryToFetchUserTableDescriptors(
         QualifiedName &inSchNam, char* buffer, Lng32 bufLen);

  Lng32 loadTrafMetadataIntoSharedCache(QualifiedName &schName,
                                        NABoolean loadLocalIfEmpty,
                                        CmpDDLwithStatusInfo* dws = NULL);

  Lng32 loadTrafDataIntoSharedCache(QualifiedName &schName, NABoolean loadLocalIfEmpty, CmpDDLwithStatusInfo* dws = NULL);

  void generateQueryToFetchOneTableDescriptor(
          const QualifiedName &tableName, char* buffer, Lng32 bufLen);
  
  Lng32 updateTrafMetadataSharedCacheForTable(const QualifiedName& tatbleName,
                                              NABoolean insertOnly,
                                              NABoolean errorAsWarning);
  Lng32 checkTrafMetadataSharedCacheForTable(const QualifiedName& tableName,
                                             CmpDDLwithStatusInfo* dws);
  Lng32 checkTrafMetadataSharedCacheForSchema(const QualifiedName& schemaName,
                                             CmpDDLwithStatusInfo* dws);
  Lng32 checkTrafMetadataSharedCacheAll(CmpDDLwithStatusInfo* dws);

  
  Lng32 
  alterSharedDescCache(StmtDDLAlterSharedCache* ascNode,
                   CmpDDLwithStatusInfo* dws = NULL);

  Lng32 updateTrafDataSharedCacheForTable(
                                          const vector<pair<QualifiedName, int>> &tables,
                                          NABoolean insert,
                                          NABoolean errorAsWarning);
  Lng32 checkTrafDataSharedCacheForTable(const QualifiedName &tableName,
                                         CmpDDLwithStatusInfo *dws);
  Lng32 checkTrafDataSharedCacheForSchema(const QualifiedName &schemaName,
                                          CmpDDLwithStatusInfo *dws);
  ...
  short updateColAndKeyInfo
  (const NAColumn * keyCol, 
   CollIndex i,
   NABoolean alignedFormat,
   NAString &defaultColFam,
   short nonKeyColType,
   short ordering,
   const char * colNameSuffix,
   ComTdbVirtTableColumnInfo * colInfoEntry,
   ComTdbVirtTableKeyInfo * keyInfoEntry,
   Lng32 &keyLength,
   NAMemory * heap);
  
  short createIndexColAndKeyInfoArrays(
				       ElemDDLColRefArray & indexColRefArray,
                                       ElemDDLColRefArray & addnlColRefArray,
				       NABoolean isUnique,
  ...
  Lng32 getSeabasePartitionV2Info(ExeCliInterface *cliInterface,
                                  Int64 btUid,
                                  ComTdbVirtTablePartitionV2Info** outPartionV2InfoArray);

  Lng32 getSeabasePartitionBoundaryInfo(ExeCliInterface *cliInterface,
                                  Int64 btUid,
                                  ComTdbVirtTablePartitionV2Info** outPartionV2InfoArray);

  NABoolean compareDDLs(ExeCliInterface *cliInterface,
                          NATable * naTabA,
                          NATable * naTabB,
                          NABoolean ignoreClusteringKey = FALSE,
                          NABoolean ignoreSaltUsing = FALSE,
...
protected:
  ...
  short validateInputNames(ExeCliInterface * cliInterface,
                           RelBackupRestore * brExpr,
                           NABoolean validateObjects,
                           NAString &currCatName, NAString &currSchName);

  short genObjectsToBackup(RelBackupRestore * brExpr,
                           NAString &objUIDsWherePred,
                           ExeCliInterface * cliInterface,
                           CmpDDLwithStatusInfo * dws);
  short genObjectsToRestore(RelBackupRestore * brExpr,
                            NAArray<HbaseStr>* mdList,
                            NAString &objUIDsWherePred,
                            ExeCliInterface * cliInterface,
                            CmpDDLwithStatusInfo * dws);

  short processBRShowObjects(RelBackupRestore * brExpr,
                             NAArray<HbaseStr>* mdList,
                             NAString &objUIDsWherePred,
                             ExeCliInterface * cliInterface,
                             CmpDDLwithStatusInfo * dws);
  
  short createBackupMDschema(RelBackupRestore * ddlExpr,
                             ExeCliInterface * cliInterface,
                             NAString &backupSch,
                             const char* oper);
  
  short truncateBackupMD(NAString &backupSch,
                         ExeCliInterface * cliInterface);
  
  short invalidateTgtObjects(ExeCliInterface * cliInterface,
                             char * objUIDsWherePred,
                             char * tgtSch,
                             char * srcSch,
                             SharedCacheDDLInfoList &sharedCacheList);
  
  short deleteTgtObjectsFromMD(RelBackupRestore *brExpr,
                               ExeCliInterface * cliInterface,
                               NAString &objUIDsWherePred,
                               char * tgtSch, char * tgtSch2,
                               char * srcSch);
  
  short cleanupTgtObjectsFromMD(ExeCliInterface * cliInterface,
                                char * objUIDsWherePred,
                                char * srcSch);

  short copyBRSrcToTgtBasic(RelBackupRestore *brExpr,
                            ExeCliInterface * cliInterface,
  ...
  short copyBRSrcToTgt(RelBackupRestore *brExpr,
                       ExeCliInterface * cliInterface,
                       const char * objUIDsWherePred,
                       const char * srcSch1, const char * srcSch2, 
                       const char * tgtSch1, const char * tgtSch2,
  ...
  short backupSystem(RelBackupRestore * ddlExpr, ExeCliInterface * cliInterface,
                     CmpDDLwithStatusInfo *dws);
  
  short backupHistStats(ExeCliInterface * cliInterface,
                        ElemDDLList * tableList,
                        char * backupSch);

  short restoreHistStats(ExeCliInterface * cliInterface,
                         char * backupSch);
  
  short createProgressTable(ExeCliInterface * cliInterface);

  short deleteFromProgressTable(ExeCliInterface * cliInterface,
                                RelBackupRestore *brExpr,
                                const char * oper);

  short insertProgressTable(ExeCliInterface * cliInterface,
                            RelBackupRestore *brExpr,
                            const char * oper,
                            const char *stepText,
                            const char *state,
  ...
  Int32 getBREIOperCount(ExeCliInterface * cliInterface,
                         const char * oper,
                         const char * tag);
  ...
  short updateProgressTable(ExeCliInterface * cliInterface,
  ...
  short getProgressStatus(RelBackupRestore * brExpr, 
                          ExeCliInterface * cliInterface, 
                          CmpDDLwithStatusInfo *dws);

  // regular or incremental backup of subset of objects (schemas or tables)
  short backupSubset(RelBackupRestore * ddlExpr, ExeCliInterface * cliInterface,
                     NAString &currCatName, NAString &currSchName,
                     CmpDDLwithStatusInfo *dws);

  short createSnapshotForIncrBackup(ExeCliInterface * cliInterface,
                                    const NABoolean incrBackupEnabled,
  ...
  short setHiatus(const NAString &hiatusObjectName,
                  NABoolean resetHiatus,
                  NABoolean createSnapIfNotExist = FALSE,
                  NABoolean ignoreSnapIfNotExist = FALSE);

  // restore all or subset of objects  
  short restore(RelBackupRestore * ddlExpr, 
                ExeCliInterface * cliInterface,
                NAString &currCatName, NAString &currSchName,
                CmpDDLwithStatusInfo *dws);
  
  short restoreSystem(RelBackupRestore* brExpr, 
                      ExeCliInterface * cliInterface,
                      NAString &currCatName, NAString &currSchName,
                      CmpDDLwithStatusInfo *dws,
                      ExpHbaseInterface *ehi,
  ...
  short restoreSubset(RelBackupRestore* brExpr, 
                      ExeCliInterface * cliInterface,
                      NAString &currCatName, NAString &currSchName,
                      CmpDDLwithStatusInfo *dws,
                      ExpHbaseInterface * ehi,
  ...
  short returnObjectsList(ExeCliInterface * cliInterface,
                          const char * objUIDsWherePred,
                          char * srcSch,
                          NAArray<HbaseStr>* &objectsList);
  
  short showBRObjects(RelBackupRestore *brExpr,
  ...
  short deleteSnapshot(ExpHbaseInterface *ehi,
                       const char * oper,
                       const char *backupTag,
                       NABoolean ifExists,
  ...
  short dropBackupMD(RelBackupRestore * ddlExpr,
                     ExeCliInterface * cliInterface,
                     NABoolean checkPrivs = TRUE);
  short dropBackupTags(RelBackupRestore * ddlExpr, ExeCliInterface * cliInterface);
  short getBackupMD(RelBackupRestore * ddlExpr, 
                    ExeCliInterface * cliInterface,
                    CmpDDLwithStatusInfo *dws);                    

  short getBackupTags(RelBackupRestore * ddlExpr, 
                      ExeCliInterface * cliInterface,
                      CmpDDLwithStatusInfo *dws);                    
  
  short getVersionOfBackup(RelBackupRestore * ddlExpr,
                           ExeCliInterface *cliInterface,
                           CmpDDLwithStatusInfo *dws);

  short exportOrImportBackup(RelBackupRestore * ddlExpr, 
                             ExeCliInterface * cliInterface);

  short getBackupSnapshots(RelBackupRestore * ddlExpr, 
                           ExeCliInterface * cliInterface,
                           CmpDDLwithStatusInfo *dws);
  ...
  short checkIfBackupMDisLocked(RelBackupRestore * brExpr,
                                ExeCliInterface * cliInterface,
                                const char * inOper,
                                NAString &oper, NAString &tag);

  short checkIfObjectsLockedInMD(ExeCliInterface * cliInterface,
                                 char * objUIDsWherePred,
                                 char * srcSch,
  ...
  short isTruncateTableLockedInMD(ExeCliInterface * cliInterface,
                                 NAString &lockedObjs);

  Lng32 isBRInProgress(ExeCliInterface *cliInterface,
                       const char *catalogName,
                       const char *schemaName,
                       const char *objectName,
                       Int64 &objUid);

  short lockObjectsInMD(ExeCliInterface * cliInterface,
                        const char * oper,
                        char * objUIDsWherePred,
                        char * srcSch,
                        char * backupTag,
  ...
  short lockBackupMD(RelBackupRestore * brExpr,
                     ExeCliInterface * cliInterface,
                     const char * oper,
                     NABoolean override);

  short unlockBackupMD(RelBackupRestore * brExpr,
                       ExeCliInterface * cliInterface,
                       const char * oper);

  short unlockObjectsInMD(ExeCliInterface * cliInterface,
                          char * objUIDsWherePred,
                          char * srcSch,
                          NABoolean schemasOnlyBackup);

  short getBackupLockedObjects(RelBackupRestore * ddlExpr, 
                               ExeCliInterface * cliInterface,
                               CmpDDLwithStatusInfo *dws);                    

  short cleanupLockedObjects(RelBackupRestore * brExpr, 
                             ExeCliInterface * cliInterface);

  short cleanupLockForTag(RelBackupRestore * brExpr, 
                          ExeCliInterface * cliInterface,
                          ExpHbaseInterface * ehi);

  short createBackupTags(RelBackupRestore * brExpr, 
                         ExeCliInterface * cliInterface);

  short createNamespacesForRestore(RelBackupRestore* brExpr, 
                                   std::vector<std::string> *schemaListTV,
                                   std::vector<std::string> *tableListTV,
                                   NABoolean createrReservedNS,
                                   ExpHbaseInterface * ehi,
                                   Int32 restoreThreads);

  short cleanupBackupMetadata(ExeCliInterface *cliInterface,
                              NAString &backupTag);

  short cleanupLinkedBackupMD(ExeCliInterface * cliInterface,
                              NAArray<HbaseStr>* backupList);

  short genLobLocation(Int64 objUID,
                       const char *schName,
                       ExeCliInterface * cliInterface,
                       //TextVec &lobLocList,
                       std::vector<std::string> &lobLocList,
                       Int32 &numLOBfiles,
                       NABoolean forDisplay);

  short genLobObjs(ElemDDLList * tableList,
                   char * srcSch,
                   ExeCliInterface * cliInterface,
                   Queue* &lobsQueue,
                   NAString &lobObjs);

  short genIndexObjs(ElemDDLList * tableList,
                     char * srcSch,
                     ExeCliInterface * cliInterface,
                     Queue* &indexesQueue,
                     NAString &indexesObjs);

  short genReferencedObjs(ElemDDLList * tableList,
                          char * srcSch,
                          ExeCliInterface * cliInterface,
                          Queue* &refsQueue,
                          NAString &refsObjs);

  short genLibsUsedProcs(NAString libsToBackup,
                         NAString &libsUsedProcs,
                         ExeCliInterface * cliInterface);
  
  short genProcsUsedLibs(NAString procsToBackup,
                         NAString &procsUsedLibs,
                         ExeCliInterface * cliInterface);
  
  short genListOfObjs(ElemDDLList * objList,
                      NAString &objsToBackup,
                      NABoolean &prependOR,
                      NAString *schPrivsList);

  short genBRObjUIDsWherePred(RelBackupRestore *brExpr,
  ...
  short populateDiags(const char * oper, const char * errMsg,
                      const char * string0, const char * string1,
                      int retcode);
  
  NABoolean containsTagInSnapshotList(
  ...
  NABoolean getTimeStampFromSnapshotList(
       NAArray<HbaseStr>* snapshotList,
       char * brExprTag,
       char * timeStamp,
       ComDiagsArea** diagsArea);

  short checkCompatibility(BackupAttrList *attrList,
                           NAString &errorMsg);

  short getExtendedAttributes(ExpHbaseInterface * ehi,
                              const char * backupTag,
  ...
  short getUsersAndRoles(ExeCliInterface * cliInterface,
                         const char * objUIDsWherePred,
                         const char * srcSch,
                         Lng32 &numUR,
                         NAString &userOrRoles);
  short checkUsersAndRoles(ExeCliInterface * cliInterface,
                           const char * userOrRoles,
                           NAString &lackedUR,
                           std::map<Int32, NAString> &userMap);

  short verifyBRAuthority (const char *privsWherePred,
                           ExeCliInterface *cliInterface,
                           NABoolean checkShowPrivilege,
                           NABoolean isBackup,
                           const char *schToUse,
                           const NABoolean checkSpecificPrivs = FALSE,
                           const char *owner = NULL);

  short checkBackupAuthIDs(ExeCliInterface *cliInterface);

  short fixBackupAuthIDs(ExeCliInterface *cliInterface,
  ...
  short dumpMetadataOfObjects(RelDumpLoad * ddlExpr
                                    , ExeCliInterface *cliInterface);

  short loadMetadataOfObjects(RelDumpLoad * ddlExpr
                                    , ExeCliInterface *cliInterface);

  
  short generateStoredStats(
       Int64 tableUID,
       Int64 objDataUID,
       const NAString &catName, 
       const NAString &schName, 
  ...
  short genLobChunksTableName(ExeCliInterface *cliInterface,
                              const char *catName, 
                              const char *schName,
                              const char *objName, 
  ...
  Lng32 lockTruncateTable(
        ExeCliInterface *cliInterface,
        Int64 objUid);
  Lng32 unlockTruncateTable(
        ExeCliInterface *cliInterface,
        Int64 objUid);
  ...
  static void setCacheAndStoredDescOp(UInt32 &op,
                                      UInt32 bitOp)
  {
    op |= bitOp;
  }

  static void resetCacheAndStoredDescOp(UInt32 &op,
                                        UInt32 bitOp)
  {
    op &= ~bitOp;
  }

  static NABoolean isCacheAndStoredDescOpSet(UInt32 op,
                                             UInt32 bitOp)
  {
    return (op & bitOp) != 0;
  }

  Lng32 updateCachesAndStoredDesc(
        ExeCliInterface *cliInterface,
        const NAString &catName,
        const NAString &schName,
        const NAString &objName,
  ...
  Lng32 updateCachesAndStoredDescByNATable(
        ExeCliInterface *cliInterface,
        const NAString &catName,
        const NAString &schName,
        const NAString &objName,
  ...
  Lng32 checkPartition(ElemDDLPartitionNameAndForValuesArray * partArray,
                           TableDesc * tableDesc,
                           BindWA & bindWA,
                           NAString & objectName,
                           NAString & invalidPartName, /* out */

...
int64_t PrivMgrComponents::getUniqueID()
{
   ...
   if (maxValue < USER_COMPONENT_START_UID)
     return USER_COMPONENT_START_UID;
   return ++maxValue;
   
}
//******************** End of PrivMgrComponents::getUniqueID *******************

bool PrivMgrComponents::isReservedComponent(
  const std::string &componentName)
{
   ...
   
{
   ...
   {
      *pDiags_ << DgSqlCode(-CAT_NOT_ALLOWED_FOR_SYSTEM_OBJECT)

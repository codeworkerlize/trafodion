...
short CmpSeabaseDDL::initTrafMD(CmpDDLwithStatusInfo *dws)
{
              ...
              case 1:
                {
                  ...
                  if (errNum == -1409) // namespace upgrade needed.
                    {
                      ...
                      *CmpCommon::diags() << DgSqlCode(3242)
                                          << DgString0("Namespace cannot be upgraded.");
                      setValuesInDWS(dws, IT_FAILED, 
                                     "Version Check: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);
                  ...
                  setValuesInDWS(dws, IT_RSRVD_NAMESPACES, 
        ...
        case IT_RSRVD_NAMESPACES:
          {
            switch (dws->subStep())
              ...
              case 0:
                {
                  setValuesInDWS(dws, IT_NO_CHANGE,
                                 "Create Reserved Namespaces: Started", 1, FALSE,
                                 TRUE, FALSE, FALSE);
                  return 0;
                }
                break;
              ...
              case 1:
                {
                  ...
                  if (dropCreateReservedNamespaces(ehi, TRUE, TRUE))
                    {
                      setValuesInDWS(dws, IT_STEP_FAILED,
                                     "Create Reserved Namespaces: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);
                  ...
                  setValuesInDWS(dws, IT_TDDL_TRUNCATE,
                                 "Create Reserved Namespaces: Completed", 0, TRUE,
                                 FALSE, TRUE, TRUE);
                  ...
                  for (Lng32 i = 0; i < numTables; i++)
                    {
                      ...
                      NAString hbaseObjectStr = genHBaseObjName(
                           NAString(sysCat), NAString(SEABASE_MD_SCHEMA), 
                           NAString(mdti.newName), nameSpace);
              ...
              case 1:
                {
                  ...
                  setValuesInDWS(dws,
                                 (dws->getMinimalInitTraf() ? IT_CREATE_MD_VIEWS : IT_CREATE_XDC_MD_TABLES),
                                 "Create Metadata Tables: Completed",
                                 0, TRUE,
                                 FALSE, TRUE, TRUE);
        ...
        case IT_CREATE_XDC_MD_TABLES:
          {
            switch (dws->subStep())
              ...
              case 0:
                {
                  setValuesInDWS(dws, IT_NO_CHANGE,
                                 "Create XDC Metadata Tables: Started", 1, FALSE,
                                 TRUE, FALSE, FALSE);
                  return 0;
                }
                break;
              ...
              case 1:
                {
                  ...
                  if (createXDCMeta(&cliInterface))
                    {
                      setValuesInDWS(dws, IT_STEP_FAILED,
                                     "Create XDC Metadata Tables: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);
                  ...
                  setValuesInDWS(dws, IT_CREATE_MD_PART_TABLES,
                                 "Create XDC Metadata Tables: Completed", 
                                 0, TRUE,
                                 FALSE, TRUE, TRUE);
        ...
        case IT_CREATE_MD_PART_TABLES:
          {
            switch (dws->subStep())
              ...
              case 0:
                {
                  setValuesInDWS(dws, IT_NO_CHANGE,
                                 "Create Metadata Partition Tables: Started", 1, FALSE,
                                 TRUE, FALSE, FALSE);
                  return 0;
                }
                break;
              ...
              case 1:
                {
                  ...
                  if (createMDPartTables(&cliInterface))
                    {
                      setValuesInDWS(dws, IT_STEP_FAILED,
                                     "Create Metadata Partition Tables: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);
                  ...
                  setValuesInDWS(dws, IT_CREATE_MD_VIEWS,
                                 "Create Metadata Partition Tables: Completed", 
                                 0, TRUE,
                                 FALSE, TRUE, TRUE);
              ...
              case 1:
                {
                  ...
                  //   IT_DONE
                  setValuesInDWS(dws,
                                 (dws->getMinimalInitTraf() ? IT_DONE : IT_CREATE_LIBRARIES),
 ...
 const char* sysCat = 
                  ...
                  NAString installJar("trafodion-sql-currversion.jar");
                   ...
                   // update library info
                  Int64 libUID;
                  if (updateSeabaseMDLibrary(&cliInterface, sysCat, SEABASE_MD_SCHEMA, 
                    ...
                    {
                      setValuesInDWS(dws, IT_STEP_FAILED,
                                     "Update Libraries Tables: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);                      
                  ...
                  setValuesInDWS(dws, IT_CREATE_SCHEMA_OBJECTS,
                                 "Create Libraries Tables: Completed",
                                 0, TRUE,
                                 FALSE, TRUE, TRUE);
                  return 0;
                } // case 1
              ...
              case 1:
                {
                  ...
                  setValuesInDWS(dws, IT_CREATE_REPOS,
              ...
              case 1:
                {
                  ...
                  setValuesInDWS(dws, IT_CREATE_BACKUP_REPOS,
        ...
        case IT_CREATE_BACKUP_REPOS:
          {
            ...
            switch (dws->subStep())
              ...
              case 0:
                {
                  setValuesInDWS(dws, IT_NO_CHANGE,
                                 "Create Backup Repository Tables: Started", 1, FALSE,
                                 TRUE, FALSE, FALSE);
              ...
              case 1:
                {
                  ...
                  if (createBackupRepos(&cliInterface))
                    {
                      setValuesInDWS(dws, IT_STEP_FAILED,
                                     "Create Backup Repository Tables: Failed", 0, TRUE,
                                     FALSE, TRUE, TRUE);
                      return 0;
                    }

                  setValuesInDWS(dws, IT_CREATE_TENANT,
                                 "Create Backup Repository Tables: Completed", 0, TRUE,
                                 FALSE, TRUE, TRUE);
              ...
              case 1:
                {
                  ...
                  setValuesInDWS(dws, IT_CREATE_LIBMGR,
                                 "Create Tenant: Completed", 0, TRUE,
                                 FALSE, TRUE, TRUE);
...
short CmpSeabaseDDL::createOrDropLobMD (ExeCliInterface *cliInterface,
                                        NABoolean isCreate)
{
  Lng32 cliRC = 0;
  ...
  if (isCreate && beginXnIfNotInProgress(cliInterface, xnWasStartedHere))
    goto label_return;
  
  str_sprintf(queryBuf, "%s.\"%s\"",
  ...
  if (isCreate)
    ...
    {
      str_sprintf(queryBuf, "cleanup table %s.\"%s\".%s",

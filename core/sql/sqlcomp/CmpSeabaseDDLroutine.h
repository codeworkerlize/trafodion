...
static const QString seabaseCallSPSQLTriggerInfo[] =
{
  ...
  {"  EXTERNAL NAME 'org.trafodion.sql.udr.spsql.SPSQL.callSPSQLTrigger(java.lang.String, int, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String,int, java.lang.String, int, java.lang.String, int)' "},
  {"  EXTERNAL SECURITY DEFINER "},
  {"  LIBRARY %s.\"%s\".%s "},
  {"  LANGUAGE JAVA "},
  {"  PARAMETER STYLE JAVA "},
...
static const LibmgrRoutineInfo allLibmgrRoutineInfo[] = {
  ...
  {"PROCEDURE",
   SYSTEM_PROC_HOTCOLD_CLEANUP,
   seabaseProcHotcold_cleanupDDL,
   sizeof(seabaseProcHotcold_cleanupDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },

  {"PROCEDURE",
   SYSTEM_PROC_HOTCOLD_CREATE,
   seabaseProcHotcold_createDDL,
   sizeof(seabaseProcHotcold_createDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },

  {"PROCEDURE",
   SYSTEM_PROC_HOTCOLD_CREATE_ADVANCED,
   seabaseProcHotcold_create_advancedDDL,
   sizeof(seabaseProcHotcold_create_advancedDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },

  {"PROCEDURE",
   SYSTEM_PROC_HOTCOLD_MOVETOCOLD,
   seabaseProcHotcold_movetocoldDDL,
   sizeof(seabaseProcHotcold_movetocoldDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },
  ...
  {"FUNCTION",
   SYSTEM_TMUDF_JDBC_CONFIG,
   seabaseTMUDFJDBCCONFIGDDL,
   sizeof(seabaseTMUDFJDBCCONFIGDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },

  {"FUNCTION",
   SYSTEM_TMUDF_BINLOG_READER,
   seabaseTMUDFBINLOGREADERDDL,
   sizeof(seabaseTMUDFBINLOGREADERDDL),
   LibmgrRoutineInfo::JAVA_LIB,
   LibmgrRoutineInfo::LIBMGR_ROLE
  },

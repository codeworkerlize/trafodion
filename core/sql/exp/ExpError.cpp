			     ...
			     const char * stringParam3)
{
  ...
  if (gEnableRowLevelLock && ((intParam1 != NULL) &&
                              (*intParam1 == -HBASE_LOCK_TIME_OUT_ERROR ||
                               *intParam1 == -HBASE_LOCK_ROLLBACK_ERROR ||
                               *intParam1 == -HBASE_DEAD_LOCK_ERROR ||
                               *intParam1 == -HBASE_RPC_TIME_OUT_ERROR ||
                               *intParam1 == -HBASE_CANCEL_OPERATION ||
                               *intParam1 == -HBASE_LOCK_REGION_MOVE_ERROR ||
                               *intParam1 == -HBASE_LOCK_REGION_SPLIT_ERROR ||
                               *intParam1 == -HBASE_LOCK_NOT_ENOUGH_RESOURCE))) {
    return *diagsArea;
  }

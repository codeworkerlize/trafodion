                                                       ...
                                                       Attributes * attr2)
{
  ...
  if (cs)
	  ...
	  (attr2->getDatatype() == REC_BYTE_F_ASCII))
	{
      ...
      else if ((attr1->getDatatype() == REC_BYTE_F_ASCII &&
                attr2->getDatatype() == REC_BYTE_V_ASCII))
        {
      ...
      else if ((attr1->getDatatype() == REC_BYTE_V_ASCII &&
                attr2->getDatatype() == REC_BYTE_F_ASCII))
        {
...
ex_expr::exp_return_type ExFunctionRangeOfValues::fixup(Space * space,
					     CollHeap * exHeap,
					     char * constantsArea,
					     char * tempsArea,
					     char * persistentArea,
					     ...
					     NABoolean spaceCompOnly) 
{
  rangeOfValues_ = ( nativeByteOrder_ ) ? 
          new (exHeap) NativeBloomFilterRT(totalSizeCap_, exHeap)
                     :

                          ...
                          Int32 port)
{
  ...
  err = ExLobsOper((char*)"dummy",
		   ...
		   NULL, dummyParam2, 0, dummyParam, 
                   dummyParam, dummyParam, dummyParam, dummyParam, status, cliError,
		   NULL, NULL, Lob_Outline,
		   NULL, 0, 
		   0,NULL,
		   Lob_Init,
		   Lob_None,
	                    ...
	                    int    blockSize)
{
  ...
  err = ExLobsOper(lobName,
		   ...
		   NULL, dummyParam2, 0, dummyParam, 
                   dummyParam, dummyParam, dummyParam, dummyParam, status, cliError, 
		   lobLoc, NULL, (ComLobsStorageType)lobType, //Lob_Outline,
		   NULL, 0,
		   0,NULL,
		   Lob_Create,
		   Lob_None,
			       ...
			       Lng32 lobHdfsPort)
{
  ...
  ComLobsStorageType ls = (ComLobsStorageType)lobType;
  ...
  ComLobsStorageType ls = (ComLobsStorageType)lobType;
    ...
    err = ExLobsOper(tgtLobName, 
		   ...
		   inDescSyskey, outDescSyskey, 
                   retOperLen,dummyParam,
		   lobHdfsDataOffset, dummyParam,
                   status, ce,
                   lobStorageLocation, NULL, ls, //Lob_Outline,
				 ...
				 )
{
  ...
  err = ExLobsOper(tgtLobName, 
		   ...
		   lobHdfsServer, lobHdfsPort,
                   ...
                   dummyParam, dummyParam,
                   status,cliError,
                   lobStorageLocation, srcLobStorageLocation, 
                   ls, //Lob_Outline,
		   lobData, lobLen, //ExLobsOper::source,sourceLen
		   0,NULL,
		   Lob_InsSel, 
		   so,
                   dummyParam,
				  ...
				  )
{
  ...
  err = ExLobsOper(tgtLobName, 
		   ...
		   tgtDescSyskey, dummyParam, operLen,
                   ...
                   lobStorageLocation, NULL, Lob_Outline,

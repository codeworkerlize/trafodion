...
ex_expr::exp_return_type ex_comp_clause::processResult(Int32 compare_code, Lng32 *result, CollHeap *heap,
...
ex_expr::exp_return_type ex_comp_clause::eval(char *op_data[], CollHeap *heap, ComDiagsArea **diagsArea) {
  ...
  switch (getInstruction()) {
    ...
    case LT_BIN64U_BIN64S:
      *(Lng32 *)op_data[0] = ((*(Int64 *)op_data[2] < 0) ? 0 : (*(UInt64 *)op_data[1] < *(Int64 *)op_data[2]));
      break;

    case LT_BIN64S_BIN64U:
      *(Lng32 *)op_data[0] = ((*(Int64 *)op_data[1] < 0) ? 1 : (*(Int64 *)op_data[1] < *(UInt64 *)op_data[2]));
      break;
    ...
    case GT_BIN64U_BIN64S:
      *(Lng32 *)op_data[0] = ((*(Int64 *)op_data[2] < 0) ? 1 : (*(UInt64 *)op_data[1] > *(Int64 *)op_data[2]));
      break;

    case GT_BIN64S_BIN64U:
      *(Lng32 *)op_data[0] = ((*(Int64 *)op_data[1] < 0) ? 0 : (*(Int64 *)op_data[1] > *(UInt64 *)op_data[2]));
      break;
    ...
    case NE_ASCII_COMP: {
      ...
      retcode = processResult(compare_code, (Lng32 *)op_data[0], heap, diagsArea);
      break;
    }
    ...
    case COMP_COMPLEX:
      *(Lng32 *)op_data[0] = ((ComplexType *)getOperand(1))->comp(getOperType(), getOperand(2), op_data);
      break;
  ...
  if ((getRollupColumnNum() >= 0) && (*(Lng32 *)op_data[0] == 0) && (getExeGlobals())) {
    getExeGlobals()->setRollupColumnNum(getRollupColumnNum());
  }

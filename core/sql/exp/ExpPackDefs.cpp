...
Long ExFunctionMaxBytes::pack(void * space_)
{
  return packClause(space_, sizeof(ExFunctionMaxBytes));
}
...
Long ExRegexpReplace::pack(void * space_)
{
  return packClause(space_, sizeof(ExRegexpReplace));
}

Long ExRegexpSubstrOrCount::pack(void * space_)
{
  return packClause(space_, sizeof(ExRegexpSubstrOrCount));
}
...
Long ex_function_numberformat::pack(void * space_)
{
  return packClause(space_, sizeof(ex_function_numberformat));
}
...
Long ex_function_monthsbetween::pack(void * space_)
{
  return packClause(space_, sizeof(ex_function_monthsbetween));
}
...
Long ex_function_ansi_tenant::pack(void * space_)
{
  return packClause(space_, sizeof(ex_function_ansi_tenant));
}
...
{
  return packClause(space_, sizeof(ex_function_firstngram));
}

Long ex_function_ngramcount::pack(void * space_)
{
  return packClause(space_, sizeof(ex_function_ngramcount));
}  
...
Long ExFunctionRangeOfValues::pack(void * space)
{
  return packClause(space, sizeof(ExFunctionRangeOfValues));
}
...
Lng32 ExFunctionRangeOfValues::unpack(void *base, void * reallocator)
{
  return unpackClause(base, reallocator);
}

Long ex_function_beginkey::pack(void *space_)
{
  return packClause(space_, sizeof(ex_function_beginkey));
}

Long ex_function_endkey::pack(void *space_)
{
  return packClause(space_, sizeof(ex_function_endkey));
}

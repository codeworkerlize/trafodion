...
void atp_struct::dump(ostream& out, const char* title, Int32 idx, ex_cri_desc* cri)
{
   ...
   for (Int32 i=start; i<=end; i++ ) {
      ...
      if ( desc )
        out << "Tupp[" << i << "]: allocatedSize=" << tup.getAllocatedSize() << endl;
...
void atp_struct::dump(const char* title, Int32 idx, ex_cri_desc* cri)
{
   dump(cout, title, idx, cri);
}
...
void 
atp_struct::dumpMinMaxTupp(const char* title, Int32 idx, ex_cri_desc* cri)
{
...
void 
atp_struct::dumpMinMaxTupp2Log(logLevel level, const char* title, Int32 idx, ex_cri_desc* cri)
{

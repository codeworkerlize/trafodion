...
ex_expr::exp_return_type ex_expr::evalClauses(ex_clause *clause,
					      ...
					      char * fetchedDataPtr
                                              ...
                                              ,Int32 clauseToDisplay
                                              ,Int32 operandToDisplay
#endif
                                             )
{
  ...
  while (clause)
	   ...
	   i++, op++, opdata++, nulldata++, vardata++)
	{
      ...
      if (diagsArea && (diagsArea != atp1->getDiagsArea()))
	atp1->setDiagsArea(diagsArea);
					    ...
					    ULng32 *rowLen)
{
  ...
  while(1) {
    ...
    **/
	...
	retCode = alignAndEval(clause, opDataData, atp1, atp2, atp3,
                               getHeap(), &diagsArea);
	      ...
	      if (seed < 1)
                {
                  ...
                  QRLogger::log(CAT_SQL_EX_SPLIT_BOTTOM,
                    LL_DEBUG,
                    "ex_expr::evalPCode(): updated seed=%d\n", seed);
...
ex_expr::exp_return_type ex_clause::eval(char * /*op_data*/[],
                                         atp_struct*, atp_struct*, atp_struct*,
					 CollHeap*,
					 ComDiagsArea**)
{
  // default eval method does nothing and returns OK

...
void ex_expr_lean::displayContents(Space *space, short mode, const char *displayStr, ULng32 flag) {
  char buf[200];
...
void AggrExpr::displayContents(Space *space, short mode, const char *displayStr, ULng32 flag) {
  char buf[100];

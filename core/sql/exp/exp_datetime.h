...
public:
  ...
  { 
    ...
    DATETIME_FORMAT_EXTRA_FF,   // Fractional seconds,Use the numbers 1 to 9 after FF to specify the number of digits in the fractional second portion of the datetime value returned.
 ...
 short computeLastDayOfMonth(rec_datetime_field startField,
                             rec_datetime_field endField,
  ...
  static short compDatetimes(const char *datetimeOpData1,
...
static   
  short convAsciiDatetimeToUtcOrLocal(char *srcData,
                                      Lng32 srcLen,
                                      char *dstData,
                                      Lng32 dstLen,
                                      Int64 gmtDiff,
  ...
  {
    if (0 == strlen(formatStr))
      return DATETIME_FORMAT_NULL;

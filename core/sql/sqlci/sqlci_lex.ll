...
[Dd][Ee][Ss][Cc]                       return_IDENT_or_TOKEN(DESC, 0);
[Dd][Ee][Ss][Cc][Rr][Ii][Bb][Ee]       return_IDENT_or_TOKEN(DESCRIBE, 0);
...
[Dd][Uu][Mm][Pp]                       return_IDENT_or_TOKEN(DUMP, 0);
...
[Ee][Xx][Pp][Oo][Rr][Tt]               return_IDENT_or_TOKEN(EXPORTtoken, 0);
...
[Ii][Mm][Pp][Oo][Rr][Tt]               return_IDENT_or_TOKEN(IMPORTtoken, 0);
...
[Ss][Uu][Bb][Ee][Rr][Rr][Oo][Rr]                   return_IDENT_or_TOKEN(SUBERRORtoken, 0);
[Hh][Bb][Aa][Ss][Ee]                   return_IDENT_or_TOKEN(HBASEtoken, 0);
[Tt][Mm]                       return_IDENT_or_TOKEN(TMtoken, 0);
...
[Ss][Hh][Oo][Ww][Ee][Nn][Vv]           return_IDENT_or_TOKEN(SHOWENV, 0);
...
[Ss][Hh][Oo][Ww][Ii][Nn][Ff][Oo]       return_IDENT_or_TOKEN(SHOWINFO, 0);
...
[Ee][Xx][Ee][Cc]        	       return_IDENT_or_TOKEN(EXECUTEtoken, 0);
...
[Cc][Hh][Ee][Cc][Kk]                   return_IDENT_or_TOKEN(CHECK, 0);
...
[Tt][Ee][Nn][Aa][Nn][Tt]                 return_IDENT_or_TOKEN(TENANTtoken, 0);
[Ss][Aa][Vv][Ee][Pp][Oo][Ii][Nn][Tt]   return_IDENT_or_TOKEN(TOK_SAVEPOINT, 0);
[Rr][Ee][Ll][Ee][Aa][Ss][Ee]           return_IDENT_or_TOKEN(TOK_RELEASE, 0);

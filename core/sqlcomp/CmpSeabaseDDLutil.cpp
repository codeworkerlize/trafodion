...
//
const literalAndEnumStruct RowFormatXlateArray[] = {{COM_UNKNOWN_FORMAT_TYPE, COM_UNKNOWN_FORMAT_LIT},
                                                    {COM_ALIGNED_FORMAT_TYPE, COM_ALIGNED_FORMAT_LIT},
                                                    {COM_HBASE_FORMAT_TYPE, COM_HBASE_FORMAT_LIT},
                                                    {COM_HBASE_STR_FORMAT_TYPE, COM_HBASE_STR_FORMAT_LIT}};
...
const literalAndEnumStruct ColumnDefaultClassXlateArray[] = {
    ...
    {COM_SYS_GUID_FUNCTION_DEFAULT, COM_SYS_GUID_FUNCTION_DEFAULT_LIT}};
...
const literalAndEnumStruct SequenceGeneratorTypeXlateArray[] = {
    ...
    {COM_SYSTEM_SG, COM_SYSTEM_SG_LIT},
...
const literalAndEnumStruct IdClassXlateArray[] = {{COM_ROLE_CLASS, COM_ROLE_CLASS_LIT},
                                                  ...
                                                  {COM_TENANT_CLASS, COM_TENANT_CLASS_LIT},

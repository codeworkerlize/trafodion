...
static short udr_codegen(Generator *generator, RelExpr &relExpr, ComTdbUdr *&newTdb, const RoutineDesc *rdesc,
  ...
  // for details)
  // @TODO there are two potential bugs:
  //  1. the number of java function parameters (count by its signature) may
  //     exceed 255 (too much [Ljava/sql/ResultSet; padding);
  //  2. in the ky10.aarch64 environment, the stack addresses of &inColumns

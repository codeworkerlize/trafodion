...
#define  RES_EXTENSION_REBALANCE 0
#define  RES_EXTENSION_RESTART 1
#define  RES_EXTENSION_DISABLE 2
#define  RES_EXTENSION_RESTORE 3
#define  RES_EXTENSION_ENTERMXOTIMESTAMP 4
#define  RES_EXTENSION_ENTERENGINETIMESTAMP 5
#define  RES_EXTENSION_LEAVEENGINETIMESTAMP 6
#define  RES_EXTENSION_LEAVEMXOTIMESTAMP 7
// add new extension here
#define  RES_EXTENSION_NUM  8  //  If a new extension is added, increase the value of num


// Add the extension of the PREPARE response, please add each item in order
//  |---optNum---|--optType1---|---optVal1---|--optType2---|---optVal2---|......
#define  RES_PREPARE_EXTENSION_NUM 3
#define  RES_PREPARE_EXTENSION_ESPS 0
#define  RES_PREPARE_EXTENSION_QIDLEN 1
#define  RES_PREPARE_EXTENSION_QID 2

...
// This macro returns the original error if there was an error for lob api.
#define HANDLE_ERROR3(x, y) \
    {\
        if (x != 0) \
        {\
            if (x < 0) \
...
SQLRETURN BuildSQLDesc2(SRVR_STMT_HDL *pSrvrStmt,
                        SQLDESC_ID *pDesc,
						Int32 sqlQueryType,
						Int32 maxRowsetSize,
...
SQLRETURN BuildSQLDesc2withRowsets(SRVR_STMT_HDL *pSrvrStmt,
						SQLDESC_ID *pDesc,
						Int32 sqlQueryType,
						Int32 maxRowsetSize,
						bool &sqlBulkFetchPossible,

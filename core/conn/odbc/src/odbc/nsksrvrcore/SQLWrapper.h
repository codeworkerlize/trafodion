...
Int32 WSQL_EXEC_CancelOperation (Int64 transid);
...
Int32 WSQL_EXEC_SetClientInfo(
        /*IN*/ const char       *value,
        /*IN*/ int              length,
        /*IN OPTIONAL*/         const char *characterset = NULL);

Int32 WSQL_EXEC_GetTransactionId(
       /*OUT*/ Int64*     trans_id);

Int32 WSQL_EXEC_GetStatementHeapSize(
      /*IN*/ SQLSTMT_ID *statement_id,
      /*OUT*/ Int64* heapSize);

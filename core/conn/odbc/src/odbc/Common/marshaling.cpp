...
void IDL_int64_copy(IDL_int64* pname, char*& curptr)
{
	memcpy(curptr, pname, sizeof(IDL_int64));
	curptr += sizeof(IDL_int64);
}
...
void IDL_boolean_copy(IDL_boolean* pname, char*& curptr)
{
    memcpy(curptr, pname, sizeof(IDL_boolean));
    curptr += sizeof(IDL_boolean);
}

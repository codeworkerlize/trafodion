...
public class PythonInterface
{
   ...
   public void openConnection(String userName, String password, String serverName, String portNumber, String dsnName)
   {
		...
		String tenantName = "";
	    openConnection(userName, password, roleName, serverName, portNumber, dsnName, tenantName );   
   }
   
   public void openConnection(String userName, String password,String roleName, String serverName, String portNumber, String dsnName, String tenantName)
   {
      try
      {

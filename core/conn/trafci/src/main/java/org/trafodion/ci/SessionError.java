...
public interface SessionError
{
    ...
    //More Warnings
    ErrorObject DESCRIBE_MESSAGES_NOT_FOUND = new ErrorObject("29563", "Describe messages not found.", 'D');
    ErrorObject DESCRIBE_PSTMT_IS_EMPTY = new ErrorObject("29564", "DESCRIBE pStmt is empty.", 'D');
}

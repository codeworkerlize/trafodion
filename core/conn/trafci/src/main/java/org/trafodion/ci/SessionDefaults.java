...
public interface SessionDefaults {
   ...
   final int TENANT_INVALID=-29194;
   ...
   final int SET_IGNORECOMMENTS = iqKeyWordBase + 160;
   final int SHOW_IGNORECOMMENTS = iqKeyWordBase + 161;
   final int SHOW_CLIENTINFO = iqKeyWordBase + 162;
   ...
   final int SET_TRAFDES=dbqKeyBase+9;
   final int SET_CLIENTINFO=dbqKeyBase+10;

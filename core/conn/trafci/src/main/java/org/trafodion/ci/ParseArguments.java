...
public class ParseArguments
{
   ...
   **-------------------------------------------------------------------------------*/
      ...
      throws InvalidNumberOfArguments, IOException, UserInterruption
   {
      ...
      if (!noConnectOption && tenantName == null)
      {
    	  tenantName = System.getProperty("t4jdbc.tenantName");
    	  if(tenantName == null)
    		  tenantName = "";
    		  //tenantName=getRequiredArg("Tenant Name : ");
          //System.setProperty("t4jdbc.tenantName", tenantName);
      }
   ...
   private void printUsage()
   {
      ...
      cwObj.println("\t-t[enant]   specifies the tenant name associated with the user. This only take effect when multi-tenancy enable");
   ...
   **------------------------------------------------------------------*/
   ...
   public String[] rebuildArgList(String[] oldArgs)
   {
      ...
      if (this.userName == null || this.password == null || this.tenantName ==null)
      {
         argKey1 = "-u";
         argKey2 = "-p";
         argKey3 = "-user";

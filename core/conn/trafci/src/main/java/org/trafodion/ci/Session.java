...
public class Session extends RepObjInterface
{
   ...
   private String sessionTenant=null;
   ...
   private boolean sessionIgnoreComments = true;
   ...
   //control trafci show message details 
   private boolean trafDetails = true;
   ...
   private Properties clientInfoProp = null;
...
static {
   ...
   Session(String sessionUser,   String sessionPass, String sessionRole ,String sessionServer, String sessionPort,
      String sessionDsn, String sessionTenant, ConsoleReader crObj, ConsoleWriter cwObj)
   {
   ...
   public void setSessionTenant(String sessionTenant){
	   this.sessionTenant = sessionTenant;
	   this.setNewPrompt();
   }
   ...
   public boolean isSessionIgnoreComments() {
       return sessionIgnoreComments;
   }

   public void setSessionIgnoreComments(boolean sessionIgnoreComments) {
       this.sessionIgnoreComments = sessionIgnoreComments;
   }
...
*/
        ...
        try
            {
                ...
                stmt.executeUpdate("CONTROL QUERY DEFAULTS TRAF_BINARY_SUPPORT 'ON', TRAF_BINARY_INPUT 'ON', TRAF_BINARY_OUTPUT 'ON';");
		stmt.close();
            } catch (Exception se)
            {
  ...
  protected void setUnsignedCQDs()
    {
        try
            {
                Statement stmt = this.connObj.createStatement();
                stmt.executeUpdate("CONTROL QUERY DEFAULTS TRAF_LARGEINT_UNSIGNED_IO 'ON';");
		stmt.close();
            } catch (Exception se)
            {
                System.out.println("error:"+se.getMessage());
  ...
  protected void setBooleanCQDs()
    {
        try
            {
                Statement stmt = this.connObj.createStatement();
                stmt.executeUpdate("CONTROL QUERY DEFAULTS TRAF_BOOLEAN_IO 'ON';");
		stmt.close();
            } catch (Exception se)
            {
                System.out.println("error:"+se.getMessage());
  ...
  protected void setTinyintCQDs()
    {
        try
            {
                Statement stmt = this.connObj.createStatement();
                stmt.executeUpdate("CONTROL QUERY DEFAULTS TRAF_TINYINT_SUPPORT 'ON', TRAF_TINYINT_RETURN_VALUES 'ON', TRAF_TINYINT_INPUT_PARAMS 'ON';");
		stmt.close();
            } catch (Exception se)
            {
                System.out.println("error:"+se.getMessage());
    ...
    protected void setLobHandleCQD()
    {
        try
            {
                Statement stmt = this.connObj.createStatement();
                stmt.executeUpdate("CONTROL QUERY DEFAULTS TRAF_RETURN_LOB_HANDLE_WITHOUT_INLINE_DATA 'ON';");
		stmt.close();
            } catch (Exception se)
            {
                System.out.println("error:"+se.getMessage());
    ...
    protected void setTrafciCQD()
    {
        try
            {
                Statement stmt = this.connObj.createStatement();
                stmt.executeUpdate("CONTROL QUERY DEFAULT IS_TRAFCI 'ON';");
		stmt.close();
            } catch (Exception se)
            {
                System.out.println("error:"+se.getMessage());
  ...
  public void setTempSessionRole(String tempSessionRole) {
   ...
   {	   
    ...
    public boolean isTrafDetails() {
        return trafDetails;
    }

    public void setTrafDetails(boolean trafDetails) {
        this.trafDetails = trafDetails;
    }

    public void setClientInfoProp(String key, String value){
	    if(clientInfoProp == null){
	        clientInfoProp = new Properties();
        }
        clientInfoProp.setProperty(key, value);
    }

    public String getClientInfoProp(String key){
	    return clientInfoProp == null ? null : clientInfoProp.getProperty(key);
    }
}

...
sed 's/\#\#TRAFCI_PYTHON_CLASSPATH\#\#/\${MY_SQROOT}\/export\/lib\/jdbcT4-${TRAFODION_VER}.jar:\${MY_SQROOT}\/trafci\/lib\/trafci.jar:/g' trafci.py > lnxplatform.py
mv -f lnxplatform.py $TEMPSRC/trafci.py
...
$CP $TEMPSRC/trafci.sh trafci.cmd trafci.pl $TEMPSRC/trafci.py trafci-perl.pl trafci-python.py ciencr.sh trafci $INSTALL_BINDIR

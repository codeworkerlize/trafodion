...
#define CLI_ExecFetch(statement_id, input_descriptor, num_ptr_pairs) SQL_EXEC_ExecFetch(statement_id, input_descriptor, num_ptr_pairs, 0)
...
#define CLI_ExecDirect(statement_id, sql_source, input_descriptor, num_ptr_pairs) SQL_EXEC_ExecDirect(statement_id, sql_source, input_descriptor, num_ptr_pairs, 0)
#define CLI_Exec(statement_id, input_descriptor, num_ptr_pairs) SQL_EXEC_Exec(statement_id, input_descriptor, num_ptr_pairs, 0)
...
#define CLI_Fetch(statement_id, output_descriptor, num_ptr_pairs) SQL_EXEC_Fetch(statement_id, output_descriptor, num_ptr_pairs, 0)
...
#define CLI_ClearExecFetchClose(statement_id, input_descriptor, output_descriptor, num_input_ptr_pairs, num_output_ptr_pairs, num_total_ptr_pairs) SQL_EXEC_ClearExecFetchClose(statement_id, input_descriptor, output_descriptor, num_input_ptr_pairs, num_output_ptr_pairs, num_total_ptr_pairs, 0)

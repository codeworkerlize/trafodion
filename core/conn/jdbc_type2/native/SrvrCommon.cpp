...
int initSqlCore(int argc, char *argv[])
{
    ...
    gDescItems[16].item_id = SQLDESC_LOB_INLINE_DATA_MAXLEN;
    gDescItems[17].item_id = SQLDESC_LOB_CHUNK_MAXLEN;
...
)
{
    ...
    *stmtId = (long)pSrvrStmt;
    ...
    char    TypeString[] = " (VALUES ("
        ...
        "('VARCHAR', 12, 4194304, '''', '''', 'max length', 1, 1, 3, NULL, 0, NULL, 'VARCHAR', NULL, NULL, 'VARCHAR', 65, NULL, -1, -1, 12, NULL, NULL, 0, 0, 3, 0), "
...
"FOR READ UNCOMMITTED ACCESS ORDER BY 1;",
        ...
        case SQL_API_SQLGETTYPEINFO :
         ...
         " from "
         " %s "
        " ORDER BY 2,1 FOR READ UNCOMMITTED ACCESS;", TypeString);
            break;
        ...
        "FOR READ UNCOMMITTED ACCESS order by 1, 2, 3, co.COLUMN_NUMBER ; ",
                                tableParam[0], TypeString, schcriteria, tblcriteria, colcriteria , inputParam[0]);
                    }
                    break;

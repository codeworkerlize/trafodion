...
const char *CliDebugSqlTypeCode(int code)
{
	...
	switch (code)
	{
		...
		case SQLTYPECODE_LARGEINT:
			return("SQLTYPECODE_LARGEINT_UNSIGNED");
										...
										const char *filename, unsigned long line)
{
	...
	long rc = SQL_EXEC_ExecFetch(statement_id, input_descriptor, num_ptr_pairs, 0);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
...
long CliDebug_SwitchContext(SQLCTX_HANDLE context_handle, SQLCTX_HANDLE * prev_context_handle,									    const char *filename, unsigned long line)
{
										 ...
										 const char *filename, unsigned long line)
{
	...
	long rc = SQL_EXEC_ExecDirect(statement_id, sql_source, input_descriptor, num_ptr_pairs, 0);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
								   ...
								   const char *filename, unsigned long line)
{
	...
	long rc = SQL_EXEC_Exec(statement_id, input_descriptor, num_ptr_pairs, 0);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
									...
									const char *filename, unsigned long line)
{
	...
	long rc = SQL_EXEC_Fetch(statement_id, output_descriptor, num_ptr_pairs, 0);

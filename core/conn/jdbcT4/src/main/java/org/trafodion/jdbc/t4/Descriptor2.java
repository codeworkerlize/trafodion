...
class Descriptor2 {
    ...
    public Descriptor2(LogicalByteArray buf, InterfaceConnection ic)
        ...
        // for the lobV2 the headingName_ will have the colName which is lob column name in sql
        // eg: create table lob_tbl(a int , bbb blob); insert into lob_tbl values (?,?);
        // the second placeholder will have the value BBB for headingName_
        ...
        // for new version that changes the col desc
        lobInlineMaxLen_ = buf.extractInt();
        lobChunkMaxLen_ = buf.extractInt();
    }
}

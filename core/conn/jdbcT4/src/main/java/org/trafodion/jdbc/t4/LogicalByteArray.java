	...
	long extractLong() {
		...
		if (swap) {
			value = ((array[loc]) & 0x00000000000000ffL) | ((array[loc + 1] << 8) & 0x000000000000ff00L)
					...
					| (((long)array[loc + 4] << 32) & 0x000000ff00000000L) | (((long) array[loc + 5] << 40) & 0x0000ff0000000000L)
					| (((long)array[loc + 6] << 48) & 0x00ff000000000000L) | (((long)array[loc + 7] << 56) & 0xff00000000000000L);
		} else {
			value = ((array[loc + 7]) & 0x00000000000000ffL) | ((array[loc + 6] << 8) & 0x000000000000ff00L)
					...
					| (((long)array[loc + 3] << 32) & 0x000000ff00000000L) | (((long)array[loc + 2] << 40) & 0x0000ff0000000000L)
					| (((long)array[loc + 1] << 48) & 0x00ff000000000000L) | (((long)array[loc] << 56) & 0xff00000000000000L);
		}

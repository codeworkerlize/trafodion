...
class odbc_SQLSvc_ExtractLob_exc_ {
    ...
    static final int odbc_SQLSvc_ExtractLob_EndOfData_exn_ = 100;
    ...
    void extractFromByteArray(LogicalByteArray buffer1, InterfaceConnection ic)
        ...
        switch (exception_nr) {
            ...
            case odbc_SQLSvc_ExtractLob_EndOfData_exn_:
                break;
            ...
            case odbc_SQLSvc_ExtractLob_ParamError_exn_:
                ...
                throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_program_error", ParamError,
                        ic.getTargetServer());

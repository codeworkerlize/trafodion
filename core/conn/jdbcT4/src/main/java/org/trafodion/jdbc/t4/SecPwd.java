...
public class SecPwd {
    static HashMap<Connection, SecPwd> storage = new HashMap<Connection, SecPwd> ();
      ...
      * @return SecPwd
      */
    public static SecPwd getInstance(Connection con, String directory, String fileName, String serverName,
            boolean spjMode, byte[] procInfo) throws SecurityException {
        if (con == null)
        ...
        // TODO The ProcessId in ConnReply may be different in the same conn. So cache by conn is not a good idea.
        // it will be a good idea to cache the encrypted str.
//        if (secpwd == null) {
//            storage.put(con, secpwd);
//        }

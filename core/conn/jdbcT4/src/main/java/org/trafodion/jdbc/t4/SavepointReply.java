...
class SavepointReply {
    odbc_SQLSvc_Savepoint_exc_ m_p1;
    ERROR_DESC_LIST_def m_p2;

    SavepointReply(LogicalByteArray buf, String addr, InterfaceConnection ic) throws CharacterCodingException,
        UnsupportedCharsetException, SQLException {
            buf.setLocation(Header.sizeOf());
            m_p1 = new odbc_SQLSvc_Savepoint_exc_();

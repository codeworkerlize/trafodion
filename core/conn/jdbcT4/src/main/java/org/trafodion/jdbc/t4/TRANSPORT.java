...
class TRANSPORT {
	...
	//CFGDRVR
	static final short AS_API_DCSMXOKEEPALIVE = AS_API_GETOBJREF + 1; // OK
	//CFGDRVR
	static final short AS_API_ACTIVE_MASTER = AS_API_DCSMXOKEEPALIVE + 1; // OK
	// NSKDRVR/CFGDRVR
    ...
    static final short SRVR_API_SAVEPOINT = 3032;
    static final short SRVR_API_TORESTORE = 3033;

	static final short SQL_ATTR_ROWSET_RECOVERY = 2000;
    static final short SQL_ATTR_CLIPVARCHAR = 2001;
    static final short SQL_ATTR_TRANSACTION_TYPE = 2002;
    ...
    // XATTRS 
    static final int XATTRS_SET_CLIPVARCHAR = 0;
    static final int XATTRS_TEST = XATTRS_SET_CLIPVARCHAR+1;
    static final int XATTRS_SESSION_DEBUG  = XATTRS_TEST +1;
	static final int XATTRS_NUM = XATTRS_SESSION_DEBUG+1;

    // Add the extension of the response, please add each item in order
    // |---optNum---|--optType1---|---optVal1---|--optType2---|---optVal2---|......
    //
    static final int RES_EXTENSION_REBALANCE = 0;
    // add new extension here
    static final int RES_EXTENSION_RESTART = 1; 
    static final int RES_EXTENSION_DISABLE = 2;
    static final int RES_EXTENSION_RESTORE = 3;
    static final int RES_EXTENSION_ENTERMXOTIMESTAMP = 4;
    static final int RES_EXTENSION_ENTERENGINETIMESTAMP = 5;
    static final int RES_EXTENSION_LEAVEENGINETIMESTAMP = 6;
    static final int RES_EXTENSION_LEAVEMXOTIMESTAMP = 7;

    // Add the extension of the response, please add each item in order
    // |---optNum---|--optType1---|---optVal1---|--optType2---|---optVal2---|......
    //

    static final int RES_PREPARE_EXTENSION_ESPS = 0; //  If a new extension is added, increase the value of num


    // exeucte api
    static final int NORMAL = 0;
    static final int EXECUTEQUERY = 1;

    static final int RMS_LIMIT_SQL_CODE = 30048;

    static final short TRACE_PREPARE_TIME = 0;
    static final short TRACE_EXECUTE_TIME = 1;
    static final short TRACE_EXECUTEDIRECT_TIME = 2;
    static final short TRACE_EXECUTEBATCH_TIME = 3;
    static final short TRACE_ENDTRANSACTION_TIME = 4;

    static final String ACTIVE_MASTER_REPLY_ERROR = "ACTIVE_MASTER_REPLY_API_ERROR";
} // end class TRANSPORT

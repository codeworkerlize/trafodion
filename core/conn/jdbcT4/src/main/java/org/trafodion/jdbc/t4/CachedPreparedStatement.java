...
public class CachedPreparedStatement {
    ...
    private final static org.slf4j.Logger LOG =
            LoggerFactory.getLogger(CachedPreparedStatement.class);
    ...
    protected long getNoOfTimesUsed() {
    ...
    protected long prepareTimeMills() {
        return pstmt_.getPrepareTimeMills();
    }
    protected long notUsedTimeMills() {
        return System.currentTimeMillis() - lastUsedTime_;
    }
}

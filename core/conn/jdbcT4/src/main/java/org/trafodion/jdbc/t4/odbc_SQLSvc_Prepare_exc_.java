...
class odbc_SQLSvc_Prepare_exc_ {
	...
	void extractFromByteArray(LogicalByteArray buf, String addr, InterfaceConnection ic) throws SQLException,
		...
		case odbc_SQLSvc_Prepare_SQLQueryCancelled_exn_:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_s1_008");
		...
		case odbc_SQLSvc_Prepare_ParamError_exn_:
			...
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_program_error", sqlError, addr);
		case odbc_SQLSvc_Prepare_InvalidConnection_exn_:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_08_s01");
		case odbc_SQLSvc_Prepare_TransactionError_exn_:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_transaction_error", returnCode, addr);
		default:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_unknown_reply_error", returnCode);
		}
	}
    ...
    public String toString() {
        ...
        if (sqlError != null) {
            sb.append(", sql error = ").append(sqlError);
        }
        return sb.toString();
    }
}

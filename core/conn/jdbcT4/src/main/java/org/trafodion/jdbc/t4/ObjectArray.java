...
class ObjectArray implements Cloneable {
    ...
    ObjectArray(int arraySize) {
        ...
        arrayElements_ = new BitSet(arraySize);
    }
    ...
    /**
     * get the updated element of the given index
     *
    ...
    /**
     * get the raw element of the given index
     *
     * @param idx the first parameter is 1, the second is 2, ...
     * @return
     */
    protected Object getRawArrayElement(int idx) {
        return objectArray_[idx - 1];
    }
    ...
    protected void refreshArrayElement(int idx, Object obj) {
        objectArray_[idx - 1] = obj;
        arrayElements_.clear(idx - 1);
    }

    protected void backArrayElement() {
        for (int i = 0; i < getSize(); i++) {
            updatedArray_[i] = null;
            arrayElements_.clear(i);
        }
    }

    /**
     * check the element of the given index is updated.
     *
     * @param idx the first parameter is 1, the second is 2, ...
     * @return
     */
    protected boolean isElementUpdated(int idx) {
        return arrayElements_.get(idx - 1);
    }
    ...
    /**
     * mark all updated elements as init.
     *
     */
    protected void resetElementUpdated() {
    ...
    public String toString() {
        ...
        sb.append("colNum <" + arraySize_ + ">. objectArr <");
        for (int i = 0; i < objectArray_.length; i++) {
            if (objectArray_[i] instanceof byte[]) {
                sb.append(Arrays.toString((byte[]) objectArray_[i])).append(". ");
            } else {
                sb.append(objectArray_[i]).append(". ");
            }
        }
        sb.append(">");
        return sb.toString();

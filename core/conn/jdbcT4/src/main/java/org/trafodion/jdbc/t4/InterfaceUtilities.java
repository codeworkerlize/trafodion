...
public class InterfaceUtilities {
    ...
    static private final HashMap<Integer, String> valueToCharset;
	static {
		valueToCharset = new HashMap<Integer, String>(11);
	...
	static private HashMap<String, Integer> charsetToValue;
	static {
		charsetToValue = new HashMap<String, Integer>(11);
	...
	static final String SQLCHARSET_UNICODE = "UTF-16LE";

	// ISO_MAPPING values
	static final int SQLCHARSETCODE_SJIS = 10;
	static final int SQLCHARSETCODE_UTF8 = 15;
    static final String SQLCHARSET_UTF8 = "UTF-8";
	...
	protected static byte[] convertBigDecimalToSQLBigNum(BigDecimal bd, int targetLength, int targetScale) {
...
//			targetData[i * 2 + 1] = (byte) (targetInShorts[i] & 0xFF);
	...
	protected static BigDecimal convertSQLBigNumToBigDecimal(byte[] sourceData, int scale, boolean swap, boolean isUnsigned) {

...
class odbc_SQLSvc_Execute_exc_ {
	...
	void extractFromByteArray(LogicalByteArray buf, String addr, InterfaceConnection ic)
		...
		case odbc_SQLSvc_Execute_ParamError_exn_:
			...
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_program_error", ParamError, addr);
		...
		case odbc_SQLSvc_Execute_TransactionError_exn_:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_transaction_error", temp1, addr);
		default:
			throw TrafT4Messages.createSQLException(ic.getT4props(), "ids_unknown_reply_error", temp0, temp1);
		}
	}

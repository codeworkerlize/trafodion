...
class Header {
    ...
    static final char COMP_DEFAULT = 0xFF;
	...
	Header(short operation_id, short compatibilityVersion, int dialogueId, int total_length, int cmp_length, char compress_ind, char compress_type,
	...
	void insertIntoByteArray(LogicalByteArray buffer1) throws SQLException {
		
		buffer1.insertShort(operation_id_);
		buffer1.insertShort(compatibilityVersion); // + 2 filler
	...
	void extractFromByteArray(LogicalByteArray buffer1) {
		...
		compatibilityVersion = buffer1.extractShort(); // + 2 filler
    ...
    public String toString() {
        ...
        sb.append("OperationId : " + operation_id_);
        sb.append(", dialogueId : " + dialogueId_);
        sb.append(", totalLength : " + total_length_);
        sb.append(", cmpLength : " + cmp_length_);
        sb.append(", compressInd : " + String.valueOf(compress_ind_));
        sb.append(", compressType : " + String.valueOf(compress_type_));
        sb.append(", hdrType : " + hdr_type_);
        sb.append(", signature : " + signature_);
        sb.append(", version : " + version_);
        sb.append(", platform : " + String.valueOf(platform_));
        sb.append(", transport : " + String.valueOf(transport_));
        sb.append(", swap : " + String.valueOf(swap_));
        sb.append(", error : " + error_);
        sb.append(", errorDetail : " + error_detail_);
        return sb.toString();
    }
}

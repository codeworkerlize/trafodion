...
public class T4DSProperties extends T4Properties {
	...
	public void setT4Url(String url){
		super.setT4Url(url);
	}

	public String getT4Url(){
		return super.getT4Url();
	}
	...
	public void setSessionDebug(short sessionDebug) {
		super.setSessionDebug(sessionDebug);
	}
	public void setMds(short mds) {
		super.setMds(mds);
	}

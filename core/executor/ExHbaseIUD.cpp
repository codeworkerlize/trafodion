...
ExWorkProcRetcode ExHbaseAccessInsertTcb::work() {
  ...
  while (!qparent_.down->isEmpty()) {
    ...
    if (pentry_down->downState.request == ex_queue::GET_NOMORE) step_ = CLOSE_AND_DONE;
    ...
    switch (step_) {
      ...
      case PROCESS_INSERT: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertTcb PROCESS_INSERT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[0], sumCost[0] / (callCount[0] ? callCount[0] : 1), sumCost[0], time2,
                   table_.val);
        }
        ...
        if (getHbaseAccessStats()) getHbaseAccessStats()->incUsedRows();
      ...
      case INSERT_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertTcb INSERT_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[1], sumCost[1] / (callCount[1] ? callCount[1] : 1), sumCost[1], time2,
                   table_.val);
        }
      ...
      case CLOSE_AND_DONE: {
        ...
        if (handleDone(rc, matches_)) return rc;
        step_ = NOT_STARTED;
      } break;
...
ExHbaseAccessInsertRowwiseTcb::ExHbaseAccessInsertRowwiseTcb(const ExHbaseAccessTdb &hbaseAccessTdb, ex_globals *glob)
    ...
    switch (step_) {
      ...
      case PROCESS_INSERT: {
        if (numColsInDirectBuffer() > 0) {
          ...
          rowID.len = insRowId_.size();
          retcode = ehi_->insertRow(table_, rowID, row_, hbaseAccessTdb().useHbaseXn(), hbaseAccessTdb().replSync(),
                                    hbaseAccessTdb().incrementalBackup(), hbaseAccessTdb().useRegionXn(),
                                    -1,      //*insColTS_
                                    FALSE);  // AsyncOperations is always FALSE for native HBase
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseAccessInsertRowwiseTcb PROCESS_INSERT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                     pid, transId, callCount[2], (sumCost[2] / (callCount[2] ? callCount[2] : 1)), sumCost[2], time2,
                     table_.val);
          }
          if (setupError(retcode, "ExpHbaseInterface::insertRow")) {
            step_ = HANDLE_ERROR;
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertRowwiseTcb INSERT_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                   pid, transId, callCount[3], (sumCost[3] / (callCount[3] ? callCount[3] : 1)), sumCost[3], time2,
                   table_.val);
        }
...
ExHbaseAccessInsertSQTcb::ExHbaseAccessInsertSQTcb(const ExHbaseAccessTdb &tdb, ex_globals *glob)
...
ExWorkProcRetcode ExHbaseAccessInsertSQTcb::work() {
  ...
  if (hbaseAccessTdb().useTrigger() && getGlobals() != NULL && getGlobals()->castToExExeStmtGlobals() != NULL) {
    ...
    switch (step_) {
      ...
      case EVAL_INSERT_EXPR: {
        ...
        if (convertExpr()) {
          ...
          ex_expr::exp_return_type evalRetCode =
              convertExpr()->eval(pentry_down->getAtp(), workAtp_, NULL, -1, &insertRowlen_);
          if (evalRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
      ...
      case CREATE_MUTATIONS: {
        retcode = createDirectRowBuffer(
            hbaseAccessTdb().convertTuppIndex_, convertRow_, hbaseAccessTdb().listOfUpdatedColNames(),
            hbaseAccessTdb().listOfOmittedColNames(), (hbaseAccessTdb().hbaseSqlIUD() ? FALSE : TRUE));
      ...
      case CHECK_AND_INSERT: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = ehi_->checkAndInsertRow(
              table_, rowID, row_, hbaseAccessTdb().useHbaseXn(), hbaseAccessTdb().replSync(),
              hbaseAccessTdb().incrementalBackup(), hbaseAccessTdb().useRegionXn(), insColTSval_, asyncOperation_,
              (hbaseAccessTdb().useEncryption() ? (char *)&encryptionInfo_ : NULL),
              (char *)(hbaseAccessTdb().getTriggers(table_.val)),
              (hbaseAccessTdb().useTrigger() ? getCurExecUtf8sql() : NULL), hbaseAccessTdb().getColIndexOfPK1());
        ...
        if (retcode == HBASE_DUP_ROW_ERROR)  // row exists, return error
        {
          ...
          ExRaiseSqlError(getHeap(), &diagsArea, (ExeErrorCode)(8102));
        ...
        if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
        ...
        if (hbaseAccessTdb().returnRow()) {
          ...
          if (recordCostTh_ >= 0 && time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertSQTcb CHECK_AND_INSERT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
        ...
        if (asyncOperation_) {
          ...
          if (recordCostTh_ >= 0 && time2 >= recordCostTh_)
            QRWARN(
                "ExHbaseAccessInsertSQTcb CHECK_AND_INSERT_async PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                pid, transId, callCount[4], (sumCost[4] / (callCount[4] ? callCount[4] : 1)), sumCost[4], time2,
                table_.val);
      ...
      case PROCESS_INSERT: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode =
              ehi_->insertRow(table_, rowID, row_, hbaseAccessTdb().useHbaseXn(), hbaseAccessTdb().replSync(),
                              hbaseAccessTdb().incrementalBackup(), hbaseAccessTdb().useRegionXn(), insColTSval_,
                              asyncOperation_, (hbaseAccessTdb().useEncryption() ? (char *)&encryptionInfo_ : NULL),
                              (char *)(hbaseAccessTdb().getTriggers(table_.val)),
        ...
        if (asyncOperation_) {
          if (recordCostTh_ >= 0 && time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertSQTcb PROCESS_INSERT_async PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                   pid, transId, callCount[5], (sumCost[5] / (callCount[5] ? callCount[5] : 1)), sumCost[5], time2,
                   table_.val);
          step_ = COMPLETE_ASYNC_INSERT;
          return WORK_CALL_AGAIN;
        } else {
        ...
        if (recordCostTh_ >= 0 && time2 >= recordCostTh_)
          QRWARN("ExHbaseAccessInsertSQTcb PROCESS_INSERT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
      ...
      case RETURN_ROW: {
        ...
        if (returnUpdateExpr()) {
          ...
          if (allocateUpEntryTupps(-1, 0, hbaseAccessTdb().returnedTuppIndex_, hbaseAccessTdb().returnUpdatedRowLen_,
                                   FALSE, &rc))
            return 1;

          ex_expr::exp_return_type exprRetCode = returnUpdateExpr()->eval(up_entry->getAtp(), workAtp_);
          ...
          if (moveRowToUpQueue(&rc)) return 1;
        } else {
          rc = 0;
          // moveRowToUpQueue also increments matches_
      ...
      case INSERT_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessInsertSQTcb INSERT_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
      ...
      case CLOSE_AND_DONE: {
        ...
        if (NOT hbaseAccessTdb().computeRowsAffected()) matches_ = 0;
...
ExHbaseAccessUpsertVsbbSQTcb::ExHbaseAccessUpsertVsbbSQTcb(const ExHbaseAccessTdb &hbaseAccessTdb, ex_globals *glob)
    : ExHbaseAccessInsertTcb(hbaseAccessTdb, glob) {
  prevTailIndex_ = 0;
...
ExWorkProcRetcode ExHbaseAccessUpsertVsbbSQTcb::work() {
  ...
  while (!qparent_.down->isEmpty()) {
    ...
    ex_queue_entry *pentry_down = qparent_.down->getHeadEntry();
    if ((step_ == HANDLE_ERROR) || (step_ == CLOSE_AND_DONE)) {
      ...
      if (currRowNum_ > rowsInserted_) {
        ...
        if (lastHandledStep_ == ALL_DONE) matches_ = 0;
        step_ = ALL_DONE;
      }
    }
    ...
    switch (step_) {
      ...
      case INSERT_INIT: {
        ...
        ExpTupleDesc *rowTD = hbaseAccessTdb().workCriDesc_->getTupleDescriptor(hbaseAccessTdb().convertTuppIndex_);
        ...
        if (hbaseAccessTdb().getCanAdjustTrafParams()) {
          if (hbaseAccessTdb().getWBSize() > 0) {
            retcode = ehi_->setWriteBufferSize(table_, hbaseAccessTdb().getWBSize());
            if (setupError(retcode, "ExpHbaseInterface::setWriteBufferSize")) {
              step_ = HANDLE_ERROR;
              break;
            }
          }
          retcode = ehi_->setWriteToWAL(table_, hbaseAccessTdb().getTrafWriteToWAL());
      ...
      case CREATE_MUTATIONS: {
        retcode = createDirectRowBuffer(hbaseAccessTdb().convertTuppIndex_, convertRow_,
                                        hbaseAccessTdb().listOfUpdatedColNames(),
                                        hbaseAccessTdb().listOfOmittedColNames(), TRUE);
        if (retcode == -1) {
          step_ = HANDLE_ERROR;
          break;
        }
      ...
      case EVAL_ROWID_EXPR: {
        ...
        if (!hbaseAccessTdb().returnRow()) matches_++;
      ...
      case RETURN_ROW: {
        ...
        if (returnUpdateExpr()) {
          ...
          rc = 0;
          // moveRowToUpQueue also increments matches_
          if (moveRowToUpQueue(&rc)) return rc;
        } else {
          rc = 0;
          // moveRowToUpQueue also increments matches_
          if (moveRowToUpQueue(convertRow_,
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode =
              ehi_->insertRows(table_, hbaseAccessTdb().getRowIDLen(), rowIDs_, rows_, hbaseAccessTdb().useHbaseXn(),
                               hbaseAccessTdb().replSync(), hbaseAccessTdb().incrementalBackup(), insColTSval_,
                               asyncOperation_, (hbaseAccessTdb().useEncryption() ? (char *)&encryptionInfo_ : NULL),
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_ && asyncOperation_)
              QRWARN(
                  "ExHbaseAccessUpsertVsbbSQTcb PROCESS_INSERT_AND_CLOSE_async PID %d txID %ld TCC %d ATC %.2f TTC "
                  "%.2f TC %ld  %s",
                  pid, transId, callCount[7], (sumCost[7] / (callCount[7] ? callCount[7] : 1)), sumCost[7], time2,
                  table_.val);
            else if (time2 >= recordCostTh_)
              QRWARN(
                  "ExHbaseAccessUpsertVsbbSQTcb PROCESS_INSERT_AND_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC "
                  "%ld  %s",
                  pid, transId, callCount[7], (sumCost[7] / (callCount[7] ? callCount[7] : 1)), sumCost[7], time2,
                  table_.val);
          }
      ...
      case COMPLETE_ASYNC_INSERT: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN(
                "ExHbaseAccessUpsertVsbbSQTcb COMPLETE_ASYNC_INSERT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                "%s",
                pid, transId, callCount[8], (sumCost[8] / (callCount[8] ? callCount[8] : 1)), sumCost[8], time2,
                table_.val);
        }
        if (retcode == HBASE_RETRY_AGAIN) {
          asyncCompleteRetryCount_++;
      ...
      case INSERT_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessUpsertVsbbSQTcb INSERT_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[9], (sumCost[9] / (callCount[9] ? callCount[9] : 1)), sumCost[9], time2,
                   table_.val);
        }
        if (setupError(retcode, "ExpHbaseInterface::close")) {
          step_ = HANDLE_ERROR;
      ...
      case ALL_DONE: {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseAccessUpsertVsbbSQTcb INSERT_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                     pid, transId, callCount[9], (sumCost[9] / (callCount[9] ? callCount[9] : 1)), sumCost[9], time2,
                     table_.val);
          }
        }
        if (NOT hbaseAccessTdb().computeRowsAffected()) matches_ = 0;

        if ((step_ == DONE) && (qparent_.down->getLength() == 1)) {
        ...
        if (handleDone(rc, (step_ == ALL_DONE ? matches_ : 0))) return rc;
        lastHandledStep_ = step_;
...
ExHbaseUMDtrafUniqueTaskTcb::ExHbaseUMDtrafUniqueTaskTcb(ExHbaseAccessUMDTcb *tcb)
    ...
    switch (step_) {
      ...
      case SETUP_UMD: {
        ...
        if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_)
          tcb_->setupListOfColNames(tcb_->hbaseAccessTdb().listOfUpDeldColNames(), tcb_->deletedColumns_);
      ...
      case GET_NEXT_ROWID: {
        ...
        retcode = tcb_->ehi_->getRowOpen(
            tcb_->table_, tcb_->rowIds_[tcb_->currRowidIdx_], tcb_->columns_, -1,
            tcb_->hbaseAccessTdb().getNumReplications(), tcb_->hbaseAccessTdb().getLockMode(),
            tcb_->hbaseAccessTdb().getIsolationLevel(), tcb_->hbaseAccessTdb().getScanMemoryTable(), true);
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafUniqueTaskTcb GET_NEXT_ROWID PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                   pid, transId, callCount[10], (sumCost[10] / (callCount[10] ? callCount[10] : 1)), sumCost[10], time2,
                   tcb_->table_.val);
        }
      } break;
      ...
      case NEXT_ROW: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafUniqueTaskTcb NEXT_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
        ...
        if (tcb_->setupError(retcode, "ExpHbaseInterface::nextRow"))
          step_ = HANDLE_ERROR;
        else if ((tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_) && (!tcb_->scanExpr()) &&
                 (!tcb_->lobDelExpr()) && (NOT tcb_->hbaseAccessTdb().returnRow()))
          step_ = DELETE_ROW;
        else
      ...
      case APPLY_PRED: {
        ...
        if (rc == 1) {
          if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_)
            step_ = DELETE_ROW;
          else if ((tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::MERGE_) && (tcb_->mergeUpdScanExpr()))
      ...
      case CREATE_UPDATED_ROW: {
        if (tcb_->hbaseAccessTdb().updateTuppIndex_ > 0)
          tcb_->workAtp_->getTupp(tcb_->hbaseAccessTdb().updateTuppIndex_).setDataPointer(tcb_->updateRow_);
        ...
        if ((!tcb_->updateExpr()) && (!tcb_->hbTagExpr())) {
          tcb_->currRowidIdx_++;
        ...
        if (tcb_->updateExpr()) {
          ...
          ex_expr::exp_return_type evalRetCode =
              tcb_->updateExpr()->eval(pentry_down->getAtp(), tcb_->workAtp_, NULL, -1, &tcb_->insertRowlen_);
          if (evalRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
      ...
      case CREATE_MUTATIONS: {
        ...
        if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::MERGE_) {
          ...
          if (tcb_->mergeInsertExpr()) {
            rowTD =
                tcb_->hbaseAccessTdb().workCriDesc_->getTupleDescriptor(tcb_->hbaseAccessTdb().mergeInsertTuppIndex_);
          } else {
            rowTD = tcb_->hbaseAccessTdb().workCriDesc_->getTupleDescriptor(tcb_->hbaseAccessTdb().updateTuppIndex_);
          }

          if (rowTD->numAttrs() > 0) tcb_->allocateDirectRowBufferForJNI(rowTD->numAttrs());
        }

        retcode = 0;
        if ((tcb_->hbaseAccessTdb().updateTuppIndex_ > 0) && (tcb_->updateRow_))
          retcode = tcb_->createDirectRowBuffer(tcb_->hbaseAccessTdb().updateTuppIndex_, tcb_->updateRow_,
                                                tcb_->hbaseAccessTdb().listOfUpdatedColNames(),
                                                tcb_->hbaseAccessTdb().listOfOmittedColNames(), TRUE);
        if (retcode == -1) {
          step_ = HANDLE_ERROR;
          break;
        }
      ...
      case CREATE_MERGE_INSERTED_ROW: {
        ...
        tcb_->workAtp_->getTupp(tcb_->hbaseAccessTdb().mergeInsertTuppIndex_).setDataPointer(tcb_->mergeInsertRow_);

        if (tcb_->mergeInsertExpr()) {
          tcb_->insertRowlen_ = tcb_->hbaseAccessTdb().mergeInsertRowLen_;
          ex_expr::exp_return_type evalRetCode =
              tcb_->mergeInsertExpr()->eval(pentry_down->getAtp(), tcb_->workAtp_, NULL, -1, &tcb_->insertRowlen_);
          if (evalRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
        }
        if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::MERGE_) rowUpdated_ = FALSE;
      ...
      case EVAL_INS_CONSTRAINT: {
        ...
        retcode = tcb_->createDirectRowBuffer(tcb_->hbaseAccessTdb().mergeInsertTuppIndex_, tcb_->mergeInsertRow_,
      ...
      case UPDATE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = tcb_->ehi_->insertRow(
              tcb_->table_, tcb_->rowIds_[tcb_->currRowidIdx_], tcb_->row_,
              (tcb_->hbaseAccessTdb().useHbaseXn() ? TRUE : FALSE), tcb_->hbaseAccessTdb().replSync(),
              tcb_->hbaseAccessTdb().incrementalBackup(), tcb_->hbaseAccessTdb().useRegionXn(),
              tcb_->hbaseAccessTdb().hbaseCellTS_, asyncOperationLocal_,
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseUMDtrafUniqueTaskTcb UPDATE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
        ...
        if (NOT tcb_->hbaseAccessTdb().returnRow()) tcb_->matches_++;
      ...
      case CHECK_AND_UPDATE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 > recordCostTh_)
              QRWARN(
                  "ExHbaseUMDtrafUniqueTaskTcb CHECK_AND_UPDATE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                  "%s",
                  pid, transId, callCount[13], (sumCost[13] / (callCount[13] ? callCount[13] : 1)), sumCost[13], time2,
                  tcb_->table_.val);
          }
        }
      ...
      case UPDATE_TAG_AFTER_ROW_UPDATE: {
        ...
        if (tcb_->hbaseAccessTdb().hbTagTuppIndex_ > 0)
          tcb_->workAtp_->getTupp(tcb_->hbaseAccessTdb().hbTagTuppIndex_).setDataPointer(tcb_->hbTagRow_);

        ex_expr::exp_return_type evalRetCode = tcb_->hbTagExpr()->eval(pentry_down->getAtp(), tcb_->workAtp_);
        if (evalRetCode == ex_expr::EXPR_ERROR) {
          step_ = HANDLE_ERROR;
          break;
        }
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafUniqueTaskTcb UPDATE_TAG PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[14], (sumCost[14] / (callCount[14] ? callCount[14] : 1)), sumCost[14], time2,
                   tcb_->table_.val);
        }
        ...
        if (step_ == UPDATE_TAG) tcb_->matches_++;
      ...
      case CHECK_AND_INSERT_ROW: {
        ...
        if (tcb_->mergeInsertRowIdExpr()) {
          tcb_->workAtp_->getTupp(tcb_->hbaseAccessTdb().mergeInsertRowIdTuppIndex_).setDataPointer(tcb_->rowIdRow_);
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = tcb_->ehi_->checkAndInsertRow(
              ...
              tcb_->asyncOperation_, (tcb_->hbaseAccessTdb().useEncryption() ? (char *)&tcb_->encryptionInfo_ : NULL),
              (char *)(tcb_->hbaseAccessTdb().getTriggers(tcb_->table_.val)),
              (tcb_->hbaseAccessTdb().useTrigger() ? tcb_->getCurExecUtf8sql() : NULL),
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN(
                  "ExHbaseUMDtrafUniqueTaskTcb CHECK_AND_INSERT_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                  "%s",
                  pid, transId, callCount[15], (sumCost[15] / (callCount[15] ? callCount[15] : 1)), sumCost[15], time2,
                  tcb_->table_.val);
          }
        }
        ...
        if (retcode == HBASE_DUP_ROW_ERROR) {
          ComDiagsArea *diagsArea = NULL;
          ExRaiseSqlError(tcb_->getHeap(), &diagsArea, (ExeErrorCode)(8102));
          pentry_down->setDiagsArea(diagsArea);
          step_ = HANDLE_ERROR;
          break;
      ...
      case DELETE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = tcb_->ehi_->deleteRow(
              tcb_->table_, tcb_->rowIds_[tcb_->currRowidIdx_], &tcb_->deletedColumns_,
              tcb_->hbaseAccessTdb().useHbaseXn(), tcb_->hbaseAccessTdb().replSync(),
              tcb_->hbaseAccessTdb().incrementalBackup(), tcb_->hbaseAccessTdb().useRegionXn(), latestRowTimestamp_,
              asyncOperationLocal_,
              (tcb_->hbaseAccessTdb().getComHbaseAccessOptions()
                   ? tcb_->hbaseAccessTdb().getComHbaseAccessOptions()->hbaseAuths()
                   : NULL),
              (tcb_->hbaseAccessTdb().useEncryption() ? (char *)&tcb_->encryptionInfo_ : NULL),
              (tcb_->hbaseAccessTdb().updateKey() ? NULL
                                                  : ((char *)(tcb_->hbaseAccessTdb().getTriggers(tcb_->table_.val)))),
              (tcb_->hbaseAccessTdb().useTrigger() ? tcb_->getCurExecUtf8sql(tcb_->hbaseAccessTdb().withNoReplicate())
                                                   : NULL));
          tcb_->ehi_->settrigger_operation(COM_UNKNOWN_IUD);
          if (recordCostTh_ >= 0) {
            long time2 = (JULIANTIMESTAMP() - time1) / 1000;
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseUMDtrafUniqueTaskTcb DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                     transId, callCount[16], (sumCost[16] / (callCount[16] ? callCount[16] : 1)), sumCost[16], time2,
                     tcb_->table_.val);
          }
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
            g->getStatement()->setTriggerExecErr(TRUE);
        ...
        if (tcb_->lobDelExpr()) {
          ex_expr::exp_return_type exprRetCode = tcb_->lobDelExpr()->eval(pentry_down->getAtp(), tcb_->workAtp_);
          if (exprRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
      ...
      case CHECK_AND_DELETE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 > recordCostTh_)
              QRWARN(
                  "ExHbaseUMDtrafUniqueTaskTcb CHECK_AND_DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                  "%s",
                  pid, transId, callCount[17], (sumCost[17] / (callCount[17] ? callCount[17] : 1)), sumCost[17], time2,
                  tcb_->table_.val);
          }
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
            g->getStatement()->setTriggerExecErr(TRUE);
      ...
      case EVAL_RETURN_ROW_EXPRS: {
        ...
        // allocate tupps where returned rows will be created
        if (tcb_->allocateUpEntryTupps(tcb_->hbaseAccessTdb().returnedFetchedTuppIndex_,
                                       tcb_->hbaseAccessTdb().returnFetchedRowLen_,
                                       tcb_->hbaseAccessTdb().returnedUpdatedTuppIndex_,
                                       tcb_->hbaseAccessTdb().returnUpdatedRowLen_, FALSE, &rc))
          return 1;
        ...
        if (tcb_->returnFetchExpr()) {
          exprRetCode = tcb_->returnFetchExpr()->eval(up_entry->getAtp(), tcb_->workAtp_);
          if (exprRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
          fetchedDataPtr =
              up_entry->getAtp()->getTupp(tcb_->hbaseAccessTdb().returnedFetchedTuppIndex_).getDataPointer();
        }
        if (tcb_->hbaseAccessTdb().mergeIUDIndicatorTuppIndex_ > 0)
          mergeIUDIndicatorDataPtr =
              tcb_->workAtp_->getTupp(tcb_->hbaseAccessTdb().mergeIUDIndicatorTuppIndex_).getDataPointer();

        if (rowUpdated_) {
          if (tcb_->returnUpdateExpr()) {
            if (mergeIUDIndicatorDataPtr) *mergeIUDIndicatorDataPtr = 'U';
            exprRetCode = tcb_->returnUpdateExpr()->eval(up_entry->getAtp(), tcb_->workAtp_);
            if (exprRetCode == ex_expr::EXPR_ERROR) {
              step_ = HANDLE_ERROR;
              break;
            }
          ...
          if (mergeIUDIndicatorDataPtr) *mergeIUDIndicatorDataPtr = 'I';
          if (tcb_->returnMergeInsertExpr()) {
            exprRetCode = tcb_->returnMergeInsertExpr()->eval(up_entry->getAtp(), tcb_->workAtp_);
            if (exprRetCode == ex_expr::EXPR_ERROR) {
              step_ = HANDLE_ERROR;
              break;
            }
      ...
      case RETURN_UPDATED_ROWS: {
        rc = 0;
        // moveRowToUpQueue also increments matches_
        if (tcb_->moveRowToUpQueue(&rc)) return 1;
      ...
      case GET_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafUniqueTaskTcb GET_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
...
ExHbaseUMDnativeUniqueTaskTcb::ExHbaseUMDnativeUniqueTaskTcb(ExHbaseAccessUMDTcb *tcb)
    : ExHbaseUMDtrafUniqueTaskTcb(tcb), step_(NOT_STARTED) {}
  ...
  while (1) {
    ...
    switch (step_) {
      ...
      case SETUP_UMD: {
        ...
        tcb_->setupListOfColNames(tcb_->hbaseAccessTdb().listOfDeletedColNames(), tcb_->deletedColumns_);

        tcb_->setupListOfColNames(tcb_->hbaseAccessTdb().listOfFetchedColNames(), tcb_->columns_);
        if (costThreshold != NULL) recordCostTh_ = atoi(costThreshold);
        step_ = GET_NEXT_ROWID;
      } break;
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeUniqueTaskTcb GET_NEXT_ROWID PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                   pid, transId, callCount[19], (sumCost[19] / (callCount[19] ? callCount[19] : 1)), sumCost[19], time2,
                   tcb_->table_.val);
        }
        if (tcb_->setupError(retcode, "ExpHbaseInterface::getRowOpen"))
          step_ = HANDLE_ERROR;
      ...
      case NEXT_ROW: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeUniqueTaskTcb NEXT_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[20], (sumCost[20] / (callCount[20] ? callCount[20] : 1)), sumCost[20], time2,
                   tcb_->table_.val);
        }
        if (retcode == HBASE_ACCESS_EOD || retcode == HBASE_ACCESS_EOR) {
          step_ = GET_CLOSE;
      ...
      case NEXT_CELL: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeUniqueTaskTcb NEXT_CELL PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[21], (sumCost[21] / (callCount[21] ? callCount[21] : 1)), sumCost[21], time2,
                   tcb_->table_.val);
        }
        if (retcode == HBASE_ACCESS_EOD) {
          if ((tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_) && (!tcb_->scanExpr()))
            step_ = DELETE_ROW;
          else
            step_ = CREATE_FETCHED_ROW;
          break;
      ...
      case CREATE_FETCHED_ROW: {
        ...
        if (rc < 0) {
          if (rc != -1) tcb_->setupError(rc, "createRowwiseRow");
          step_ = HANDLE_ERROR;
          break;
        }
      ...
      case CREATE_UPDATED_ROW: {
        ...
        ExpTupleDesc *rowTD =
            tcb_->hbaseAccessTdb().workCriDesc_->getTupleDescriptor(tcb_->hbaseAccessTdb().updateTuppIndex_);

        Attributes *attr = rowTD->getAttr(0);

        rowUpdated_ = TRUE;
        retcode = tcb_->createDirectRowwiseBuffer(&tcb_->updateRow_[attr->getOffset()]);
        if (retcode == -1) {
          step_ = HANDLE_ERROR;
          break;
        }
      ...
      case DELETE_ROW: {
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = tcb_->ehi_->deleteRow(
              tcb_->table_, tcb_->rowIds_[tcb_->currRowidIdx_], &tcb_->deletedColumns_,
              tcb_->hbaseAccessTdb().useHbaseXn(), tcb_->hbaseAccessTdb().replSync(),
              tcb_->hbaseAccessTdb().incrementalBackup(), tcb_->hbaseAccessTdb().useRegionXn(), -1,
              tcb_->asyncOperation_,
              (tcb_->hbaseAccessTdb().getComHbaseAccessOptions()
                   ? tcb_->hbaseAccessTdb().getComHbaseAccessOptions()->hbaseAuths()
                   : NULL),
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 > recordCostTh_)
              QRWARN("ExHbaseUMDnativeUniqueTaskTcb DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                     pid, transId, callCount[22], (sumCost[22] / (callCount[22] ? callCount[22] : 1)), sumCost[22],
                     time2, tcb_->table_.val);
          }
          tcb_->ehi_->settrigger_operation(COM_UNKNOWN_IUD);
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
            g->getStatement()->setTriggerExecErr(TRUE);
            ...
            if (recordCostTh_ >= 0) {
              ...
              if (time2 > recordCostTh_)
                QRWARN("ExHbaseUMDnativeUniqueTaskTcb UPDATE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                       pid, transId, callCount[23], (sumCost[23] / (callCount[23] ? callCount[23] : 1)), sumCost[23],
                       time2, tcb_->table_.val);
            }
            if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
              g->getStatement()->setTriggerExecErr(TRUE);
      ...
      case GET_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDnativeUniqueTaskTcb GET_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[24], (sumCost[24] / (callCount[24] ? callCount[24] : 1)), sumCost[24], time2,
                   tcb_->table_.val);
        }
        if (tcb_->setupError(retcode, "ExpHbaseInterface::getClose"))
          step_ = HANDLE_ERROR;
...
ExHbaseUMDtrafSubsetTaskTcb::ExHbaseUMDtrafSubsetTaskTcb(ExHbaseAccessUMDTcb *tcb)
    : ExHbaseTaskTcb(tcb), step_(NOT_STARTED) {}
    ...
    switch (step_) {
      ...
      case SCAN_OPEN: {
        ...
        retcode = tcb_->ehi_->scanOpen(
            ...
            tcb_->hbaseAccessTdb().getHbasePerfAttributes()->numCacheRows(), FALSE, NULL, NULL, NULL,
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafSubsetTaskTcb SCAN_OPEN PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[25], (sumCost[25] / (callCount[25] ? callCount[25] : 1)), sumCost[25], time2,
                   tcb_->table_.val);
        }
      ...
      case NEXT_ROW: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafSubsetTaskTcb NEXT_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[26], (sumCost[26] / (callCount[26] ? callCount[26] : 1)), sumCost[26], time2,
                   tcb_->table_.val);
        }
        if (retcode == HBASE_ACCESS_EOD || retcode == HBASE_ACCESS_EOR) {
          step_ = SCAN_CLOSE;
        ...
        if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_) {
          if ((!tcb_->scanExpr()) && (NOT tcb_->hbaseAccessTdb().returnRow())) {
            step_ = DELETE_ROW;
            break;
          }
        }
      ...
      case UPDATE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseUMDtrafSubsetTaskTcb UPDATE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                     transId, callCount[27], (sumCost[27] / (callCount[27] ? callCount[27] : 1)), sumCost[27], time2,
                     tcb_->table_.val);
          }
          tcb_->ehi_->settrigger_operation(COM_UNKNOWN_IUD);
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
      ...
      case UPDATE_TAG_AFTER_ROW_UPDATE: {
        ...
        tagRow.val = tcb_->hbTagRow_;
        tagRow.len = tcb_->hbaseAccessTdb().hbTagRowLen_;
        retcode = tcb_->ehi_->updateVisibility(tcb_->table_, rowID, tagRow, tcb_->hbaseAccessTdb().useHbaseXn());
      ...
      case DELETE_ROW: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = tcb_->ehi_->deleteRow(
              ...
              tcb_->hbaseAccessTdb().replSync(), tcb_->hbaseAccessTdb().incrementalBackup(),
              tcb_->hbaseAccessTdb().useRegionXn(), -1, tcb_->asyncOperation_,
              (tcb_->hbaseAccessTdb().getComHbaseAccessOptions()
                   ? tcb_->hbaseAccessTdb().getComHbaseAccessOptions()->hbaseAuths()
                   : NULL),
              (tcb_->hbaseAccessTdb().useEncryption() ? (char *)&tcb_->encryptionInfo_ : NULL),
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 > recordCostTh_)
              QRWARN("ExHbaseUMDtrafSubsetTaskTcb DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                     transId, callCount[28], (sumCost[28] / (callCount[28] ? callCount[28] : 1)), sumCost[28], time2,
                     tcb_->table_.val);
          }
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
            g->getStatement()->setTriggerExecErr(TRUE);
      ...
      case SCAN_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 > recordCostTh_)
            QRWARN("ExHbaseUMDtrafSubsetTaskTcb DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[29], (sumCost[29] / (callCount[29] ? callCount[29] : 1)), sumCost[29], time2,
                   tcb_->table_.val);
        }
...
ExHbaseUMDnativeSubsetTaskTcb::ExHbaseUMDnativeSubsetTaskTcb(ExHbaseAccessUMDTcb *tcb)
    : ExHbaseUMDtrafSubsetTaskTcb(tcb), step_(NOT_STARTED) {}
    ...
    switch (step_) {
      ...
      case SCAN_OPEN: {
        ...
        retcode = tcb_->ehi_->scanOpen(
            ...
            tcb_->hbaseAccessTdb().getIsolationLevel(), TRUE, FALSE,  // no scan operator
            tcb_->hbaseAccessTdb().replSync(), tcb_->hbaseAccessTdb().getHbasePerfAttributes()->cacheBlocks(),
            tcb_->hbaseAccessTdb().getHbasePerfAttributes()->useSmallScanner(),
            tcb_->hbaseAccessTdb().getHbasePerfAttributes()->numCacheRows(), FALSE, NULL, NULL, NULL,
            tcb_->hbaseAccessTdb().getNumReplications(),
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeSubsetTaskTcb SCAN_OPEN PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[30], (sumCost[30] / (callCount[30] ? callCount[30] : 1)), sumCost[30], time2,
                   tcb_->table_.val);
        }
        if (tcb_->setupError(retcode, "ExpHbaseInterface::scanOpen"))
          step_ = HANDLE_ERROR;
      ...
      case NEXT_ROW: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeSubsetTaskTcb NEXT_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[31], (sumCost[31] / (callCount[31] ? callCount[31] : 1)), sumCost[31], time2,
                   tcb_->table_.val);
        }
        if (retcode == HBASE_ACCESS_EOD || retcode == HBASE_ACCESS_EOR) {
          tcb_->isEOD_ = TRUE;
      ...
      case NEXT_CELL: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeSubsetTaskTcb NEXT_CELL PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[32], (sumCost[32] / (callCount[32] ? callCount[32] : 1)), sumCost[32], time2,
                   tcb_->table_.val);
        }
        if (retcode == HBASE_ACCESS_EOD) {
          if (tcb_->hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_) {
      ...
      case CREATE_UPDATED_ROWWISE_ROW: {
        ...
        if (tcb_->updateExpr()) {
          ex_expr::exp_return_type evalRetCode = tcb_->updateExpr()->eval(pentry_down->getAtp(), tcb_->workAtp_);
          if (evalRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
            ...
            if (recordCostTh_ >= 0) {
              ...
              if (time2 >= recordCostTh_)
                QRWARN("ExHbaseUMDnativeSubsetTaskTcb UPDATE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                       pid, transId, callCount[33], (sumCost[33] / (callCount[33] ? callCount[33] : 1)), sumCost[33],
                       time2, tcb_->table_.val);
            }
            if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
              g->getStatement()->setTriggerExecErr(TRUE);
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_)
              QRWARN("ExHbaseUMDnativeSubsetTaskTcb DELETE_ROW PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s",
                     pid, transId, callCount[34], (sumCost[34] / (callCount[34] ? callCount[34] : 1)), sumCost[34],
                     time2, tcb_->table_.val);
          }
          tcb_->ehi_->settrigger_operation(COM_UNKNOWN_IUD);
          if (retcode == TRIGGER_EXECUTE_EXCEPTION || retcode == TRIGGER_PARAMETER_EXCEPTION) {
      ...
      case SCAN_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseUMDnativeSubsetTaskTcb SCAN_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[35], (sumCost[35] / (callCount[35] ? callCount[35] : 1)), sumCost[35], time2,
                   tcb_->table_.val);
        }
        if (tcb_->setupError(retcode, "ExpHbaseInterface::scanClose"))
          step_ = HANDLE_ERROR;
...
ExHbaseAccessUMDTcb::ExHbaseAccessUMDTcb(const ExHbaseAccessTdb &hbaseAccessTdb, ex_globals *glob)
  ...
  if (hbaseTdb.listOfScanRows()) {
    ...
    if (hbaseTdb.sqHbaseTable())
      umdSQSubsetTaskTcb_ = new (getGlobals()->getDefaultHeap()) ExHbaseUMDtrafSubsetTaskTcb(this);
    else
      umdSQSubsetTaskTcb_ = new (getGlobals()->getDefaultHeap()) ExHbaseUMDnativeSubsetTaskTcb(this);
  }

  if ((hbaseTdb.keySubsetGen()) && (NOT hbaseTdb.uniqueKeyInfo())) {
  ...
  if (hbaseTdb.listOfGetRows()) {
    ...
    if (hbaseTdb.sqHbaseTable())
      umdSQUniqueTaskTcb_ = new (getGlobals()->getDefaultHeap()) ExHbaseUMDtrafUniqueTaskTcb(this);
    else
      umdSQUniqueTaskTcb_ = new (getGlobals()->getDefaultHeap()) ExHbaseUMDnativeUniqueTaskTcb(this);
  }

  if ((hbaseTdb.keySubsetGen()) && (hbaseTdb.uniqueKeyInfo())) {
  ...
  while (!qparent_.down->isEmpty()) {
    ...
    switch (step_) {
      ...
      case UMD_INIT: {
        ...
        if (umdSQSubsetTaskTcb_) umdSQSubsetTaskTcb_->init();

        if (umdSQUniqueTaskTcb_) umdSQUniqueTaskTcb_->init();
...
ExHbaseAccessSQRowsetTcb::ExHbaseAccessSQRowsetTcb(const ExHbaseAccessTdb &hbaseAccessTdb, ex_globals *glob)
    : ExHbaseAccessTcb(hbaseAccessTdb, glob), step_(NOT_STARTED) {
  prevTailIndex_ = 0;
...
int ExHbaseAccessSQRowsetTcb::setupUniqueKey() {
  ...
  if (keyRangeStatus == keyRangeEx::EXPRESSION_ERROR) return -1;
...
int ExHbaseAccessSQRowsetTcb::setupRowIds() {
  ...
  while (nextRequest_ != tlindex) {
    ...
    if (numRowsInDirectBuffer() >= rowsetMaxRows) return 1;
  }
  return 0;
}
...
ExWorkProcRetcode ExHbaseAccessSQRowsetTcb::work() {
  ...
  while (!qparent_.down->isEmpty()) {
    ...
    switch (step_) {
      ...
      case RS_INIT: {
        ...
        if (hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::UPDATE_) {
          ExpTupleDesc *rowTD = hbaseAccessTdb().workCriDesc_->getTupleDescriptor(hbaseAccessTdb().updateTuppIndex_);
          allocateDirectRowBufferForJNI(rowTD->numAttrs(), hbaseAccessTdb().getHbaseRowsetVsbbSize());
        }
        if (hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::UPDATE_ ||
      ...
      case SETUP_UMD: {
        ...
        if (hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::DELETE_)
          setupListOfColNames(hbaseAccessTdb().listOfUpDeldColNames(), deletedColumns_);
      ...
      case PROCESS_DELETE_AND_CLOSE: {
        ...
        if (rowIDs_.len > hbaseAccessTdb().getRowIDLen() && hbaseAccessTdb().getTriggers(table_.val) != NULL) {
          if (numRowsInVsbbBuffer_ > 0) {
            ...
            retcode =
                ehi_->getRowsOpen(table_, hbaseAccessTdb().getRowIDLen(), rowIDs_, columns_,
                                  // deletedColumns_,
                                  hbaseAccessTdb().getNumReplications(), hbaseAccessTdb().getLockMode(),
                                  hbaseAccessTdb().getIsolationLevel(), hbaseAccessTdb().getScanMemoryTable(),
                                  hbaseAccessTdb().skipReadConflict(), hbaseAccessTdb().skipTransactionForced(), NULL);
          } else {
            retcode = ehi_->getRowOpen(table_, rowIDs_,
                                       // deletedColumns_,
                                       columns_, -1, hbaseAccessTdb().getNumReplications(),
                                       hbaseAccessTdb().getLockMode(), hbaseAccessTdb().getIsolationLevel(),
                                       hbaseAccessTdb().getScanMemoryTable(), true, NULL);
          }
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          retcode = ehi_->deleteRows(
              ...
              (hbaseAccessTdb().getComHbaseAccessOptions() ? hbaseAccessTdb().getComHbaseAccessOptions()->hbaseAuths()
                                                           : NULL),
              (hbaseAccessTdb().useEncryption() ? (char *)&encryptionInfo_ : NULL),
              (char *)(hbaseAccessTdb().getTriggers(table_.val)),
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_ && asyncOperation_)
              QRWARN(
                  "ExHbaseAccessSQRowsetTcb PROCESS_DELETE_AND_CLOSE_async PID %d txID %ld TCC %d ATC %.2f TTC %.2f  "
                  "TC %ld  %s",
                  pid, transId, callCount[36], (sumCost[36] / (callCount[36] ? callCount[36] : 1)), sumCost[36], time2,
                  table_.val);
            else if (time2 >= recordCostTh_)
              QRWARN(
                  "ExHbaseAccessSQRowsetTcb PROCESS_DELETE_AND_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                  "%s",
                  pid, transId, callCount[36], (sumCost[36] / (callCount[36] ? callCount[36] : 1)), sumCost[36], time2,
                  table_.val);
          }
      ...
      case PROCESS_SELECT: {
        if (numRowsInDirectBuffer() > 0) {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 > recordCostTh_)
              QRWARN("ExHbaseAccessSQRowsetTcb PROCESS_SELECT PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                     transId, callCount[37], (sumCost[37] / (callCount[37] ? callCount[37] : 1)), sumCost[37], time2,
                     table_.val);
          }
          currRowNum_ = 0;
          if (setupError(retcode, "ExpHbaseInterface::getRowsOpen")) {
      ...
      case CREATE_UPDATED_ROW: {
        ...
        if (updateExpr()) {
          ex_expr::exp_return_type evalRetCode = updateExpr()->eval(pentry_down->getAtp(), workAtp_);
          if (evalRetCode == ex_expr::EXPR_ERROR) {
            step_ = HANDLE_ERROR;
            break;
          }
      ...
      case EVAL_CONSTRAINT: {
        ...
        retcode = createDirectRowBuffer(hbaseAccessTdb().updateTuppIndex_, updateRow_,
                                        hbaseAccessTdb().listOfUpdatedColNames(),
                                        hbaseAccessTdb().listOfOmittedColNames(), TRUE);
        if (retcode == -1) {
          step_ = HANDLE_ERROR;
      ...
      case PROCESS_UPDATE_AND_CLOSE: {
        ...
        if (g != NULL && g->getStatement() != NULL && g->getStatement()->getTriggerExecErr() == TRUE) {
          ...
          if (recordCostTh_ >= 0) {
            ...
            if (time2 >= recordCostTh_ && asyncOperation_)
              QRWARN(
                  "ExHbaseAccessSQRowsetTcb PROCESS_UPDATE_AND_CLOSE_async PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC "
                  "%ld  %s",
                  pid, transId, callCount[38], (sumCost[38] / (callCount[38] ? callCount[38] : 1)), sumCost[38], time2,
                  table_.val);
            else if (time2 >= recordCostTh_)
              QRWARN(
                  "ExHbaseAccessSQRowsetTcb PROCESS_UPDATE_AND_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  "
                  "%s",
                  pid, transId, callCount[38], (sumCost[38] / (callCount[38] ? callCount[38] : 1)), sumCost[38], time2,
                  table_.val);
          }
      ...
      case RS_CLOSE: {
        ...
        if (recordCostTh_ >= 0) {
          ...
          if (time2 >= recordCostTh_)
            QRWARN("ExHbaseAccessSQRowsetTcb RS_CLOSE PID %d txID %ld TCC %d ATC %.2f TTC %.2f TC %ld  %s", pid,
                   transId, callCount[39], (sumCost[39] / (callCount[39] ? callCount[39] : 1)), sumCost[39], time2,
                   table_.val);
        }
        if (setupError(retcode, "ExpHbaseInterface::close")) {
          step_ = HANDLE_ERROR;
  ...
  if (qparent_.down->isEmpty() && (hbaseAccessTdb().getAccessType() == ComTdbHbaseAccess::SELECT_)) {
    ehi_->close();
    step_ = NOT_STARTED;
  }

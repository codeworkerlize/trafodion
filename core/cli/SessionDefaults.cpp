...
static int gSkipEndValidDDLCheck = -1;

static const SessionDefaults::SessionDefaultMap sessionDefaultMap[] = {
    // Attribute                                       Attr String                 Attr Datatype IsCQD    InDef  IsSSD
    // Ext
    //                                                                                                                           Table
    // ==============================================================================================================================================
    SDEntry(SessionDefaults::ALTPRI_ESP, ALTPRI_ESP, SessionDefaults::SDT_BOOLEAN, FALSE, TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ALTPRI_FIRST_FETCH, ALTPRI_FIRST_FETCH, SessionDefaults::SDT_BOOLEAN, FALSE, FALSE, TRUE,
            FALSE),
    SDEntry(SessionDefaults::ALTPRI_MASTER, ALTPRI_MASTER, SessionDefaults::SDT_BOOLEAN, FALSE, TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ALTPRI_MASTER_SEQ_EXE, ALTPRI_MASTER_SEQ_EXE, SessionDefaults::SDT_BOOLEAN, FALSE, FALSE,
            TRUE, FALSE),
    SDEntry(SessionDefaults::AQR_ENTRIES, AQR_ENTRIES, SessionDefaults::SDT_ASCII, FALSE, TRUE, TRUE, FALSE),
    SDEntry(SessionDefaults::AUTO_QUERY_RETRY_WARNINGS, AUTO_QUERY_RETRY_WARNINGS, SessionDefaults::SDT_BOOLEAN, TRUE,
            TRUE, FALSE, FALSE),
    SDEntry(SessionDefaults::CALL_EMBEDDED_ARKCMP, CALL_EMBEDDED_ARKCMP, SessionDefaults::SDT_BOOLEAN, TRUE, FALSE,
            TRUE, FALSE),
    SDEntry(SessionDefaults::CANCEL_ESCALATION_INTERVAL, CANCEL_ESCALATION_INTERVAL, SessionDefaults::SDT_BINARY_SIGNED,
            FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::CANCEL_ESCALATION_MXOSRVR_INTERVAL, CANCEL_ESCALATION_MXOSRVR_INTERVAL,
            SessionDefaults::SDT_BINARY_SIGNED, FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::CANCEL_ESCALATION_SAVEABEND, CANCEL_ESCALATION_SAVEABEND, SessionDefaults::SDT_BOOLEAN,
            FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::CANCEL_LOGGING, CANCEL_LOGGING, SessionDefaults::SDT_BOOLEAN, FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::CANCEL_QUERY_ALLOWED, CANCEL_QUERY_ALLOWED, SessionDefaults::SDT_BOOLEAN, TRUE, TRUE, TRUE,
            FALSE),
    SDEntry(SessionDefaults::CANCEL_UNIQUE_QUERY, CANCEL_UNIQUE_QUERY, SessionDefaults::SDT_BOOLEAN, FALSE, FALSE, TRUE,
            FALSE),
    SDEntry(SessionDefaults::CATALOG, CATALOG, SessionDefaults::SDT_ASCII, TRUE, TRUE, FALSE, FALSE),
    SDEntry(SessionDefaults::COMPILER_IDLE_TIMEOUT, COMPILER_IDLE_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::DBTR_PROCESS, DBTR_PROCESS, SessionDefaults::SDT_BOOLEAN, TRUE, FALSE, FALSE, FALSE),
    SDEntry(SessionDefaults::ESP_ASSIGN_DEPTH, ESP_ASSIGN_DEPTH, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE,
            TRUE),
    SDEntry(SessionDefaults::ESP_ASSIGN_TIME_WINDOW, ESP_ASSIGN_TIME_WINDOW, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_CLOSE_ERROR_LOGGING, ESP_CLOSE_ERROR_LOGGING, SessionDefaults::SDT_BOOLEAN, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_FIXUP_PRIORITY, ESP_FIXUP_PRIORITY, SessionDefaults::SDT_BINARY_SIGNED, FALSE, FALSE,
            TRUE, FALSE),
    SDEntry(SessionDefaults::ESP_FIXUP_PRIORITY_DELTA, ESP_FIXUP_PRIORITY_DELTA, SessionDefaults::SDT_BINARY_SIGNED,
            FALSE, TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_FREEMEM_TIMEOUT, ESP_FREEMEM_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, FALSE, FALSE,
            TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_IDLE_TIMEOUT, ESP_IDLE_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE,
            TRUE),
    SDEntry(SessionDefaults::ESP_INACTIVE_TIMEOUT, ESP_INACTIVE_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_PRIORITY, ESP_PRIORITY, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_PRIORITY_DELTA, ESP_PRIORITY_DELTA, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE,
            TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_STOP_IDLE_TIMEOUT, ESP_STOP_IDLE_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::ESP_RELEASE_WORK_TIMEOUT, ESP_RELEASE_WORK_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED,
            FALSE, TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::INTERNAL_FORMAT_IO, INTERNAL_FORMAT_IO, SessionDefaults::SDT_BOOLEAN, FALSE, FALSE, TRUE,
            FALSE),
    SDEntry(SessionDefaults::ISO_MAPPING, ISO_MAPPING, SessionDefaults::SDT_ASCII, FALSE, TRUE, TRUE, FALSE),
    SDEntry(SessionDefaults::MASTER_PRIORITY, MASTER_PRIORITY, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE,
            TRUE),
    SDEntry(SessionDefaults::MASTER_PRIORITY_DELTA, MASTER_PRIORITY_DELTA, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::MAX_POLLING_INTERVAL, MAX_POLLING_INTERVAL, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::MXCMP_PRIORITY, MXCMP_PRIORITY, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE,
            TRUE),
    SDEntry(SessionDefaults::MXCMP_PRIORITY_DELTA, MXCMP_PRIORITY_DELTA, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::AUTO_QUERY_RETRY_WARNINGS, MULTI_THREADED_ESP, SessionDefaults::SDT_BOOLEAN, TRUE, TRUE,
            FALSE, FALSE),
    SDEntry(SessionDefaults::ONLINE_BACKUP_TIMEOUT, ONLINE_BACKUP_TIMEOUT, SessionDefaults::SDT_BINARY_SIGNED, TRUE,
            TRUE, TRUE, TRUE),
    SDEntry(SessionDefaults::PARENT_QID, PARENT_QID, SessionDefaults::SDT_ASCII, FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::PARENT_QID_SYSTEM, PARENT_QID_SYSTEM, SessionDefaults::SDT_ASCII, FALSE, FALSE, TRUE,
            FALSE),
    SDEntry(SessionDefaults::PARSER_FLAGS, PARSER_FLAGS, SessionDefaults::SDT_BINARY_SIGNED, FALSE, FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::PERSISTENT_OPENS, PERSISTENT_OPENS, SessionDefaults::SDT_BINARY_SIGNED, FALSE, TRUE, TRUE,
            TRUE),
    SDEntry(SessionDefaults::RECLAIM_FREE_MEMORY_RATIO, RECLAIM_FREE_MEMORY_RATIO, SessionDefaults::SDT_BINARY_SIGNED,
            FALSE, FALSE, TRUE, TRUE),
    SDEntry(SessionDefaults::RECLAIM_FREE_PFS_RATIO, RECLAIM_FREE_PFS_RATIO, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            FALSE, TRUE, TRUE),
    SDEntry(SessionDefaults::RECLAIM_MEMORY_AFTER, RECLAIM_MEMORY_AFTER, SessionDefaults::SDT_BINARY_SIGNED, FALSE,
            FALSE, TRUE, TRUE),
    SDEntry(SessionDefaults::ROWSET_ATOMICITY, ROWSET_ATOMICITY, SessionDefaults::SDT_BINARY_SIGNED, FALSE, FALSE,
            FALSE, FALSE),
    ...
    SDEntry(SessionDefaults::SKIP_END_VALID_DDL_CHECK, SKIP_END_VALID_DDL_CHECK, SessionDefaults::SDT_BOOLEAN, FALSE,
            FALSE, TRUE, FALSE),
    SDEntry(SessionDefaults::STATISTICS_VIEW_TYPE, STATISTICS_VIEW_TYPE, SessionDefaults::SDT_ASCII, FALSE, FALSE, TRUE,
            TRUE),
    ...
    SDEntry(SessionDefaults::USER_EXPERIENCE_LEVEL, USER_EXPERIENCE_LEVEL, SessionDefaults::SDT_ASCII, TRUE, TRUE,
            FALSE, FALSE),
...
SessionDefaults::SessionDefaults(CollHeap *heap)
  ...
  if (gSkipEndValidDDLCheck == -1)  // just do the getenv once per process lifetime
  {
    char *envVar = getenv("STMT_SKIP_END_VALID_DDL_CHECK");
    if (envVar && envVar[0])
      gSkipEndValidDDLCheck = 1;
    else
      gSkipEndValidDDLCheck = 0;
  }
  if (gSkipEndValidDDLCheck == 1) skipEndValidDDLCheck_ = TRUE;

  setSkipEndValidDDLCheck(skipEndValidDDLCheck_);
...
void SessionDefaults::setSessionDefaultAttributeValue(SessionDefaultMap sda, char *attrValue, int attrValueLen) {
  ...
  if (attrValue) {
    if (sda.attributeType == SessionDefaults::SDT_BINARY_SIGNED) {
      ...
      if ((strcmp(attrValue, "ON") == 0) || (strcmp(attrValue, "TRUE") == 0)) defaultValueAsBoolean = TRUE;
    }
  }
  ...
  switch (sda.attribute) {
    ...
    case MULTI_THREADED_ESP:
      setMultiThreadedEsp(defaultValueAsBoolean);
      break;
    ...
    case ISO_MAPPING: {
      if (attrValueLen != strlen(SQLCHARSETSTRING_ISO88591) || strcmp(attrValue, SQLCHARSETSTRING_ISO88591) != 0) {
...
void SessionDefaults::updateDefaultsValueString(SessionDefaultAttribute sda, const Int16 DisAmbiguate,
                                                NABoolean value) {
...
void SessionDefaults::updateDefaultsValueString(SessionDefaultAttribute sda, int value) {
  ...
  if (value < 0) {
    ...
    str_itoa((int)(-value), &defaultsValueString_[sda][1]);
  } else
    str_itoa((int)(value), defaultsValueString_[sda]);
}

void SessionDefaults::updateDefaultsValueString(SessionDefaultAttribute sda, char *value) {
  if (defaultsValueString_[sda]) NADELETEBASIC(defaultsValueString_[sda], heap_);
...
void SessionDefaults::saveSessionDefaults() {
  ...
  for (int i = 0; i < len; i++) {
    ...
    if (defaultsValueString_[i]) {
      savedDefaultsValueString_[i] = new (heap_) char[strlen(defaultsValueString_[i]) + 1];
...
int SessionDefaults::readFromDefaultsTable(CliGlobals *cliGlobals) {
  ...
  if (f) {
    ...
    while (rc = fscanf(f, " %100[A-Za-z0-9_#] ,", attrName) == 0) {
      ...
      attrNameUp.toUpper();
      if (attrNameUp[0] != '#')
        initializeSessionDefault((char *)attrNameUp.data(), attrNameUp.length(), attrValue, str_len(attrValue));
    }
  }
...
short SessionDefaults::getNextSessionDefault(char *&attributeString, char *&attributeValue, int &isCQD,
  ...
  attributeValue = defaultsValueString_[sessionDefaultMap[currDef_].attribute];
...
// class AQRInfo
//////////////////////////////////////////////////////////////////////
static const QueryString cqdInfo[] = {{"unique_hash_joins"},
                                      {"OFF"},
...
static const AQRInfo::AQRErrorMap aqrErrorMap[] = {
    ...
    AQREntry(1582, 0, 1, 0, 1, 1, "03", 0, 0),
    ...
    AQREntry(2034, 0, 3, 1, 2, 0, "", 0, 0),
    AQREntry(2235, 0, 1, 0, 1, 1, "03", 0, 0),

    // compile errors
    AQREntry(4001, 0, 1, 0, 1, 1, "03", 0, 0),
    AQREntry(4023, 0, 1, 0, 1, 1, "03", 0, 0),
    AQREntry(4035, 0, 1, 0, 1, 1, "03", 0, 0),
    AQREntry(4039, 0, 1, 0, 1, 1, "03", 0, 0),

    // object locked due to a backup or restore operation in progress.
    AQREntry(4264, 0, 10, 60, 0, 0, "", 0, 0),

    // error during backup. Retry.
    //  AQREntry(  5050,       0,      1,    60,      0,   0, "",    0,     0),

    // parallel purgedata failed
    AQREntry(8022, 0, 3, 60, 0, 0, "", 0, 1),

    // Apache Sentry privilege authorization expired; AQR will cause
    // a fresh privilege check. Note that we need type of 6 (RETRY_SENTRY_PRIV_CHECK)
    // so that the compiler will bypass query cache and go through metadata cache
    // access to then do the privilege check.
    AQREntry(8360, 0, 1, 0, 6, 0, "", 0, 0),
    ...
    // retry for hdfs access errors
    AQREntry(8458, 0, 30, 5, 0, 0, "", 0, 0),
    ...
    // DDL became invalid while query was executing
    AQREntry(8751, 0, 1, 0, 1, 1, "03", 0, 0),

    // Histogram change detected before query started
    AQREntry(8753, 0, 1, 0, 1, 0, "", 0, 0),
    ...
    AQREntry(8967, 0, 1, 0, 1, 1, "06", 0, 0),
};
  ...
  switch (task) {
    case ComTdbExeUtilAQR::ADD_:  // add
    {
      if (found) {
        ...
        if (((*aqrErrorList_)[(entry - 1)].delay == delay) && ((*aqrErrorList_)[(entry - 1)].retries == retries))
...
short AQRInfo::setAQREntriesFromInputStr(char *inStr, int inStrLen) {
  ...
  while (i < n) {
    ...
    if (newStr[i] == '+') {
      if ((numberSeen) || (task != ComTdbExeUtilAQR::NONE_)) return -1;
    ...
    if (newStr[i] == '|') {
      if (task == ComTdbExeUtilAQR::NONE_) task = ComTdbExeUtilAQR::ADD_;

      if (setAQREntry(task, sqlcode, nskcode, retries, delay, type, numCQDs, cqdStr, cmpInfo, intAQR)) return -1;
...
short AQRInfo::getAQREntry(int sqlcode, int nskcode, int &retries, int &delay, int &type, int &numCQDs, char *&cqdStr,
  ...
  for (UInt32 i = 0; i < aqrErrorList_->entries(); i++) {
    ...
    } else if ((ABS(sqlcode) == (*aqrErrorList_)[i].sqlcode) && ((*aqrErrorList_)[i].nskcode == 0)) {
      nskcodeZeroFound = TRUE;
      nskcodeZeroEntryNum = i;
    } else if ((ABS(sqlcode) == (*aqrErrorList_)[i].sqlcode) && (ABS(nskcode) == (*aqrErrorList_)[i].nskcode))
      found = TRUE;
...
void AQRStatementInfo::clearRetryInfo() {
  ...
  if (savedStmtAttributes_) savedStmtAttributes_->clear();
}

void AQRStatementInfo::saveAttributesFromStmt(Statement *fromStmt) {
  if (savedStmtAttributes_) savedStmtAttributes_->getAttributesFromStatement(fromStmt);
}
void AQRStatementInfo::copyAttributesToStmt(Statement *toStmt) {
  if (savedStmtAttributes_) savedStmtAttributes_->setAttributesInStatement(toStmt);
}
...
AQRStatementAttributes::~AQRStatementAttributes() {
  if (uniqueStmtId_) NADELETEBASIC(uniqueStmtId_, heap_);
...
int AQRInfo::setCompilerInfo(char *queryId, ComCondition *errCond, ContextCli *context) {
  ...
  rc = context->setCS("AQR_COMPILER_INFO", csVal);
...
SessionEnvvar::SessionEnvvar(CollHeap *heap, char *envvarName, char *envvarValue)
    : heap_(heap), envvarName_(NULL), envvarValue_(NULL) {
...
SessionEnvvar::~SessionEnvvar() {
  if (envvarName_) NADELETEBASIC(envvarName_, heap_);

  if (envvarValue_) NADELETEBASIC(envvarValue_, heap_);
}

NABoolean SessionEnvvar::operator==(const SessionEnvvar &other) const {
  if ((!envvarName_) || (!other.envvarName_)) return FALSE;
...
void SessionDefaults::setExSMTraceFilePrefix(const char *attrValue, int attrValueLen) {
  ...
  if (attrValue == NULL || attrValue[0] == 0 || attrValueLen == 0) return;

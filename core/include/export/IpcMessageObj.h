...
inline IpcMessageObjSize packStrIntoBuffer(char *&buffer, char *targetObj, int objSize) {
...
inline void unpackStrFromBuffer(const char *&buffer, char *targetObj, int objSize) {

...
class ex_aggregate_clause : public ex_clause {
 public:
  ...
  //
  ex_aggregate_clause(){};
  ex_aggregate_clause(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space);
...
class ex_aggr_one_row_clause : public ex_aggregate_clause {
 public:
  ...
  ex_aggr_one_row_clause(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space)
...
class ex_aggr_any_true_max_clause : public ex_aggregate_clause {
 public:
  ...
  ex_aggr_any_true_max_clause(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space)
      : ex_aggregate_clause(oper_type, num_operands, attr, space){};
...
class ex_aggr_min_max_clause : public ex_aggregate_clause {
 public:
  ...
  ex_aggr_min_max_clause(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space)
      : ex_aggregate_clause(oper_type, num_operands, attr, space){};
...
class ExFunctionGrouping : public ex_aggregate_clause {
 public:
  ExFunctionGrouping(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Int16 rollupGroupIndex,
                     Space *space)
      : ex_aggregate_clause(oper_type, num_operands, attr, space),
...
class ex_pivot_group_clause : public ex_aggregate_clause {
 public:
  ...
  NABoolean ovflWarn() { return (flags_ & OVFL_WARN) != 0; }
  void setOvflWarn(NABoolean v) { (v ? flags_ |= OVFL_WARN : flags_ &= ~OVFL_WARN); }
...
class ex_arith_clause : public ex_clause {
 ...
 public:
  // Construction
  //
  ex_arith_clause() { setAugmentedAssignOperation(TRUE); }

  ex_arith_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space, short arithRoundingMode,
                  NABoolean divToDownscale);
  ex_arith_clause(clause_type type, OperatorTypeEnum oper_type, Attributes **attr, Space *space);
  ...
  void setInstruction();
  void setInstruction(OperatorTypeEnum op, Attributes *attr1, Attributes *attr2, Attributes *result);
  ...
  ex_expr::exp_return_type unaryArithPCodeGenerate(Space *space, UInt32 flags);

  ex_expr::exp_return_type fixup(Space *space = 0, CollHeap *exHeap = 0, char *constants_area = 0, char *temps_area = 0,
                                 char *persistentArea = 0, short fixupConstsAndTemps = 0,
 ...
 private:
  enum { DIV_TO_DOWNSCALE = 0x01, ALLOW_AUGMENTED_ASSIGN_OPERATION = 0x02 };
  ...
  const ArithInstrStruct *getMatchingRow(OperatorTypeEnum op, short datatype1, short datatype2, short resulttype);

  const ArithInstruction computeCaseIndex(OperatorTypeEnum op, Attributes *attr1, Attributes *attr2,
                                          Attributes *result);

  NABoolean getDivToDownscale() { return (flags_ & DIV_TO_DOWNSCALE) != 0; }
  void setDivToDownscale(NABoolean v) { (v ? flags_ |= DIV_TO_DOWNSCALE : flags_ &= ~DIV_TO_DOWNSCALE); }

 public:
  NABoolean isAugmentedAssignOperation() { return (flags_ & ALLOW_AUGMENTED_ASSIGN_OPERATION) != 0; }
...
class ex_arith_sum_clause : public ex_arith_clause {
 public:
  ex_arith_sum_clause(){};
  ex_arith_sum_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class ex_arith_count_clause : public ex_arith_clause {
 public:
  ...
  ex_arith_count_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class ex_bool_clause : public ex_clause {
 public:
  ...
  //
  ex_bool_clause(){};
  ex_bool_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class bool_result_clause : public ex_clause {
 public:
  ...
  //
  bool_result_clause(){};
  bool_result_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class ex_branch_clause : public ex_clause {
 public:
  ...
  ex_branch_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);

  ex_branch_clause(OperatorTypeEnum oper_type, Space *space);

  // Accessors
  //
  // inline void set_branch_clause(ex_clause*);
  inline void set_branch_clause(ex_clause *clause_) { branch_clause = clause_; };
  // inline void set_saved_next(ex_clause*);
  inline void set_saved_next(ex_clause *clause_) { saved_next_clause = clause_; };
  inline ex_clause *get_branch_clause() { return branch_clause; };
  // inline ex_clause * get_saved_next();
  inline ex_clause *get_saved_next() { return saved_next_clause; };
...
enum CompInstruction {
  ...
  // comparison between sql binary vs binary
  BINARY_COMP = 195,
  // comparison between sql binary vs varbinary
  // or varbinary vs varbinary datatypes
  BINARY_COMP_VAR = 196,

  COMP_NOT_SUPPORTED = 197
};
...
class ex_comp_clause : public ex_clause {
 ...
 public:
  ...
  void setInstruction();
  void setInstruction(OperatorTypeEnum op, Attributes *attr1, Attributes *attr2);
  ...
  NABoolean getCollationEncodeComp() { return ((flags_ & COLLATION_ENCODE_COMP) != 0); }
  void setCollationEncodeComp(NABoolean v) { (v) ? flags_ |= COLLATION_ENCODE_COMP : flags_ &= ~COLLATION_ENCODE_COMP; }
 ...
 private:
  ...
  const CompInstruction computeCaseIndex(OperatorTypeEnum op, Attributes *attr1, Attributes *attr2);
};
...
enum ConvInstruction {
  ...
  // array and row move
  CONV_ARRAY_ARRAY = 287,
  CONV_ROW_ROW = 288,

  CONV_BINARY_TO_BINARY = 289,
  CONV_BINARY_TO_VARBINARY = 290,
  CONV_VARBINARY_TO_BINARY = 291,
  CONV_VARBINARY_TO_VARBINARY = 292,

  CONV_BINARY_TO_OTHER = 293,
  CONV_VARBINARY_TO_OTHER = 294,
  CONV_OTHER_TO_BINARY = 295,
  CONV_OTHER_TO_VARBINARY = 296
};
...
class ex_conv_clause : public ex_clause {
 ...
 public:
  ...
  ex_conv_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space, short num_operands = 2,
                 NABoolean checkTruncErr = FALSE, NABoolean reverseDataErrorConversionFlag = FALSE,
                 NABoolean noStringTruncWarnings = FALSE, NABoolean convertToNullWhenErrorFlag = FALSE,
                 NABoolean padUseZero = FALSE);
  ...
  NABoolean noDatetimeValidation() { return ((flags_ & NO_DATETIME_VALIDATION) != 0); };
  ...
  void setLastVOAoffset(UInt32 v) { lastVOAoffset_ = v; }

  UInt32 getLastVOAoffset() { return lastVOAoffset_; }

  void setLastVcIndicatorLength(Int16 v) { lastVcIndicatorLength_ = v; }
  void setLastNullIndicatorLength(Int16 v) { lastNullIndicatorLength_ = v; }

  void setComputedLength(UInt32 v) { computedLength_ = v; }
  UInt32 getComputedLength() { return computedLength_; }
  void setAlignment(Int16 v) { alignment_ = v; }
  Int16 getAlignment() { return alignment_; }
...
enum ConvDoItFlags {
  ...
  // We will truncate tail '0' in default, and if the following flag is set,
  // we will keep tail '0'.
  CONV_NOT_TRIM_TAIL_ZERO = 0x0100,

  // Pad use '\0' instead of space
  CONV_PAD_USE_ZERO = 0x0200
};
...
inline int requiresNoConvOrVal(int sourceLen, int sourcePrecision, int sourceScale, int targetLen, int targetPrecision,
  ...
  return (
      ...
      (  // source and target charsets are the same, and...
          ...
          (targetLen >= sourceLen || !(CharInfo::isVariableWidthMultiByteCharSet((CharInfo::CharSet)targetScale))) &&

          // ...we do not need to enforce a max. char limit
          //    (target precision is not set or no possibility of exceeding its limit)
          (targetPrecision == 0 ||
           ((targetPrecision >= sourcePrecision && sourcePrecision > 0 || targetPrecision >= sourceLen) &&
...
class ex_function_clause : public ex_clause {
 public:
  ...
  //
  ex_function_clause(){};
  ex_function_clause(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space);
  ...
  NABoolean derivedFunction() { return ((flags_ & DERIVED_FUNCTION) != 0); };

  void setDerivedFunction(NABoolean v) { (v) ? flags_ |= DERIVED_FUNCTION : flags_ &= ~DERIVED_FUNCTION; }

  NABoolean caseInsensitiveOperation() { return ((flags_ & CI_OPERATION) != 0); };

  void setCaseInsensitiveOperation(NABoolean v) { (v) ? flags_ |= CI_OPERATION : flags_ &= ~CI_OPERATION; }

  OperatorTypeEnum origFunctionOperType() { return (OperatorTypeEnum)origFunctionOperType_; }
  void setOrigFunctionOperType(OperatorTypeEnum type) { origFunctionOperType_ = (Int16)type; }
  ...
  char *getUserTextStr() { return (userTextStr_[0] == 0 ? NULL : userTextStr_); }
  const char *getUserTextStr() const { return (userTextStr_[0] == 0 ? NULL : userTextStr_); }
  void setUserTextStr(const char *v) {
    strncpy(userTextStr_, v, MAX_USER_TEXT_STR_LEN);
    userTextStr_[MAX_USER_TEXT_STR_LEN] = 0;
  }
 ...
 private:
  ...
  // as the same function clause.
  // In such cases, error or other internal display would show up as
  // the underlying function clause name instead of the user specified
  // function.
  //
  // For ex, INSTR and POSITION are both created as ex_function_position.
  ...
  // actual user function that was used in the corresponding ItemExpr.
  // This value is moved to userTextStr_ of ex_function_clause during
  // codegen. It is null terminated.
  //
  // If no user specified value is set, then userTextStr_ has '\0'
  // as the first byte.
  //
  // see optimizer/ItemExpr.h for details on userTextStr.
  // ---------------------------------------------------------------------
  enum { MAX_USER_TEXT_STR_LEN = 25 };
  char userTextStr_[26];  // 06-31
...
class ex_inout_clause : public ex_clause {
 public:
  ...
  ex_inout_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class ex_unlogic_clause : public ex_clause {
 public:
  ...
  //
  ex_unlogic_clause(){};
  ex_unlogic_clause(OperatorTypeEnum oper_type, Attributes **attr, Space *space);
...
class ExRegexpClauseBase : public ex_clause {
 public:
  // Construction
  //
  ExRegexpClauseBase() { setCollation(CharInfo::DefaultCollation); }
  ExRegexpClauseBase(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space)
      : ex_clause(ex_clause::LIKE_TYPE, oper_type, num_operands, attr, space) {
  ...
  inline char *getPatternStr() { return patternStr_; }

  inline void setPatternStr(char *pat) { patternStr_ = pat; }
  ...
  // ---------------------------------------------------------------------
 protected:
  inline CharInfo::Collation getCollation() { return (CharInfo::Collation)collation_; }

  inline void setCollation(CharInfo::Collation v) { collation_ = (Int16)v; }
...
class ExRegexpClauseChar : public ExRegexpClauseBase {
 public:
  ...
  ExRegexpClauseChar(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space);
...
class ex_like_clause_base : public ex_clause {
 public:
  // Construction
  //
  ex_like_clause_base() { setCollation(CharInfo::DefaultCollation); }
  ex_like_clause_base(OperatorTypeEnum oper_type, short num_operands, Attributes **attr, Space *space)
      : ex_clause(ex_clause::LIKE_TYPE, oper_type, num_operands, attr, space) {
    setCollation(CharInfo::DefaultCollation);
  }
  ...
  void setAllowEscapeNull(NABoolean v) { allowEscapeNull_ = v; };
...
class ex_like_clause_char : public ex_like_clause_base {
 public:
  ...
  //
  ex_like_clause_char(){};
  ex_like_clause_char(OperatorTypeEnum oper_type, short num_operands, NABoolean allowEscapeNull, Attributes **attr,
                      Space *space);
...
class ex_like_clause_doublebyte : public ex_like_clause_base {
 public:
  ...
  ex_like_clause_doublebyte(OperatorTypeEnum oper_type, short num_operands, NABoolean allowEscapeNull,
...
class ExFunctionRangeOfValues : public ex_aggregate_clause {
 public:
  ...
  static NABoolean IsRangeOfValuesEnum(OperatorTypeEnum x) {
    return (x == ITM_RANGE_VALUES_MERGE || x == ITM_RANGE_VALUES_INSERT || x == ITM_RANGE_VALUES_COPY ||
            x == ITM_RANGE_VALUES_UNPACK || x == ITM_RANGE_VALUES_IN);
  }

  ex_expr::exp_return_type fixup(Space *space, CollHeap *exHeap, char *constantsArea, char *tempsArea,
  ...
  RangeOfValues *get() { return rangeOfValues_; };
  ...
  // linked in clause
  static ex_expr::exp_return_type conditionalPack(ex_clause *clause, atp_struct *atp, OperatorTypeEnum op,
                                                  const char *msg = NULL, NABoolean clearWhenDone = TRUE,
                                                  ScanFilterStatsList *stats = NULL,
                                                  ScanFilterStats::MergeSemantics = ScanFilterStats::COPY);

  // check this ExFunctionRangeOfValues object for possibility
  // in bad shape and disable the object if so.
  void sanityCheck();

  // init this object before each execution of a statement
  ex_expr::exp_return_type init();

  // check all ExFunctionRangeOfValues objects for possibility
  // in bad shape.
  ...
  static void conditionalPrint(ostream &out, ex_clause *cptr, OperatorTypeEnum op, const char *msg);

  static void showRSA(ex_clause *cptr, OperatorTypeEnum op, const char *msg);

  void displayOpData(const char *msg, char *op_data[], CollHeap *hea);
  void displayOpData(fstream &out, const char *msg, char *op_data[], CollHeap *hea);

 private:
  RangeOfValues *rangeOfValues_;

  // total bytes in the allocated memory to pack into.
  UInt32 totalSizeCap_;

  Int16 filterId_;

  NABoolean dumpDebugData_;

  // An indicator on whether to treat a date value as
  // a timestamp..
  NABoolean treatDateAsTimestamp_;

...
enum ExeErrorCode {
  ...
  EXE_GSS_EXCEPTION_ERROR = 8037,
  EXE_CONNECT_BY_LOOP_ERROR = 8038,
  EXE_CONNECT_BY_MAX_REC_ERROR = 8039,
  EXE_CONNECT_BY_MAX_MEM_ERROR = 8040,
  ...
  EXE_STMT_RUNTIME_ERROR = 8146,

  // ---------------------------------------------------------------------
  // Errors pertaining to the Object Epoch Cache
  // ---------------------------------------------------------------------
  EXE_OEC_UNEXPECTED_STATE = 8148,
  EXE_OEC_UNABLE_TO_GET_DIST_LOCK = 8149,
  EXE_OEC_INTERNAL_ERROR = 8150,
  EXE_OEC_CACHE_FULL = 8151,

  // ---------------------------------------------------------------------
  // Errors used for the Object Lock
  // ---------------------------------------------------------------------
  EXE_OL_UNABLE_TO_GET_DIST_LOCK = 8200,
  EXE_OL_UNABLE_TO_GET_DDL_LOCK = 8201,
  EXE_OL_UNABLE_TO_GET_DML_LOCK = 8202,
  EXE_OL_UNABLE_TO_RELEASE_DDL_LOCK = 8203,
  EXE_OL_RELEASE_DDL_LOCK_TOO_EARLY = 8204,
  EXE_OL_OUT_OF_LOCK_ENTRY = 8205,
  EXE_OL_CLEANUP_PARTIAL_LOCK = 8206,
  ...
  //----------------------------------------------------------------------
  // Run-time privilege checking
  //----------------------------------------------------------------------
  EXE_APACHE_SENTRY_PRIV_EXPIRED = 8360,
  ...
  EXE_TOKEN_NOT_FOUND = 8438,
  EXE_TENANT_FUNCTION_ERROR = 8439,
  ...
  EXE_TOO_MANY_LOBHANDLES_ERROR = 8444,
  EXE_ERROR_HDFS_SCAN = 8447,
  EXE_INVALID_INTERVAL_RESULT = 8456,
  EXE_HIVE_ROW_TOO_LONG = 8457,
  EXE_ERROR_FROM_LOB_INTERFACE_RETRY = 8458,
  EXE_OPERAND_OUT_OF_RANGE = 8459,
  EXE_LAST_EXPRESSIONS_ERROR = 8499,
  EXE_OLAP_NEGATIVE_OFFSET = 8558,
  EXE_RANGE_VALUES_INVALID_OPERATOR_TYPE = 8559,
  EXE_RANGE_VALUES_UNPACK_NO_ENOUGH_SPACE = 8560,
  EXE_RANGE_VALUES_COPY_LENGTHS_DIFF = 8561,
  EXE_RANGE_VALUES_UNSUPPORTED_TYPE = 8562,
  EXE_ENCODE_DECODE_ERROR = 8564,
  ...
  EXE_LOB_CONCURRENT_ACCESS_ERROR = 8563,
  ...
  EXE_SAVEPOINT_NEED_USER_XN = 8611,
  ...
  EXE_BEGIN_SAVEPOINT_ERROR = 8617,
  EXE_COMMIT_SAVEPOINT_ERROR = 8618,
  EXE_ROLLBACK_SAVEPOINT_ERROR = 8619,
  EXE_SAVEPOINT_OPERATION_ERROR = 8620,
  EXE_SAVEPOINT_MODE_CANNOT_BE_SET = 8621,
  EXE_LAST_CONCURRENCY_CONTROL_ERROR = 8629,
  EXE_SAVEPOINT_NAME_NOT_FOUND = 8630,
  ...
  CLI_TENANT_NOT_REGISTERED = 8747,
  CLI_ASSIGN_CGROUP = 8748,  // See CGroups.cpp
  CLI_CREATE_CGROUP = 8749,  // See CGroups.cpp
  CLI_CONFLICTING_CONCURRENT_DDL = 8750,
  CLI_STMT_CONFLICTING_CONCURRENT_DDL = 8751,
  CLI_CANNOT_EXECUTE_DDL = 8752,
  CLI_HISTOGRAM_UPDATE = 8753,
  ...
  EXE_JSON_INVALID_KEY_NULL = 8982,
  EXE_JSON_PATH_LANGUAGE_INVALID = 8983,
  EXE_JSON_PATH_RESULT_ONLY_ONE_ELEM_ALLOW = 8984,
  EXE_JSON_PATH_RESULT_NOT_SCALAR = 8985,
  EXE_JSON_PATH_RESULT_EMPTY = 8986,
  EXE_JSON_PATH_RESULT_NEED_ARRAY_WRAPPER = 8987,
  EXE_JSON_CHARSET_MISMATCH = 8988,
  EXE_JSON_UNEXPECTED_ERROR = 8989,

  // ---------------------------------------------------------------------
  // Built-in Function ( to_char )
  // ---------------------------------------------------------------------
  EXE_TOCHAR_INVALID_FORMAT_ERROR = 8990,
  ...
  // trigger error
  EXE_STATEMENT_TRIGGER_FAIL = 11007,
  // ---------------------------------------------------------------------
  ...
  // Sequence error
  // ---------------------------------------------------------------------
  FAIL_TO_ACQUIRE_LOCK = 30048,

  FAIL_TO_ACQUIRE_DISTRIBUTED_LOCK = 1238,

  // ---------------------------------------------------------------------
  // Error code related to row-level lock
  // ---------------------------------------------------------------------
  EXE_ROW_LEVEL_LOCK_TIMEOUT_ERROR = 30052,
  EXE_ROW_LEVEL_LOCK_LOCKREQUIRED_ERROR = 30053,
  EXE_ROW_LEVEL_DEAD_LOCK_ERROR = 30054,
  EXE_HBASE_RPC_TIME_OUT_ERROR = 30055,
  EXE_HBASE_LOCK_REGION_MOVE_ERROR = 30056,
  EXE_HBASE_LOCK_REGION_SPLIT_ERROR = 30057,
  EXE_LOCK_NOT_ENOUGH_RESOURCE = 30058,
  EXE_ROW_LEVEL_LOCK_ROLLBACK_ERROR = 30059,

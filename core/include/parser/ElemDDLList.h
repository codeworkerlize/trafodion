...
class ElemDDLList : public ElemDDLNode {
 public:
  ...
  ElemDDLList(const enum OperatorTypeEnum operType, ElemDDLNode *commaExpr, ElemDDLNode *otherExpr);
  ...
  virtual void traverseList(ElemDDLNode *pOtherNode, void (*visitNode)(ElemDDLNode *, CollIndex, ElemDDLNode *));
 ...
 private:
  ...
  void initializeDataMembers(ElemDDLNode *commaExpr, ElemDDLNode *otherExpr);
  ...
  enum { INDEX_ELEM_DDL_LIST_CHILD = 0, INDEX_ELEM_DDL_NODE_CHILD, MAX_ELEM_DDL_LIST_ARITY };
...
inline ElemDDLList *ElemDDLList::getParentListNode() const { return pParentListNode_; }

//
// mutator
//

inline void ElemDDLList::setParentListNode(ElemDDLList *pParentListNode) { pParentListNode_ = pParentListNode; }

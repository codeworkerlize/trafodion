...
class ElemDDLTenantOption : public ElemDDLNode {
 public:
  ...
  // constructors
  // option value
  ElemDDLTenantOption(TenantOptions tenantOption, const char *optionValue, CollHeap *h = PARSERHEAP())
  ...
  // schema name
  ElemDDLTenantOption(TenantOptions tenantOption, const SchemaName *schemaName, CollHeap *h = PARSERHEAP())
      : ElemDDLNode(ELM_TENANT_OPTION_ELEM),
        tenantOption_(tenantOption),
        optionValue_(NULL),
        optionList_(NULL),
  ...
  // option list
  ElemDDLTenantOption(TenantOptions tenantOption, ElemDDLNode *optionList, CollHeap *h = PARSERHEAP())
      : ElemDDLNode(ELM_TENANT_OPTION_ELEM),
        tenantOption_(tenantOption),
        optionValue_(NULL),
  ...
  // node list
  ElemDDLTenantOption(TenantOptions tenantOption, const ConstStringList *optionList, CollHeap *h = PARSERHEAP())
      : ElemDDLNode(ELM_TENANT_OPTION_ELEM),
        tenantOption_(tenantOption),
        optionValue_(NULL),
        optionList_(NULL),
  ...
  ElemDDLTenantOption(TenantOptions tenantOption, char *optionValue, const ConstStringList *optionList,

...
#include "parser/ElemDDLReplicateClause.h"
#include "parser/ElemDDLSaltOptions.h"
#include "parser/ElemDDLTableFeature.h"
...
class StmtDDLCreateTable : public StmtDDLNode {
  ...
  //
  friend void StmtDDLCreateTable_visitPartitionElement(ElemDDLNode *pThisNode, CollIndex index, ElemDDLNode *pElement);

  friend void StmtDDLCreateTable_visitPartitionV2Element(ElemDDLNode *pThisNode, CollIndex index,
                                                         ElemDDLNode *pElement);

  friend void StmtDDLPartition_visitSubpartitionElement(ElemDDLNode *pPartition, CollIndex index,
                                                        ElemDDLNode *pElement);

 public:
  // (default) constructor
  StmtDDLCreateTable(const QualifiedName &TableQualName, ElemDDLNode *pTableBodyDefinition,
                     ElemDDLNode *pCreateTableAttributeList = NULL, ElemDDLNode *pInsertColumnsList = NULL,
                     RelExpr *queryExpression = NULL, CollHeap *heap = PARSERHEAP());
  ...
  inline const StmtDDLAddConstraintCheckArray &getAddConstraintCheckArray() const;
  ...
  inline const StmtDDLAddConstraintUniqueArray &getAddConstraintUniqueArray() const;
  ...
  inline ElemDDLPartitionV2Array &getPartitionV2Array();
  inline NABoolean isPartitionByClauseV2Spec();
  inline const ElemDDLColRefArray &getPartitionV2ColRefArray() const;
  inline const ElemDDLColRefArray &getSubpartitionColRefArray() const;
  inline void setPartitionType(ComPartitioningSchemeV2 val);
  inline void setSubpartitionType(ComPartitioningSchemeV2 val);
  inline const ComPartitioningSchemeV2 getPartitionType() const;
  inline const ComPartitioningSchemeV2 getSubpartitionType() const;
  ...
  inline NABoolean isLobStorageOptionsSpecified() const;

  // returns TRUE if LOB STORAGE OPTIONS clause appears;
  // returns FALSE otherwise.
  ...
  inline const NAString &getHiveOptions() { return hiveOptions_; }
  void setHiveOptions(NAString h) { hiveOptions_ = h; }
  ...
  ComBoolean isRegularTable() const { return (eInsertMode_ == COM_REGULAR_TABLE_INSERT_MODE); }
  ComBoolean isSetTable() const { return (eInsertMode_ == COM_SET_TABLE_INSERT_MODE); }
  ComBoolean isMultiSetTable() const { return (eInsertMode_ == COM_MULTISET_TABLE_INSERT_MODE); }
  ...
  inline ElemDDLReplicateClause *getReplicateClause();
  inline ElemDDLHbaseOptions *getHbaseOptionsClause();
  inline ElemDDLLobStorageOptions *getLobStorageOptionsClause();
  ...
  inline void setIsStoreByClauseSpecifiedFlag(NABoolean bFlag = TRUE) { isStoreByClauseSpec_ = bFlag; }
 ...
 private:
  ...
  void setPartitionsV2(ElemDDLPartitionClauseV2 *pPartitionClauseNodeV2);
  ...
  void setPartitionV2ColRef(ElemDDLPartitionClauseV2 *pPartitionClauseV2);
  ...
  // new PARTITION table, compatible with famous O
  NABoolean isPartitionByClauseV2Spec_;
  ElemDDLPartitionV2Array partitionV2Array_;
  ElemDDLColRefArray partitionV2ColRefArray_;
  ElemDDLColRefArray subpartitionColRefArray_;
  ComPartitioningSchemeV2 partitionType_;
  ComPartitioningSchemeV2 subpartitionType_;
  ...
  // REPLICATE clause for HBase tables
  ElemDDLReplicateClause *pReplicateClause_;
  ...
  // LOB STORAGE OPTIONS clause
  NABoolean isLobStorageOptionsSpec_;
  ElemDDLLobStorageOptions *pLobStorageOptionsParseNode_;
  ...
  enum { INDEX_TABLE_DEFINITION = 0, INDEX_ATTRIBUTE_LIST, MAX_STMT_DDL_CREATE_TABLE_ARITY };
...
inline QualifiedName &StmtDDLCreateTable::getOrigTableNameAsQualifiedName() { return origTableQualName_; }

inline const QualifiedName &StmtDDLCreateTable::getOrigTableNameAsQualifiedName() const { return origTableQualName_; }

inline QualifiedName &StmtDDLCreateTable::getTableNameAsQualifiedName() { return tableQualName_; }

inline const QualifiedName &StmtDDLCreateTable::getTableNameAsQualifiedName() const { return tableQualName_; }

inline StmtDDLAddConstraintCheckArray &StmtDDLCreateTable::getAddConstraintCheckArray() {
  return addConstraintCheckArray_;
}

inline const StmtDDLAddConstraintCheckArray &StmtDDLCreateTable::getAddConstraintCheckArray() const {
  return addConstraintCheckArray_;
}

inline StmtDDLAddConstraintPK *StmtDDLCreateTable::getAddConstraintPK() const { return pAddConstraintPK_; }

inline StmtDDLAddConstraintRIArray &StmtDDLCreateTable::getAddConstraintRIArray() { return addConstraintRIArray_; }

inline const StmtDDLAddConstraintRIArray &StmtDDLCreateTable::getAddConstraintRIArray() const {
  return addConstraintRIArray_;
}

inline StmtDDLAddConstraintUniqueArray &StmtDDLCreateTable::getAddConstraintUniqueArray() {
  return addConstraintUniqueArray_;
}

inline const StmtDDLAddConstraintUniqueArray &StmtDDLCreateTable::getAddConstraintUniqueArray() const {
  return addConstraintUniqueArray_;
}
...
// Table statement.)
//
inline const ElemDDLColDefArray &StmtDDLCreateTable::getColDefArray() const { return columnDefArray_; }
inline ElemDDLColDefArray &StmtDDLCreateTable::getColDefArray() { return columnDefArray_; }

inline const ParDDLFileAttrsCreateTable &StmtDDLCreateTable::getFileAttributes() const { return fileAttributes_; }

inline ParDDLFileAttrsCreateTable &StmtDDLCreateTable::getFileAttributes() { return fileAttributes_; }

inline const NAString &StmtDDLCreateTable::getGuardianLocation() const { return guardianLocation_; }

inline NABoolean StmtDDLCreateTable::getIsConstraintPKSpecified() const { return isPrimaryKeyClauseSpec_; }

// is the like clause specified?
inline NABoolean StmtDDLCreateTable::getIsLikeOptionSpecified() const { return isLikeClauseSpec_; }

// is location clause/phrase specified?
inline NABoolean StmtDDLCreateTable::getIsLocationSpecified() const { return isLocationClauseSpec_; }

// is the STORE BY clause specified?
// same as getIsStoreBySpecified()
inline NABoolean StmtDDLCreateTable::getIsStoreBySpecified() const { return isStoreByClauseSpec_; }

// is the STORE BY clause a UNIQUE keylist?
// same as getIsUniqueStoreByKeylistSpecified()
inline NABoolean StmtDDLCreateTable::getIsUniqueStoreByKeylistSpecified() const { return isUniqueStoreByKeylist_; }

// is the STORE BY clause a UNIQUE primary key?
// same as getIsUniqueStoreByPrimaryKeySpecified()
inline NABoolean StmtDDLCreateTable::getIsUniqueStoreByPrimaryKeySpecified() const {
  return isUniqueStoreByPrimaryKey_;
}

// is HASH partition specified?
inline NABoolean StmtDDLCreateTable::getIsHashV1PartitionSpecified() const { return isHashV1PartitionSpec_; }

// is HASH2 partition specified?
inline NABoolean StmtDDLCreateTable::getIsHashV2PartitionSpecified() const { return isHashV2PartitionSpec_; }
...
inline const ElemDDLColRefArray &StmtDDLCreateTable::getKeyColumnArray() const { return keyColRefArray_; }

// get key column list in STORE BY clause
inline ElemDDLColRefArray &StmtDDLCreateTable::getKeyColumnArray() { return keyColRefArray_; }

// if LIKE clause is not specified, an
// empty string is returned
inline const CorrName &StmtDDLCreateTable::getLikeSourceTableCorrName() const { return likeSourceTableCorrName_; }

inline const NAString StmtDDLCreateTable::getLikeSourceTableName() const {
  return likeSourceTableCorrName_.getQualifiedNameObj().getQualifiedNameAsAnsiString();
}

inline void StmtDDLCreateTable::setLikeSourceTableName(CorrName &srcName) { likeSourceTableCorrName_ = srcName; }

inline QualifiedName &StmtDDLCreateTable::getOrigLikeSourceTableName() { return origLikeSourceTableQualName_; }

inline const QualifiedName &StmtDDLCreateTable::getOrigLikeSourceTableName() const {
  return origLikeSourceTableQualName_;
}

//++ MV
inline const ExtendedQualName::SpecialTableType StmtDDLCreateTable::getLikeSourceTableType() const {
...
inline const ParDDLLikeOptsCreateTable &StmtDDLCreateTable::getLikeOptions() const { return likeOptions_; }

inline ParDDLLikeOptsCreateTable &StmtDDLCreateTable::getLikeOptions() { return likeOptions_; }

inline const NAString &StmtDDLCreateTable::getLocation() const { return locationName_; }

inline NAString StmtDDLCreateTable::getLocationName() const { return locationName_; }

inline NAString StmtDDLCreateTable::getPartitionName() const { return partitionName_; }

inline ElemDDLLocation::locationNameTypeEnum StmtDDLCreateTable::getLocationNameType() const {
...
// parse node contains all legal attributes
// associating with a partition)
inline const ElemDDLPartitionArray &StmtDDLCreateTable::getPartitionArray() const { return partitionArray_; }
inline ElemDDLPartitionArray &StmtDDLCreateTable::getPartitionArray() { return partitionArray_; }

inline const NAString &StmtDDLCreateTable::getSplitByClause() const { return splitByClause_; }

// new partition table implement
inline ElemDDLPartitionV2Array &StmtDDLCreateTable::getPartitionV2Array() { return partitionV2Array_; }

inline NABoolean StmtDDLCreateTable::isPartitionByClauseV2Spec() { return isPartitionByClauseV2Spec_; }

inline const ElemDDLColRefArray &StmtDDLCreateTable::getPartitionV2ColRefArray() const {
  return partitionV2ColRefArray_;
}

inline const ElemDDLColRefArray &StmtDDLCreateTable::getSubpartitionColRefArray() const {
  return subpartitionColRefArray_;
}

inline void StmtDDLCreateTable::setPartitionType(ComPartitioningSchemeV2 val) { partitionType_ = val; }

inline void StmtDDLCreateTable::setSubpartitionType(ComPartitioningSchemeV2 val) { subpartitionType_ = val; }

inline const ComPartitioningSchemeV2 StmtDDLCreateTable::getPartitionType() const { return partitionType_; }

inline const ComPartitioningSchemeV2 StmtDDLCreateTable::getSubpartitionType() const { return subpartitionType_; }

// get column name list in primary key clause
inline const ElemDDLColRefArray &StmtDDLCreateTable::getPrimaryKeyColRefArray() const { return primaryKeyColRefArray_; }

// get column name list in primary key clause
inline ElemDDLColRefArray &StmtDDLCreateTable::getPrimaryKeyColRefArray() { return primaryKeyColRefArray_; }

// get column name list in partition by clause
inline const ElemDDLColRefArray &StmtDDLCreateTable::getPartitionKeyColRefArray() const {
  return partitionKeyColRefArray_;
}

// get column name list in partition by clause
inline ElemDDLColRefArray &StmtDDLCreateTable::getPartitionKeyColRefArray() { return partitionKeyColRefArray_; }

// is HBASE_OPTIONS specified?
inline NABoolean StmtDDLCreateTable::isHbaseOptionsSpecified() const { return isHbaseOptionsSpec_; }

// is LOB STORAGE OPTIONS specified?
inline NABoolean StmtDDLCreateTable::isLobStorageOptionsSpecified() const { return isLobStorageOptionsSpec_; }

// is the DIVISION BY clause specified?
// same as getIsDivisionClauseSpecified()
inline NABoolean StmtDDLCreateTable::isDivisionClauseSpecified() const { return isDivisionByClauseSpec_; }

inline NABoolean StmtDDLCreateTable::getIsDivisionClauseSpecified() const { return isDivisionByClauseSpec_; }

inline ElemDDLDivisionClause::divisionTypeEnum StmtDDLCreateTable::getDivisionType() const {
  return (pDivisionByClauseParseNode_ EQU NULL ? ElemDDLDivisionClause::UNKNOWN_DIVISION_TYPE
                                               : pDivisionByClauseParseNode_->getDivisionType());
}

inline ElemDDLDivisionClause *StmtDDLCreateTable::getDivisionClause() { return pDivisionByClauseParseNode_; }

inline ItemExprList *StmtDDLCreateTable::getDivisionExprList() {
  return (pDivisionByClauseParseNode_ EQU NULL ? NULL : pDivisionByClauseParseNode_->getDivisionExprList());
}

inline ElemDDLColRefArray *StmtDDLCreateTable::getDivisionColRefArray() {
  return (pDivisionByClauseParseNode_ EQU NULL ? NULL : &pDivisionByClauseParseNode_->getDivisionColRefArray());
}

inline ElemDDLHbaseOptions *StmtDDLCreateTable::getHbaseOptionsClause() { return pHbaseOptionsParseNode_; }

inline ElemDDLLobStorageOptions *StmtDDLCreateTable::getLobStorageOptionsClause() {
  return pLobStorageOptionsParseNode_;
}

inline ElemDDLSaltOptionsClause *StmtDDLCreateTable::getSaltOptions() { return pSaltOptions_; }

inline ElemDDLReplicateClause *StmtDDLCreateTable::getReplicateClause() { return pReplicateClause_; }
...
inline ComStoreOption StmtDDLCreateTable::getStoreOption() const { return storeOption_; }

// get table name
inline const NAString StmtDDLCreateTable::getTableName() const { return tableQualName_.getQualifiedNameAsAnsiString(); }

// is the like clause specified?
// same as getIsLikeOptionSpecified()
inline NABoolean StmtDDLCreateTable::isLikeOptionSpecified() const { return isLikeClauseSpec_; }

// is location clause/phrase specified?
// same as getIsLocationSpecified()
inline NABoolean StmtDDLCreateTable::isLocationSpecified() const { return isLocationClauseSpec_; }

// is PARTITION clause specified?
inline NABoolean StmtDDLCreateTable::isPartitionSpecified() const { return isPartitionClauseSpec_; }

// is PARTITION BY clause specified?
inline NABoolean StmtDDLCreateTable::isPartitionBySpecified() const { return isPartitionByClauseSpec_; }

inline NABoolean StmtDDLCreateTable::isSplitBySpecified() const { return isSplitByClauseSpec_; }

// is the STORE BY clause specified?
// same as getIsStoreBySpecified()
inline NABoolean StmtDDLCreateTable::isStoreBySpecified() const { return isStoreByClauseSpec_; }

// is the STORE BY clause's key list qualified by UNIQUE?
inline NABoolean StmtDDLCreateTable::isUniqueStoreByKeylistSpecified() const { return isUniqueStoreByKeylist_; }

// is the STORE BY clause's primary key qualified by UNIQUE?
inline NABoolean StmtDDLCreateTable::isUniqueStoreByPrimaryKeySpecified() const { return isUniqueStoreByPrimaryKey_; }

// is the attributes clause specified?
inline NABoolean StmtDDLCreateTable::isAttributeSpecified() const { return isAttributeClauseSpec_; }

inline void StmtDDLCreateTable::setIsRoundRobinPartitioningSpecified() { isRoundRobinPartitioningSpecified_ = TRUE; }

// ++MV
inline NABoolean StmtDDLCreateTable::isSpecialTypeSpecified() const { return isSpecialTypeSpecified_; }
...
inline const ElemDDLNode *StmtDDLCreateTable::insertColumnsList() const { return pInsertColumnsList_; }

inline ElemDDLNode *StmtDDLCreateTable::insertColumnsList() { return pInsertColumnsList_; }

inline const RelExpr *StmtDDLCreateTable::getQueryExpression() const { return pQueryExpression_; }

inline RelExpr *StmtDDLCreateTable::getQueryExpression() { return pQueryExpression_; }

inline const StringPos StmtDDLCreateTable::getStartOfCreateTableQueryPosition() const {
  return startOfCreateTableQuery_;
}

inline void StmtDDLCreateTable::setStartOfCreateTableQueryPosition(const StringPos startPos) {
  startOfCreateTableQuery_ = startPos;
}

inline const StringPos StmtDDLCreateTable::getStartOfCreateTableAsAttrListPosition() const {
  return startOfCreateTableAsAttrList_;
}

inline void StmtDDLCreateTable::setStartOfCreateTableAsAttrListPosition(const StringPos startPos) {
  startOfCreateTableAsAttrList_ = startPos;
}

inline const StringPos StmtDDLCreateTable::getEndOfCreateTableAsAttrListPosition() const {
  return endOfCreateTableAsAttrList_;
}

inline void StmtDDLCreateTable::setEndOfCreateTableAsAttrListPosition(const StringPos endPos) {
  endOfCreateTableAsAttrList_ = endPos;
}

inline const StringPos StmtDDLCreateTable::getEndOfCreateTableAsWithClausePosition() const {
  return endOfCreateTableAsWithClause_;
}

inline void StmtDDLCreateTable::setEndOfCreateTableAsWithClausePosition(const StringPos endPos) {
...
inline ExtendedQualName::SpecialTableType StmtDDLCreateTable::getTableType() const { return tableType_; }

//-- MV

// POS
NABoolean StmtDDLCreateTable::isPOSNumPartnsSpecified() const { return isPOSNumPartnsSpecified_; }

NABoolean StmtDDLCreateTable::isPOSInitialTableSizeSpecified() const { return isPOSInitialTableSizeSpecified_; }

NABoolean StmtDDLCreateTable::isPOSMaxTableSizeSpecified() const { return isPOSMaxTableSizeSpecified_; }

NABoolean StmtDDLCreateTable::isPOSIgnoreSpecified() const { return isPOSIgnoreSpecified_; }

NABoolean StmtDDLCreateTable::isPOSDiskPoolSpecified() const { return isPOSDiskPoolSpecified_; }

inline ComSInt32 StmtDDLCreateTable::getPOSDiskPool() const { return posDiskPool_; }

inline void StmtDDLCreateTable::setPOSDiskPool(ComSInt32 diskPool) { posDiskPool_ = diskPool; }

inline ComSInt32 StmtDDLCreateTable::getPOSNumDiskPools() const { return posNumDiskPools_; }

inline void StmtDDLCreateTable::setPOSNumDiskPools(ComSInt32 numOfDiskPools) { posNumDiskPools_ = numOfDiskPools; }
NABoolean StmtDDLCreateTable::isNumRowsSpecified() const { return isNumRowsSpecified_; }

NABoolean StmtDDLCreateTable::isIndexLevelsSpecified() const { return isIndexLevelsSpecified_; }

NABoolean StmtDDLCreateTable::isPartnEOFSpecified() const { return isPartnEOFSpecified_; }

inline ComSInt32 StmtDDLCreateTable::getPOSNumPartns() const { return posNumPartns_; }

inline ComSInt32 StmtDDLCreateTable::getPOSInitialTableSize() const { return posInitialTableSize_; }

inline ComSInt32 StmtDDLCreateTable::getPOSMaxTableSize() const { return posMaxTableSize_; }

inline NABoolean StmtDDLCreateTable::getPOSIgnore() const { return posIgnore_; }

inline double StmtDDLCreateTable::getNumRows() const { return numRows_; }

inline ComSInt32 StmtDDLCreateTable::getIndexLevels() const { return indexLevels_; }

inline ComSInt64 StmtDDLCreateTable::getPartnEOF() const { return partnEOF_; }

inline void StmtDDLCreateTable::setPOSNumPartns(ComSInt32 partns) { posNumPartns_ = partns; }

inline void StmtDDLCreateTable::setIsPOSNumPartnsSpecified(NABoolean flag) { isPOSNumPartnsSpecified_ = flag; }

inline ComInsertMode StmtDDLCreateTable::getInsertMode() const { return eInsertMode_; }

inline void StmtDDLCreateTable::setInsertMode(ComInsertMode insertMode) { eInsertMode_ = insertMode; }

inline void StmtDDLCreateTable::setCTAcolumnsAreRenamed(NABoolean r) { ctaColumnsAreRenamed_ = r; }

inline NABoolean StmtDDLCreateTable::ctaColumnsAreRenamed() { return ctaColumnsAreRenamed_; }

inline void StmtDDLCreateTable::setLoadIfExists(NABoolean l) { loadIfExists_ = l; }

inline NABoolean StmtDDLCreateTable::loadIfExists() { return loadIfExists_; }

inline void StmtDDLCreateTable::setNoLoad(NABoolean l) { noLoad_ = l; }

inline void StmtDDLCreateTable::setDeleteData(NABoolean d) { deleteData_ = d; }

inline NABoolean StmtDDLCreateTable::deleteData() { return deleteData_; }

inline NABoolean StmtDDLCreateTable::noLoad() { return noLoad_; }

// is the attributes clause specified?
inline NABoolean StmtDDLCreateTable::isTableFeatureSpecified() const { return isTableFeatureSpecified_; }

inline void StmtDDLCreateTable::setTableFeature(ElemDDLTableFeature *pFeature) {
  if (isTableFeatureSpecified_) *SqlParser_Diags << DgSqlCode(-3167);
...
inline NABoolean StmtDDLCreateTable::isDroppable() { return isDroppable_; }
inline NABoolean StmtDDLCreateTable::isInsertOnly() { return isInsertOnly_; }

inline const ElemDDLSGOptions *StmtDDLCreateTable::getSGOptions() const { return pSGOptions_; }

inline ElemDDLSGOptions *StmtDDLCreateTable::getSGOptions() { return pSGOptions_; }

inline void StmtDDLCreateTable::setSGOptions(ElemDDLSGOptions *pSGOptions) { pSGOptions_ = pSGOptions; }
...
class StmtDDLCreateHbaseTable : public StmtDDLNode {
 public:
  // (default) constructor
  StmtDDLCreateHbaseTable(const QualifiedName &TableQualName, ConstStringList *csl,
                          ElemDDLHbaseOptions *hbaseOptions = NULL, CollHeap *heap = PARSERHEAP());
...
inline QualifiedName &StmtDDLCreateHbaseTable::getOrigTableNameAsQualifiedName() { return origTableQualName_; }

inline const QualifiedName &StmtDDLCreateHbaseTable::getOrigTableNameAsQualifiedName() const {
  return origTableQualName_;
}

inline QualifiedName &StmtDDLCreateHbaseTable::getTableNameAsQualifiedName() { return tableQualName_; }

inline const QualifiedName &StmtDDLCreateHbaseTable::getTableNameAsQualifiedName() const { return tableQualName_; }

// get table name
inline const NAString StmtDDLCreateHbaseTable::getTableName() const {
  return tableQualName_.getQualifiedNameAsAnsiString();
}

inline ElemDDLHbaseOptions *StmtDDLCreateHbaseTable::getHbaseOptionsClause() { return pHbaseOptionsParseNode_; }

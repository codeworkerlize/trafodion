...
class StmtDDLCreateIndex : public StmtDDLNode {
 ...
 private:
  ...
  // list of additional user specified table columns added to the index.
  // These cols are not part of index key.
  ElemDDLColRefArray addnlColumnRefArray_;

  // create only if index doesnt exist. Otherwise just return.

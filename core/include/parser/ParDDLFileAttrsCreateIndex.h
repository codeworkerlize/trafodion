...
class ParDDLFileAttrsCreateIndex : public ParDDLFileAttrs {
 public:
  ...
  ParDDLFileAttrsCreateIndex(
      ParDDLFileAttrs::fileAttrsNodeTypeEnum fileAttrsNodeType = ParDDLFileAttrs::FILE_ATTRS_CREATE_INDEX);

  // copy constructor
  ParDDLFileAttrsCreateIndex(const ParDDLFileAttrsCreateIndex &createIndexFileAttributes);

  // virtual destructor
  virtual ~ParDDLFileAttrsCreateIndex();

  // assignment operator
  ParDDLFileAttrsCreateIndex &operator=(const ParDDLFileAttrsCreateIndex &rhs);
...
inline NABoolean ParDDLFileAttrsCreateIndex::getIsBuffered() const { return isBuffered_; }

inline NABoolean ParDDLFileAttrsCreateIndex::getIsClearOnPurge() const { return isClearOnPurge_; }

inline ComCompressionType ParDDLFileAttrsCreateIndex::getCompressionType() const { return compressionType_; }

inline NABoolean ParDDLFileAttrsCreateIndex::getIsDCompress() const { return isDCompress_; }
...
inline NABoolean ParDDLFileAttrsCreateIndex::isAllocateSpecified() const { return isAllocateSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isAuditCompress() const { return getIsAuditCompress(); }

// is the [No] AuditCompress phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isAuditCompressSpecified() const { return isAuditCompressSpec_; }

// is the BlockSize phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isBlockSizeSpecified() const { return isBlockSizeSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isBuffered() const { return getIsBuffered(); }

// is the [No] Buffered phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isBufferedSpecified() const { return isBufferedSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isClearOnPurge() const { return getIsClearOnPurge(); }

// is the [No] ClearOnPurge phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isClearOnPurgeSpecified() const { return isClearOnPurgeSpec_; }

// is the compression phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isCompressionTypeSpecified() const { return isCompressionTypeSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isStorageTypeSpecified() const { return isStorageTypeSpec_; }

inline ComStorageType ParDDLFileAttrsCreateIndex::storageType() const { return storageType_; }

// void ParDDLFileAttrsCreateIndex::setStorageType(ComStorageType st)
//{ storageType_ = st; }

inline NABoolean ParDDLFileAttrsCreateIndex::isDCompress() const { return getIsDCompress(); }

// is the DCompress phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isDCompressSpecified() const { return isDCompressSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isICompress() const { return getIsICompress(); }

// is the ICompress phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isICompressSpecified() const { return isICompressSpec_; }

// is the MaxSize phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isMaxSizeSpecified() const { return isMaxSizeSpec_; }

inline NABoolean ParDDLFileAttrsCreateIndex::isMaxSizeUnbounded() const { return isMaxSizeUnbounded_; }

// is the Extent phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isExtentSpecified() const { return isExtentSpec_; }

// is the MaxExtent phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isMaxExtentSpecified() const { return isMaxExtentSpec_; }

// is the UID phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isUIDSpecified() const { return isUIDSpec_; }

// is the Row Format phrase specified?
inline NABoolean ParDDLFileAttrsCreateIndex::isRowFormatSpecified() const { return isRowFormatSpec_; }

//
// mutator
//

inline void ParDDLFileAttrsCreateIndex::setIsBuffered(NABoolean setting) { isBuffered_ = setting; }

...
class ParDDLFileAttrsAlterIndex : public ParDDLFileAttrs {
 public:
  // default constructor
  ParDDLFileAttrsAlterIndex(
      ParDDLFileAttrs::fileAttrsNodeTypeEnum fileAttrsNodeType = ParDDLFileAttrs::FILE_ATTRS_ALTER_INDEX);

  // copy constructor
  ParDDLFileAttrsAlterIndex(const ParDDLFileAttrsAlterIndex &alterIndexFileAttributes);

  // virtual destructor
  virtual ~ParDDLFileAttrsAlterIndex();

  // assignment operator
  ParDDLFileAttrsAlterIndex &operator=(const ParDDLFileAttrsAlterIndex &rhs);
...
inline ComSInt16 ParDDLFileAttrsAlterIndex::getExtentsToAllocate() const { return extentsToAllocate_; }

inline NABoolean ParDDLFileAttrsAlterIndex::getIsAuditCompress() const { return isAuditCompress_; }

inline NABoolean ParDDLFileAttrsAlterIndex::getIsBuffered() const { return isBuffered_; }
...
inline NABoolean ParDDLFileAttrsAlterIndex::isAuditCompress() const { return getIsAuditCompress(); }

// is the [No] AuditCompress phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isAuditCompressSpecified() const { return isAuditCompressSpec_; }

inline NABoolean ParDDLFileAttrsAlterIndex::isBuffered() const { return getIsBuffered(); }

// is the [No] Buffered phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isBufferedSpecified() const { return isBufferedSpec_; }

inline NABoolean ParDDLFileAttrsAlterIndex::isClearOnPurge() const { return getIsClearOnPurge(); }

// is the [No] ClearOnPurge phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isClearOnPurgeSpecified() const { return isClearOnPurgeSpec_; }

inline NABoolean ParDDLFileAttrsAlterIndex::isCompressionTypeSpecified() const { return isCompressionTypeSpec_; }

inline ComCompressionType ParDDLFileAttrsAlterIndex::getCompressionType() const { return compressionType_; }

// is the Deallocate phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isDeallocateSpecified() const { return isDeallocateSpec_; }

// is the MaxSize phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isMaxSizeSpecified() const { return isMaxSizeSpec_; }

inline NABoolean ParDDLFileAttrsAlterIndex::isMaxSizeUnbounded() const { return isMaxSizeUnbounded_; }

// is the Extent phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isExtentSpecified() const { return isExtentSpec_; }

// is the MaxExtents phrase specified?
inline NABoolean ParDDLFileAttrsAlterIndex::isMaxExtentSpecified() const { return isMaxExtentSpec_; }

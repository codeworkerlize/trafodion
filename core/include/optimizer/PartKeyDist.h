...
#include "optimizer/PartFunc.h"    /* partitioning function */
...
class PartitionKeyDistribution {
 public:
  ...
  PartitionKeyDistribution(const RangePartitioningFunction &partFunc, const ColStatDescList &inputHistograms);

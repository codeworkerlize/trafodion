...
class SimpleCostVector : public CostVector {
  ...
  //-------------------------------
  friend SimpleCostVector operator+(const SimpleCostVector &v1, const SimpleCostVector &v2);
  friend SimpleCostVector operator-(const SimpleCostVector &v1, const SimpleCostVector &v2);
  friend SimpleCostVector operator*(const SimpleCostVector &vector, const CostScalar &scalar);
  friend SimpleCostVector operator/(const SimpleCostVector &vector, const CostScalar &scalar);
  friend SimpleCostVector blockingAdd(const SimpleCostVector &v1, const SimpleCostVector &v2,
                                      const ReqdPhysicalProperty *const rpp);
  friend SimpleCostVector overlapAdd(const SimpleCostVector &v1, const SimpleCostVector &v2);
  friend SimpleCostVector overlapAddUnary(const SimpleCostVector &v1, const SimpleCostVector &v2);

  friend SimpleCostVector etMINOF(const SimpleCostVector &v1, const SimpleCostVector &v2,
                                  const ReqdPhysicalProperty *const rpp);
  friend SimpleCostVector etMAXOF(const SimpleCostVector &v1, const SimpleCostVector &v2,
                                  const ReqdPhysicalProperty *const rpp);
  friend SimpleCostVector vecMINOF(const SimpleCostVector &v1, const SimpleCostVector &v2);
  friend SimpleCostVector vecMAXOF(const SimpleCostVector &v1, const SimpleCostVector &v2);
  friend NABoolean isLowerBound(const SimpleCostVector &v1, const SimpleCostVector &v2);
 ...
 public:
  ...
  SimpleCostVector(const CostScalar &CPUTime = csZero, const CostScalar &IOTime = csZero,
                   const CostScalar &MSGTime = csZero, const CostScalar &idleTime = csZero,
  ...
  j*/
  // Used by SCM
  SimpleCostVector(const CostScalar &CPUTime, const CostScalar &IOTime, const CostScalar &MSGTime,
  ...
  virtual CostVector *copy() const { return new (CmpCommon::statementHeap()) SimpleCostVector(*this); }
  ...
  const SimpleCostVector &enforceUpperBound(const SimpleCostVector &upperBoundVector);
  ...
  inline const CostScalar &getCPUTime() const { return counter_[CPU_TIME]; }
  ...
  CostScalar getElapsedTime(const PerformanceGoal &goal, const CostWeight *const vectorWeight = NULL) const;
  ...
  inline const CostScalar &getIOTime() const { return counter_[IO_TIME]; }

  // -- time spent processing messages

  inline const CostScalar &getMessageTime() const { return counter_[MSG_TIME]; }

  // -- time spent without doing useful work

  inline const CostScalar &getIdleTime() const { return counter_[IDLE_TIME]; }
  // For SCM
  // get tuples processed
  inline const CostScalar &getTcProc() const { return counter_[TC_PROC]; }
  // get tuples produced
  inline const CostScalar &getTcProd() const { return counter_[TC_PROD]; }

  // get tuples sent
  inline const CostScalar &getTcSent() const { return counter_[TC_SENT]; }

  // get Random Ios
  inline const CostScalar &getIoRand() const { return counter_[IO_RAND]; }

  // get sequential Ios
  inline const CostScalar &getIoSeq() const { return counter_[IO_SEQ]; }

  // -- number of times the plan is run

  inline const CostScalar &getNumProbes() const { return counter_[NUM_PROBES]; }
  ...
  inline void setCPUTime(const CostScalar &value) { counter_[CPU_TIME] = value; }
  ...
  inline void setIOTime(const CostScalar &value) { counter_[IO_TIME] = value; }
  ...
  inline void setMSGTime(const CostScalar &value) { counter_[MSG_TIME] = value; }
  ...
  inline void setIdleTime(const CostScalar &value) { counter_[IDLE_TIME] = value; }
  inline void addToIdleTime(const CostScalar &value) { counter_[IDLE_TIME] += value; }

  inline void addToCpuTime(const CostScalar &value) { counter_[CPU_TIME] += value; }
  ////////////////// SET METHODS FOR SCM /////////////////////////////

  inline void setTcProc(const CostScalar &value) { counter_[TC_PROC] = value; }

  inline void setTcProd(const CostScalar &value) { counter_[TC_PROD] = value; }

  inline void setTcSent(const CostScalar &value) { counter_[TC_SENT] = value; }

  inline void setIoRand(const CostScalar &value) { counter_[IO_RAND] = value; }

  inline void setIoSeq(const CostScalar &value) { counter_[IO_SEQ] = value; }

  //////////////////// SETTING NUMBER OF PROBES /////////////////////

  // -- number of times the plan is run

  inline void setNumProbes(const CostScalar &value) { counter_[NUM_PROBES] = value; }
  inline void addToNumProbes(const CostScalar &value) { counter_[NUM_PROBES] += value; }

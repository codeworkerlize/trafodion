...
class RETDesc : public NABasicObject {
 ...
 public:
  ...
  CollIndex getSysColDegree() const { return systemColumnList_.entries(); }
 ...
 private:
  ...
  // ---------------------------------------------------------------------
  // store colRefName of all user columns of the table
  // ---------------------------------------------------------------------
  NAList<NAString> potentialUserColumnList_;

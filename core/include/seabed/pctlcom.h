...
// process functions
//
SB_Export short XPROCESS_GETPAIRINFO_(SB_Phandle_Type *SB_DA(processhandle, NULL), char *SB_DA(pair, NULL),
                                      short SB_DA(maxlen, 0), short *SB_DA(pair_length, NULL),
                                      SB_Phandle_Type *SB_DA(primary_processhandle, NULL),
                                      SB_Phandle_Type *SB_DA(backup_processhandle, NULL), int *SB_DA(search, NULL),
                                      SB_Phandle_Type *SB_DA(ancestor_phandle, NULL), char *SB_DA(node, NULL),
                                      short SB_DA(node_len, 0), short SB_DA(options, 0),
                                      char *SB_DA(ancestor_desc, NULL), short SB_DA(ancestor_desc_maxlen, 0),
                                      short *SB_DA(ancestor_desc_len, NULL),
                                      short *SB_DA(error_detail, NULL)) SB_DIAG_UNUSED;

//
// process handle functions
//
SB_Export short XPROCESSHANDLE_DECOMPOSE_(SB_Phandle_Type *processhandle, int *SB_DA(cpu, NULL), int *SB_DA(pin, NULL),
                                          int *SB_DA(nodenumber, NULL), char *SB_DA(nodename, NULL),
                                          short SB_DA(nodename_maxlen, XOMITSHORT), short *SB_DA(nodename_length, NULL),
                                          char *SB_DA(procname, NULL), short SB_DA(procname_maxlen, XOMITSHORT),
                                          short *SB_DA(procname_length, NULL),
                                          SB_Int64_Type *SB_DA(sequence_number, NULL)) SB_DIAG_UNUSED;

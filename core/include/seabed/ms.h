...
// SRE flags
enum { BSRE_PROCDEAD = 32, BSRE_MON = 8, BSRE_REMM = 4, BSRE_REMIDM = 2, BSRE_SECUREM = 1 };
enum { XSRE_PROCDEAD = 32, XSRE_MON = 8, XSRE_REMM = 4, XSRE_REMIDM = 2, XSRE_SECUREM = 1 };
...
typedef int (*MS_Mon_Tmlib_Cb_Type)(MS_Mon_Tmlib_Fun_Type fun, MS_Mon_Transid_Type transid_in,
                                    MS_Mon_Transid_Type *transid_out);
typedef int (*MS_Mon_Tmlib2_Cb_Type)(MS_Mon_Tmlib_Fun_Type fun, MS_Mon_Transid_Type transid_in,
                                     MS_Mon_Transid_Type *transid_out, MS_Mon_Transseq_Type startid_in,
                                     MS_Mon_Transseq_Type *startid_out, SB_Int64_Type svptid_in,
                                     SB_Int64_Type *svptid_out, SB_Int64_Type psvptid_in, SB_Int64_Type *psvptid_out);
...
typedef int (*MS_Lim_Queue_Cb_Type)(int msg_ptype, short *msg_ctrl, int msg_ctrl_len, char *msg_data, int msg_data_len);

// if these are updated, check msg_mon_init
typedef enum { MS_Mon_State_UnMounted = 0, MS_Mon_State_Mounted } MS_MON_DEVICE_STATE;
typedef enum {
...
typedef enum {
  ...
  MS_Mon_ZoneType_Any = (MS_Mon_ZoneType_Edge | MS_Mon_ZoneType_Aggregation | MS_Mon_ZoneType_Storage),
  MS_Mon_ZoneType_Frontend = (MS_Mon_ZoneType_Edge | MS_Mon_ZoneType_Aggregation),
  MS_Mon_ZoneType_Backend = (MS_Mon_ZoneType_Aggregation | MS_Mon_ZoneType_Storage)
} MS_MON_ZoneType;
...
//
enum { MS_BUF_OPTION_COPY = 0x00000001, MS_BUF_OPTION_ALL = 0x00000001 };
SB_Export short msg_buf_options(int options) SB_DIAG_UNUSED;
SB_Export short msg_buf_read_ctrl(int msgid, short **reqctrl, int *bytecount, int clear) SB_DIAG_UNUSED;
SB_Export short msg_buf_read_data(int msgid, char **buffer, int *bytecount, int clear) SB_DIAG_UNUSED;
SB_Export short msg_buf_register(MS_Buf_Alloc_Cb_Type callback_alloc, MS_Buf_Free_Cb_Type callback_free) SB_DIAG_UNUSED;

// Message System Messages to query about features enabled
SB_Export short msg_license_features_enabled();
SB_Export bool msg_license_advanced_enabled();
SB_Export bool msg_license_enterprise_enabled();
SB_Export bool msg_license_multitenancy_enabled();
...
// immediately exit.
//
SB_Export void msg_debug_hook(const char *who, const char *fname);
...
// Called by SQL
//
SB_Export SB_Phandle_Type *msg_get_phandle(char *pname) SB_DIAG_UNUSED;
SB_Export SB_Phandle_Type *msg_get_phandle(char *pname, int *fserr) SB_DIAG_UNUSED;

//
// Called by SQL
//
SB_Export SB_Phandle_Type *msg_get_phandle_no_open(char *pname) SB_DIAG_UNUSED;
...
SB_Export const char *msg_getenv_str(const char *key) SB_DIAG_UNUSED;

//
// Call this to get sequence id
//
SB_Export int msg_seqid_get_id(long *id, int timeout) SB_DIAG_UNUSED;

//
// Call this to initialize - like calling MPI_Init
// Note: This WILL change the args, so that it looks like start from a prog
//
SB_Export int msg_init(int *argc, char ***argv) SB_THROWS_FATAL SB_DIAG_UNUSED;

//
// Call this to initialize - like calling MPI_Init
// Note: args will NOT be changed (as in msg_init).
//
SB_Export int msg_init_attach(int *argc, char ***argv, int forkexec, char *name) SB_THROWS_FATAL SB_DIAG_UNUSED;
...
//
SB_Export int msg_init_attach_no_msg(int *argc, char ***argv, int forkexec, char *name) SB_THROWS_FATAL SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_close_process(SB_Phandle_Type *phandle) SB_DIAG_UNUSED;

#ifdef SQ_PHANDLE_VERIFIER
//
// Call this to create process name with seq #
//
SB_Export int msg_mon_create_name_seq(char *name, SB_Verif_Type verifier, char *name_seq,
                                      int name_seq_len) SB_DIAG_UNUSED;
#endif
...
//
SB_Export int msg_mon_deregister_death_notification(int target_nid, int target_pid,
...
// target_nid/target_pid may be -1 to deregister all associated with target_transid.
//
SB_Export int msg_mon_deregister_death_notification2(int notify_nid, int notify_pid, int target_nid, int target_pid,
                                                     MS_Mon_Transid_Type target_transid)
    SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
// target_nid/target_pid may be -1 to deregister all associated with target_transid.
//
SB_Export int msg_mon_deregister_death_notification3(int notify_nid, int notify_pid, SB_Verif_Type notify_verifier,
                                                     int target_nid, int target_pid, SB_Verif_Type target_verifier,
                                                     MS_Mon_Transid_Type target_transid) SB_DIAG_UNUSED;
...
// target_name may not be NULL!
//
SB_Export int msg_mon_deregister_death_notification_name2(const char *notify_name, const char *target_name,
                                                          MS_Mon_Transid_Type target_transid) SB_DIAG_UNUSED;
#endif
...
//
SB_Export int msg_mon_dump_process_id(const char *path, int nid, int pid,
                                      char *core_file) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED

//
// Call this to dump process by name
//
SB_Export int msg_mon_dump_process_name(const char *path, const char *name, char *core_file) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_event_send(int nid, int pid, int process_type, int event_id, int event_len,
                                 char *event_data) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
// The event data max size is MS_MON_MAX_SYNC_DATA.
//
SB_Export int msg_mon_event_send_name(const char *name, int process_type, int event_id, int event_len,
                                      char *event_data) SB_DIAG_UNUSED;
#endif
...
//
SB_Export int msg_mon_event_wait(int event_id, int *event_len, char *event_data) SB_DIAG_UNUSED;

//
// Similar to msg_mon_event_wait() but will return the an event-id.
//
SB_Export int msg_mon_event_wait2(int *event_id, int *event_len, char *event_data) SB_DIAG_UNUSED;

//
// Call this to get cluster id and instance id
//
SB_Export int msg_mon_get_instance_id(int *cluster_id, int *instance_id) SB_DIAG_UNUSED;

//
// Call this to get monitor stats
//
SB_Export int msg_mon_get_monitor_stats(MS_Mon_Monitor_Stats_Type *stats) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_get_my_process_name(char *name, int len) SB_DIAG_UNUSED;

//
// Call this to get segid
//
SB_Export int msg_mon_get_my_segid(int *segid) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_get_node_info(int *count, int max, MS_Mon_Node_Info_Entry_Type *info) SB_DIAG_UNUSED;
...
// if count would be greater than max, an error is returned
//
SB_Export int msg_mon_get_node_info2(int *count, int max, MS_Mon_Node_Info_Entry_Type *info, int *node_count,
                                     int *pnode_count, int *spares_count, int *available_spares_count) SB_DIAG_UNUSED;
...
// info is returned
//
SB_Export int msg_mon_get_node_info_all(MS_Mon_Node_Info_Type *info) SB_DIAG_UNUSED;
...
// info: is returned
//
SB_Export int msg_mon_get_node_info_detail(int nid, MS_Mon_Node_Info_Type *info) SB_DIAG_UNUSED;
...
// deprecated
//
SB_Export int msg_mon_get_open_info(int nid, int pid, char *name, int opened,
                                    MS_Mon_Open_Info_Type *info) SB_DIAG_DEPRECATED;
...
// deprecated
//
SB_Export int msg_mon_get_open_info_max(int nid, int pid, char *name, int opened, int *count, int max,
                                        MS_Mon_Open_Info_Max_Type *info) SB_DIAG_DEPRECATED;
...
// pid:  is returned
//
SB_Export int msg_mon_get_process_info(char *name, int *nid,
                                       int *pid) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
//
SB_Export int msg_mon_get_process_info2(char *name, int *nid, int *pid, SB_Verif_Type *verifier) SB_DIAG_UNUSED;
#endif
...
// info: is returned
//
SB_Export int msg_mon_get_process_info_detail(char *name, MS_Mon_Process_Info_Type *info) SB_DIAG_UNUSED;
...
// if count would be greater than max, an error is returned
//
SB_Export int msg_mon_get_process_info_type(int ptype, int *count, int max,
                                            MS_Mon_Process_Info_Type *info) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_get_process_name(int nid, int pid,
                                       char *name) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
// name:     is returned name
//
SB_Export int msg_mon_get_process_name2(int nid, int pid, SB_Verif_Type verifier, char *name) SB_DIAG_UNUSED;
#endif

//
// Call this to get trans info for process
//
SB_Export int msg_mon_get_trans_info_process(char *name, MS_Mon_Trans_Info_Type *info) SB_DIAG_UNUSED;

//
// Call this to get trans info for transid
//
SB_Export int msg_mon_get_trans_info_transid(MS_Mon_Transid_Type transid, MS_Mon_Trans_Info_Type *info) SB_DIAG_UNUSED;
...
// if count would be greater than max, an error is returned
//
SB_Export int msg_mon_get_zone_info(int *count, int max, MS_Mon_Zone_Info_Entry_Type *info) SB_DIAG_UNUSED;
...
// info: is returned
//
SB_Export int msg_mon_get_zone_info_detail(int nid, int zid, MS_Mon_Zone_Info_Type *info) SB_DIAG_UNUSED;

//
// Call this to mount device.
//
SB_Export int msg_mon_mount_device() SB_DIAG_UNUSED;

SB_Export int msg_mon_mount_device2(MS_MON_DEVICE_STATE *primary, MS_MON_DEVICE_STATE *mirror) SB_DIAG_UNUSED;

//
// Call this to down node.
//
SB_Export int msg_mon_node_down(int nid) SB_DIAG_UNUSED;

#ifdef SQ_PHANDLE_VERIFIER
//
// Call this to down node (with reason).
//
SB_Export int msg_mon_node_down2(int nid, const char *reason) SB_DIAG_UNUSED;
#endif

//
// Call this to up node.
//
SB_Export int msg_mon_node_up(int nid) SB_DIAG_UNUSED;

//
// Call this to open process
//
SB_Export int msg_mon_open_process(char *name, SB_Phandle_Type *phandle, int *oid) SB_DIAG_UNUSED;

//
// Call this to open process (backup)
//
SB_Export int msg_mon_open_process_backup(char *name, SB_Phandle_Type *phandle, int *oid) SB_DIAG_UNUSED;

//
// Call this to open process (interceptor)
//
SB_Export int msg_mon_open_process_ic(char *name, SB_Phandle_Type *phandle, int *oid) SB_DIAG_UNUSED;

//
// Call this to open process (nowait with callback)
//
SB_Export int msg_mon_open_process_nowait_cb(char *name, SB_Phandle_Type *phandle, MS_Mon_Open_Process_Cb_Type callback,
                                             long long tag, int *done, int *oid) SB_DIAG_UNUSED;

//
// Call this to open process (self)
//
SB_Export int msg_mon_open_process_self(SB_Phandle_Type *phandle, int *oid) SB_DIAG_UNUSED;

//
// Call this to open process (self-interceptor)
//
SB_Export int msg_mon_open_process_self_ic(SB_Phandle_Type *phandle, int *oid) SB_DIAG_UNUSED;

//
// Call this to handle process close
//
SB_Export int msg_mon_process_close() SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_process_startup(int sysmsgs) SB_THROWS_FATAL SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_process_startup2(int sysmsgs, int eventmsgs) SB_THROWS_FATAL SB_DIAG_UNUSED;
...
SB_Export int msg_mon_process_startup3(int sysmsgs, int pipeio,
                                       bool remap_stderr = true) SB_THROWS_FATAL SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_process_startup4(int sysmsgs, int pipeio, int altsig) SB_THROWS_FATAL SB_DIAG_UNUSED;

//
// Call this to process shutdown
//
SB_Export int msg_mon_process_shutdown() SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_reg_get(MS_Mon_ConfigType config_type, int next, char *group, char *key,
                              MS_Mon_Reg_Get_Type *info) SB_DIAG_UNUSED;

//
// Call this to set registry
//
SB_Export int msg_mon_reg_set(MS_Mon_ConfigType config_type, char *group, char *key, char *value) SB_DIAG_UNUSED;

//
// Call this to register for death notifications
//
SB_Export int msg_mon_register_death_notification(int target_nid,
                                                  int target_pid) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED

//
// Call this to register for death notifications (to notify_nid/notify_pid)
//
SB_Export int msg_mon_register_death_notification2(int notify_nid, int notify_pid, int target_nid,
                                                   int target_pid) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
//
SB_Export int msg_mon_register_death_notification4(int target_nid, int target_pid,
                                                   SB_Verif_Type target_verifier) SB_DIAG_UNUSED;
...
// target_name may not be NULL!
//
SB_Export int msg_mon_register_death_notification_name(const char *target_name) SB_DIAG_UNUSED;
...
SB_Export int msg_mon_register_death_notification_name2(const char *notify_name,
                                                        const char *target_name) SB_DIAG_UNUSED;
#endif

//
// Call this to re-open process (not normally called by application)
//
SB_Export int msg_mon_reopen_process(SB_Phandle_Type *phandle) SB_DIAG_UNUSED;

//
// Call this to shutdown
//
SB_Export int msg_mon_shutdown(int level) SB_DIAG_UNUSED;
...
// verifier: verifier
//
SB_Export int msg_mon_start_process(char *prog, char *name, char *ret_name, int argc, char **argv,
                                    SB_Phandle_Type *phandle, int open, int *oid, int ptype, int priority, int debug,
                                    int backup, int *nid, int *pid, char *infile, char *outfile
#ifdef SQ_PHANDLE_VERIFIER
                                    ,
...
//
SB_Export int msg_mon_start_process2(char *prog, char *name, char *ret_name, int argc, char **argv,
                                     SB_Phandle_Type *phandle, int open, int *oid, int ptype, int priority, int debug,
                                     int backup, int *nid, int *pid, char *infile, char *outfile, int unhooked
#ifdef SQ_PHANDLE_VERIFIER
                                     ,
                                     SB_Verif_Type *verifier = NULL
#endif
...
// verifier: verifier
//
SB_Export int msg_mon_start_process_nowait(char *prog, char *name, char *ret_name, int argc, char **argv,
                                           SB_Phandle_Type *phandle, int ptype, int priority, int debug, int backup,
                                           long long tag, int *nid, int *pid, char *infile, char *outfile
#ifdef SQ_PHANDLE_VERIFIER
                                           ,
                                           SB_Verif_Type *verifier = NULL
#endif
...
//
SB_Export int msg_mon_start_process_nowait2(char *prog, char *name, char *ret_name, int argc, char **argv,
                                            SB_Phandle_Type *phandle, int ptype, int priority, int debug, int backup,
                                            long long tag, int *nid, int *pid, char *infile, char *outfile, int unhooked
#ifdef SQ_PHANDLE_VERIFIER
                                            ,
                                            SB_Verif_Type *verifier = NULL
#endif
...
// verifier: verifier
//
SB_Export int msg_mon_start_process_nowait_cb(MS_Mon_Start_Process_Cb_Type callback, char *prog, char *name,
                                              char *ret_name, int argc, char **argv, int ptype, int priority, int debug,
                                              int backup, long long tag, int *nid, int *pid, char *infile, char *outfile
#ifdef SQ_PHANDLE_VERIFIER
                                              ,
                                              SB_Verif_Type *verifier = NULL
#endif
...
//
SB_Export int msg_mon_start_process_nowait_cb2(MS_Mon_Start_Process_Cb_Type callback, char *prog, char *name,
                                               char *ret_name, int argc, char **argv, int ptype, int priority,
                                               int debug, int backup, long long tag, int *nid, int *pid, char *infile,
                                               char *outfile, int unhooked
#ifdef SQ_PHANDLE_VERIFIER
                                               ,
                                               SB_Verif_Type *verifier = NULL
#endif
...
//
SB_Export int msg_mon_stop_process(char *name, int nid,
                                   int pid) SB_DIAG_UNUSED;  // TODO: ->SB_DIAG_DEPRECATED
...
// target_name may not be NULL!
//
SB_Export int msg_mon_stop_process_name(const char *name) SB_DIAG_UNUSED;
#endif
...
//
SB_Export int msg_mon_stfsd_send(void *data, int len, void *rsp_data, int *output_len, int tag) SB_DIAG_UNUSED;
#endif

//
// Call this to get text for config type
//
SB_Export const char *msg_mon_text_get_mon_config_type(MS_Mon_ConfigType ct) SB_DIAG_UNUSED;

//
// Call this to get text for device state
//
SB_Export const char *msg_mon_text_get_mon_device_state(MS_MON_DEVICE_STATE state) SB_DIAG_UNUSED;

//
// Call this to get text for msg type
//
SB_Export const char *msg_mon_text_get_mon_msg_type(MS_Mon_MSGTYPE mt) SB_DIAG_UNUSED;

//
// Call this to get text for proc state
//
SB_Export const char *msg_mon_text_get_mon_proc_state(MS_MON_PROC_STATE state) SB_DIAG_UNUSED;

//
// Call this to get text for process type
//
SB_Export const char *msg_mon_text_get_mon_process_type(MS_Mon_PROCESSTYPE pt) SB_DIAG_UNUSED;

//
// Call this to get text for req type
//
SB_Export const char *msg_mon_text_get_mon_req_type(MS_Mon_REQTYPE rt) SB_DIAG_UNUSED;

//
// Call this to get text for shutdown level
//
SB_Export const char *msg_mon_text_get_mon_shutdown_level(MS_MON_ShutdownLevel sl) SB_DIAG_UNUSED;

//
// Call this to get text for zone type
//
SB_Export const char *msg_mon_text_get_mon_zone_type(MS_MON_ZoneType zt) SB_DIAG_UNUSED;

//
// Call this to set TM leader
//
SB_Export int msg_mon_tm_leader_set(int *nid, int *pid, char *name) SB_DIAG_UNUSED;

//
// Call this to set TM ready for transactions
//
SB_Export int msg_mon_tm_ready(void) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_tmsync_issue(void *data, int len, int *handle, int tag) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_tmsync_register(MS_Mon_TmSync_Cb_Type callback) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_trace_register_change(MS_Mon_Trace_Cb_Type callback) SB_DIAG_UNUSED;

//
// Call this to delist trans
//
SB_Export int msg_mon_trans_delist(int tm_nid, int tm_pid, MS_Mon_Transid_Type transid) SB_DIAG_UNUSED;

//
// Call this to end trans
//
SB_Export int msg_mon_trans_end(int tm_nid, int tm_pid, MS_Mon_Transid_Type transid) SB_DIAG_UNUSED;

//
// Call this to enlist trans
//
SB_Export int msg_mon_trans_enlist(int tm_nid, int tm_pid, MS_Mon_Transid_Type transid) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_trans_register_tmlib(MS_Mon_Tmlib_Cb_Type callback) SB_DIAG_UNUSED;
...
//
SB_Export int msg_mon_trans_register_tmlib2(MS_Mon_Tmlib2_Cb_Type callback) SB_DIAG_UNUSED;

//
// Called by SQL
//
SB_Export short msg_set_phandle(char *pname, SB_Phandle_Type *phandle) SB_DIAG_UNUSED;

//
// Call this to disable assert (test)
//
SB_Export int msg_test_assert_disable() SB_DIAG_UNUSED;
...
//
SB_Export int msg_test_enable_client_only() SB_DIAG_UNUSED;

//
// For testing
//
SB_Export int msg_test_init(int *argc, char ***argv, int mpi_init) SB_DIAG_UNUSED;
...
// emulation functions
//
SB_Export short BMSG_ABANDON_(int msgid) SB_DIAG_UNUSED;
SB_Export short BMSG_AWAIT_(int msgid, int tov) SB_DIAG_UNUSED;
SB_Export short BMSG_BREAK_(int msgid, short *results, SB_Phandle_Type *phandle) SB_DIAG_UNUSED;
SB_Export short BMSG_BREAK_TIMEOUT_(int msgid, short *results, SB_Phandle_Type *phandle, int timeout) SB_DIAG_UNUSED;
SB_Export void BMSG_BREAK2_(int msgid, short *results, SB_Phandle_Type *phandle);
SB_Export short BMSG_GETREQINFO_(int itemcode, int msgid, int *item) SB_DIAG_UNUSED;
SB_Export void BMSG_HOLD_(int msgid);
SB_Export short BMSG_ISCANCELED_(int msgid) SB_DIAG_UNUSED;
SB_Export short BMSG_ISDONE_(int msgid) SB_DIAG_UNUSED;
SB_Export short BMSG_LINK_(SB_Phandle_Type *phandle, int *msgid, short *reqctrl, int reqctrlsize, short *replyctrl,
                           int replyctrlmax, char *reqdata, int reqdatasize, char *replydata, int replydatamax,
                           long linkertag, short pri, short xmitclass, short linkopts) SB_DIAG_UNUSED;
SB_Export short BMSG_LINK2_(SB_Phandle_Type *phandle, int *msgid, short *reqctrl, int reqctrlsize, short *replyctrl,
                            int replyctrlmax, char *reqdata, int reqdatasize, char *replydata, int replydatamax,
                            long linkertag, short pri, short xmitclass, short linkopts) SB_DIAG_UNUSED;
SB_Export short BMSG_LISTEN_(short *sre, short listenopts, long listenertag) SB_DIAG_UNUSED;
SB_Export short BMSG_READCTRL_(int msgid, short *reqctrl, int bytecount) SB_DIAG_UNUSED;
SB_Export short BMSG_READDATA_(int msgid, char *buffer, int bytecount) SB_DIAG_UNUSED;
SB_Export void BMSG_RELEASEALLHELD_();
SB_Export void BMSG_REPLY_(int msgid, short *replyctrl, int replyctrlsize, char *replydata, int replydatasize,
                           short errorclass, SB_Phandle_Type *newphandle);
SB_Export short BMSG_SETTAG_(int msgid, long tag) SB_DIAG_UNUSED;

SB_Export short XMSG_ABANDON_(int msgid) SB_DIAG_UNUSED;
SB_Export short XMSG_AWAIT_(int msgid, int tov) SB_DIAG_UNUSED;
SB_Export short XMSG_BREAK_(int msgid, short *results, SB_Phandle_Type *phandle) SB_DIAG_UNUSED;
SB_Export void XMSG_BREAK2_(int msgid, short *results, SB_Phandle_Type *phandle);
SB_Export short XMSG_GETREQINFO_(int itemcode, int msgid, int *item) SB_DIAG_UNUSED;
SB_Export void XMSG_HOLD_(int msgid);
SB_Export short XMSG_ISCANCELED_(int msgid) SB_DIAG_UNUSED;
SB_Export short XMSG_ISDONE_(int msgid) SB_DIAG_UNUSED;
SB_Export short XMSG_LINK_(SB_Phandle_Type *phandle, int *msgid, short *reqctrl, ushort reqctrlsize, short *replyctrl,
                           ushort replyctrlmax, char *reqdata, ushort reqdatasize, char *replydata, ushort replydatamax,
                           long linkertag, short pri, short xmitclass, short linkopts) SB_DIAG_UNUSED;
SB_Export short XMSG_LINK2_(SB_Phandle_Type *phandle, int *msgid, short *reqctrl, ushort reqctrlsize, short *replyctrl,
                            ushort replyctrlmax, char *reqdata, ushort reqdatasize, char *replydata,
                            ushort replydatamax, long linkertag, short pri, short xmitclass,
                            short linkopts) SB_DIAG_UNUSED;
SB_Export short XMSG_LISTEN_(short *sre, short listenopts, long listenertag) SB_DIAG_UNUSED;
SB_Export short XMSG_READCTRL_(int msgid, short *reqctrl, ushort bytecount) SB_DIAG_UNUSED;
SB_Export short XMSG_READDATA_(int msgid, char *buffer, ushort bytecount) SB_DIAG_UNUSED;
SB_Export void XMSG_RELEASEALLHELD_();
SB_Export void XMSG_REPLY_(int msgid, short *replyctrl, ushort replyctrlsize, char *replydata, ushort replydatasize,
                           short errorclass, SB_Phandle_Type *newphandle);
SB_Export short XMSG_SETTAG_(int msgid, long tag) SB_DIAG_UNUSED;

SB_Export short XCONTROLMESSAGESYSTEM(short actioncode, short value) SB_DIAG_UNUSED;

SB_Export short XMESSAGESYSTEMINFO(short itemcode, short *value) SB_DIAG_UNUSED;
...
enum { MSGINFO_NID = 1, MSGINFO_PID = 2, MSGINFO_PTYPE = 3 };

// max limits for XCONTROLMESSAGESYSTEM
enum { XMAX_SETTABLE_RECVLIMIT = 4095, XMAX_SETTABLE_SENDLIMIT = 4095 };
enum { XMAX_SETTABLE_RECVLIMIT_H = 16383, XMAX_SETTABLE_SENDLIMIT_H = 16383 };
enum { XMAX_SETTABLE_RECVLIMIT_TM = 25700, XMAX_SETTABLE_SENDLIMIT_TM = 25700 };

// item codes for XCONTROLMESSAGESYSTEM
enum { XCTLMSGSYS_SETRECVLIMIT = 0, XCTLMSGSYS_SETSENDLIMIT = 1 };

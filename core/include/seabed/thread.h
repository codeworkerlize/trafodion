...
//
SB_Export int thread_resume_suspended() SB_DIAG_UNUSED;

//
// suspend all threads except self
//
SB_Export int thread_suspend_all() SB_DIAG_UNUSED;
...
class SB_Export Sthr {
 public:
  ...
  static Id_Ptr create(char *name, Function fun, void *arg) SB_DIAG_UNUSED;
  ...
  static bool isExited(Id_Ptr tid) SB_DIAG_UNUSED;
  ...
  static int specific_key_create(int &new_key, Dtor_Function) SB_DIAG_UNUSED;
...
class SB_Export Nsem : public Sem {
 public:
  ...
  virtual int init(const char *name, int oflag, unsigned int mode, unsigned int value) SB_DIAG_UNUSED;
  virtual int post() SB_DIAG_UNUSED;                    // post

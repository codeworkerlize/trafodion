...
enum COM_VERSION {
  ...
  ,
  COM_VERS_OLDEST_SUPPORTED_SYSTEM_SCHEMA_VERSION =
      COM_VERS_OLDEST_SUPPORTED_SCHEMA_VERSION  // System schema version  (obsolete as of R2.4)
  ,
...
inline COM_VERSION ComVersion_GetCurrentSchemaVersion(void) { return COM_VERS_CURR_SCHEMA; };
inline COM_VERSION ComVersion_GetMXV(void) { return COM_VERS_MXV; };
inline COM_VERSION ComVersion_GetCurrentPlanVersion(void) { return COM_VERS_CURR_PLAN; };

...
#define RANGE_40TO7E (VBIT_40 | VBIT_41TO5A | VBIT_5BTO60 | VBIT_61TO7A | VBIT_7BTO7D | VBIT_7E)
...
#define RANGE_41TO5A_61TO7A_81TOFE (VBIT_41TO5A | VBIT_61TO7A | RANGE_81TOFE)
#define RANGE_41TO5A_61TO7A_81TOA0 (VBIT_41TO5A | VBIT_61TO7A | RANGE_81TOA0)
...
#define SJIS_PLANE2(c)    ((__cvtab[(unsigned)(c)] & RANGE_E0TOFC) && ((unsigned)(c) <= 0xea))
#define SJIS_PLANEU(c)    ((__cvtab[(unsigned)(c)] & RANGE_E0TOFC) && ((c) >= 0xeb))
#define SJIS_ROW1(c)      ((c)-0x81)
#define SJIS_ROW2(c)      ((c)-0xe0)
#define SJIS_ROW3(c)      (((c) >= 0xf0) ? ((c)-0xf0) : ((c)-0xeb + (0xfc - 0xf0 + 1)))
...
#define UIDX1_SJIS(idx)   ((((idx) / SJIS_COLSIZ + 0xf0) << 8) | idx_to_sjis[(idx) % SJIS_COLSIZ])
#define UIDX2_SJIS(idx)   ((((idx) / SJIS_COLSIZ + 0xeb) << 8) | idx_to_sjis[(idx) % SJIS_COLSIZ])
#define UIDX_SJIS(idx) \
  (((idx) < SJIS_UCNT1) ? UIDX1_SJIS(idx) : (((idx) -= SJIS_UCNT1), ((idx) < SJIS_UCNT2) ? UIDX2_SJIS(idx) : BAD))
...
#define BIG5_PLANE1(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOF9) && (__cvtab[(unsigned)(c2)] & RANGE_40TO7E))
#define BIG5_PLANE2(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOF9) && (__cvtab[(unsigned)(c2)] & RANGE_A1TOFE))
...
#define BIG5_IDXU(c1, c2) \
  (PLANEU + (BIG5_UDC1(c1) ? BIG5_UDC1IDX(c1) : BIG5_UDC2(c1) ? BIG5_UDC2IDX(c1) : BIG5_UDC3IDX(c1)) + big5_to_idx[c2])
#define BIG5_UDC(c1, c2)  BIG5_PLANEU(c1, c2)
#define BIG5_UIDX(c1, c2) (BIG5_IDXU(c1, c2) - PLANEU)
#define UIDX1_BIG5(idx)   ((((idx) / BIG5_COLSIZ + 0xfa) << 8) | idx_to_big5[(idx) % BIG5_COLSIZ])
#define UIDX2_BIG5(idx)   ((((idx) / BIG5_COLSIZ + 0x8e) << 8) | idx_to_big5[(idx) % BIG5_COLSIZ])
#define UIDX3_BIG5(idx)   ((((idx) / BIG5_COLSIZ + 0x81) << 8) | idx_to_big5[(idx) % BIG5_COLSIZ])
#define UIDX_BIG5(idx)                                 \
  (((idx) < BIG5_UCNT1)                                \
       ? UIDX1_BIG5(idx)                               \
       : (((idx) -= BIG5_UCNT1), ((idx) < BIG5_UCNT2)  \
                                     ? UIDX2_BIG5(idx) \
                                     : (((idx) -= BIG5_UCNT2), ((idx) < BIG5_UCNT3) ? UIDX3_BIG5(idx) : BAD)))
/*
...
#define HKSCS_PLANE1(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOFE) && (__cvtab[(unsigned)(c2)] & RANGE_40TO7E))
#define HKSCS_PLANE2(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOFE) && (__cvtab[(unsigned)(c2)] & RANGE_A1TOFE))
#define HKSCS_PLANE3(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_81TOA0) && ((c1) >= 0x88))
...
#define HKSCS_IDX3(c1, c2)   (PLANE3 + ((c1)-0x88) * HKSCS_COLSIZ + big5_to_idx[c2])
...
#define DECHANYU_IDXU1(c1, c2)                                                    \
  (PLANEU + (((c1) >= 0xfd) ? ((((c1)-0xfd) * 94 + (c2)-0xcc) + DECHANYU_START11) \
                            : ((((c1)-0xaa) * 94 + (c2)-0xa1) + DECHANYU_START12)))
#define DECHANYU_IDXU2(c1, c2) (PLANEU + (((c1)-0xf2) * 94 + (c2)-0x21) + DECHANYU_START2 - 0x24)

#define UIDX11_DECHANYU(idx) ((((idx + 0x2b) / 94 + 0xfd) << 8) | ((idx + 0x2b) % 94 + 0xa1))
#define UIDX12_DECHANYU(idx) ((((idx) / 94 + 0xaa) << 8) | ((idx) % 94 + 0xa1))
#define UIDX2_DECHANYU(idx)  ((((idx + 0x24) / 94 + 0xf2) << 8) | ((idx + 0x24) % 94 + 0x21))
#define UIDX_DECHANYU(idx)                                                               \
  (((idx) < DECHANYU_UCNT11) ? UIDX11_DECHANYU(idx)                                      \
                             : (((idx) -= DECHANYU_UCNT11),                              \
                                ((idx) < DECHANYU_UCNT12) ? UIDX12_DECHANYU(idx)         \
                                                          : (((idx) -= DECHANYU_UCNT12), \
                                                             ((idx) < DECHANYU_UCNT2) ? UIDX2_DECHANYU(idx) : BAD)))
...
#define DECHANYU_TO_IDXU4(c1, c2) (PLANEXU + ((c1)-0xa1) * 94 + DECHANYU_XUDC3_CNT + (c2)-0x21)
#define DECHANYU_FR_XUDC(ucs)                                            \
  (ucs -= UCS_XUDC_START,                                                \
   ((ucs) < DECHANYU_XUDC3_CNT)                                          \
       ? (0xc2cb0000 | (((ucs) / 94 + 0xe5) << 8) | ((ucs) % 94 + 0xa1)) \
       : (ucs -= DECHANYU_XUDC3_CNT,                                     \
          ((ucs) < DECHANYU_XUDC4_CNT) ? (0xc2cb0000 | (((ucs) / 94 + 0xa1) << 8) | ((ucs) % 94 + 0x21)) : BAD))
/*
...
#define UIDX_DECHANZI(idx)      ((idx) < DECHANZI_UCNT) ? ((((idx) / 94 + 0xa1) << 8) | (idx) % 94 + 0x21) : BAD
...
#define GB2312_IDXU(c1, c2) \
  (PLANEU +                 \
   (((c1) <= 0xaf) ? ((((c1)-0xaa) * 94 + (c2)-0xa1) + GBK_START11) : ((((c1)-0xf8) * 94 + (c2)-0xa1) + GBK_START12)))

#define UIDX11_GB2312(idx) ((((idx) / 94 + 0xaa) << 8) | ((idx) % 94 + 0xa1))
#define UIDX12_GB2312(idx) ((((idx) / 94 + 0xf8) << 8) | ((idx) % 94 + 0xa1))
#define UIDX_GB2312(idx)                        \
  (((idx) < GB2312_UCNT11) ? UIDX11_GB2312(idx) \
                           : (((idx) -= GB2312_UCNT11), ((idx) < GB2312_UCNT12) ? UIDX12_GB2312(idx) : BAD))
...
#define GBK_PLANE1(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOFE) && (__cvtab[(unsigned)(c2)] & RANGE_A1TOFE))
#define GBK_PLANE2(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_81TOA0) && (__cvtab[(unsigned)(c2)] & RANGE_40TO7E_80TOFE))
#define GBK_PLANE3(c1, c2) ((__cvtab[(unsigned)(c1)] & RANGE_A1TOFE) && (__cvtab[(unsigned)(c2)] & RANGE_40TO7E_80TOA0))
...
#define GBK_IDXU1(c1, c2) \
  (PLANEU +               \
   (((c1) <= 0xaf) ? ((((c1)-0xaa) * 94 + (c2)-0xa1) + GBK_START11) : ((((c1)-0xf8) * 94 + (c2)-0xa1) + GBK_START12)))
#define GBK_IDXU3(c1, c2) (PLANEU + ((c1)-0xa1) * 96 + __gbk_2bidx[c2] + GBK_START3)
...
#define UIDX_GBK(idx)                                  \
  (((idx) < GBK_UCNT11)                                \
       ? UIDX11_GBK(idx)                               \
       : (((idx) -= GBK_UCNT11), ((idx) < GBK_UCNT12)  \
                                     ? UIDX12_GBK(idx) \
                                     : (((idx) -= GBK_UCNT12), ((idx) < GBK_UCNT3) ? UIDX3_GBK(idx) : BAD)))
...
#define GB18030_4BYTE(c1, c2)  (GBK_VALID1(c1) && (__cvtab[(unsigned)(c2)] & VBIT_30TO39))
...
#define UIDX_DECKANJI(idx)      ((idx) < DECKANJI_UCNT) ? ((((idx) / 94 + 0xa1) << 8) | (idx) % 94 + 0x21) : BAD
...
#define EUCTW_TO_IDXU4(c1, c2) (PLANEXU + ((c1)-0xef) * 94 + EUCTW_XUDC3_CNT + (c2)-0xa1)
#define EUCTW_FR_XUDC(ucs)                                               \
  (ucs -= UCS_XUDC_START,                                                \
   ((ucs) < EUCTW_XUDC3_CNT)                                             \
       ? (0x8ea30000 | (((ucs) / 94 + 0xe8) << 8) | ((ucs) % 94 + 0xa1)) \
       : (ucs -= EUCTW_XUDC3_CNT,                                        \
          ((ucs) < EUCTW_XUDC4_CNT) ? (0x8ea40000 | (((ucs) / 94 + 0xef) << 8) | ((ucs) % 94 + 0xa1)) : BAD))
...
#define EUCJP_IDXU2(c1, c2)                                                    \
  (PLANEU + (((c1) >= 0xf5) ? ((((c1)-0xf5) * 94 + ((c2)-0xa1)) + EUCJP_UCNT1) \
...
#define UIDX_EUCJP(idx)                                   \
  (((idx) < EUCJP_UCNT1)                                  \
       ? UIDX1_EUCJP(idx)                                 \
       : (((idx) -= EUCJP_UCNT1), ((idx) < EUCJP_UCNT21)  \
                                      ? UIDX21_EUCJP(idx) \
                                      : (((idx) -= EUCJP_UCNT21), ((idx) < EUCJP_UCNT22) ? UIDX22_EUCJP(idx) : BAD)))
...
#define UCS_UIDX(ucs) (((ucs) >= UCS_XUDC_START) ? ((ucs)-UCS_XUDC_START + UCS_UCNT) : ((ucs)-0xe000))
#define UCS_UDC(ucs)  (((0xe000 <= (ucs)) && ((ucs) <= 0xf8ff)) || ((ucs) >= UCS_XUDC_START))
#define IDXU_UCS(idx) (((idx) >= PLANEXU) ? ((idx) + UCS_XUDC_START - PLANEXU) : ((idx) + UCS_UDC_START - PLANEU))

...
enum CatErrorCode {
  ...
  CAT_NOT_ALLOWED_FOR_SYSTEM_OBJECT = 1038,
  ...
  CAT_SENTRY_PRIV_EXCEPTION = 1054,
  CAT_TABLE_ALREADY_EXISTS = 1055,
  CAT_UNABLE_TO_UPGRADE = 1056,
  CAT_UNABLE_TO_RETRIEVE_ROLES = 1057,
  CAT_HISTOGRAM_TABLE_NOT_CREATED = 1058,
  CAT_DEPENDENT_CONSTRAINT_EXISTS = 1059,
  CAT_NO_LICENSE_ERROR = 1060,
  CAT_WRONG_NAMESPACE = 1061,
  CAT_USER_CANNOT_DROP_SMD_SCHEMA = 1062
  // used by namespace code                       = 1063
  // used by namespace code                       = 1064
  // used by namespace code                       = 1065
  // used by namespace code                       = 1066
  // used by namespace code                       = 1067
  ,
  ...
  // unused                                       = 1075
  ,
  CAT_REGISTER_USER_FAIL = 1075,
  CAT_AUTO_REGISTER_USER = 1076,
  CAT_PRIV_NOT_GRANTED_TO_ROLE = 1077,
  CAT_UNABLE_TO_RETRIEVE_AUTH_DETAILS = 1078
  // Used by dbSecurity
  ,
  CAT_USER_INVALID_FOR_TENANT = 1079
  ...
  CAT_NODE_NAME_INVALID = 1085,
  CAT_IS_NOT_CORRECT_AUTHID = 1086,
  CAT_GROUP_ALREADY_DEFINED = 1087,
  CAT_RESOURCE_GROUP_NOT_EXIST = 1088,
  CAT_SYSKEY_NOT_LAST_COLUMN = 1089,
  CAT_SELF_REFERENCING_CONSTRAINT = 1090,
  CAT_TENANT_DEFAULT_SCHEMA_INVALID = 1091
  // used in JNI interface TenantHelper           = 1092
  // used in JNI interface TenantHelper           = 1093
  ,
  CAT_TENANT_ALLOCATIONS = 1094,
  CAT_LAST_RESOURCE_GROUP = 1095,
  CAT_RESOURCE_GROUP_NOT_ASSIGNED = 1096,
  CAT_PARTITION_KEY_NOT_EXIST = 1097,
  CAT_PARTITION_KEY_DUPLICATED = 1098,
  CAT_VIEW_COLUMN_UNNAMED = 1099,
  CAT_LOB_COLUMN_ALTER = 1100,
  CAT_MISMATCH_AS_RG_TENANTS = 1101,
  CAT_INVALID_TENANT_RESOURCE_GROUPS = 1102,
  CAT_BALANCE_TENANTS = 1103,
  CAT_LAST_NODE = 1104,
  CAT_AUTHORIZATION_CLAUSE_INCORRECT = 1105,
  CAT_ROLE_OWNS_RESOURCES = 1106,
  CAT_RESOURCE_GROUP_NO_RESOURCES = 1107,
  CAT_NUM_OF_VIEW_COLS_NOT_MATCHED = 1108,
  CAT_WITH_CK_OPT_IN_NOT_UPDATABLE_VIEW = 1109,
  CAT_KLUDGE_TO_PRINT_TRACE_MESSAGE = 1110,
  CAT_SCHEMA_NOT_PART_OF_TENANT = 1111,
  CAT_SYSKEY_ONLY_INDEXED_COLUMNS_LIST = 1112,
  CAT_INVALID_ADMIN_ROLE = 1113,
  ...
  CAT_ROLE_UNAVAILABLE = 1124,
  CAT_ROLE_TO_GROUP_NOT_ALLOWED = 1125,
  CAT_INVALID_STORED_DESC = 1126,
  ...
  CAT_ROWKEY_LEN_TOO_LARGE_USING_SALT_PARTIONS = 1142,
  ...
  CAT_DDL_OP_IN_PROGRESS = 1224,
  CAT_NOT_ALLOWED_OPERATION_ON_LDAP_AUTH = 1225,
  CAT_IGNORE_SETUP_PASSWORD_WHEN_LOCAL_AUTH = 1226,
  ...
  // unused                                       = 1232
  ,
  CAT_SHARED_CACHE_LOAD_ERROR = 1233,
  CAT_SHARED_CACHE_DDL_OP_FAILED = 1235
  // unused                                       = 1236
  ,
  CAT_SHARED_CACHE_DUPLICATE_ESP = 1239,
  ...
  CAT_CANNOT_DROP_ADMIN_ROLE = 1365,
  ...
  CAT_INVALID_CHARS_IN_AUTH_PASSWORD = 1371,
  CAT_NOT_ALLOWED_CHANGE_OTHERS_PASSWORD = 1372,
  CAT_INVALID_SYNTAX_FORMAT = 1373,
  CAT_MUST_INPUT_PASSWORD = 1374
  // unused                                       = 1375
  // unused                                       = 1376
  // unused                                       = 1377
  // unused                                       = 1378
  // unused                                       = 1379
  ,
  CAT_EXCEED_MAX_PASSWORD_LENGTH = 1379
  // unused                                       = 1380
  // unused                                       = 1381
  ,
  ...
  // 1404 in use
  ,
  CAT_SENTRY_NOT_SUPPORTED = 1405,
  CAT_SENTRY_NO_GROUPS = 1406,
  CAT_SENTRY_NO_LINUX_UID = 1407,
  CAT_SENTRY_USER_NOT_FOUND = 1408
  // 1409 in use by namespace
  // Error code for Ngram Index
  ,
  CAT_NGRAM_INDEX_COL_CONFLICT_WITH_CLUSTERING_KEY = 1410,
  CAT_NGRAM_INDEX_COL_ON_MULTICOLUMNS_FORBIDDEN = 1411,
  CAT_NGRAM_INDEX_COL_ON_NONE_CHAR_VARCHAR_COLUMN = 1412,
  CAT_NGRAM_INDEX_CONFLICT_WITH_COMMON_INDEX = 1413,
  CAT_NGRAM_INDEX_DISABLED = 1414

  ,
  CAT_RESERVED_TENANT = 1415

  // 1420 - 1432 in use
  ,
  CAT_NOT_TENANT_USAGE = 1433,
  CAT_UPSHIFT_PLUS_SALT_NOT_SUPPORTED = 1434
  ...
  CAT_IDENTITY_COLUMN_DATATYPE_ALTER = 1515

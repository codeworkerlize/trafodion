...
class ex_hashj_tcb : public ex_tcb {
 ...
 public:
  ...
  enum HashJoinPhase { PHASE_1, PHASE_2, PHASE_3, PHASE_END };
 ...
 protected:
  ...
  // static versions
  static ExWorkProcRetcode sWorkDown(ex_tcb *tcb) { return ((ex_hashj_tcb *)tcb)->workDown(); }
  ...
  ex_expr *rangeSpecPackingExpr() const { return hashJoinTdb().rangeSpecPackingExpr(); }
...
inline ex_hashj_tcb::HashJoinState ex_hashj_private_state::getState() { return (state_); }

inline void ex_hashj_private_state::setOldState(ex_hashj_tcb::HashJoinState state) { oldState_ = state; }

inline ex_hashj_tcb::HashJoinState ex_hashj_private_state::getOldState() { return (oldState_); }

inline void ex_hashj_private_state::setPhase(ex_hashj_tcb::HashJoinPhase phase, ExBMOStats *bmoStats) {
  phase_ = phase;
  if (bmoStats) bmoStats->setBmoPhase(ex_hashj_tcb::HashJoinPhase::PHASE_END - phase);
}

inline ex_hashj_tcb::HashJoinPhase ex_hashj_private_state::getPhase() { return (phase_); }

inline void ex_hashj_private_state::usePreviousHT() { usingPreviousHT_ = TRUE; }

inline NABoolean ex_hashj_private_state::usingPreviousHT() { return (usingPreviousHT_); }

inline void ex_hashj_private_state::setHaveClusters(NABoolean haveClusters) { haveClusters_ = haveClusters; }

inline NABoolean ex_hashj_private_state::getHaveClusters() { return (haveClusters_); }
...
class ExUniqueHashJoinTcb : public ex_hashj_tcb {
 ...
 public:
  ExUniqueHashJoinTcb(const ex_hashj_tdb &hashJoinTdb, const ex_tcb &leftChildTcb, const ex_tcb &rightChildTcb,
                      ex_globals *glob);
 ...
 private:
  // static versions
  static ExWorkProcRetcode sWorkDown(ex_tcb *tcb) { return ((ExUniqueHashJoinTcb *)tcb)->workDown(); }
  static ExWorkProcRetcode sWorkUp(ex_tcb *tcb) { return ((ExUniqueHashJoinTcb *)tcb)->workUp(); }
  static ExWorkProcRetcode sCancel(ex_tcb *tcb) { return ((ExUniqueHashJoinTcb *)tcb)->workCancel(); }
  ...
  short workReadOuter();
  short workReturnRow(HashRow *dataPointer, atp_struct *leftRowAtp);
};

...
import com.esgyn.security.common.RuntimeEnv;
...
public class User {
  ...
  public String getShortName() throws InternalException {
   /* try {
	...
	//EsgynDB users run with trafodion principal. So use the EsgynDB user name as is and do not get the short kerberos name.
	return getName();
  }

...
public final class Constants {
  ...
  public static final String DEFAULT_ZOOKEEPER_ZNODE_MASTER = DEFAULT_ZOOKEEPER_ZNODE_DCS_PARENT + "/master";
  public static final String DEFAULT_ZOOKEEPER_ZNODE_MASTER_LEADER = DEFAULT_ZOOKEEPER_ZNODE_DCS_PARENT + "/leader";
  public static final String DEFAULT_ZOOKEEPER_ZNODE_SERVERS = DEFAULT_ZOOKEEPER_ZNODE_DCS_PARENT + "/servers";
  ...
  public static final String DEFAULT_TENANTS = "tenants";
  ...
  public static final String DEFAULT_ZOOKEEPER_ZNODE_WMS_TENANTS = DEFAULT_ZOOKEEPER_ZNODE_WMS_PARENT + "/" + DEFAULT_TENANTS;
  /**

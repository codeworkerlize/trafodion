...
#Unique identifier for rest servers
#export REST_IDENTIFIER=
...
# export SSH_OPTS="-o ConnectTimeout=1 -o SendEnv=REST_CONF_DIR"
...
# export REST_REST_OPTS="$REST_REST_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=8072"
...
# The directory where pid files are stored. $TRAF_VAR by default.

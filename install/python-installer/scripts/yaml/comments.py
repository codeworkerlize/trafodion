...
from scripts.yaml.compat import PY2, string_types, MutableSliceableSequence
from scripts.yaml.scalarstring import ScalarString
from scripts.yaml.anchor import Anchor
...
class CommentedBase(object):
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from scripts.yaml.error import CommentMark
        from scripts.yaml.tokens import CommentToken

...
# fmt: off
from scripts.yaml.error import (MarkedYAMLError, MarkedYAMLFutureWarning,
                               MantissaNoDotYAML1_1Warning)
from scripts.yaml.nodes import *                               # NOQA
from scripts.yaml.nodes import (SequenceNode, MappingNode, ScalarNode)
from scripts.yaml.compat import (utf8, builtins_module, to_str, PY2, PY3,  # NOQA
                                text_type, nprint, nprintf, version_tnf)
from scripts.yaml.compat import ordereddict, Hashable, MutableSequence  # type: ignore
from scripts.yaml.compat import MutableMapping  # type: ignore

from scripts.yaml.comments import *                               # NOQA
from scripts.yaml.comments import (CommentedMap, CommentedOrderedMap, CommentedSet,
                                  CommentedKeySeq, CommentedSeq, TaggedScalar,
                                  CommentedKeyMap)
from scripts.yaml.scalarstring import (SingleQuotedScalarString, DoubleQuotedScalarString,
                                      LiteralScalarString, FoldedScalarString,
                                      PlainScalarString, ScalarString,)
from scripts.yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from scripts.yaml.scalarfloat import ScalarFloat
from scripts.yaml.scalarbool import ScalarBoolean
from scripts.yaml.timestamp import TimeStamp
from scripts.yaml.util import RegExp
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from scripts.yaml.serializer import templated_id

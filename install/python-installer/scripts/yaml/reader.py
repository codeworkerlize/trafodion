...
from scripts.yaml.error import YAMLError, FileMark, StringMark, YAMLStreamError
from scripts.yaml.compat import text_type, binary_type, PY3, UNICODE_SIZE
from scripts.yaml.util import RegExp

if False:  # MYPY
    from typing import Any, Dict, Optional, List, Union, Text, Tuple, Optional  # NOQA
#    from scripts.yaml.compat import StreamTextType  # NOQA

...
from scripts.yaml.compat import utf8
...
Use 'load(stream, Loader=utils.yaml.Loader)' explicitly if that is OK.
Alternatively include the following in your code:

  import warnings
  warnings.simplefilter('ignore', utils.yaml.error.UnsafeLoaderWarning)
...
or alternatively include the following in your code:
  ...
  import warnings
  warnings.simplefilter('ignore', utils.yaml.error.MantissaNoDotYAML1_1Warning)

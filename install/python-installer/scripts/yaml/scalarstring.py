...
from scripts.yaml.compat import text_type
...
def walk_tree(base, map=None):
    ...
    (first of which is executed):
        map = scripts.yaml.compat.ordereddict
        map['\n'] = preserve_literal
        map[':'] = SingleQuotedScalarString
        walk_tree(data, map=map)
    """
    from scripts.yaml.compat import string_types
    from scripts.yaml.compat import MutableMapping, MutableSequence  # type: ignore

...
from scripts.yaml.error import YAMLError
from scripts.yaml.compat import nprint, DBG_NODE, dbg, string_types, nprintf  # NOQA
from scripts.yaml.util import RegExp

from scripts.yaml.events import (
    StreamStartEvent,
    StreamEndEvent,
    MappingStartEvent,
    MappingEndEvent,
...
from scripts.yaml.nodes import MappingNode, ScalarNode, SequenceNode

if False:  # MYPY
    from typing import Any, Dict, Union, Text, Optional  # NOQA
    from scripts.yaml.compat import VersionType  # NOQA

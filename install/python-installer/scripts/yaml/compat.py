...
nprint = Nprint()
nprintf = Nprint('/var/tmp/scripts.yaml.log')
...
def version_tnf(t1, t2=None):
    # type: (Any, Any) -> Any
    """
    return True if scripts.yaml version_info < t1, None if t2 is specified and bigger else False
    """
    from scripts.yaml import version_info  # NOQA

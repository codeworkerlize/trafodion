...
import sys
from scripts.yaml.error import YAMLError, YAMLStreamError
from scripts.yaml.events import *  # NOQA

# fmt: off
from scripts.yaml.compat import utf8, text_type, PY2, nprint, dbg, DBG_EVENT, \
    check_anchorname_char
# fmt: on

if False:  # MYPY
    from typing import Any, Dict, List, Union, Text, Tuple, Optional  # NOQA
    from scripts.yaml.compat import StreamType  # NOQA

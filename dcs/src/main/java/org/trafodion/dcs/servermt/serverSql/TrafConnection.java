...
// Publication Properties
        ...
        String internalQueriesInRepo = conf.get(Constants.DCS_SERVER_USER_PROGRAM_STORE_INTERNAL_QUERIES_IN_REPO,Constants.DEFAULT_DCS_SERVER_USER_PROGRAM_INTERNAL_QUERIES_IN_REPO);
        if(LOG.isDebugEnabled()){
            LOG.debug(serverWorkerName + ". Publication properties : statisticsIntervalTime :" + 
                     statisticsIntervalTime + " statisticsLimitTime :" + statisticsLimitTime + 
                    " internalQueriesInRepo :" + internalQueriesInRepo + 
        ...
        prop.setProperty(Constants.PROPERTY_STORE_INTERNAL_QUERIES_IN_REPO, internalQueriesInRepo);
        ...
        if (LOG.isDebugEnabled()) {
            ...
            for (String env : envs) {
                String value = GetJavaProperty.getEnv(env);
                if (value.length() != 0) {

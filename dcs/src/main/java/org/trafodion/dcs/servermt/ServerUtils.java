...
public final class ServerUtils  {
    ...
    public static final String[] MXO_STATES = new String[]{};
    ...
    private void init(){
        ...
        registeredPath = server.parentDcsZnode + Constants.DEFAULT_ZOOKEEPER_ZNODE_SERVERS_REGISTERED;
...
//================== Update Server State ===========================================
    ...
    public void updateServerState(int serverState) {
        try {
            switch (serverState) {
                case ServerConstants.SERVER_STATE_INIT:
                    updateStateToStarting();
                    break;
                case ServerConstants.SERVER_STATE_CONNECTED:
                    updateStateToConnected();
                    break;
                case ServerConstants.SERVER_STATE_DISCONNECTED:
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_CONNECT_FAILED:
                    updateStateConnectFailed();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_CONNECT_REJECTED:
                    updateStateConnectRejected();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_CONNECTING_TIMEOUTED:
                    updateStateConnectingTimeouted();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_READ_TIMEOUTED:
                    updateStateReadTimeouted();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_WRITE_TIMEOUTED:
                    updateStateWriteTimeouted();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_CLIENT_TIMEOUTED:
                    updateStateClientTimeouted();
                    updateServerStateAvailable();
                    break;
                case ServerConstants.SERVER_STATE_PORTINUSE:

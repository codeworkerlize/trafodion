...
<% 
  ...
  String zkParentDcsZnode = master.getZKParentDcsZnode(); 
...
<tr><td>Zookeeper Znode</td><td><%= zkParentDcsZnode %></td><td>Parent znode of DCS for this cluster</td></tr>
...
<br>
    ...
    <display:table name="serverItemList" id="currow"> 
        ...
        <display:column property="ctime" title="Start Time" sortable="true"/>
